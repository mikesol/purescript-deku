...
(function($PS) {
  ...
  var text_ = function (dictIsEvent) {
      return function (txt) {
          return text(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(txt));
      };
  };
...
(function($PS) {
  ...
  var button_ = function (dictIsEvent) {
      return button(dictIsEvent)(Control_Plus.empty(dictIsEvent.Plus0()));
  };
...
(function($PS) {
  ...
  var code_ = function (dictIsEvent) {
      return code(dictIsEvent)(Control_Plus.empty(dictIsEvent.Plus0()));
  };
  exports["code_"] = code_;
})(PS);
(function($PS) {
...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["Deku.DOM.Elt.Hr"] = $PS["Deku.DOM.Elt.Hr"] || {};
  var exports = $PS["Deku.DOM.Elt.Hr"];
  var Control_Plus = $PS["Control.Plus"];
  var Deku_Control = $PS["Deku.Control"];                
  ...
  var hr_ = function (dictIsEvent) {
      return hr(dictIsEvent)(Control_Plus.empty(dictIsEvent.Plus0()));
  };
  exports["hr_"] = hr_;
})(PS);
(function($PS) {
  ...
  var i_ = function (dictIsEvent) {
      return i(dictIsEvent)(Control_Plus.empty(dictIsEvent.Plus0()));
  };
  exports["i_"] = i_;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["Deku.DOM.Elt.Img"] = $PS["Deku.DOM.Elt.Img"] || {};
  var exports = $PS["Deku.DOM.Elt.Img"];
  var Deku_Control = $PS["Deku.Control"];                
...
(function($PS) {
  ...
  var li_ = function (dictIsEvent) {
      return li(dictIsEvent)(Control_Plus.empty(dictIsEvent.Plus0()));
  };
  exports["li_"] = li_;
})(PS);
(function($PS) {
  ...
  var pre_ = function (dictIsEvent) {
      return pre(dictIsEvent)(Control_Plus.empty(dictIsEvent.Plus0()));
  };
  exports["pre_"] = pre_;
})(PS);
(function($PS) {
  ...
  var span_ = function (dictIsEvent) {
      return span(dictIsEvent)(Control_Plus.empty(dictIsEvent.Plus0()));
  };
  exports["span"] = span;
  exports["span_"] = span_;
})(PS);
(function($PS) {
  ...
  var ul_ = function (dictIsEvent) {
      return ul(dictIsEvent)(Control_Plus.empty(dictIsEvent.Plus0()));
  };
  exports["ul_"] = ul_;
})(PS);
(function($PS) {
      ...
      return function (dictPlus) {
          return function (dpage) {
              return Deku_Pursx.makePursx({
                  ...
                  code: Deku_Pursx.nut(Deku_DOM_Elt_Pre.pre_(dictIsEvent)([ Deku_DOM_Elt_Code.code_(dictIsEvent)([ Deku_Control.text_(dictIsEvent)("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Deku.Control (flatten, text_)\x0aimport Deku.DOM as D\x0aimport Deku.Attribute ((:=))\x0aimport Deku.Toplevel ((\ud83d\ude80))\x0aimport Effect (Effect)\x0a\x0amain :: Effect Unit\x0amain = unit \ud83d\ude80 \\_ _ ->\x0a  flatten\x0a    [ D.button_ [ text_ \"I do nothing\" ]\x0a    , D.ul_ $ map (D.li_ <<< pure <<< text_) [ \"A\", \"B\", \"C\" ]\x0a    , D.div_\x0a        [ D.a (bang $ D.Href := \"https://example.com\")\x0a            [ text_ \"foo \" ]\x0a        , D.i_ [ text_ \" bar \" ]\x0a        , D.span (bang $ D.Style := \"font-weight: 800;\")\x0a            [ text_ \" baz\" ]\x0a        ]\x0a    , D.div_\x0a        [ D.div_\x0a            [ D.div_ [ D.input (bang $ D.Xtype := \"range\") [] ]\x0a            ]\x0a        ]\x0a    ]") ]) ])),
                  result: Deku_Pursx.nut(Deku_DOM_Elt_Div.div_(dictIsEvent)([ Deku_DOM_Elt_Button.button_(dictIsEvent)([ Deku_Control.text_(dictIsEvent)("I do nothing") ]), Deku_DOM_Elt_Ul.ul_(dictIsEvent)(Data_Functor.map(Data_Functor.functorArray)((function () {
                      var $2 = Deku_DOM_Elt_Li.li_(dictIsEvent);
                      var $3 = Control_Applicative.pure(Control_Applicative.applicativeArray);
                      var $4 = Deku_Control.text_(dictIsEvent);
                      return function ($5) {
                          return $2($3($4($5)));
                      };
                  })())([ "A", "B", "C" ])), Deku_DOM_Elt_Div.div_(dictIsEvent)([ Deku_DOM_Elt_A.a(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_Href.attrA_HrefString)(Deku_DOM_Attr_Href.Href.value)("https://example.com")))([ Deku_Control.text_(dictIsEvent)("foo ") ]), Deku_DOM_Elt_I.i_(dictIsEvent)([ Deku_Control.text_(dictIsEvent)(" bar ") ]), Deku_DOM_Elt_Span.span(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_Style.attrSpan_StyleString)(Deku_DOM_Attr_Style.Style.value)("font-weight: 800;")))([ Deku_Control.text_(dictIsEvent)(" baz") ]) ]), Deku_DOM_Elt_Div.div_(dictIsEvent)([ Deku_DOM_Elt_Div.div_(dictIsEvent)([ Deku_DOM_Elt_Div.div_(dictIsEvent)([ Deku_DOM_Elt_Input.input(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_Xtype.attrInput_XtypeString)(Deku_DOM_Attr_Xtype.Xtype.value)("range")))([  ]) ]) ]) ]) ])),
                  next: FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.PURSX1.value))(Deku_Example_Docs_Util.scrollToTop)))))
              });
          };
      };
  };
                  ...
                  var go = function (parent) {
                      return function (v) {
                          return FRP_Event_Class.keepLatest(dictIsEvent)(Data_Functor.map((dictIsEvent.Filterable1()).Functor1())(function (id) {
                              return Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(FRP_Event_Class.bang(dictIsEvent)(v.makeSubgraph({
                                  id: id,
                                  parent: parent,
                                  scenes: scenes
                                  ...
                                  if (v1.value1 instanceof Insert) {
                                      return v.insertSubgraph({
                                          id: id,
                                          pos: Data_Hashable.hash(dictHashable)(v1.value0),
                                          index: v1.value0
                                      });
                                  };
                                  throw new Error("Failed pattern match at Deku.Subgraph (line 40, column 36 - line 44, column 49): " + [ v1.value1.constructor.name ]);
                              })(mods));
                          })(FRP_Behavior.sample_(dictIsEvent)(v.ids)(FRP_Event_Class.bang(dictIsEvent)(Data_Unit.unit))));
                      };
                  };
                  return go;
              };
  ...
  var clickCb = function (push) {
      return Deku_Attribute.cb(Data_Function["const"](function __do() {
          ...
          return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
              ...
              throw new Error("Failed pattern match at Deku.Example.Docs.Effects (line 45, column 9 - line 52, column 48): " + [ result.constructor.name ]);
          }))();
      }));
  };
                  ...
                  result: Deku_Pursx.nut(Deku_Subgraph.subgraph(Data_Hashable.hashableUnit)(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Data_Unit.unit, Deku_Subgraph.Insert.value)))(function (v) {
                      return Data_Exists.mkExists(function (push) {
                          return function (event) {
                              ...
                              return Deku_Control.flatten(dictIsEvent.Plus0())([ Deku_DOM_Elt_Div.div_(dictIsEvent)([ Deku_DOM_Elt_Button.button(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(clickCb(push))))([ Deku_Control.text(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(FRP_Event_Class.bang(dictIsEvent)(clickText))(Data_Functor.voidLeft((dictIsEvent.Filterable1()).Functor1())(loading)("Loading...")))(Data_Functor.voidLeft((dictIsEvent.Filterable1()).Functor1())(result)(clickText))) ]) ]), Deku_DOM_Elt_Div.div(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_Style.attrDiv_StyleString)(Deku_DOM_Attr_Style.Style.value)("display: none;")))(Data_Functor.voidLeft((dictIsEvent.Filterable1()).Functor1())(Data_Compactable.compact((dictIsEvent.Filterable1()).Compactable0())(FRP_Event_Class.mapAccum(dictIsEvent)(function (v1) {
                                  return function (b) {
                              ...
                              })(result)(true)))(Deku_Attribute.attr(Deku_DOM_Attr_Style.attrDiv_StyleString)(Deku_DOM_Attr_Style.Style.value)("display: block;"))))([ Deku_DOM_Elt_Pre.pre_(dictIsEvent)([ Deku_DOM_Elt_Code.code_(dictIsEvent)([ Deku_Control.text(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(FRP_Event_Class.bang(dictIsEvent)(""))(result)) ]) ]) ]) ]);
                          };
                      });
                  })),
                  next: FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.PURSX2.value))(Deku_Example_Docs_Util.scrollToTop)))))
              });
          };
      };
  };
      ...
      return function (dictPlus) {
          return function (dpage) {
              return Deku_Pursx.makePursx({
                  ...
                  code: Deku_Pursx.nut(Deku_DOM_Elt_Pre.pre_(dictIsEvent)([ Deku_DOM_Elt_Code.code_(dictIsEvent)([ Deku_Control.text_(dictIsEvent)("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Control.Alt ((<|>))\x0aimport Data.Filterable (filter, filterMap)\x0aimport Data.Foldable (for_, oneOfMap)\x0aimport Data.Maybe (Maybe(..))\x0aimport Data.Tuple.Nested ((/\\))\x0aimport Deku.Attribute (cb, (:=))\x0aimport Deku.Control (text, text_)\x0aimport Deku.DOM as D\x0aimport Deku.Toplevel ((\ud83d\ude80))\x0aimport Effect (Effect)\x0aimport FRP.Event (mapAccum)\x0aimport Web.DOM.Element (fromEventTarget)\x0aimport Web.Event.Event (target)\x0aimport Web.HTML.HTMLInputElement (fromElement, valueAsNumber)\x0a\x0adata UIEvents = UIShown | ButtonClicked | SliderMoved Number\x0aderive instance Eq UIEvents\x0a\x0amain :: Effect Unit\x0amain = UIShown \ud83d\ude80 \\push event ->\x0a  D.div_\x0a    [ D.button\x0a        (bang (D.OnClick := cb (const $ push ButtonClicked)))\x0a        [ text_ \"Click\" ]\x0a    , D.div_\x0a        [ text\x0a            ( (bang \"Val: 0\") <|>\x0a                ( mapAccum (const $ \\x -> (x + 1) /\\ x)\x0a                    (filter (eq ButtonClicked) event)\x0a                    0\x0a                    # map (append \"Val: \" <<< show)\x0a                )\x0a            )\x0a        ]\x0a    , D.div_\x0a        [ D.input\x0a            ( oneOfMap bang\x0a                [ D.Xtype := \"range\"\x0a                , D.OnInput := cb \\e -> for_\x0a                    ( target e\x0a                        >>= fromEventTarget\x0a                        >>= fromElement\x0a                    )\x0a                    ( valueAsNumber\x0a                        >=> push <<< SliderMoved\x0a                    )\x0a                ]\x0a            )\x0a            []\x0a        , D.div_\x0a            [ text\x0a                ( (bang \"Val: 50\") <|>\x0a                    ( filterMap\x0a                        ( case _ of\x0a                            SliderMoved n -> Just n\x0a                            _ -> Nothing\x0a                        )\x0a                        event\x0a                        # map (append \"Val: \" <<< show)\x0a                    )\x0a                )\x0a            ]\x0a        ]\x0a    ]\x0a") ]) ])),
                  result: Deku_Pursx.nut(Deku_Subgraph.subgraph(Data_Hashable.hashableUnit)(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Data_Unit.unit, Deku_Subgraph.Insert.value)))(function (v) {
                      return Data_Exists.mkExists(function (push) {
                          return function (event) {
                              return Deku_Control.flatten(dictIsEvent.Plus0())([ Deku_DOM_Elt_Button.button(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(ButtonClicked.value))))))([ Deku_Control.text_(dictIsEvent)("Click") ]), Deku_DOM_Elt_Div.div_(dictIsEvent)([ Deku_Control.text(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(FRP_Event_Class.bang(dictIsEvent)("Val: 0"))(Data_Functor.map((dictIsEvent.Filterable1()).Functor1())((function () {
                              ...
                              }))(Data_Filterable.filter(dictIsEvent.Filterable1())(Data_Eq.eq(eqUIEvents)(ButtonClicked.value))(event))(1)))) ]), Deku_DOM_Elt_Div.div_(dictIsEvent)([ Deku_DOM_Elt_Input.input(dictIsEvent)(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(dictIsEvent.Plus0())(FRP_Event_Class.bang(dictIsEvent))([ Deku_Attribute.attr(Deku_DOM_Attr_Xtype.attrInput_XtypeString)(Deku_DOM_Attr_Xtype.Xtype.value)("range"), Deku_Attribute.attr(Deku_DOM_Attr_OnInput.attrOnInputCb)(Deku_DOM_Attr_OnInput.OnInput.value)(Deku_Attribute.cb(function (e) {
                              ...
                              })) ]))([  ]), Deku_DOM_Elt_Div.div_(dictIsEvent)([ Deku_Control.text(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(FRP_Event_Class.bang(dictIsEvent)("Val: 50"))(Data_Functor.map((dictIsEvent.Filterable1()).Functor1())((function () {
                  ...
                  next: FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.Effects.value))(Deku_Example_Docs_Util.scrollToTop)))))
              });
          };
      };
  };
      ...
      return function (dictIsEvent) {
          return function (dpage) {
              return Deku_Pursx.makePursx({
                  ...
                  code: Deku_Pursx.nut(Deku_DOM_Elt_Pre.pre_(dictIsEvent)([ Deku_DOM_Elt_Code.code_(dictIsEvent)([ Deku_Control.text_(dictIsEvent)("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Deku.Control (text_)\x0aimport Deku.Toplevel ((\ud83d\ude80))\x0aimport Effect (Effect)\x0a\x0amain :: Effect Unit\x0amain = unit \ud83d\ude80 \\_ _ -> text_ \"Hello world\"") ]) ])),
                  result: Deku_Pursx.nut(Deku_DOM_Elt_Div.div_(dictIsEvent)([ Deku_Control.text_(dictIsEvent)("Hello world") ])),
                  next: FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.SimpleComponent.value))(Deku_Example_Docs_Util.scrollToTop)))))
              });
          };
      };
  };
  ...
  var intro = function (dictIsEvent) {
      return function (dictPlus) {
          return function (dpage) {
              ...
              })()()(Deku_Pursx.pursxToElementConsAttr()(Deku_Pursx.pursxToElementNil(dictIsEvent.Plus0()))({
                  reflectSymbol: function () {
                      return "next";
                  }
              }))(dictIsEvent)(px)({
                  next: FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.HelloWorld.value))(Deku_Example_Docs_Util.scrollToTop)))))
              });
          };
      };
  };
  ...
  var portal = function (dictIsEvent) {
      return function (elt) {
          return function (cf) {
              var go = function (parent) {
                  return function (v) {
                      return FRP_Event_Class.keepLatest(dictIsEvent)(Data_Functor.mapFlipped((dictIsEvent.Filterable1()).Functor1())(FRP_Behavior.sample_(dictIsEvent)(v.ids)(FRP_Event_Class.bang(dictIsEvent)(Data_Unit.unit)))(function (portalId) {
                          var cont = cf(function (eb) {
                              var gogo = function (par) {
                                  return function (v1) {
                                      return FRP_Event_Class.keepLatest(dictIsEvent)(Data_Functor.mapFlipped((dictIsEvent.Filterable1()).Functor1())(FRP_Behavior.sample_(dictIsEvent)(v1.ids)(FRP_Event_Class.bang(dictIsEvent)(Data_Unit.unit)))(function (gatewayId) {
                                          return Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(FRP_Event_Class.bang(dictIsEvent)(v1.makeGateway({
                                              id: gatewayId,
                                              parent: par,
                                              portal: portalId
                          ...
                          return Data_Foldable.oneOf(Data_Foldable.foldableArray)(dictIsEvent.Plus0())([ FRP_Event_Class.bang(dictIsEvent)(v.makePortal({
                              id: portalId
...
(function($PS) {
  ...
  var Deku_DOM_Elt_Code = $PS["Deku.DOM.Elt.Code"];
  var Deku_DOM_Elt_Div = $PS["Deku.DOM.Elt.Div"];
  var Deku_DOM_Elt_Img = $PS["Deku.DOM.Elt.Img"];
  var Deku_DOM_Elt_Pre = $PS["Deku.DOM.Elt.Pre"];
  ...
  var hashableSgs = {
      hash: (function () {
          var $32 = Data_Hashable.hash(Data_Hashable.hashableString);
          var $33 = Data_Show.show(showSgs);
          return function ($34) {
              return $32($33($34));
          };
      })(),
              ...
              return function (gateway1) {
                  return function (sg) {
                      return Data_Exists.mkExists(function (v) {
                          return function (v1) {
                              return Deku_DOM_Elt_Div.div_(dictIsEvent)([ gateway0(Data_Functor.map((dictIsEvent.Filterable1()).Functor1())((function () {
  ...
  var portals = function (dictIsEvent) {
      return function (dictPlus) {
          return function (v) {
              return Deku_Pursx.makePursx({
              ...
              })()()(Deku_Pursx.pursxToElementConsElt()(Deku_Pursx.pursxToElementConsElt()(Deku_Pursx.pursxToElementNil(dictIsEvent.Plus0()))({
                  reflectSymbol: function () {
                      return "result";
                  }
              }))({
                  ...
                  code: Deku_Pursx.nut(Deku_DOM_Elt_Pre.pre_(dictIsEvent)([ Deku_DOM_Elt_Code.code_(dictIsEvent)([ Deku_Control.text_(dictIsEvent)("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Control.Alt ((<|>))\x0aimport Data.Exists (mkExists)\x0aimport Data.Hashable (class Hashable, hash)\x0aimport Data.Tuple.Nested ((/\\))\x0aimport Deku.Attribute (Attribute, cb, (:=))\x0aimport Deku.Control (flatten, text_)\x0aimport Deku.Core (Element, Subgraph, SubgraphF(..))\x0aimport Deku.DOM as D\x0aimport Deku.Portal (portal)\x0aimport Deku.Subgraph (SubgraphAction(..), (@@))\x0aimport Deku.Toplevel ((\ud83d\ude80))\x0aimport Effect (Effect)\x0aimport FRP.Event (class IsEvent)\x0aimport FRP.Event.Class (bang)\x0a\x0adata UIEvents = UIShown | ButtonClicked | SliderMoved Number\x0aderive instance Eq UIEvents\x0a\x0adata Sgs = Sg0 | Sg1\x0aderive instance Eq Sgs\x0aderive instance Ord Sgs\x0ainstance Show Sgs where\x0a  show Sg0 = \"Sg0\"\x0a  show Sg1 = \"Sg1\"\x0ainstance Hashable Sgs where\x0a  hash = show >>> hash\x0a\x0amySub\x0a  :: forall event payload\x0a   . IsEvent event => event Boolean\x0a  -> (event Boolean -> Element event payload)\x0a  -> (event Boolean -> Element event payload)\x0a  -> Subgraph Sgs event payload\x0amySub event gateway0 gateway1 sg = mkExists $ SubgraphF \\_ _ -> D.div_\x0a  [ gateway0\x0a      ( map\x0a          ( case sg of\x0a              Sg0 -> identity\x0a              Sg1 -> not\x0a          )\x0a          event\x0a      )\x0a  , gateway1\x0a      ( map\x0a          ( case sg of\x0a              Sg0 -> not\x0a              Sg1 -> identity\x0a          )\x0a          event\x0a      )\x0a  ]\x0a\x0aimg0' :: forall event. IsEvent event => event (Attribute D.Img_)\x0aimg0' = bang $ D.Src := \"https://picsum.photos/200\"\x0aimg1' :: forall event. IsEvent event => event (Attribute D.Img_)\x0aimg1' = bang $ D.Src := \"https://picsum.photos/300\"\x0a\x0amain :: Effect Unit\x0amain = false \ud83d\ude80 \\push event ->\x0a  portal (D.img img0' []) \\img0 ->\x0a    portal (D.img img1' []) \\img1 ->\x0a      let eventBool = event <|> bang false in\x0a      flatten\x0a        [ ( bang (Sg0 /\\ Insert)\x0a              <|> bang (Sg1 /\\ Insert)\x0a          ) @@ mySub eventBool img0 img1\x0a        , D.button (map (\\e -> D.OnClick :=\x0a        cb (const (push $ not e))) eventBool)\x0a            [ text_ \"Shift images between portals\" ]\x0a        ]") ]) ])),
                  result: Deku_Pursx.nut(Deku_Subgraph.subgraph(Data_Hashable.hashableUnit)(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Data_Unit.unit, Deku_Subgraph.Insert.value)))(function (v1) {
                      return Data_Exists.mkExists(function (push) {
                          return function (event) {
                              return Deku_Portal.portal(dictIsEvent)(Deku_DOM_Elt_Img.img(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_Src.attrImg_SrcString)(Deku_DOM_Attr_Src.Src.value)("https://picsum.photos/200")))([  ]))(function (img0) {
                                  return Deku_Portal.portal(dictIsEvent)(Deku_DOM_Elt_Img.img(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_Src.attrImg_SrcString)(Deku_DOM_Attr_Src.Src.value)("https://picsum.photos/300")))([  ]))(function (img1) {
                                      var eventBool = Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(event)(FRP_Event_Class.bang(dictIsEvent)(false));
                                      return Deku_Control.flatten(dictIsEvent.Plus0())([ Deku_Subgraph.subgraph(hashableSgs)(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Sg0.value, Deku_Subgraph.Insert.value)))(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Sg1.value, Deku_Subgraph.Insert.value))))(mySub(dictIsEvent)(eventBool)(img0)(img1)), Deku_DOM_Elt_Button.button(dictIsEvent)(Data_Functor.map((dictIsEvent.Filterable1()).Functor1())(function (e) {
                                          return Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(!e))));
      ...
      return function (dictPlus) {
          return function (dpage) {
              return Deku_Pursx.makePursx({
                  ...
                  })()(Deku_Pursx.pursxToElementNil(dictIsEvent.Plus0()))(dictIsEvent)(myDom)),
                  next: FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.Events.value))(Deku_Example_Docs_Util.scrollToTop)))))
              });
          };
      };
  };
                  ...
                  result: Deku_Pursx.nut(Deku_Subgraph.subgraph(Data_Hashable.hashableUnit)(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Data_Unit.unit, Deku_Subgraph.Insert.value)))(function (v) {
                      return Data_Exists.mkExists(function (push) {
                          return function (event) {
                              return Deku_Pursx.makePursx({
                              ...
                              })()()(Deku_Pursx.pursxToElementConsAttr()(Deku_Pursx.pursxToElementConsElt()(Deku_Pursx.pursxToElementNil(dictIsEvent.Plus0()))({
                                  reflectSymbol: function () {
                                      return "somethingNew";
                                  }
                              }))({
                                  ...
                                  myli: FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_Style.attrLi_StyleString)(Deku_DOM_Attr_Style.Style.value)("background-color:rgb(200,240,210);")),
                                  somethingNew: Deku_Pursx.nut(Deku_DOM_Elt_Button.button(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(new Data_Maybe.Just(Data_Unit.unit)))))))([ Deku_Control.text(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(Data_Functor.voidLeft((dictIsEvent.Filterable1()).Functor1())(Data_Compactable.compact((dictIsEvent.Filterable1()).Compactable0())(event))("Thanks for clicking me!"))(FRP_Event_Class.bang(dictIsEvent)("I was dynamically inserted"))) ]))
                              });
                          };
                      });
                  })),
                  next: FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.Subgraph.value))(Deku_Example_Docs_Util.scrollToTop)))))
              });
          };
      };
  };
...
(function($PS) {
  ...
  var Deku_DOM_Elt_Code = $PS["Deku.DOM.Elt.Code"];
  var Deku_DOM_Elt_Div = $PS["Deku.DOM.Elt.Div"];
  var Deku_DOM_Elt_Hr = $PS["Deku.DOM.Elt.Hr"];
  var Deku_DOM_Elt_Pre = $PS["Deku.DOM.Elt.Pre"];
  var Deku_Example_Docs_Types = $PS["Deku.Example.Docs.Types"];
  var Deku_Example_Docs_Util = $PS["Deku.Example.Docs.Util"];
  var Deku_Pursx = $PS["Deku.Pursx"];
  ...
  var showSgs = {
      show: function (v) {
          ...
          throw new Error("Failed pattern match at Deku.Example.Docs.Subgraphs (line 32, column 1 - line 34, column 19): " + [ v.constructor.name ]);
      }
  };
  var eqSgs = {
      eq: function (x) {
  ...
  var hashableSgs = {
      hash: (function () {
          var $37 = Data_Hashable.hash(Data_Hashable.hashableString);
          var $38 = Data_Show.show(showSgs);
          return function ($39) {
              return $37($38($39));
          };
      })(),
              ...
              return function (raise) {
                  return function (v) {
                      if (v instanceof Sg0) {
                          return Data_Exists.mkExists(function (push) {
                              return function (event) {
                                  var left = Data_Filterable.filterMap(dictFilterable)(function (v1) {
                                      ...
                                      throw new Error("Failed pattern match at Deku.Example.Docs.Subgraphs (line 53, column 9 - line 55, column 27): " + [ v1.constructor.name ]);
                                  })(oevent);
                                  return Deku_DOM_Elt_Div.div_(dictIsEvent)([ Deku_DOM_Elt_Div.div_(dictIsEvent)([ Deku_DOM_Elt_Button.button(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](raise(Sg0.value))))))([ Deku_Control.text_(dictIsEvent)("Send to B") ]), Deku_DOM_Elt_Div.div_(dictIsEvent)([ Deku_Control.text(dictIsEvent)(Data_Functor.map(dictFilterable.Functor1())((function () {
                                      var $40 = Data_Semigroup.append(Data_Semigroup.semigroupString)("A: ");
                                      var $41 = Data_Show.show(Data_Show.showInt);
                                      return function ($42) {
                                          return $40($41($42));
                                      };
                                  })())(counter(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(left)(FRP_Event_Class.bang(dictIsEvent)(Data_Unit.unit))))) ]), Deku_DOM_Elt_Button.button(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(Data_Unit.unit))))))([ Deku_Control.text_(dictIsEvent)("Send to C") ]), Deku_DOM_Elt_Div.div_(dictIsEvent)([ Deku_Control.text(dictIsEvent)(Data_Functor.map(dictFilterable.Functor1())((function () {
                                      var $43 = Data_Semigroup.append(Data_Semigroup.semigroupString)("C: ");
                                      var $44 = Data_Show.show(Data_Show.showInt);
                                      return function ($45) {
                                          return $43($44($45));
                                      };
                                  })())(counter(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(event)(FRP_Event_Class.bang(dictIsEvent)(Data_Unit.unit))))) ]), Deku_DOM_Elt_Hr.hr_(dictIsEvent)([  ]) ]) ]);
                              };
                          });
                      };
                      if (v instanceof Sg1) {
                          return Data_Exists.mkExists(function (push) {
                              return function (event) {
                                  var left = Data_Filterable.filterMap(dictFilterable)(function (v1) {
                                      ...
                                      throw new Error("Failed pattern match at Deku.Example.Docs.Subgraphs (line 78, column 9 - line 80, column 25): " + [ v1.constructor.name ]);
                                  })(oevent);
                                  return Deku_DOM_Elt_Div.div_(dictIsEvent)([ Deku_DOM_Elt_Div.div_(dictIsEvent)([ Deku_DOM_Elt_Button.button(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](raise(Sg1.value))))))([ Deku_Control.text_(dictIsEvent)("Send to A") ]), Deku_DOM_Elt_Div.div_(dictIsEvent)([ Deku_Control.text(dictIsEvent)(Data_Functor.map(dictFilterable.Functor1())((function () {
                                      var $46 = Data_Semigroup.append(Data_Semigroup.semigroupString)("B: ");
                                      var $47 = Data_Show.show(Data_Show.showInt);
                                      return function ($48) {
                                          return $46($47($48));
                                      };
                                  })())(counter(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(left)(FRP_Event_Class.bang(dictIsEvent)(Data_Unit.unit))))) ]), Deku_DOM_Elt_Button.button(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(Data_Unit.unit))))))([ Deku_Control.text_(dictIsEvent)("Send to D") ]), Deku_DOM_Elt_Div.div_(dictIsEvent)([ Deku_Control.text(dictIsEvent)(Data_Functor.map(dictFilterable.Functor1())((function () {
                                      var $49 = Data_Semigroup.append(Data_Semigroup.semigroupString)("D: ");
                                      var $50 = Data_Show.show(Data_Show.showInt);
                                      return function ($51) {
                                          return $49($50($51));
                                      };
                                  })())(counter(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(event)(FRP_Event_Class.bang(dictIsEvent)(Data_Unit.unit))))) ]) ]) ]);
                              };
                          });
                      };
                      throw new Error("Failed pattern match at Deku.Example.Docs.Subgraphs (line 43, column 1 - line 49, column 32): " + [ oevent.constructor.name, raise.constructor.name, v.constructor.name ]);
                  };
              };
          };
      };
      ...
      return function (dictPlus) {
          return function (dpage) {
              return Deku_Pursx.makePursx({
                  ...
                  code: Deku_Pursx.nut(Deku_DOM_Elt_Pre.pre_(dictIsEvent)([ Deku_DOM_Elt_Code.code_(dictIsEvent)([ Deku_Control.text_(dictIsEvent)("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Control.Alt ((<|>))\x0aimport Data.Exists (mkExists)\x0aimport Data.Filterable (class Filterable, compact, filterMap)\x0aimport Data.Hashable (class Hashable, hash)\x0aimport Data.Maybe (Maybe(..))\x0aimport Data.Tuple (snd)\x0aimport Data.Tuple.Nested ((/\\))\x0aimport Deku.Attribute (cb, (:=))\x0aimport Deku.Control (text, text_)\x0aimport Deku.Core (Subgraph, SubgraphF(..))\x0aimport Deku.DOM as D\x0aimport Deku.Subgraph (SubgraphAction(..), (@@))\x0aimport Deku.Toplevel ((\ud83d\ude80))\x0aimport Effect (Effect)\x0aimport FRP.Event (class IsEvent, mapAccum)\x0aimport FRP.Event.Class (bang)\x0a\x0adata UIevents = UIShown | ButtonClicked | SliderMoved Number\x0aderive instance Eq UIevents\x0a\x0adata Sgs = Sg0 | Sg1\x0aderive instance Eq Sgs\x0aderive instance Ord Sgs\x0ainstance Show Sgs where\x0a  show Sg0 = \"Sg0\"\x0a  show Sg1 = \"Sg1\"\x0ainstance Hashable Sgs where\x0a  hash = show >>> hash\x0a\x0acounter :: forall event a. IsEvent event => event a \u2192 event Int\x0acounter event = map snd $ mapAccum f event 0\x0a  where\x0a  f a b = (b + 1) /\\ (a /\\ b)\x0a\x0amySub\x0a  :: forall event payload\x0a   . Filterable event\x0a  => IsEvent event\x0a  => event Sgs\x0a  -> (Sgs -> Effect Unit)\x0a  -> Subgraph Sgs event payload\x0amySub oevent raise Sg0 = mkExists $ SubgraphF \\push event ->\x0a  let\x0a    left = filterMap\x0a      ( case _ of\x0a          Sg0 -> Nothing\x0a          Sg1 -> Just unit\x0a      )\x0a      oevent\x0a    right = event\x0a  in\x0a    D.div_\x0a      [ D.div_\x0a          [ D.button\x0a              (bang $ D.OnClick := cb (const $ raise Sg0))\x0a              [ text_ \"Send to B\" ]\x0a          , D.div_ [ text (map (append \"A: \" <<< show)\x0a                      (counter (left <|> bang unit))) ]\x0a          , D.button\x0a              (bang $ D.OnClick := cb (const $ push unit))\x0a              [ text_ \"Send to C\" ]\x0a          , D.div_ [ text (map (append \"C: \" <<< show)\x0a                      (counter (right <|> bang unit))) ]\x0a          , D.hr_ []\x0a          ]\x0a      ]\x0amySub oevent raise Sg1 = mkExists $ SubgraphF \\push event ->\x0a  let\x0a    left = filterMap\x0a      ( case _ of\x0a          Sg0 -> Just unit\x0a          Sg1 -> Nothing\x0a      )\x0a      oevent\x0a    right = event\x0a  in\x0a    D.div_\x0a      [ D.div_\x0a          [ D.button\x0a              (bang $ D.OnClick := cb (const $ raise Sg1))\x0a              [ text_ \"Send to A\" ]\x0a          , D.div_ [ text (map (append \"B: \" <<< show)\x0a                      (counter (left <|> bang unit))) ]\x0a          , D.button\x0a              (bang $ D.OnClick := cb (const $ push unit))\x0a              [ text_ \"Send to D\" ]\x0a          , D.div_ [ text (map (append \"D: \" <<< show)\x0a                      (counter (right <|> bang unit))) ]\x0a          ]\x0a      ]\x0a\x0amain :: Effect Unit\x0amain = Nothing \ud83d\ude80 \\push event ->\x0a  ( bang (Sg0 /\\ Insert) <|> bang (Sg1 /\\ Insert)\x0a  ) @@ mySub (compact event) (push <<< Just)") ]) ])),
                  result: Deku_Pursx.nut(Deku_Subgraph.subgraph(Data_Hashable.hashableUnit)(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Data_Unit.unit, Deku_Subgraph.Insert.value)))(function (v) {
                      return Data_Exists.mkExists(function (push) {
                          return function (event) {
                              return Deku_Subgraph.subgraph(hashableSgs)(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Sg0.value, Deku_Subgraph.Insert.value)))(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Sg1.value, Deku_Subgraph.Insert.value))))(mySub(dictIsEvent.Filterable1())(dictIsEvent)(Data_Compactable.compact((dictIsEvent.Filterable1()).Compactable0())(event))(function ($52) {
                                  return push(Data_Maybe.Just.create($52));
                              }));
                          };
                      });
                  })),
                  next: FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.Portals.value))(Deku_Example_Docs_Util.scrollToTop)))))
              });
          };
      };
  };
...
(function($PS) {
  ...
  var unsafeMarkAsMemoized = $foreign.unsafeMarkAsMemoizedImpl;
  exports["unsafeMarkAsMemoized"] = unsafeMarkAsMemoized;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  ...
  var create = Data_Functor.mapFlipped(Effect.functorEffect)(FRP_Event.create)(function (i) {
      return {
          event: Event(FRP_Event_Memoize.unsafeMarkAsMemoized(i.event)),
          push: i.push
      };
  });
  exports["create"] = create;
                  ...
                  var page = function (dpage) {
                      return function (v) {
                          if (v instanceof Deku_Example_Docs_Types.Intro) {
                              return Data_Exists.mkExists(function (v1) {
                                  return function (v2) {
                                      return Deku_Example_Docs_Intro.intro(dictIsEvent)(dictIsEvent.Plus0())(dpage);
                                  };
                              });
                          };
                          if (v instanceof Deku_Example_Docs_Types.HelloWorld) {
                              return Data_Exists.mkExists(function (v1) {
                                  return function (v2) {
                                      return Deku_Example_Docs_HelloWorld.helloWorld(dictIsEvent.Plus0())(dictIsEvent)(dpage);
                                  };
                              });
                          };
                          if (v instanceof Deku_Example_Docs_Types.SimpleComponent) {
                              return Data_Exists.mkExists(function (v1) {
                                  return function (v2) {
                                      return Deku_Example_Docs_Component.components(dictIsEvent)(dictIsEvent.Plus0())(dpage);
                                  };
                              });
                          };
                          if (v instanceof Deku_Example_Docs_Types.PURSX1) {
                              return Data_Exists.mkExists(function (v1) {
                                  return function (v2) {
                                      return Deku_Example_Docs_Pursx1.pursx1(dictIsEvent)(dictIsEvent.Plus0())(dpage);
                                  };
                              });
                          };
                          if (v instanceof Deku_Example_Docs_Types.Events) {
                              return Data_Exists.mkExists(function (v1) {
                                  return function (v2) {
                                      return Deku_Example_Docs_Events.events(dictIsEvent)(dictIsEvent.Plus0())(dpage);
                                  };
                              });
                          };
                          if (v instanceof Deku_Example_Docs_Types.Effects) {
                              return Data_Exists.mkExists(function (v1) {
                                  return function (v2) {
                                      return Deku_Example_Docs_Effects.effects(dictIsEvent)(dictIsEvent.Plus0())(dpage);
                                  };
                              });
                          };
                          if (v instanceof Deku_Example_Docs_Types.PURSX2) {
                              return Data_Exists.mkExists(function (v1) {
                                  return function (v2) {
                                      return Deku_Example_Docs_Pursx2.pursx2(dictIsEvent)(dictIsEvent.Plus0())(dpage);
                                  };
                              });
                          };
                          if (v instanceof Deku_Example_Docs_Types.Subgraph) {
                              return Data_Exists.mkExists(function (v1) {
                                  return function (v2) {
                                      return Deku_Example_Docs_Subgraphs.subgraphs(dictIsEvent)(dictIsEvent.Plus0())(dpage);
                                  };
                              });
                          };
                          if (v instanceof Deku_Example_Docs_Types.Portals) {
                              return Data_Exists.mkExists(function (v1) {
                                  return function (v2) {
                                      return Deku_Example_Docs_Portals.portals(dictIsEvent)(dictIsEvent.Plus0())(dpage);
                                  };
                              });
                          };
                          throw new Error("Failed pattern match at Deku.Example.Docs (line 106, column 3 - line 106, column 63): " + [ dpage.constructor.name, v.constructor.name ]);
                      };
                  };
                  return Deku_Control.flatten(dictIsEvent.Plus0())([ Deku_DOM_Elt_Div.div_(dictIsEvent)(Data_Functor.map(Data_Functor.functorArray)(function (v) {
                      return Deku_DOM_Elt_Span.span_(dictIsEvent)([ Deku_DOM_Elt_A.a(dictIsEvent)(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(dictIsEvent.Plus0())(FRP_Event_Class.bang(dictIsEvent))([ Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(v.value0)))), Deku_Attribute.attr(Deku_DOM_Attr_Style.attrA_StyleString)(Deku_DOM_Attr_Style.Style.value)("cursor:pointer;") ]))([ Deku_Control.text_(dictIsEvent)(v.value1.value0) ]), Deku_DOM_Elt_Span.span(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_Style.attrSpan_StyleString)(Deku_DOM_Attr_Style.Style.value)((function () {
                          if (v.value1.value1) {
                              return "";
                          };
                          return "display:none;";
                      ...
                      return Control_Alt.alt((dictIsEvent.Plus0()).Alt0())((function () {
                          if (v.value0 instanceof Data_Maybe.Nothing) {
                              return Control_Plus.empty(dictIsEvent.Plus0());
                          };
                          if (v.value0 instanceof Data_Maybe.Just) {
                              return FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(v.value0.value0, Deku_Subgraph.Remove.value));
                          };
                          throw new Error("Failed pattern match at Deku.Example.Docs (line 95, column 21 - line 97, column 51): " + [ v.value0.constructor.name ]);
                      })())(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(v.value1, Deku_Subgraph.Insert.value)));
