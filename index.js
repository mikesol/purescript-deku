  ...
  var clickCb = function (push) {
      return Deku_Graph_Attribute.cb(Data_Function["const"](function __do() {
          ...
          return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
              ...
              throw new Error("Failed pattern match at Deku.Example.Docs.Effects (line 200, column 9 - line 206, column 48): " + [ result.constructor.name ]);
          }))();
      }));
  };
  var sg = function (dt) {
          ...
          return function (v) {
              return Deku_Control_Functions.loopUsingSceneSG(Data_Monoid_Additive.monoidAdditive(Data_Semiring.semiringInt))(dictDOMInterpret)(Deku_Create.createSGAll())()(function (v1) {
                  ...
                  return function (v1) {
                      ...
                      throw new Error("Failed pattern match at Deku.Example.Docs.Effects (line 222, column 32 - line 243, column 26): " + [ e.constructor.name ]);
                  };
              });
          };
      };
          ...
          return function (v) {
              return Deku_Control_Functions.loopUsingSceneSG(Data_Monoid_Additive.monoidAdditive(Data_Semiring.semiringInt))(dictDOMInterpret)(Deku_Create.createSGAll())()(function (v1) {
                  ...
                  return function (nclicks) {
                      ...
                      throw new Error("Failed pattern match at Deku.Example.Docs.Events (line 279, column 22 - line 291, column 17): " + [ e.constructor.name ]);
                  };
              });
          };
      };
              ...
              return function (v1) {
                  return Deku_Control_Functions.u({
                      head: Deku_Graph_DOM.div([  ])({
                          ...
                          })())(new Data_Tuple.Tuple(Deku_Graph_DOM.span([  ])(Deku_Graph_DOM_Shorthand.text("The main goal of Deku is ")), new Data_Tuple.Tuple(Deku_Graph_DOM.span([ Deku_Graph_DOM.attr(Deku_Graph_DOM.attrSpan_StyleString)(Deku_Graph_DOM.Style.value)("font-weight: 800;") ])({
      ...
      return function (dictDOMInterpret) {
          return Deku_Control_Functions.loopUsingSceneSG(Data_Monoid_Additive.monoidAdditive(Data_Semiring.semiringInt))(dictDOMInterpret)(Deku_Create.createSGAll())()(function (v) {
              ...
              return function (v) {
                  ...
                  throw new Error("Failed pattern match at Deku.Example.Docs.Pursx2 (line 164, column 16 - line 166, column 80): " + [ e.constructor.name ]);
              };
          });
      };
  };
                  ...
                  return function (v1) {
                      return Deku_Control_Functions.u({
                          head: Deku_Graph_DOM.div([  ])({
                              ...
                              })())(new Data_Tuple.Tuple(Deku_Graph_DOM.text("As your app gets larger, you'll want to split up your code into logical components. Besides making the code easier to work with, in Deku, this allows us to change child components on the fly without changing the type of the parent graph. We call these "), new Data_Tuple.Tuple(Deku_Graph_DOM.span([ Deku_Graph_DOM.attr(Deku_Graph_DOM.attrSpan_StyleString)(Deku_Graph_DOM.Style.value)("font-weight: 800;") ])(Deku_Graph_DOM_Shorthand.text("subgraphs")), new Data_Tuple.Tuple(Deku_Graph_DOM.text("."), Data_Unit.unit))))), new Data_Tuple.Tuple(Deku_Graph_DOM.p([  ])(Deku_Util.detup(Deku_Util.detupTuple(Data_Typelevel_Num_Ops.typelevelSucc(Data_Typelevel_Num_Sets.posD1)()(Data_Typelevel_Num_Ops.divMod10D0D0)()(Data_Typelevel_Num_Ops.divMod10D1D0))(Deku_Util.detupUnit)()()()({
                                  reflectSymbol: function () {
                                      return "@0";
                                  }
                              })())(new Data_Tuple.Tuple(Deku_Graph_DOM.text("In the code below, two subgraphs are divided by a horizontal line. They communicate with each other via message passing, and they also have internal messaging."), Data_Unit.unit))), new Data_Tuple.Tuple(Deku_Graph_DOM.pre([  ])(Deku_Graph_DOM_Shorthand.code([  ])(Deku_Graph_DOM_Shorthand.text("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Data.Array ((..))\x0aimport Data.Either (Either(..))\x0aimport Data.Foldable (for_)\x0aimport Data.Map as Map\x0aimport Data.Maybe (Maybe(..))\x0aimport Data.Monoid.Additive (Additive(..))\x0aimport Data.Tuple.Nested ((/\\))\x0aimport Deku.Change (change)\x0aimport Deku.Control.Functions (modifyRes, (%!>), (%>), (@>))\x0aimport Deku.Control.Types (Frame0, Scene)\x0aimport Deku.Graph.Attribute (cb)\x0aimport Deku.Graph.DOM (AsSubgraph(..), xsubgraph, Href(..), OnClick(..), a, a'attr, root, subgraph, text, (:=))\x0aimport Deku.Graph.DOM as D\x0aimport Deku.Interpret (makeFFIDOMSnapshot)\x0aimport Deku.Run (RunDOM, RunEngine, TriggeredScene, defaultOptions, run)\x0aimport Deku.Toplevel ((\ud83d\ude80))\x0aimport Effect (Effect)\x0aimport FRP.Event (subscribe)\x0aimport Web.DOM as WEB.DOM\x0aimport Web.HTML (window)\x0aimport Web.HTML.HTMLDocument (body)\x0aimport Web.HTML.HTMLElement (toElement)\x0aimport Web.HTML.Window (document)\x0a\x0adata HelloWorld = Hello | World\x0a\x0amain :: Effect Unit\x0amain =\x0a  ( \\push0 ->\x0a      let\x0a        falsy n =\x0a          Map.fromFoldable (map (\\i -> i /\\ Just false) (0 .. n))\x0a      in\x0a        { hello: D.div []\x0a            { hello: a\x0a                [ Href := \"#\", OnClick := cb (const $ push0 Hello) ]\x0a                { ht: text \"click\" }\x0a            , helloA: subgraph (falsy 40)\x0a                ( AsSubgraph \\i ->\x0a\x0a                    ( \\_ push ->\x0a                        { myA: a\x0a                            [ Href := \"#\"\x0a                            , OnClick := cb\x0a                                ( const $ do\x0a                                    push false\x0a                                    when (i == 4) (push0 Hello)\x0a                                )\x0a                            ]\x0a                            { myTxt: text \" me \" }\x0a                        } /\\ push\x0a\x0a                    ) %>\x0a                      ( \\e push ->\x0a                          case e of\x0a                            Left tf ->\x0a                              when tf\x0a                                (change { \"myA.myTxt\": \"banana\" }) $> push\x0a                            Right tf ->\x0a                              change\x0a                                { \"myA\": a'attr\x0a                                    [ OnClick := cb (const $ push (not tf))\x0a                                    ]\x0a                                , \"myA.myTxt\": if tf then \" me \" else \" em \"\x0a                                } $> push\x0a                      )\x0a                )\x0a            }\x0a        , world: D.div []\x0a            { wA: a [ Href := \"#\", OnClick := cb (const $ push0 World) ]\x0a                { ht: text \"click\" }\x0a            , wB: subgraph (falsy 10)\x0a                ( AsSubgraph \\i ->\x0a                    ( \\_ push ->\x0a                        ( { myA: a\x0a                              [ Href := \"#\"\x0a                              , OnClick := cb\x0a                                  ( const $ do\x0a                                      push false\x0a                                      when (i == 11) (push0 Hello)\x0a                                  )\x0a                              ]\x0a                              { myTxt: text $ \" me\" <> show i <> \" \" }\x0a                          } /\\ (push /\\ Additive i) /\\ (Additive i)\x0a                        )\x0a                    ) %!>\x0a                      \\e (push /\\ (Additive i')) ->\x0a                        case e of\x0a                          Left _ ->\x0a                            map ((/\\) push) $ modifyRes\x0a                              (const $ Additive ((i' + 1) `mod` 40))\x0a                          Right tf ->\x0a                            map ((/\\) push)\x0a                              ( change\x0a                                  { \"myA\": a'attr\x0a                                      [ OnClick := cb\x0a                                          (const $ push (not tf))\x0a                                      ]\x0a                                  , \"myA.myTxt\":\x0a                                      if tf then \" me\"\x0a                                      else \" em\" <> show i <> \" \"\x0a                                  } *> modifyRes (const $ Additive i')\x0a                              )\x0a                )\x0a            }\x0a        } /\\ 0\x0a  ) \ud83d\ude80 \\e lmt ->\x0a    lmt + 1 <$ case e of\x0a      Hello -> change\x0a        { \"root.hello.helloA\": xsubgraph (Map.singleton 9 (Just true))\x0a        }\x0a      World -> change\x0a        { \"root.world.wB\": xsubgraph\x0a            ( Map.fromFoldable\x0a                ( map\x0a                    ( \\i -> i /\\\x0a                        (if i < lmt `mod` 10 then Just false else Nothing)\x0a                    )\x0a                    (0 .. 10)\x0a                )\x0a            )\x0a        }\x0a"))), new Data_Tuple.Tuple(Deku_Graph_DOM.p([  ])(Deku_Util.detup(Deku_Util.detupTuple(Data_Typelevel_Num_Ops.typelevelSucc(Data_Typelevel_Num_Sets.posD1)()(Data_Typelevel_Num_Ops.divMod10D0D0)()(Data_Typelevel_Num_Ops.divMod10D1D0))(Deku_Util.detupUnit)()()()({
                                  reflectSymbol: function () {
                                      return "@0";
                                  }
                              })())(new Data_Tuple.Tuple(Deku_Graph_DOM.text("Here's what it produces:"), Data_Unit.unit))), new Data_Tuple.Tuple(Deku_Graph_DOM.blockquote([  ])({
                      ...
                      main: Deku_Graph_DOM.main([  ])({
                          topbar: Deku_Graph_DOM.div([  ])(Deku_Graph_DOM_Shorthand.div([  ])((function () {
                              var sections = Data_Functor.map(Data_Vec.functorVec)(function (v1) {
                                  return Deku_Graph_DOM.span([  ])(Deku_Util.detup(Deku_Util.detupTuple(Data_Typelevel_Num_Ops.typelevelSucc(Data_Typelevel_Num_Sets.posD1)()(Data_Typelevel_Num_Ops.divMod10D0D0)()(Data_Typelevel_Num_Ops.divMod10D1D0))(Deku_Util.detupTuple(Data_Typelevel_Num_Ops.typelevelSucc(Data_Typelevel_Num_Sets.posD2)()(Data_Typelevel_Num_Ops.divMod10D1D0)()(Data_Typelevel_Num_Ops.divMod10D2D0))(Deku_Util.detupUnit)()()()({
                                      reflectSymbol: function () {
                                          return "@1";
                                      }
                                  })())()()()({
                                  ...
                                  })())(new Data_Tuple.Tuple(Deku_Graph_DOM.a([ Deku_Example_Docs_Util.cot(dt)(Deku_Graph_Attribute.cb(Data_Function["const"](push(v1.value0)))), Deku_Graph_DOM.attr(Deku_Graph_DOM.attrA_StyleString)(Deku_Graph_DOM.Style.value)("cursor:pointer;") ])(Deku_Graph_DOM_Shorthand.text(v1.value1.value0)), new Data_Tuple.Tuple(Deku_Graph_DOM.span([ Deku_Graph_DOM.attr(Deku_Graph_DOM.attrSpan_StyleString)(Deku_Graph_DOM.Style.value)((function () {
                                      if (v1.value1.value1) {
                                          return "";
                                      };
                                      return "display:none;";
