                  ...
                  return function __do() {
                      ...
                      var cancelOuter = FRP_Event.subscribe(children)(function (inner) {
                          return function __do() {
                                          ...
                                          var cncl = Effect_AVar.take(av)(function (q) {
                                              if (q instanceof Data_Either.Right) {
                                                  return function __do() {
                                                      ...
                                                      Control_Bind.join(Effect.bindEffect)(Effect_Ref.read(eltsUnsub))();
                                              ...
                                              throw new Error("Failed pattern match at Deku.Internal (line 74, column 44 - line 79, column 45): " + [ q.constructor.name ]);
                                          })();
                                          return cncl();
                                      };
                                      return Data_Unit.unit;
                              ...
                              Effect_Ref.modify_(Foreign_Object.insert(unsubId)(c0))(cancelInner)();
