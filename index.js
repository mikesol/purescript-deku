...
(function($PS) {
  ...
  var filterablePhantomEvent = FRP_Event.filterableEvent;
  var compactablePhantomEvent = FRP_Event.compactableEvent;
  var applicativePhantomEvent = FRP_Event.applicativeEvent;
  var altPhantomEvent = FRP_Event.altEvent;
  ...
  exports["applicativePhantomEvent"] = applicativePhantomEvent;
  exports["isEventPhantomEvent"] = isEventPhantomEvent;
  exports["filterablePhantomEvent"] = filterablePhantomEvent;
  exports["compactablePhantomEvent"] = compactablePhantomEvent;
  exports["plusPhantomEvent"] = plusPhantomEvent;
  exports["altPhantomEvent"] = altPhantomEvent;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  ...
  var components = function (dpage) {
      ...
      })()()(Deku_Pursx.pursxToElementConsElt()(Deku_Pursx.pursxToElementConsAttr()(Deku_Pursx.pursxToElementConsElt()(Deku_Pursx.pursxToElementNil(FRP_Event_Phantom.plusPhantomEvent))({
          reflectSymbol: function () {
              return "result";
          }
      }))({
      ...
      }))(FRP_Event_Phantom.isEventPhantomEvent)(px)({
          code: Deku_Pursx.nut(Deku_DOM.pre_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_DOM.code_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_Control.text_(FRP_Event_Phantom.isEventPhantomEvent)("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Deku.Control (flatten, text_)\x0aimport Deku.DOM as D\x0aimport Deku.Attribute ((:=))\x0aimport Deku.Toplevel ((\ud83d\ude80))\x0aimport Effect (Effect)\x0a\x0amain :: Effect Unit\x0amain = unit \ud83d\ude80 \\_ _ ->\x0a  flatten\x0a    [ D.button_ [ text_ \"I do nothing\" ]\x0a    , D.ul_ $ map (D.li_ <<< pure <<< text_) [ \"A\", \"B\", \"C\" ]\x0a    , D.div_\x0a        [ D.a (pure $ D.Href := \"https://example.com\")\x0a            [ text_ \"foo \" ]\x0a        , D.i_ [ text_ \" bar \" ]\x0a        , D.span (pure $ D.Style := \"font-weight: 800;\")\x0a            [ text_ \" baz\" ]\x0a        ]\x0a    , D.div_\x0a        [ D.div_\x0a            [ D.div_ [ D.input (pure $ D.Xtype := \"range\") [] ]\x0a            ]\x0a        ]\x0a    ]") ]) ])),
          result: Deku_Pursx.nut(Deku_DOM.div_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_DOM.button_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_Control.text_(FRP_Event_Phantom.isEventPhantomEvent)("I do nothing") ]), Deku_DOM.ul_(FRP_Event_Phantom.isEventPhantomEvent)(Data_Functor.map(Data_Functor.functorArray)((function () {
              var $0 = Deku_DOM.li_(FRP_Event_Phantom.isEventPhantomEvent);
              var $1 = Control_Applicative.pure(Control_Applicative.applicativeArray);
              var $2 = Deku_Control.text_(FRP_Event_Phantom.isEventPhantomEvent);
              return function ($3) {
                  return $0($1($2($3)));
              };
          })())([ "A", "B", "C" ])), Deku_DOM.div_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_DOM.a(FRP_Event_Phantom.isEventPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(Deku_Attribute.attr(Deku_DOM.attrA_HrefString)(Deku_DOM.Href.value)("https://example.com")))([ Deku_Control.text_(FRP_Event_Phantom.isEventPhantomEvent)("foo ") ]), Deku_DOM.i_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_Control.text_(FRP_Event_Phantom.isEventPhantomEvent)(" bar ") ]), Deku_DOM.span(FRP_Event_Phantom.isEventPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(Deku_Attribute.attr(Deku_DOM.attrSpan_StyleString)(Deku_DOM.Style.value)("font-weight: 800;")))([ Deku_Control.text_(FRP_Event_Phantom.isEventPhantomEvent)(" baz") ]) ]), Deku_DOM.div_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_DOM.div_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_DOM.div_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_DOM.input(FRP_Event_Phantom.isEventPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(Deku_Attribute.attr(Deku_DOM.attrInput_XtypeString)(Deku_DOM.Xtype.value)("range")))([  ]) ]) ]) ]) ])),
          next: Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.PURSX1.value))(Deku_Example_Docs_Util.scrollToTop)))))
      });
  };
...
(function($PS) {
  ...
  var effects = function (dpage) {
      return Deku_Pursx.makePursx({
          ...
          result: Deku_Pursx.nut(Deku_Subgraph.subgraph(Data_Hashable.hashableUnit)(FRP_Event_Phantom.isEventPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(new Data_Tuple.Tuple(Data_Unit.unit, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit))))(function (v) {
              return Data_Exists.mkExists(function (push) {
                  return function (event$prime) {
                      var event = Data_Compactable.compact(FRP_Event_Phantom.compactablePhantomEvent)(Data_Functor.map(FRP_Event_Phantom.functorPhantomEvent)(Data_Either.hush)(event$prime));
                      var loadingOrResult = Data_Filterable.filterMap(FRP_Event_Phantom.filterablePhantomEvent)(function (v1) {
                      ...
                      var loading = Data_Filterable.filterMap(FRP_Event_Phantom.filterablePhantomEvent)(function (v1) {
                          if (v1 instanceof Data_Either.Left) {
                              return new Data_Maybe.Just(Data_Unit.unit);
                          };
                          return Data_Maybe.Nothing.value;
                      })(loadingOrResult);
                      var result = Data_Filterable.filterMap(FRP_Event_Phantom.filterablePhantomEvent)(function (v1) {
                          if (v1 instanceof Data_Either.Right) {
                              return new Data_Maybe.Just(v1.value0);
                          };
                          return Data_Maybe.Nothing.value;
                      })(loadingOrResult);
                      return Deku_Control.flatten(FRP_Event_Phantom.plusPhantomEvent)([ Deku_DOM.div_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_DOM.button(FRP_Event_Phantom.isEventPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(clickCb(push))))([ Deku_Control.text(FRP_Event_Phantom.isEventPhantomEvent)(Control_Alt.alt(FRP_Event_Phantom.altPhantomEvent)(Control_Alt.alt(FRP_Event_Phantom.altPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(clickText))(Data_Functor.voidLeft(FRP_Event_Phantom.functorPhantomEvent)(loading)("Loading...")))(Data_Functor.voidLeft(FRP_Event_Phantom.functorPhantomEvent)(result)(clickText))) ]) ]), Deku_DOM.div(FRP_Event_Phantom.isEventPhantomEvent)(Control_Alt.alt(FRP_Event_Phantom.altPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(Deku_Attribute.attr(Deku_DOM.attrDiv_StyleString)(Deku_DOM.Style.value)("display: none;")))(Data_Functor.voidLeft(FRP_Event_Phantom.functorPhantomEvent)(Data_Compactable.compact(FRP_Event_Phantom.compactablePhantomEvent)(FRP_Event_Class.mapAccum(FRP_Event_Phantom.isEventPhantomEvent)(function (v1) {
                          return function (b) {
                      ...
                      })(result)(true)))(Deku_Attribute.attr(Deku_DOM.attrDiv_StyleString)(Deku_DOM.Style.value)("display: block;"))))([ Deku_DOM.pre_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_DOM.code_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_Control.text(FRP_Event_Phantom.isEventPhantomEvent)(Control_Alt.alt(FRP_Event_Phantom.altPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(""))(result)) ]) ]) ]) ]);
                  };
              });
          })),
          next: Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.PURSX2.value))(Deku_Example_Docs_Util.scrollToTop)))))
      });
  };
  exports["effects"] = effects;
})(PS);
      ...
      return Deku_Pursx.makePursx({
          ...
          result: Deku_Pursx.nut(Deku_Subgraph.subgraph(Data_Hashable.hashableUnit)(FRP_Event_Phantom.isEventPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(new Data_Tuple.Tuple(Data_Unit.unit, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit))))(function (v) {
              return Data_Exists.mkExists(function (push) {
                  return function (event$prime) {
                      var event = Data_Compactable.compact(FRP_Event_Phantom.compactablePhantomEvent)(Data_Functor.map(FRP_Event_Phantom.functorPhantomEvent)(Data_Either.hush)(event$prime));
                      return Deku_Control.flatten(FRP_Event_Phantom.plusPhantomEvent)([ Deku_DOM.button(FRP_Event_Phantom.isEventPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(ButtonClicked.value))))))([ Deku_Control.text_(FRP_Event_Phantom.isEventPhantomEvent)("Click") ]), Deku_DOM.div_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_Control.text(FRP_Event_Phantom.isEventPhantomEvent)(Control_Alt.alt(FRP_Event_Phantom.altPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)("Val: 0"))(Data_Functor.map(FRP_Event_Phantom.functorPhantomEvent)((function () {
                          var $13 = Data_Semigroup.append(Data_Semigroup.semigroupString)("Val: ");
                          var $14 = Data_Show.show(Data_Show.showInt);
                          return function ($15) {
                              return $13($14($15));
                          };
                      })())(FRP_Event_Class.mapAccum(FRP_Event_Phantom.isEventPhantomEvent)(Data_Function["const"](function (x) {
                          return new Data_Tuple.Tuple(x + 1 | 0, x);
                      }))(Data_Filterable.filter(FRP_Event_Phantom.filterablePhantomEvent)(Data_Eq.eq(eqUIEvents)(ButtonClicked.value))(event))(1)))) ]), Deku_DOM.div_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_DOM.input(FRP_Event_Phantom.isEventPhantomEvent)(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(FRP_Event_Phantom.plusPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent))([ Deku_Attribute.attr(Deku_DOM.attrInput_XtypeString)(Deku_DOM.Xtype.value)("range"), Deku_Attribute.attr(Deku_DOM.attrOnInputCb)(Deku_DOM.OnInput.value)(Deku_Attribute.cb(function (e) {
                      ...
                      })) ]))([  ]), Deku_DOM.div_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_Control.text(FRP_Event_Phantom.isEventPhantomEvent)(Control_Alt.alt(FRP_Event_Phantom.altPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)("Val: 50"))(Data_Functor.map(FRP_Event_Phantom.functorPhantomEvent)((function () {
                          var $17 = Data_Semigroup.append(Data_Semigroup.semigroupString)("Val: ");
                          var $18 = Data_Show.show(Data_Show.showNumber);
                          return function ($19) {
                              return $17($18($19));
                          };
                      })())(Data_Filterable.filterMap(FRP_Event_Phantom.filterablePhantomEvent)(function (v1) {
          ...
          next: Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.Effects.value))(Deku_Example_Docs_Util.scrollToTop)))))
      });
  };
  exports["events"] = events;
})(PS);
...
(function($PS) {
  ...
  var portals = function (dpage) {
      return Deku_Pursx.makePursx({
      ...
      })()()(Deku_Pursx.pursxToElementConsElt()(Deku_Pursx.pursxToElementConsElt()(Deku_Pursx.pursxToElementNil(FRP_Event_Phantom.plusPhantomEvent))({
          reflectSymbol: function () {
              return "result";
          }
      }))({
          ...
          code: Deku_Pursx.nut(Deku_DOM.pre_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_DOM.code_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_Control.text_(FRP_Event_Phantom.isEventPhantomEvent)("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Control.Alt ((<|>))\x0aimport Deku.Attribute (Attribute, cb, (:=))\x0aimport Deku.Control (flatten, text_)\x0aimport Deku.DOM as D\x0aimport Deku.Portal (portal)\x0aimport Deku.Toplevel ((\ud83d\ude80))\x0aimport Effect (Effect)\x0a\x0aimg0' :: forall event. Applicative event => event (Attribute D.Img_)\x0aimg0' = pure $ D.Src := \"https://picsum.photos/200\"\x0aimg1' :: forall event. Applicative event => event (Attribute D.Img_)\x0aimg1' = pure $ D.Src := \"https://picsum.photos/300\"\x0a\x0amain :: Effect Unit\x0amain = false \ud83d\ude80 \\push event ->\x0a  portal (D.img img0' []) \\img0 ->\x0a    portal (D.img img1' []) \\img1 ->\x0a      let\x0a        eventBool = event <|> pure false\x0a        eventNotBool = map not eventBool\x0a      in\x0a        flatten\x0a          [ D.div_ [img0 eventBool, img1 eventNotBool]\x0a          , D.div_ [img1 eventBool, img0 eventNotBool]\x0a          , D.button\x0a              ( map\x0a                  ( \\e -> D.OnClick :=\x0a                      cb (const (push $ not e))\x0a                  )\x0a                  eventBool\x0a              )\x0a              [ text_ \"Shift images between portals\" ]\x0a          ]") ]) ])),
          result: Deku_Pursx.nut(Deku_Subgraph.subgraph(Data_Hashable.hashableUnit)(FRP_Event_Phantom.isEventPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(new Data_Tuple.Tuple(Data_Unit.unit, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit))))(function (v) {
              return Data_Exists.mkExists(function (push) {
                  return function (event$prime) {
                      var event = Data_Compactable.compact(FRP_Event_Phantom.compactablePhantomEvent)(Data_Functor.map(FRP_Event_Phantom.functorPhantomEvent)(Data_Either.hush)(event$prime));
                      return Deku_Portal.portal(FRP_Event_Phantom.isEventPhantomEvent)(Deku_DOM.img(FRP_Event_Phantom.isEventPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(Deku_Attribute.attr(Deku_DOM.attrImg_SrcString)(Deku_DOM.Src.value)("https://picsum.photos/200")))([  ]))(function (img0) {
                          return Deku_Portal.portal(FRP_Event_Phantom.isEventPhantomEvent)(Deku_DOM.img(FRP_Event_Phantom.isEventPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(Deku_Attribute.attr(Deku_DOM.attrImg_SrcString)(Deku_DOM.Src.value)("https://picsum.photos/300")))([  ]))(function (img1) {
                              var eventBool = Control_Alt.alt(FRP_Event_Phantom.altPhantomEvent)(event)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(false));
                              var eventNotBool = Data_Functor.map(FRP_Event_Phantom.functorPhantomEvent)(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean))(eventBool);
                              return Deku_Control.flatten(FRP_Event_Phantom.plusPhantomEvent)([ Deku_DOM.div_(FRP_Event_Phantom.isEventPhantomEvent)([ img0(eventBool), img1(eventNotBool) ]), Deku_DOM.div_(FRP_Event_Phantom.isEventPhantomEvent)([ img1(eventBool), img0(eventNotBool) ]), Deku_DOM.button(FRP_Event_Phantom.isEventPhantomEvent)(Data_Functor.map(FRP_Event_Phantom.functorPhantomEvent)(function (e) {
                                  return Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(!e))));
                              })(eventBool))([ Deku_Control.text_(FRP_Event_Phantom.isEventPhantomEvent)("Shift images between portals") ]) ]);
                          });
                      });
                  };
              });
...
(function($PS) {
  ...
  var pursx2 = function (dpage) {
      ...
      }))(FRP_Event_Phantom.isEventPhantomEvent)(Type_Proxy["Proxy"].value)(px)({
          ...
          result: Deku_Pursx.nut(Deku_Subgraph.subgraph(Data_Hashable.hashableUnit)(FRP_Event_Phantom.isEventPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(new Data_Tuple.Tuple(Data_Unit.unit, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit))))(function (v) {
              return Data_Exists.mkExists(function (push) {
                  return function (event$prime) {
                      ...
                      })()()(Deku_Pursx.pursxToElementConsAttr()(Deku_Pursx.pursxToElementConsElt()(Deku_Pursx.pursxToElementNil(FRP_Event_Phantom.plusPhantomEvent))({
                          reflectSymbol: function () {
                              return "somethingNew";
                          }
                      }))({
                      ...
                      }))(FRP_Event_Phantom.isEventPhantomEvent)(myDom)({
                          myli: Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(Deku_Attribute.attr(Deku_DOM.attrLi_StyleString)(Deku_DOM.Style.value)("background-color:rgb(200,240,210);")),
                          somethingNew: Deku_Pursx.nut(Deku_DOM.button(FRP_Event_Phantom.isEventPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(new Data_Maybe.Just(Data_Unit.unit)))))))([ Deku_Control.text(FRP_Event_Phantom.isEventPhantomEvent)(Control_Alt.alt(FRP_Event_Phantom.altPhantomEvent)(Data_Functor.voidLeft(FRP_Event_Phantom.functorPhantomEvent)(Data_Compactable.compact(FRP_Event_Phantom.compactablePhantomEvent)(event))("Thanks for clicking me!"))(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)("I was dynamically inserted"))) ]))
                      });
                  };
              });
          })),
          next: Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.Subgraph.value))(Deku_Example_Docs_Util.scrollToTop)))))
      });
  };
  exports["pursx2"] = pursx2;
})(PS);
(function($PS) {
  ...
  var hashableSgs = {
      hash: (function () {
          var $38 = Data_Hashable.hash(Data_Hashable.hashableString);
          var $39 = Data_Show.show(showSgs);
          return function ($40) {
              return $38($39($40));
          };
      })(),
  ...
  var mySub = function (raise) {
      return function (v) {
          if (v instanceof Sg0) {
              return Data_Exists.mkExists(function (push) {
                  return function (event) {
                      var v1 = Data_Filterable.partitionMap(FRP_Event_Phantom.filterablePhantomEvent)(Control_Category.identity(Control_Category.categoryFn))(event);
                      return Deku_DOM.div_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_DOM.div_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_DOM.button(FRP_Event_Phantom.isEventPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](raise(Sg0.value))))))([ Deku_Control.text_(FRP_Event_Phantom.isEventPhantomEvent)("Send to B") ]), Deku_DOM.div_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_Control.text(FRP_Event_Phantom.isEventPhantomEvent)(Data_Functor.map(FRP_Event_Phantom.functorPhantomEvent)((function () {
                          var $41 = Data_Semigroup.append(Data_Semigroup.semigroupString)("A: ");
                          var $42 = Data_Show.show(Data_Show.showInt);
                          return function ($43) {
                              return $41($42($43));
                          };
                      })())(counter(FRP_Event_Phantom.isEventPhantomEvent)(v1.left))) ]), Deku_DOM.button(FRP_Event_Phantom.isEventPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(Data_Unit.unit))))))([ Deku_Control.text_(FRP_Event_Phantom.isEventPhantomEvent)("Send to C") ]), Deku_DOM.div_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_Control.text(FRP_Event_Phantom.isEventPhantomEvent)(Data_Functor.map(FRP_Event_Phantom.functorPhantomEvent)((function () {
                          var $44 = Data_Semigroup.append(Data_Semigroup.semigroupString)("C: ");
                          var $45 = Data_Show.show(Data_Show.showInt);
                          return function ($46) {
                              return $44($45($46));
                          };
                      })())(Control_Alt.alt(FRP_Event_Phantom.altPhantomEvent)(Data_Functor.map(FRP_Event_Phantom.functorPhantomEvent)(Data_Semiring.add(Data_Semiring.semiringInt)(1))(counter(FRP_Event_Phantom.isEventPhantomEvent)(v1.right)))(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(0)))) ]), Deku_DOM.hr_(FRP_Event_Phantom.isEventPhantomEvent)([  ]) ]) ]);
                  };
              });
          };
          if (v instanceof Sg1) {
              return Data_Exists.mkExists(function (push) {
                  return function (event) {
                      var v1 = Data_Filterable.partitionMap(FRP_Event_Phantom.filterablePhantomEvent)(Control_Category.identity(Control_Category.categoryFn))(event);
                      return Deku_DOM.div_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_DOM.div_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_DOM.button(FRP_Event_Phantom.isEventPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](raise(Sg1.value))))))([ Deku_Control.text_(FRP_Event_Phantom.isEventPhantomEvent)("Send to A") ]), Deku_DOM.div_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_Control.text(FRP_Event_Phantom.isEventPhantomEvent)(Data_Functor.map(FRP_Event_Phantom.functorPhantomEvent)((function () {
                          var $47 = Data_Semigroup.append(Data_Semigroup.semigroupString)("B: ");
                          var $48 = Data_Show.show(Data_Show.showInt);
                          return function ($49) {
                              return $47($48($49));
                          };
                      })())(counter(FRP_Event_Phantom.isEventPhantomEvent)(v1.left))) ]), Deku_DOM.button(FRP_Event_Phantom.isEventPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(Data_Unit.unit))))))([ Deku_Control.text_(FRP_Event_Phantom.isEventPhantomEvent)("Send to D") ]), Deku_DOM.div_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_Control.text(FRP_Event_Phantom.isEventPhantomEvent)(Data_Functor.map(FRP_Event_Phantom.functorPhantomEvent)((function () {
                          var $50 = Data_Semigroup.append(Data_Semigroup.semigroupString)("D: ");
                          var $51 = Data_Show.show(Data_Show.showInt);
                          return function ($52) {
                              return $50($51($52));
                          };
                      })())(Control_Alt.alt(FRP_Event_Phantom.altPhantomEvent)(Data_Functor.map(FRP_Event_Phantom.functorPhantomEvent)(Data_Semiring.add(Data_Semiring.semiringInt)(1))(counter(FRP_Event_Phantom.isEventPhantomEvent)(v1.right)))(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(0)))) ]) ]) ]);
                  };
              });
          };
          throw new Error("Failed pattern match at Deku.Example.Docs.Subgraphs (line 43, column 1 - line 46, column 44): " + [ raise.constructor.name, v.constructor.name ]);
      };
  };
              ...
              return Data_Exists.mkExists(function (push) {
                  return function (event$prime) {
                      ...
                      return Deku_Subgraph.subgraph(hashableSgs)(FRP_Event_Phantom.isEventPhantomEvent)(Control_Alt.alt(FRP_Event_Phantom.altPhantomEvent)(Control_Alt.alt(FRP_Event_Phantom.altPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(new Data_Tuple.Tuple(Sg0.value, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit))))(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(new Data_Tuple.Tuple(Sg1.value, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit)))))(Data_Functor.map(FRP_Event_Phantom.functorPhantomEvent)(function (v1) {
                          ...
                          throw new Error("Failed pattern match at Deku.Example.Docs.Subgraphs (line 248, column 25 - line 250, column 60): " + [ v1.constructor.name ]);
                      })(Data_Compactable.compact(FRP_Event_Phantom.compactablePhantomEvent)(event))))(mySub(function ($53) {
                          return push(Data_Maybe.Just.create($53));
                      }));
                  };
              });
          })),
          next: Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.Portals.value))(Deku_Example_Docs_Util.scrollToTop)))))
      });
  };
              ...
              return function (v) {
                  if (v instanceof Deku_Example_Docs_Types.Intro) {
                      return Data_Exists.mkExists(function (v1) {
                          return function (v2) {
                              return Deku_Example_Docs_Intro.intro(FRP_Event_Phantom.isEventPhantomEvent)(FRP_Event_Phantom.plusPhantomEvent)(dpage);
                          };
                      });
                  };
                  if (v instanceof Deku_Example_Docs_Types.HelloWorld) {
                      return Data_Exists.mkExists(function (v1) {
                          return function (v2) {
                              return Deku_Example_Docs_HelloWorld.helloWorld(FRP_Event_Phantom.plusPhantomEvent)(FRP_Event_Phantom.isEventPhantomEvent)(dpage);
                          };
                      });
                  };
                  ...
                  if (v instanceof Deku_Example_Docs_Types.PURSX1) {
                      return Data_Exists.mkExists(function (v1) {
                          return function (v2) {
                              return Deku_Example_Docs_Pursx1.pursx1(FRP_Event_Phantom.isEventPhantomEvent)(FRP_Event_Phantom.plusPhantomEvent)(dpage);
                          };
                      });
                  };
                  ...
                  throw new Error("Failed pattern match at Deku.Example.Docs (line 104, column 3 - line 104, column 75): " + [ dpage.constructor.name, v.constructor.name ]);
              };
          };
          return Deku_Control.flatten(FRP_Event_Phantom.plusPhantomEvent)([ Deku_DOM.div_(FRP_Event_Phantom.isEventPhantomEvent)(Data_Functor.map(Data_Functor.functorArray)(function (v) {
              return Deku_DOM.span_(FRP_Event_Phantom.isEventPhantomEvent)([ Deku_DOM.a(FRP_Event_Phantom.isEventPhantomEvent)(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(FRP_Event_Phantom.plusPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent))([ Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(v.value0)))), Deku_Attribute.attr(Deku_DOM.attrA_StyleString)(Deku_DOM.Style.value)("cursor:pointer;") ]))([ Deku_Control.text_(FRP_Event_Phantom.isEventPhantomEvent)(v.value1.value0) ]), Deku_DOM.span(FRP_Event_Phantom.isEventPhantomEvent)(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(Deku_Attribute.attr(Deku_DOM.attrSpan_StyleString)(Deku_DOM.Style.value)((function () {
                  if (v.value1.value1) {
                      return "";
                  };
                  return "display:none;";
              })())))([ Deku_Control.text_(FRP_Event_Phantom.isEventPhantomEvent)(" | ") ]) ]);
          })([ new Data_Tuple.Tuple(Deku_Example_Docs_Types.Intro.value, new Data_Tuple.Tuple("Home", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.HelloWorld.value, new Data_Tuple.Tuple("Hello world", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.SimpleComponent.value, new Data_Tuple.Tuple("Component", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.PURSX1.value, new Data_Tuple.Tuple("Pursx 1", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.Events.value, new Data_Tuple.Tuple("Events", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.Effects.value, new Data_Tuple.Tuple("Effects", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.PURSX2.value, new Data_Tuple.Tuple("Pursx 2", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.Subgraph.value, new Data_Tuple.Tuple("Subgraphs", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.Portals.value, new Data_Tuple.Tuple("Portals", false)) ])), Deku_Subgraph.subgraph(Deku_Example_Docs_Types.hashablePage)(FRP_Event_Phantom.isEventPhantomEvent)(FRP_Event_Class.keepLatest(FRP_Event_Phantom.isEventPhantomEvent)(Data_Functor.map(FRP_Event_Phantom.functorPhantomEvent)(function (v) {
              return Control_Alt.alt(FRP_Event_Phantom.altPhantomEvent)((function () {
                  if (v.value0 instanceof Data_Maybe.Nothing) {
                      return Control_Plus.empty(FRP_Event_Phantom.plusPhantomEvent);
                  };
                  if (v.value0 instanceof Data_Maybe.Just) {
                      return Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(new Data_Tuple.Tuple(v.value0.value0, Deku_Subgraph.Remove.value));
                  };
                  throw new Error("Failed pattern match at Deku.Example.Docs (line 93, column 21 - line 95, column 51): " + [ v.value0.constructor.name ]);
              })())(Control_Applicative.pure(FRP_Event_Phantom.applicativePhantomEvent)(new Data_Tuple.Tuple(v.value1, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit))));
          })(FRP_Event_Class.mapAccum(FRP_Event_Phantom.isEventPhantomEvent)(function (a) {
              return function (b) {
  ...
  var main = function __do() {
      ...
      return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(Web_HTML_HTMLElement.toElement)(b$prime))(function (b) {
          return function __do() {
              ...
              var evt = Deku_Control.deku(FRP_Event_Phantom.isEventPhantomEvent)(b)(scene(v.push)(FRP_Event_Phantom.proof0(v.event)))(Deku_Interpret.effectfulDOMInterpret);
