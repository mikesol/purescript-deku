      ...
      return function (dictPlus) {
          return function (dpage) {
              return Deku_Pursx.makePursx({
                  ...
                  })())([ "A", "B", "C" ])), Deku_DOM.div_(dictIsEvent)([ Deku_DOM.a(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrA_HrefString)(Deku_DOM.Href.value)("https://example.com")))([ Deku_Control.text_(dictIsEvent)("foo ") ]), Deku_DOM.i_(dictIsEvent)([ Deku_Control.text_(dictIsEvent)(" bar ") ]), Deku_DOM.span(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrSpan_StyleString)(Deku_DOM.Style.value)("font-weight: 800;")))([ Deku_Control.text_(dictIsEvent)(" baz") ]) ]), Deku_DOM.div_(dictIsEvent)([ Deku_DOM.div_(dictIsEvent)([ Deku_DOM.div_(dictIsEvent)([ Deku_DOM.input(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrInput_XtypeString)(Deku_DOM.Xtype.value)("range")))([  ]) ]) ]) ]) ])),
                  next: FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.PURSX1.value))(Deku_Example_Docs_Util.scrollToTop)))))
              });
          };
      };
  };
                  ...
                  result: Deku_Pursx.nut(Deku_Subgraph.subgraph(Data_Hashable.hashableUnit)(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Data_Unit.unit, Deku_Subgraph.Insert.value)))(function (v) {
                      return Data_Exists.mkExists(function (push) {
                          return function (event) {
                              ...
                              return Deku_Control.flatten(dictIsEvent.Plus0())([ Deku_DOM.div_(dictIsEvent)([ Deku_DOM.button(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(clickCb(push))))([ Deku_Control.text(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(FRP_Event_Class.bang(dictIsEvent)(clickText))(Data_Functor.voidLeft((dictIsEvent.Filterable1()).Functor1())(loading)("Loading...")))(Data_Functor.voidLeft((dictIsEvent.Filterable1()).Functor1())(result)(clickText))) ]) ]), Deku_DOM.div(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrDiv_StyleString)(Deku_DOM.Style.value)("display: none;")))(Data_Functor.voidLeft((dictIsEvent.Filterable1()).Functor1())(Data_Compactable.compact((dictIsEvent.Filterable1()).Compactable0())(FRP_Event_Class.mapAccum(dictIsEvent)(function (v1) {
                                  return function (b) {
                              ...
                              })(result)(true)))(Deku_Attribute.attr(Deku_DOM.attrDiv_StyleString)(Deku_DOM.Style.value)("display: block;"))))([ Deku_DOM.pre_(dictIsEvent)([ Deku_DOM.code_(dictIsEvent)([ Deku_Control.text(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(FRP_Event_Class.bang(dictIsEvent)(""))(result)) ]) ]) ]) ]);
                          };
                      });
                  })),
                  next: FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.PURSX2.value))(Deku_Example_Docs_Util.scrollToTop)))))
              });
          };
      };
  };
          ...
          return function (dpage) {
              return Deku_Pursx.makePursx({
                  ...
                  result: Deku_Pursx.nut(Deku_Subgraph.subgraph(Data_Hashable.hashableUnit)(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Data_Unit.unit, Deku_Subgraph.Insert.value)))(function (v) {
                      return Data_Exists.mkExists(function (push) {
                          return function (event) {
                              return Deku_Control.flatten(dictIsEvent.Plus0())([ Deku_DOM.button(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(ButtonClicked.value))))))([ Deku_Control.text_(dictIsEvent)("Click") ]), Deku_DOM.div_(dictIsEvent)([ Deku_Control.text(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(FRP_Event_Class.bang(dictIsEvent)("Val: 0"))(Data_Functor.map((dictIsEvent.Filterable1()).Functor1())((function () {
                              ...
                              }))(Data_Filterable.filter(dictIsEvent.Filterable1())(Data_Eq.eq(eqUIEvents)(ButtonClicked.value))(event))(1)))) ]), Deku_DOM.div_(dictIsEvent)([ Deku_DOM.input(dictIsEvent)(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(dictIsEvent.Plus0())(FRP_Event_Class.bang(dictIsEvent))([ Deku_Attribute.attr(Deku_DOM.attrInput_XtypeString)(Deku_DOM.Xtype.value)("range"), Deku_Attribute.attr(Deku_DOM.attrOnInputCb)(Deku_DOM.OnInput.value)(Deku_Attribute.cb(function (e) {
                              ...
                              })) ]))([  ]), Deku_DOM.div_(dictIsEvent)([ Deku_Control.text(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(FRP_Event_Class.bang(dictIsEvent)("Val: 50"))(Data_Functor.map((dictIsEvent.Filterable1()).Functor1())((function () {
                  ...
                  next: FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.Effects.value))(Deku_Example_Docs_Util.scrollToTop)))))
              });
          };
      };
  };
      ...
      return function (dictIsEvent) {
          return function (dpage) {
              return Deku_Pursx.makePursx({
                  ...
                  next: FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.SimpleComponent.value))(Deku_Example_Docs_Util.scrollToTop)))))
              });
          };
      };
  };
      ...
      return function (dictPlus) {
          return function (dpage) {
              return Deku_Pursx.makePursx({
                  ...
                  next: FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.HelloWorld.value))(Deku_Example_Docs_Util.scrollToTop)))))
              });
          };
      };
  };
          ...
          return function (v) {
              return Deku_Pursx.makePursx({
                  ...
                  result: Deku_Pursx.nut(Deku_Subgraph.subgraph(Data_Hashable.hashableUnit)(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Data_Unit.unit, Deku_Subgraph.Insert.value)))(function (v1) {
                      return Data_Exists.mkExists(function (push) {
                          return function (event) {
                              return Deku_Portal.portal(dictIsEvent)(Deku_DOM.img(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrImg_SrcString)(Deku_DOM.Src.value)("https://picsum.photos/200")))([  ]))(function (img0) {
                                  return Deku_Portal.portal(dictIsEvent)(Deku_DOM.img(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrImg_SrcString)(Deku_DOM.Src.value)("https://picsum.photos/300")))([  ]))(function (img1) {
                                      var eventBool = Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(event)(FRP_Event_Class.bang(dictIsEvent)(false));
                                      return Deku_Control.flatten(dictIsEvent.Plus0())([ Deku_Subgraph.subgraph(hashableSgs)(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Sg0.value, Deku_Subgraph.Insert.value)))(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Sg1.value, Deku_Subgraph.Insert.value))))(mySub(dictIsEvent)(eventBool)(img0)(img1)), Deku_DOM.button(dictIsEvent)(Data_Functor.map((dictIsEvent.Filterable1()).Functor1())(function (e) {
      ...
      return function (dictPlus) {
          return function (dpage) {
              return Deku_Pursx.makePursx({
                  ...
                  next: FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.Events.value))(Deku_Example_Docs_Util.scrollToTop)))))
              });
          };
      };
  };
                      ...
                      return Data_Exists.mkExists(function (push) {
                          return function (event) {
                              return Deku_Pursx.makePursx({
                                  ...
                                  myli: FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrLi_StyleString)(Deku_DOM.Style.value)("background-color:rgb(200,240,210);")),
                                  somethingNew: Deku_Pursx.nut(Deku_DOM.button(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(new Data_Maybe.Just(Data_Unit.unit)))))))([ Deku_Control.text(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(Data_Functor.voidLeft((dictIsEvent.Filterable1()).Functor1())(Data_Compactable.compact((dictIsEvent.Filterable1()).Compactable0())(event))("Thanks for clicking me!"))(FRP_Event_Class.bang(dictIsEvent)("I was dynamically inserted"))) ]))
                              });
                          };
                      });
                  })),
                  next: FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.Subgraph.value))(Deku_Example_Docs_Util.scrollToTop)))))
              });
          };
      };
  };
                      ...
                      if (v instanceof Sg0) {
                          return Data_Exists.mkExists(function (push) {
                              return function (event) {
                                  ...
                                  return Deku_DOM.div_(dictIsEvent)([ Deku_DOM.div_(dictIsEvent)([ Deku_DOM.button(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](raise(Sg0.value))))))([ Deku_Control.text_(dictIsEvent)("Send to B") ]), Deku_DOM.div_(dictIsEvent)([ Deku_Control.text(dictIsEvent)(Data_Functor.map(dictFilterable.Functor1())((function () {
                                      var $40 = Data_Semigroup.append(Data_Semigroup.semigroupString)("A: ");
                                      var $41 = Data_Show.show(Data_Show.showInt);
                                      return function ($42) {
                                          return $40($41($42));
                                      };
                                  })())(counter(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(left)(FRP_Event_Class.bang(dictIsEvent)(Data_Unit.unit))))) ]), Deku_DOM.button(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(Data_Unit.unit))))))([ Deku_Control.text_(dictIsEvent)("Send to C") ]), Deku_DOM.div_(dictIsEvent)([ Deku_Control.text(dictIsEvent)(Data_Functor.map(dictFilterable.Functor1())((function () {
                                      var $43 = Data_Semigroup.append(Data_Semigroup.semigroupString)("C: ");
                                      var $44 = Data_Show.show(Data_Show.showInt);
                                      return function ($45) {
                                          return $43($44($45));
                                      };
                                  })())(counter(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(event)(FRP_Event_Class.bang(dictIsEvent)(Data_Unit.unit))))) ]), Deku_DOM.hr_(dictIsEvent)([  ]) ]) ]);
                              };
                          });
                      };
                      if (v instanceof Sg1) {
                          return Data_Exists.mkExists(function (push) {
                              return function (event) {
                                  ...
                                  return Deku_DOM.div_(dictIsEvent)([ Deku_DOM.div_(dictIsEvent)([ Deku_DOM.button(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](raise(Sg1.value))))))([ Deku_Control.text_(dictIsEvent)("Send to A") ]), Deku_DOM.div_(dictIsEvent)([ Deku_Control.text(dictIsEvent)(Data_Functor.map(dictFilterable.Functor1())((function () {
                                      var $46 = Data_Semigroup.append(Data_Semigroup.semigroupString)("B: ");
                                      var $47 = Data_Show.show(Data_Show.showInt);
                                      return function ($48) {
                                          return $46($47($48));
                                      };
                                  })())(counter(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(left)(FRP_Event_Class.bang(dictIsEvent)(Data_Unit.unit))))) ]), Deku_DOM.button(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(Data_Unit.unit))))))([ Deku_Control.text_(dictIsEvent)("Send to D") ]), Deku_DOM.div_(dictIsEvent)([ Deku_Control.text(dictIsEvent)(Data_Functor.map(dictFilterable.Functor1())((function () {
      ...
      return function (dictPlus) {
          return function (dpage) {
              return Deku_Pursx.makePursx({
                  ...
                  next: FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.Portals.value))(Deku_Example_Docs_Util.scrollToTop)))))
              });
          };
      };
  };
      ...
      return function (dictPlus) {
          return function (push) {
              return function (event) {
                  ...
                  return Deku_Control.flatten(dictIsEvent.Plus0())([ Deku_DOM.div_(dictIsEvent)(Data_Functor.map(Data_Functor.functorArray)(function (v) {
                      return Deku_DOM.span_(dictIsEvent)([ Deku_DOM.a(dictIsEvent)(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(dictIsEvent.Plus0())(FRP_Event_Class.bang(dictIsEvent))([ Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(v.value0)))), Deku_Attribute.attr(Deku_DOM.attrA_StyleString)(Deku_DOM.Style.value)("cursor:pointer;") ]))([ Deku_Control.text_(dictIsEvent)(v.value1.value0) ]), Deku_DOM.span(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrSpan_StyleString)(Deku_DOM.Style.value)((function () {
                          if (v.value1.value1) {
                              return "";
                          };
                          return "display:none;";
