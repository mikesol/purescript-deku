...
(function($PS) {
  ...
  var unsafeSetText = function (v) {
      return function (id) {
          return function (txt) {
              return Data_Functor.map(FRP_Event.functorEvent)(function ($44) {
  ...
  var unsafeSetAttribute = function (v) {
      return function (id) {
          return function (atts) {
              return Data_Functor.map(FRP_Event.functorEvent)(function ($45) {
                  ...
                  })(Deku_Attribute.unsafeUnAttribute($45)));
              })(atts);
          };
      };
  };
  ...
  var text = function (txt) {
      return function (parent) {
          return function (v) {
              return FRP_Event_Class.keepLatest(FRP_Event.eventIsEvent)(Data_Functor.mapFlipped(FRP_Event.functorEvent)(FRP_Behavior.sample_(FRP_Event.eventIsEvent)(v.ids)(Control_Applicative.pure(FRP_Event.applicativeEvent)(Data_Unit.unit)))(function (me) {
                  return Data_Foldable.oneOf(Data_Foldable.foldableArray)(FRP_Event.plusEvent)([ Control_Applicative.pure(FRP_Event.applicativeEvent)(unsafeText(v)(me)(parent)), unsafeSetText(v)(me)(txt) ]);
              }));
          };
      };
  };
  var text_ = function (txt) {
      return text(Control_Applicative.pure(FRP_Event.applicativeEvent)(txt));
  };
  var flatten = function (a) {
      return Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Data_Functor.functorFn)(Data_Foldable.oneOf(Data_Foldable.foldableArray)(FRP_Event.plusEvent)))(Data_Functor.map(Data_Functor.functorFn)(Data_Distributive.distribute(Data_Distributive.distributiveFunction)(Data_Functor.functorArray))(Data_Distributive.distribute(Data_Distributive.distributiveFunction)(Data_Functor.functorArray)(a)));
  };
      ...
      return function (atts) {
          return function (children) {
              return function (parent) {
                  return function (v) {
                      return FRP_Event_Class.keepLatest(FRP_Event.eventIsEvent)(Data_Functor.mapFlipped(FRP_Event.functorEvent)(FRP_Behavior.sample_(FRP_Event.eventIsEvent)(v.ids)(Control_Applicative.pure(FRP_Event.applicativeEvent)(Data_Unit.unit)))(function (me) {
                          return Data_Foldable.oneOf(Data_Foldable.foldableArray)(FRP_Event.plusEvent)(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Control_Applicative.pure(FRP_Event.applicativeEvent)(unsafeElement(v)(me)(parent)(tag)), unsafeSetAttribute(v)(me)(atts) ])(Data_Functor.map(Data_Functor.functorArray)(function (kid) {
                              return kid(me)(v);
                          })(children)));
                      }));
                  };
  ...
  var deku = function (root) {
      return function (elts) {
          return function (v) {
              return FRP_Event_Class.keepLatest(FRP_Event.eventIsEvent)(Data_Functor.mapFlipped(FRP_Event.functorEvent)(FRP_Behavior.sample_(FRP_Event.eventIsEvent)(v.ids)(Control_Applicative.pure(FRP_Event.applicativeEvent)(Data_Unit.unit)))(function (me) {
                  return Data_Foldable.oneOf(Data_Foldable.foldableArray)(FRP_Event.plusEvent)([ Control_Applicative.pure(FRP_Event.applicativeEvent)(v.makeRoot({
                      id: me,
                      root: root
                  })), elts(me)(v) ]);
              }));
...
(function($PS) {
  ...
  var ul = Deku_Control.elementify("ul");
  var ul_ = ul(Control_Plus.empty(FRP_Event.plusEvent));        
  var span = Deku_Control.elementify("span");
  var span_ = span(Control_Plus.empty(FRP_Event.plusEvent));        
  var pre = Deku_Control.elementify("pre");
  var pre_ = pre(Control_Plus.empty(FRP_Event.plusEvent));  
  var li = Deku_Control.elementify("li");
  var li_ = li(Control_Plus.empty(FRP_Event.plusEvent));  
  var input = Deku_Control.elementify("input");               
  var img = Deku_Control.elementify("img");                     
  var i = Deku_Control.elementify("i");
  var i_ = i(Control_Plus.empty(FRP_Event.plusEvent));      
  var hr = Deku_Control.elementify("hr");
  var hr_ = hr(Control_Plus.empty(FRP_Event.plusEvent));
  var div = Deku_Control.elementify("div");
  var div_ = div(Control_Plus.empty(FRP_Event.plusEvent));
  var code = Deku_Control.elementify("code");
  var code_ = code(Control_Plus.empty(FRP_Event.plusEvent));    
  var button = Deku_Control.elementify("button");
  var button_ = button(Control_Plus.empty(FRP_Event.plusEvent));
  var a = Deku_Control.elementify("a");
  exports["Href"] = Href;
  exports["Src"] = Src;
  exports["Style"] = Style;
  exports["Xtype"] = Xtype;
                  ...
                  pursxToElement: function (v) {
                      return function (r) {
                          ...
                          return {
                              ...
                              element: function (parent) {
                                  return function (di) {
                                      return Control_Alt.alt(FRP_Event.altEvent)(v1(Data_Symbol.reflectSymbol(dictIsSymbol)(Type_Proxy["Proxy"].value))(di))(v2.element(parent)(di));
                                  };
                              }
                          };
                      };
                              ...
                              return function (r) {
                                  return function (parent) {
                                      return function (v) {
                                          return FRP_Event_Class.keepLatest(FRP_Event.eventIsEvent)(Data_Functor.mapFlipped(FRP_Event.functorEvent)(FRP_Behavior.sample_(FRP_Event.eventIsEvent)(v.ids)(Control_Applicative.pure(FRP_Event.applicativeEvent)(Data_Unit.unit)))(function (me) {
                                              var v1 = pursxToElement(dictPursxToElement)(Type_Proxy["Proxy"].value)(r);
                                              return Control_Alt.alt(FRP_Event.altEvent)(Control_Applicative.pure(FRP_Event.applicativeEvent)(v.makePursx({
                                                  id: me,
                                                  parent: parent,
                                                  cache: v1.cache,
...
(function($PS) {
  ...
  var components = function (dpage) {
      return Deku_Pursx.makePursx({
          ...
          code: Deku_Pursx.nut(Deku_DOM.pre_([ Deku_DOM.code_([ Deku_Control.text_("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Deku.Control (flatten, text_)\x0aimport Deku.DOM as D\x0aimport Deku.Attribute ((:=))\x0aimport Deku.Toplevel ((\ud83d\ude80))\x0aimport Effect (Effect)\x0a\x0amain :: Effect Unit\x0amain = unit \ud83d\ude80 \\_ _ ->\x0a  flatten\x0a    [ D.button_ [ text_ \"I do nothing\" ]\x0a    , D.ul_ $ map (D.li_ <<< pure <<< text_) [ \"A\", \"B\", \"C\" ]\x0a    , D.div_\x0a        [ D.a (pure $ D.Href := \"https://example.com\")\x0a            [ text_ \"foo \" ]\x0a        , D.i_ [ text_ \" bar \" ]\x0a        , D.span (pure $ D.Style := \"font-weight: 800;\")\x0a            [ text_ \" baz\" ]\x0a        ]\x0a    , D.div_\x0a        [ D.div_\x0a            [ D.div_ [ D.input (pure $ D.Xtype := \"range\") [] ]\x0a            ]\x0a        ]\x0a    ]") ]) ])),
          result: Deku_Pursx.nut(Deku_DOM.div_([ Deku_DOM.button_([ Deku_Control.text_("I do nothing") ]), Deku_DOM.ul_(Data_Functor.map(Data_Functor.functorArray)((function () {
              var $0 = Control_Applicative.pure(Control_Applicative.applicativeArray);
              return function ($1) {
                  return Deku_DOM.li_($0(Deku_Control.text_($1)));
              };
          })())([ "A", "B", "C" ])), Deku_DOM.div_([ Deku_DOM.a(Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrA_HrefString)(Deku_DOM.Href.value)("https://example.com")))([ Deku_Control.text_("foo ") ]), Deku_DOM.i_([ Deku_Control.text_(" bar ") ]), Deku_DOM.span(Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrSpan_StyleString)(Deku_DOM.Style.value)("font-weight: 800;")))([ Deku_Control.text_(" baz") ]) ]), Deku_DOM.div_([ Deku_DOM.div_([ Deku_DOM.div_([ Deku_DOM.input(Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrInput_XtypeString)(Deku_DOM.Xtype.value)("range")))([  ]) ]) ]) ]) ])),
          next: Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.PURSX1.value))(Deku_Example_Docs_Util.scrollToTop)))))
      });
  };
  ...
  var subgraph = function (dictHashable) {
      return function (mods) {
          return function (scenes) {
              return function (parent) {
                  return function (v) {
                      return FRP_Event_Class.keepLatest(FRP_Event.eventIsEvent)(Data_Functor.map(FRP_Event.functorEvent)(function (id) {
                          return Control_Alt.alt(FRP_Event.altEvent)(Control_Applicative.pure(FRP_Event.applicativeEvent)(v.makeSubgraph({
                              id: id,
                              parent: parent,
                              scenes: scenes
                          })))(Data_Functor.map(FRP_Event.functorEvent)(function (v1) {
                              ...
                              throw new Error("Failed pattern match at Deku.Subgraph (line 38, column 34 - line 42, column 52): " + [ v1.value1.constructor.name ]);
                          })(mods));
                      })(FRP_Behavior.sample_(FRP_Event.eventIsEvent)(v.ids)(Control_Applicative.pure(FRP_Event.applicativeEvent)(Data_Unit.unit))));
                  };
              };
          };
      };
...
(function($PS) {
  ...
  var effects = function (dpage) {
      return Deku_Pursx.makePursx({
          ...
          result: Deku_Pursx.nut(Deku_Subgraph.subgraph(Data_Hashable.hashableUnit)(Control_Applicative.pure(FRP_Event.applicativeEvent)(new Data_Tuple.Tuple(Data_Unit.unit, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit))))(function (v) {
              return function (push) {
                  return function (event$prime) {
                      var event = Data_Compactable.compact(FRP_Event.compactableEvent)(Data_Functor.map(FRP_Event.functorEvent)(Data_Either.hush)(event$prime));
                      var loadingOrResult = Data_Filterable.filterMap(FRP_Event.filterableEvent)(function (v1) {
                      ...
                      var loading = Data_Filterable.filterMap(FRP_Event.filterableEvent)(function (v1) {
                          if (v1 instanceof Data_Either.Left) {
                              return new Data_Maybe.Just(Data_Unit.unit);
                          };
                          return Data_Maybe.Nothing.value;
                      })(loadingOrResult);
                      var result = Data_Filterable.filterMap(FRP_Event.filterableEvent)(function (v1) {
                          if (v1 instanceof Data_Either.Right) {
                              return new Data_Maybe.Just(v1.value0);
                          };
                          return Data_Maybe.Nothing.value;
                      })(loadingOrResult);
                      return Deku_Control.flatten([ Deku_DOM.div_([ Deku_DOM.button(Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(clickCb(push))))([ Deku_Control.text(Control_Alt.alt(FRP_Event.altEvent)(Control_Alt.alt(FRP_Event.altEvent)(Control_Applicative.pure(FRP_Event.applicativeEvent)(clickText))(Data_Functor.voidLeft(FRP_Event.functorEvent)(loading)("Loading...")))(Data_Functor.voidLeft(FRP_Event.functorEvent)(result)(clickText))) ]) ]), Deku_DOM.div(Control_Alt.alt(FRP_Event.altEvent)(Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrDiv_StyleString)(Deku_DOM.Style.value)("display: none;")))(Data_Functor.voidLeft(FRP_Event.functorEvent)(Data_Compactable.compact(FRP_Event.compactableEvent)(FRP_Event_Class.mapAccum(FRP_Event.eventIsEvent)(function (v1) {
                          return function (b) {
                      ...
                      })(result)(true)))(Deku_Attribute.attr(Deku_DOM.attrDiv_StyleString)(Deku_DOM.Style.value)("display: block;"))))([ Deku_DOM.pre_([ Deku_DOM.code_([ Deku_Control.text(Control_Alt.alt(FRP_Event.altEvent)(Control_Applicative.pure(FRP_Event.applicativeEvent)(""))(result)) ]) ]) ]) ]);
                  };
              };
          })),
          next: Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.Effects.value))(Deku_Example_Docs_Util.scrollToTop)))))
      });
  };
  exports["effects"] = effects;
})(PS);
...
(function($PS) {
  ...
  var events = function (dpage) {
      return Deku_Pursx.makePursx({
          ...
          code: Deku_Pursx.nut(Deku_DOM.pre_([ Deku_DOM.code_([ Deku_Control.text_("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Control.Alt ((<|>))\x0aimport Data.Filterable (filter, filterMap)\x0aimport Data.Foldable (for_, oneOfMap)\x0aimport Data.Maybe (Maybe(..))\x0aimport Data.Tuple.Nested ((/\\))\x0aimport Deku.Attribute (cb, (:=))\x0aimport Deku.Control (text, text_)\x0aimport Deku.DOM as D\x0aimport Deku.Toplevel ((\ud83d\ude80))\x0aimport Effect (Effect)\x0aimport FRP.Event (mapAccum)\x0aimport Web.DOM.Element (fromEventTarget)\x0aimport Web.Event.Event (target)\x0aimport Web.HTML.HTMLInputElement (fromElement, valueAsNumber)\x0a\x0adata UIEvents = UIShown | ButtonClicked | SliderMoved Number\x0aderive instance Eq UIEvents\x0a\x0amain :: Effect Unit\x0amain = UIShown \ud83d\ude80 \\push event ->\x0a  D.div_\x0a    [ D.button\x0a        (pure (D.OnClick := cb (const $ push ButtonClicked)))\x0a        [ text_ \"Click\" ]\x0a    , D.div_\x0a        [ text\x0a            ( (pure \"Val: 0\") <|>\x0a                ( mapAccum (const $ \\x -> (x + 1) /\\ x)\x0a                    (filter (eq ButtonClicked) event)\x0a                    1\x0a                    # map (append \"Val: \" <<< show)\x0a                )\x0a            )\x0a        ]\x0a    , D.div_\x0a        [ D.input\x0a            ( oneOfMap pure\x0a                [ D.Xtype := \"range\"\x0a                , D.OnInput := cb \\e -> for_\x0a                    ( target e\x0a                        >>= fromEventTarget\x0a                        >>= fromElement\x0a                    )\x0a                    ( valueAsNumber\x0a                        >=> push <<< SliderMoved\x0a                    )\x0a                ]\x0a            )\x0a            []\x0a        , D.div_\x0a            [ text\x0a                ( (pure \"Val: 50\") <|>\x0a                    ( filterMap\x0a                        ( case _ of\x0a                            SliderMoved n -> Just n\x0a                            _ -> Nothing\x0a                        )\x0a                        event\x0a                        # map (append \"Val: \" <<< show)\x0a                    )\x0a                )\x0a            ]\x0a        ]\x0a    ]\x0a") ]) ])),
          result: Deku_Pursx.nut(Deku_Subgraph.subgraph(Data_Hashable.hashableUnit)(Control_Applicative.pure(FRP_Event.applicativeEvent)(new Data_Tuple.Tuple(Data_Unit.unit, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit))))(function (v) {
              return function (push) {
                  return function (event$prime) {
                      var event = Data_Compactable.compact(FRP_Event.compactableEvent)(Data_Functor.map(FRP_Event.functorEvent)(Data_Either.hush)(event$prime));
                      return Deku_Control.flatten([ Deku_DOM.button(Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(ButtonClicked.value))))))([ Deku_Control.text_("Click") ]), Deku_DOM.div_([ Deku_Control.text(Control_Alt.alt(FRP_Event.altEvent)(Control_Applicative.pure(FRP_Event.applicativeEvent)("Val: 0"))(Data_Functor.map(FRP_Event.functorEvent)((function () {
                          var $13 = Data_Semigroup.append(Data_Semigroup.semigroupString)("Val: ");
                          var $14 = Data_Show.show(Data_Show.showInt);
                          return function ($15) {
                              return $13($14($15));
                          };
                      })())(FRP_Event_Class.mapAccum(FRP_Event.eventIsEvent)(Data_Function["const"](function (x) {
                          return new Data_Tuple.Tuple(x + 1 | 0, x);
                      }))(Data_Filterable.filter(FRP_Event.filterableEvent)(Data_Eq.eq(eqUIEvents)(ButtonClicked.value))(event))(1)))) ]), Deku_DOM.div_([ Deku_DOM.input(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(FRP_Event.plusEvent)(Control_Applicative.pure(FRP_Event.applicativeEvent))([ Deku_Attribute.attr(Deku_DOM.attrInput_XtypeString)(Deku_DOM.Xtype.value)("range"), Deku_Attribute.attr(Deku_DOM.attrOnInputCb)(Deku_DOM.OnInput.value)(Deku_Attribute.cb(function (e) {
                          return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.bind(Data_Maybe.bindMaybe)(Web_Event_Event.target(e))(Web_DOM_Element.fromEventTarget))(Web_HTML_HTMLInputElement.fromElement))(Control_Bind.composeKleisli(Effect.bindEffect)(Web_HTML_HTMLInputElement.valueAsNumber)(function ($16) {
                              return push(SliderMoved.create($16));
                          }));
                      })) ]))([  ]), Deku_DOM.div_([ Deku_Control.text(Control_Alt.alt(FRP_Event.altEvent)(Control_Applicative.pure(FRP_Event.applicativeEvent)("Val: 50"))(Data_Functor.map(FRP_Event.functorEvent)((function () {
                          var $17 = Data_Semigroup.append(Data_Semigroup.semigroupString)("Val: ");
                          var $18 = Data_Show.show(Data_Show.showNumber);
                          return function ($19) {
                              return $17($18($19));
                          };
                      })())(Data_Filterable.filterMap(FRP_Event.filterableEvent)(function (v1) {
          ...
          next: Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.PURSX2.value))(Deku_Example_Docs_Util.scrollToTop)))))
      });
  };
  exports["events"] = events;
})(PS);
(function($PS) {
  ...
  var helloWorld = function (dpage) {
      return Deku_Pursx.makePursx({
          ...
          code: Deku_Pursx.nut(Deku_DOM.pre_([ Deku_DOM.code_([ Deku_Control.text_("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Deku.Control (text_)\x0aimport Deku.Toplevel ((\ud83d\ude80))\x0aimport Effect (Effect)\x0a\x0amain :: Effect Unit\x0amain = unit \ud83d\ude80 \\_ _ -> text_ \"Hello world") ]) ])),
          result: Deku_Pursx.nut(Deku_DOM.div_([ Deku_Control.text_("Hello world") ])),
          next: Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.SimpleComponent.value))(Deku_Example_Docs_Util.scrollToTop)))))
      });
  };
  exports["helloWorld"] = helloWorld;
})(PS);
(function($PS) {
  ...
  var intro = function (dpage) {
      return Deku_Pursx.makePursx({
          ...
          next: Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.HelloWorld.value))(Deku_Example_Docs_Util.scrollToTop)))))
      });
  };
  exports["intro"] = intro;
})(PS);
(function($PS) {
  ...
  var FRP_Event = $PS["FRP.Event"];
  var FRP_Event_Class = $PS["FRP.Event.Class"];                
  var portal = function (elt) {
      return function (cf) {
          return function (parent) {
              return function (v) {
                  return FRP_Event_Class.keepLatest(FRP_Event.eventIsEvent)(Data_Functor.mapFlipped(FRP_Event.functorEvent)(FRP_Behavior.sample_(FRP_Event.eventIsEvent)(v.ids)(Control_Applicative.pure(FRP_Event.applicativeEvent)(Data_Unit.unit)))(function (portalId) {
                      var cont = cf(function (eb) {
                          return function (par) {
                              return function (v1) {
                                  return FRP_Event_Class.keepLatest(FRP_Event.eventIsEvent)(Data_Functor.mapFlipped(FRP_Event.functorEvent)(FRP_Behavior.sample_(FRP_Event.eventIsEvent)(v1.ids)(Control_Applicative.pure(FRP_Event.applicativeEvent)(Data_Unit.unit)))(function (gatewayId) {
                                      return Control_Alt.alt(FRP_Event.altEvent)(Control_Applicative.pure(FRP_Event.applicativeEvent)(v1.makeGateway({
                                          id: gatewayId,
                                          parent: par,
                                          portal: portalId
                                      })))(Data_Functor.map(FRP_Event.functorEvent)(function ($13) {
                      ...
                      return Data_Foldable.oneOf(Data_Foldable.foldableArray)(FRP_Event.plusEvent)([ Control_Applicative.pure(FRP_Event.applicativeEvent)(v.makePortal({
                          id: portalId
...
(function($PS) {
  ...
  var showSgs = {
      show: function (v) {
          ...
          throw new Error("Failed pattern match at Deku.Example.Docs.Portals (line 29, column 1 - line 31, column 19): " + [ v.constructor.name ]);
      }
  };
  var eqSgs = {
      eq: function (x) {
  ...
  var hashableSgs = {
      hash: (function () {
          var $28 = Data_Hashable.hash(Data_Hashable.hashableString);
          var $29 = Data_Show.show(showSgs);
          return function ($30) {
              return $28($29($30));
          };
      })(),
  ...
  var px = Type_Proxy["Proxy"].value;
  var mySub = function (event) {
      return function (gateway0) {
          return function (gateway1) {
              return function (sg) {
                  return function (v) {
                      return function (v1) {
                          return Deku_DOM.div_([ gateway0(Data_Functor.map(FRP_Event.functorEvent)((function () {
                              ...
                              throw new Error("Failed pattern match at Deku.Example.Docs.Portals (line 50, column 13 - line 52, column 25): " + [ sg.constructor.name ]);
                          })())(event)), gateway1(Data_Functor.map(FRP_Event.functorEvent)((function () {
                              if (sg instanceof Sg0) {
                                  return Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean);
                              };
                              if (sg instanceof Sg1) {
                              ...
                              throw new Error("Failed pattern match at Deku.Example.Docs.Portals (line 58, column 13 - line 60, column 30): " + [ sg.constructor.name ]);
                          })())(event)) ]);
                      };
                  };
              };
  ...
  var portals = function (dpage) {
      return Deku_Pursx.makePursx({
          ...
          code: Deku_Pursx.nut(Deku_DOM.pre_([ Deku_DOM.code_([ Deku_Control.text_("module Deku.Examples.Docs.Examples.Portals where\x0a\x0aimport Prelude\x0a\x0aimport Control.Alt ((<|>))\x0aimport Data.Hashable (class Hashable, hash)\x0aimport Data.Tuple.Nested ((/\\))\x0aimport Deku.Attribute (Attribute, cb, (:=))\x0aimport Deku.Control (flatten, text_)\x0aimport Deku.Core (Element_, Subgraph_)\x0aimport Deku.DOM as D\x0aimport Deku.Portal (GatewayToSubgraph, portal)\x0aimport Deku.Subgraph (SubgraphAction(..), (@@))\x0aimport Deku.Toplevel ((\ud83d\ude80))\x0aimport Effect (Effect)\x0aimport FRP.Event (Event)\x0a\x0adata UIEvents = UIShown | ButtonClicked | SliderMoved Number\x0aderive instance Eq UIEvents\x0a\x0adata Sgs = Sg0 | Sg1\x0aderive instance Eq Sgs\x0aderive instance Ord Sgs\x0ainstance Show Sgs where\x0a  show Sg0 = \"Sg0\"\x0a  show Sg1 = \"Sg1\"\x0ainstance Hashable Sgs where\x0a  hash = show >>> hash\x0a\x0amySub\x0a  :: forall env push dom engine\x0a   . Event Boolean\x0a  -> (Event Boolean -> Element_ dom engine)\x0a  -> (Event Boolean -> Element_ dom engine)\x0a  -> Subgraph_ Sgs env push dom engine\x0amySub event gateway0 gateway1 sg _ _ = D.div_\x0a  [ gateway0\x0a      ( map\x0a          ( case sg of\x0a              Sg0 -> identity\x0a              Sg1 -> not\x0a          )\x0a          event\x0a      )\x0a  , gateway1\x0a      ( map\x0a          ( case sg of\x0a              Sg0 -> not\x0a              Sg1 -> identity\x0a          )\x0a          event\x0a      )\x0a  ]\x0a\x0aimg0' :: Event (Attribute D.Img_)\x0aimg0' = pure $ D.Src := \"https://picsum.photos/200\"\x0aimg1' :: Event (Attribute D.Img_)\x0aimg1' = pure $ D.Src := \"https://picsum.photos/300\"\x0a\x0amain :: Effect Unit\x0amain = false \ud83d\ude80 \\push event ->\x0a  portal (D.img img0' []) \\img0 ->\x0a    portal (D.img img1' []) \\img1 ->\x0a      let eventBool = event <|> pure false in\x0a      flatten\x0a        [ ( pure (Sg0 /\\ InsertOrUpdate unit)\x0a              <|> pure (Sg1 /\\ InsertOrUpdate unit)\x0a          ) @@ mySub eventBool img0 img1\x0a        , D.button (map (\\e -> D.OnClick :=\x0a        cb (const (push $ not e))) eventBool)\x0a            [ text_ \"Shift images between portals\" ]\x0a        ]") ]) ])),
          result: Deku_Pursx.nut(Deku_Subgraph.subgraph(Data_Hashable.hashableUnit)(Control_Applicative.pure(FRP_Event.applicativeEvent)(new Data_Tuple.Tuple(Data_Unit.unit, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit))))(function (v) {
              return function (push) {
                  return function (event$prime) {
                      var event = Data_Compactable.compact(FRP_Event.compactableEvent)(Data_Functor.map(FRP_Event.functorEvent)(Data_Either.hush)(event$prime));
                      return Deku_Portal.portal(Deku_DOM.img(Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrImg_SrcString)(Deku_DOM.Src.value)("https://picsum.photos/200")))([  ]))(function (img0) {
                          return Deku_Portal.portal(Deku_DOM.img(Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrImg_SrcString)(Deku_DOM.Src.value)("https://picsum.photos/300")))([  ]))(function (img1) {
                              var eventBool = Control_Alt.alt(FRP_Event.altEvent)(event)(Control_Applicative.pure(FRP_Event.applicativeEvent)(false));
                              return Deku_Control.flatten([ Deku_Subgraph.subgraph(hashableSgs)(Control_Alt.alt(FRP_Event.altEvent)(Control_Applicative.pure(FRP_Event.applicativeEvent)(new Data_Tuple.Tuple(Sg0.value, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit))))(Control_Applicative.pure(FRP_Event.applicativeEvent)(new Data_Tuple.Tuple(Sg1.value, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit)))))(mySub(eventBool)(img0)(img1)), Deku_DOM.button(Data_Functor.map(FRP_Event.functorEvent)(function (e) {
                                  return Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(!e))));
                              })(eventBool))([ Deku_Control.text_("Shift images between portals") ]) ]);
                          });
                      });
                  };
              };
...
(function($PS) {
  ...
  var pursx1 = function (dpage) {
      return Deku_Pursx.makePursx({
          ...
          next: Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.Events.value))(Deku_Example_Docs_Util.scrollToTop)))))
      });
  };
  exports["pursx1"] = pursx1;
})(PS);
              ...
              return function (push) {
                  return function (event$prime) {
                      ...
                      return Deku_Pursx.makePursx({
                          ...
                          myli: Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrLi_StyleString)(Deku_DOM.Style.value)("background-color:rgb(200,240,210);")),
                          somethingNew: Deku_Pursx.nut(Deku_DOM.button(Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(new Data_Maybe.Just(Data_Unit.unit)))))))([ Deku_Control.text(Control_Alt.alt(FRP_Event.altEvent)(Data_Functor.voidLeft(FRP_Event.functorEvent)(Data_Compactable.compact(FRP_Event.compactableEvent)(event))("Thanks for clicking me!"))(Control_Applicative.pure(FRP_Event.applicativeEvent)("I was dynamically inserted"))) ]))
                      });
                  };
              };
          })),
          next: Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.Subgraph.value))(Deku_Example_Docs_Util.scrollToTop)))))
      });
  };
  exports["pursx2"] = pursx2;
})(PS);
(function($PS) {
  ...
  var showSgs = {
      show: function (v) {
          ...
          throw new Error("Failed pattern match at Deku.Example.Docs.Subgraphs (line 30, column 1 - line 32, column 19): " + [ v.constructor.name ]);
      }
  };
  var eqSgs = {
      eq: function (x) {
  ...
  var hashableSgs = {
      hash: (function () {
          var $39 = Data_Hashable.hash(Data_Hashable.hashableString);
          var $40 = Data_Show.show(showSgs);
          return function ($41) {
              return $39($40($41));
          };
      })(),
  ...
  var counter = function (event) {
      ...
      return Data_Functor.map(FRP_Event.functorEvent)(Data_Tuple.snd)(FRP_Event_Class.mapAccum(FRP_Event.eventIsEvent)(f)(event)(0));
  };
  var mySub = function (raise) {
      return function (v) {
          return function (push) {
              return function (event) {
                  if (v instanceof Sg0) {
                      var v1 = Data_Filterable.partitionMap(FRP_Event.filterableEvent)(Control_Category.identity(Control_Category.categoryFn))(event);
                      return Deku_DOM.div_([ Deku_DOM.div_([ Deku_DOM.button(Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](raise(Sg0.value))))))([ Deku_Control.text_("Send to B") ]), Deku_DOM.div_([ Deku_Control.text(Data_Functor.map(FRP_Event.functorEvent)((function () {
                          var $42 = Data_Semigroup.append(Data_Semigroup.semigroupString)("A: ");
                          var $43 = Data_Show.show(Data_Show.showInt);
                          return function ($44) {
                              return $42($43($44));
                          };
                      })())(counter(v1.left))) ]), Deku_DOM.button(Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(Data_Unit.unit))))))([ Deku_Control.text_("Send to C") ]), Deku_DOM.div_([ Deku_Control.text(Data_Functor.map(FRP_Event.functorEvent)((function () {
                          var $45 = Data_Semigroup.append(Data_Semigroup.semigroupString)("C: ");
                          var $46 = Data_Show.show(Data_Show.showInt);
                          return function ($47) {
                              return $45($46($47));
                          };
                      })())(Control_Alt.alt(FRP_Event.altEvent)(Data_Functor.map(FRP_Event.functorEvent)(Data_Semiring.add(Data_Semiring.semiringInt)(1))(counter(v1.right)))(Control_Applicative.pure(FRP_Event.applicativeEvent)(0)))) ]), Deku_DOM.hr_([  ]) ]) ]);
                  };
                  if (v instanceof Sg1) {
                      var v1 = Data_Filterable.partitionMap(FRP_Event.filterableEvent)(Control_Category.identity(Control_Category.categoryFn))(event);
                      return Deku_DOM.div_([ Deku_DOM.div_([ Deku_DOM.button(Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](raise(Sg1.value))))))([ Deku_Control.text_("Send to A") ]), Deku_DOM.div_([ Deku_Control.text(Data_Functor.map(FRP_Event.functorEvent)((function () {
                          var $48 = Data_Semigroup.append(Data_Semigroup.semigroupString)("B: ");
                          var $49 = Data_Show.show(Data_Show.showInt);
                          return function ($50) {
                              return $48($49($50));
                          };
                      })())(counter(v1.left))) ]), Deku_DOM.button(Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(Data_Unit.unit))))))([ Deku_Control.text_("Send to D") ]), Deku_DOM.div_([ Deku_Control.text(Data_Functor.map(FRP_Event.functorEvent)((function () {
                          var $51 = Data_Semigroup.append(Data_Semigroup.semigroupString)("D: ");
                          var $52 = Data_Show.show(Data_Show.showInt);
                          return function ($53) {
                              return $51($52($53));
                          };
                      })())(Control_Alt.alt(FRP_Event.altEvent)(Data_Functor.map(FRP_Event.functorEvent)(Data_Semiring.add(Data_Semiring.semiringInt)(1))(counter(v1.right)))(Control_Applicative.pure(FRP_Event.applicativeEvent)(0)))) ]) ]) ]);
                  };
                  throw new Error("Failed pattern match at Deku.Example.Docs.Subgraphs (line 41, column 1 - line 43, column 28): " + [ raise.constructor.name, v.constructor.name, push.constructor.name, event.constructor.name ]);
              };
          };
      };
  };
  var subgraphs = function (dpage) {
      return Deku_Pursx.makePursx({
          ...
          code: Deku_Pursx.nut(Deku_DOM.pre_([ Deku_DOM.code_([ Deku_Control.text_("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Control.Alt ((<|>))\x0aimport Data.Filterable (compact, partitionMap)\x0aimport Data.Hashable (class Hashable, hash)\x0aimport Data.Maybe (Maybe(..))\x0aimport Data.Tuple (snd)\x0aimport Data.Tuple.Nested ((/\\))\x0aimport Deku.Attribute (cb, (:=))\x0aimport Deku.Control (text, text_)\x0aimport Deku.Core (Subgraph)\x0aimport Deku.DOM as D\x0aimport Deku.Subgraph (SubgraphAction(..), (@@))\x0aimport Deku.Toplevel ((\ud83d\ude80))\x0aimport Effect (Effect)\x0aimport FRP.Event (Event, mapAccum)\x0a\x0adata UIEvents = UIShown | ButtonClicked | SliderMoved Number\x0aderive instance Eq UIEvents\x0a\x0adata Sgs = Sg0 | Sg1\x0aderive instance Eq Sgs\x0aderive instance Ord Sgs\x0ainstance Show Sgs where\x0a  show Sg0 = \"Sg0\"\x0a  show Sg1 = \"Sg1\"\x0ainstance Hashable Sgs where\x0a  hash = show >>> hash\x0a\x0acounter :: forall a. Event a \u2192 Event Int\x0acounter event = map snd $ mapAccum f event 0\x0a  where\x0a  f a b = (b + 1) /\\ (a /\\ b)\x0a\x0amySub\x0a  :: (Sgs -> Effect Unit)\x0a  -> Subgraph Sgs Unit Unit\x0amySub raise Sg0 push event =\x0a  let\x0a    { left, right } = partitionMap identity event\x0a  in\x0a    D.div_\x0a      [ D.div_\x0a          [ D.button\x0a              (pure $ D.OnClick := cb (const $ raise Sg0))\x0a              [ text_ \"Send to B\" ]\x0a          , D.div_ [ text\x0a                     (map (append \"A: \" <<< show) (counter left)) ]\x0a          , D.button\x0a              (pure $ D.OnClick := cb (const $ push unit))\x0a              [ text_ \"Send to C\" ]\x0a          , D.div_ [ text (map (append \"C: \" <<< show)\x0a                     (map (add 1) (counter right) <|> pure 0)) ]\x0a          , D.hr_ []\x0a\x0a          ]\x0a      ]\x0amySub raise Sg1 push event =\x0a  let\x0a    { left, right } = partitionMap identity event\x0a  in\x0a    D.div_\x0a      [ D.div_\x0a          [ D.button\x0a              (pure $ D.OnClick := cb (const $ raise Sg1))\x0a              [ text_ \"Send to A\" ]\x0a          , D.div_ [ text\x0a                     (map (append \"B: \" <<< show) (counter left)) ]\x0a          , D.button\x0a              (pure $ D.OnClick := cb (const $ push unit))\x0a              [ text_ \"Send to D\" ]\x0a          , D.div_ [ text (map (append \"D: \" <<< show)\x0a                     (map (add 1) (counter right) <|> pure 0)) ]\x0a          ]\x0a      ]\x0a\x0amain :: Effect Unit\x0amain = Nothing \ud83d\ude80 \\push event ->\x0a  ( pure (Sg0 /\\ InsertOrUpdate unit)\x0a      <|> pure (Sg1 /\\ InsertOrUpdate unit)\x0a      <|>\x0a        ( compact event # map\x0a            ( case _ of\x0a                Sg0 -> Sg1 /\\ InsertOrUpdate unit\x0a                Sg1 -> Sg0 /\\ InsertOrUpdate unit\x0a            )\x0a        )\x0a  ) @@ mySub (push <<< Just)") ]) ])),
          result: Deku_Pursx.nut(Deku_Subgraph.subgraph(Data_Hashable.hashableUnit)(Control_Applicative.pure(FRP_Event.applicativeEvent)(new Data_Tuple.Tuple(Data_Unit.unit, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit))))(function (v) {
              return function (push) {
                  return function (event$prime) {
                      var event = Data_Compactable.compact(FRP_Event.compactableEvent)(Data_Functor.map(FRP_Event.functorEvent)(Data_Either.hush)(event$prime));
                      return Deku_Subgraph.subgraph(hashableSgs)(Control_Alt.alt(FRP_Event.altEvent)(Control_Alt.alt(FRP_Event.altEvent)(Control_Applicative.pure(FRP_Event.applicativeEvent)(new Data_Tuple.Tuple(Sg0.value, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit))))(Control_Applicative.pure(FRP_Event.applicativeEvent)(new Data_Tuple.Tuple(Sg1.value, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit)))))(Data_Functor.map(FRP_Event.functorEvent)(function (v1) {
                          ...
                          throw new Error("Failed pattern match at Deku.Example.Docs.Subgraphs (line 228, column 25 - line 230, column 60): " + [ v1.constructor.name ]);
                      })(Data_Compactable.compact(FRP_Event.compactableEvent)(event))))(mySub(function ($54) {
                          return push(Data_Maybe.Just.create($54));
                      }));
                  };
              };
          })),
          next: Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.Portals.value))(Deku_Example_Docs_Util.scrollToTop)))))
      });
  };
...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["Deku.Rando"] = $PS["Deku.Rando"] || {};
  var exports = $PS["Deku.Rando"];
  var Effect_Random = $PS["Effect.Random"];
  var FRP_Behavior = $PS["FRP.Behavior"];
  var FRP_Event = $PS["FRP.Event"];                
  var random = FRP_Behavior.behavior(function (f) {
...
(function($PS) {
  ...
  var Data_Functor = $PS["Data.Functor"];
  var Data_Show = $PS["Data.Show"];
  var Deku_Rando = $PS["Deku.Rando"];
  var FRP_Behavior = $PS["FRP.Behavior"];
  var FRP_Event = $PS["FRP.Event"];                
  var effectfulDOMInterpret = {
      ids: Data_Functor.map(FRP_Behavior.functorABehavior(FRP_Event.functorEvent))(Data_Show.show(Data_Show.showNumber))(Deku_Rando.random),
      ...
      makeSubgraph: function (v) {
          return function (dom) {
              return Data_Function.flip($foreign.makeSubgraph_(v.id)(v.parent))(dom)(function (index) {
                  return function __do() {
                      ...
                      var actualized = v.scenes(index)(evtR.push)(event)(v.parent)(effectfulDOMInterpret);
                      return {
      ...
      insertOrUpdateSubgraph: function (v) {
          return $foreign.insertOrUpdateSubgraph_({
              id: v.id,
              index: v.index,
                  ...
                  return function (v1) {
                      return function (v2) {
                          ...
                          if (v instanceof Deku_Example_Docs_Types.Subgraph) {
                              return Deku_Example_Docs_Subgraphs.subgraphs(dpage);
                          };
                          if (v instanceof Deku_Example_Docs_Types.Portals) {
                              return Deku_Example_Docs_Portals.portals(dpage);
                          };
                          throw new Error("Failed pattern match at Deku.Example.Docs (line 100, column 3 - line 100, column 59): " + [ dpage.constructor.name, v.constructor.name, v1.constructor.name, v2.constructor.name ]);
                      };
                  };
              };
          };
          return Deku_Control.flatten([ Deku_DOM.div_(Data_Functor.map(Data_Functor.functorArray)(function (v) {
              return Deku_DOM.span_([ Deku_DOM.a(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(FRP_Event.plusEvent)(Control_Applicative.pure(FRP_Event.applicativeEvent))([ Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(v.value0)))), Deku_Attribute.attr(Deku_DOM.attrA_StyleString)(Deku_DOM.Style.value)("cursor:pointer;") ]))([ Deku_Control.text_(v.value1.value0) ]), Deku_DOM.span(Control_Applicative.pure(FRP_Event.applicativeEvent)(Deku_Attribute.attr(Deku_DOM.attrSpan_StyleString)(Deku_DOM.Style.value)((function () {
                  if (v.value1.value1) {
                      return "";
                  };
                  return "display:none;";
              })())))([ Deku_Control.text_(" | ") ]) ]);
          })([ new Data_Tuple.Tuple(Deku_Example_Docs_Types.Intro.value, new Data_Tuple.Tuple("Home", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.HelloWorld.value, new Data_Tuple.Tuple("Hello world", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.SimpleComponent.value, new Data_Tuple.Tuple("Component", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.PURSX1.value, new Data_Tuple.Tuple("Pursx 1", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.Events.value, new Data_Tuple.Tuple("Events", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.Effects.value, new Data_Tuple.Tuple("Effects", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.PURSX2.value, new Data_Tuple.Tuple("Pursx 2", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.Subgraph.value, new Data_Tuple.Tuple("Subgraphs", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.Portals.value, new Data_Tuple.Tuple("Portals", false)) ])), Deku_Subgraph.subgraph(Deku_Example_Docs_Types.hashablePage)(FRP_Event_Class.keepLatest(FRP_Event.eventIsEvent)(Data_Functor.map(FRP_Event.functorEvent)(function (v) {
              return Control_Alt.alt(FRP_Event.altEvent)((function () {
                  if (v.value0 instanceof Data_Maybe.Nothing) {
                      return Control_Plus.empty(FRP_Event.plusEvent);
                  };
                  if (v.value0 instanceof Data_Maybe.Just) {
                      return Control_Applicative.pure(FRP_Event.applicativeEvent)(new Data_Tuple.Tuple(v.value0.value0, Deku_Subgraph.Remove.value));
                  };
                  throw new Error("Failed pattern match at Deku.Example.Docs (line 89, column 19 - line 91, column 49): " + [ v.value0.constructor.name ]);
              })())(Control_Applicative.pure(FRP_Event.applicativeEvent)(new Data_Tuple.Tuple(v.value1, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit))));
  ...
  var main = function __do() {
      ...
      return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(Web_HTML_HTMLElement.toElement)(b$prime))(function (b) {
          return function __do() {
              ...
              var evt = Deku_Control.deku(b)(scene(v.push)(v.event))(Deku_Interpret.effectfulDOMInterpret);
