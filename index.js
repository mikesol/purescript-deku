          ...
          return function (v) {
              return Deku_Control_Functions.loopUsingSceneSG(Data_Monoid_Additive.monoidAdditive(Data_Semiring.semiringInt))(dictDOMInterpret)(Deku_Create.createSGAll())()(function (v1) {
                  ...
                  return function (nclicks) {
                      ...
                      throw new Error("Failed pattern match at Deku.Example.Docs.Events (line 313, column 22 - line 325, column 17): " + [ e.constructor.name ]);
                  };
              });
          };
      };
                  ...
                  return function (v1) {
                      return Deku_Control_Functions.u({
                          head: Deku_Graph_DOM.div([  ])({
                              ...
                              })())(new Data_Tuple.Tuple(Deku_Graph_DOM.text("While the use of "), new Data_Tuple.Tuple(Deku_Graph_DOM.code([  ])(Deku_Graph_DOM_Shorthand.text("env")), new Data_Tuple.Tuple(Deku_Graph_DOM.text(" is slightly less efficient than the use of "), new Data_Tuple.Tuple(Deku_Graph_DOM.code([  ])(Deku_Graph_DOM_Shorthand.text("push")), new Data_Tuple.Tuple(Deku_Graph_DOM.text("because each layer needs to send the message down successively, it does not cause the DOM to update unless explicitly asked in "), new Data_Tuple.Tuple(Deku_Graph_DOM.code([  ])(Deku_Graph_DOM_Shorthand.text("iloop")), new Data_Tuple.Tuple(Deku_Graph_DOM.text(". This means that it is still quite fast."), Data_Unit.unit))))))))), new Data_Tuple.Tuple(Deku_Graph_DOM.p([  ])(Deku_Util.detup(Deku_Util.detupTuple(Data_Typelevel_Num_Ops.typelevelSucc(Data_Typelevel_Num_Sets.posD1)()(Data_Typelevel_Num_Ops.divMod10D0D0)()(Data_Typelevel_Num_Ops.divMod10D1D0))(Deku_Util.detupUnit)()()()({
                                  reflectSymbol: function () {
                                      return "@0";
                                  }
