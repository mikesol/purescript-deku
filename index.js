              ...
              return FRP_Event.makeEvent(function (k) {
                  return function __do() {
                      ...
                      var cancelOuter = FRP_Event.subscribe(children)(function (inner) {
                          return function __do() {
                              var prevId = Effect_Ref["new"](Data_Maybe.Nothing.value)();
                              var prevUnsub = Effect_Ref["new"](Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit))();
                              ...
                              var rn = Data_Functor.map(Effect.functorEffect)(Data_Show.show(Data_Show.showNumber))(Effect_Random.random)();
                              var c0 = FRP_Event.subscribe(FRP_Behavior.sampleBy(FRP_Event.eventIsEvent)(Data_Tuple.Tuple.create)(v.ids)(inner))(function (v1) {
                                  if (v1.value1 instanceof Deku_Core.SendToTop) {
                                      return Control_Bind.bind(Effect.bindEffect)(Effect_Ref.read(prevId))(Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(function ($17) {
                                  ...
                                  if (v1.value1 instanceof Deku_Core.Remove) {
                                      var mic = Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Bind.bind(Effect.bindEffect)(Effect_Ref.read(prevId))(Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(function (old) {
                                          return k(v.disconnectElement({
                                              id: old,
                                              parent: parent
                                          }));
                                      })))(Control_Bind.join(Effect.bindEffect)(Effect_Ref.read(myUnsub))))(Control_Bind.join(Effect.bindEffect)(Effect_Ref.read(prevUnsub))))(Effect_Ref.modify_(Foreign_Object["delete"](rn))(cancelInner));
                                      ...
                                      return function __do() {
                                          ...
                                          var cncl = Effect_AVar.take(av)(function (q) {
                                              if (q instanceof Data_Either.Right) {
                                                  return function __do() {
                                                      Effect_Ref.write(new Data_Maybe.Just(q.value0))(prevId)();
                                                      Control_Bind.join(Effect.bindEffect)(Effect_Ref.read(prevUnsub))();
                                                      return Effect_Ref.write(c1)(prevUnsub)();
                                                  };
                                              };
...
(function($PS) {
  ...
  var plantArrayElementEventEve = function (dictTypeEquals) {
      return function (dictTypeEquals1) {
          return {
              plant: function (i) {
                  return Type_Equality.proof(Type_Equality.refl)(Safe_Coerce.coerce()(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(FRP_Event.plusEvent)(FRP_Event.bang)(Data_Functor.map(Data_Functor.functorArray)(function ($91) {
                      return FRP_Event.bang(Deku_Core.Elt.create($91));
                  })(i))));
              }
          };
      };
  ...
  var unsafeSetText = function (v) {
      return function (id) {
          return function (txt) {
              return Data_Functor.map(FRP_Event.functorEvent)(function ($92) {
  ...
  var unsafeSetAttribute = function (v) {
      return function (id) {
          return function (atts) {
              return Data_Functor.map(FRP_Event.functorEvent)(function ($93) {
                  ...
                  })(Deku_Attribute.unsafeUnAttribute($93)));
              })(atts);
          };
      };
  };
  ...
  var text = function (txt) {
      var go = function (v) {
          return function (v1) {
              return FRP_Event_Class.keepLatest(FRP_Event.eventIsEvent)(Data_Functor.mapFlipped(FRP_Event.functorEvent)(FRP_Behavior.sample_(FRP_Event.eventIsEvent)(v1.ids)(FRP_Event.bang(Data_Unit.unit)))(function (me) {
                  return FRP_Event.makeEvent(function (k) {
                      return function __do() {
                          v.raiseId(me)();
                          return FRP_Event.subscribe(Data_Foldable.oneOf(Data_Foldable.foldableArray)(FRP_Event.plusEvent)([ FRP_Event.bang(unsafeText(v1)({
                              id: me,
                              parent: v.parent,
                              scope: v.scope
  ...
  var deku = function (root) {
      return function (children) {
          return function (v) {
              return FRP_Event_Class.keepLatest(FRP_Event.eventIsEvent)(Data_Functor.mapFlipped(FRP_Event.functorEvent)(FRP_Behavior.sample_(FRP_Event.eventIsEvent)(v.ids)(FRP_Event.bang(Data_Unit.unit)))(function (me) {
                  return Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang(v.makeRoot({
                      id: me,
                      root: root
                  })))(Deku_Internal["__internalDekuFlatten"](me)(v)(Type_Equality.proof(Type_Equality.refl)(Safe_Coerce.coerce()(children))));
              }));
          };
      };
  };
  var dekuA = function (root) {
      return function (children) {
          return deku(root)(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(FRP_Event.plusEvent)(FRP_Event.bang)(Data_Functor.map(Data_Functor.functorArray)(function ($94) {
              return FRP_Event.bang(Deku_Core.Elt.create($94));
          })(children)));
      };
  };
  var blank = (function () {
          ...
          return function (v1) {
              return FRP_Event_Class.keepLatest(FRP_Event.eventIsEvent)(Data_Functor.mapFlipped(FRP_Event.functorEvent)(FRP_Behavior.sample_(FRP_Event.eventIsEvent)(v1.ids)(FRP_Event.bang(Data_Unit.unit)))(function (me) {
                  return FRP_Event.makeEvent(function (k) {
                      return function __do() {
                          v.raiseId(me)();
                          return FRP_Event.subscribe(FRP_Event.bang(v1.makeNoop({
                              id: me,
                              parent: v.parent,
                              scope: v.scope
                          })))(k)();
                                      ...
                                      return function (v1) {
                                          return FRP_Event_Class.keepLatest(FRP_Event.eventIsEvent)(Data_Functor.mapFlipped(FRP_Event.functorEvent)(FRP_Behavior.sample_(FRP_Event.eventIsEvent)(v1.ids)(FRP_Event.bang(Data_Unit.unit)))(function (me) {
                                              return FRP_Event.makeEvent(function (k) {
                                                  return function __do() {
                                                      v.raiseId(me)();
                                                      return FRP_Event.subscribe(FRP_Event_Class.keepLatest(FRP_Event.eventIsEvent)(Data_Functor.mapFlipped(FRP_Event.functorEvent)(FRP_Behavior.sample_(FRP_Event.eventIsEvent)(v1.ids)(FRP_Event.bang(Data_Unit.unit)))(function (pxScope) {
                                                          var v2 = pursxToElement(dictPursxToElement)(pxScope)(Type_Proxy["Proxy"].value)(r);
                                                          return Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang(v1.makePursx({
                                                              id: me,
                                                              parent: v.parent,
                                                              cache: v2.cache,
                                                              scope: pxScope,
...
(function($PS) {
  ...
  var events = function (dpage) {
      return Deku_Pursx.makePursx({
          reflectSymbol: function () {
              return "<div>\x0a  <h1>Events</h1>\x0a\x0a  <h2>Listening to the DOM</h2>\x0a  <p>\x0a    We'll spice up the previous example by adding an event listener to our button. When we do, Deku will keep track of how many times we clicked it. The same goes for a range slider, whose current value is displayed underneath it.\x0a  </p>\x0a\x0a  ~code~\x0a\x0a  <p>And here's what it produces:</p>\x0a\x0a  <blockquote> ~result~ </blockquote>\x0a\x0a  <h2>The bus system</h2>\x0a\x0a  <p>The function <code>bus</code> in this example can be used to create an <i>ad hoc</i> event bus. Its signature is:</p>\x0a\x0a  <pre><code>bus\x0a    :: forall a r\x0a    . ((a -> Effect Unit)\x0a    -> Event a -> r)\x0a    -> Event r\x0a</code></pre>\x0a\x0a  <p>Note that <code>bus</code> returns an <code>Event</code>, so it needs to be consumed by something that accepts events. The function <code>runInBody1</code> accepts an argument of type <code>(forall lock. Event (Element lock payload))</code>, whereas <code>runInBody2</code> that we saw in the previous examples accepts an argument of type <code>(forall lock. Element lock payload)</code>. We'll go over the <code>runInBodyX</code> family of functions when we explore events in greater detail.</p>\x0a\x0a  <h2>Event handling</h2>\x0a  <p>All DOM event handlers, like <code>OnClick</code> and <code>OnInput</code>, can be set with a value of type <code>Cb</code>. This type is a <code>newtype</code> around <code>(Event -> Effect Boolean)</code>. To hook the event up to the Deku event bus, you can use the <code>push</code> function within the event handler. The push function has a signature of <code>(push -> Effect Unit)</code>. Here, the type one can push in to <code>push</code> is UIEvents. Whenever a push happens, our <code>Event</code> receives it and all attributes are updated accordingly.</p>\x0a\x0a  <h2>Next steps</h2>\x0a  <p>In this section, saw how to react to events. In the next section, we'll use a similar mechanism to deal with arbitrary <a ~next~ style=\"cursor:pointer;\">effects</a>.</p>\x0a</div>";
          }
      })()()(Deku_Pursx.pursxToElementConsElt()(Deku_Pursx.pursxToElementConsAttr()(Deku_Pursx.pursxToElementConsElt()(Deku_Pursx.pursxToElementNil)({
          reflectSymbol: function () {
              return "result";
          ...
          code: Deku_Pursx.nut(Deku_Control.plantElementEventEventStr(Type_Equality.refl)(Type_Equality.refl))(Deku_DOM_Elt_Pre.pre_(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Code.code_(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))([ Deku_Control.text_("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Control.Alt (alt, (<|>))\x0aimport Data.Filterable (filter, filterMap)\x0aimport Data.Foldable (for_, oneOfMap)\x0aimport Data.Maybe (Maybe(..))\x0aimport Data.Profunctor (lcmap)\x0aimport Data.Tuple.Nested ((/\\))\x0aimport Deku.Attribute (cb, (:=))\x0aimport Deku.Control (blank, text, text_)\x0aimport Deku.DOM as D\x0aimport Deku.Toplevel (runInBody1)\x0aimport Effect (Effect)\x0aimport FRP.Event (mapAccum, bang, bus)\x0aimport Web.DOM.Element (fromEventTarget)\x0aimport Web.Event.Event (target)\x0aimport Web.HTML.HTMLInputElement (fromElement, valueAsNumber)\x0a\x0adata UIEvents = UIShown | ButtonClicked | SliderMoved Number\x0aderive instance Eq UIEvents\x0a\x0amain :: Effect Unit\x0amain = runInBody1\x0a  ( bus \\push -> lcmap (alt (bang UIShown)) \\event -> do\x0a      D.div_\x0a        [ D.button\x0a            (bang (D.OnClick := cb (const $ push ButtonClicked)))\x0a            [ text_ \"Click\" ]\x0a        , D.div_\x0a            [ text\x0a                ( (bang \"Val: 0\") <|>\x0a                    ( mapAccum (const $ \\x -> (x + 1) /\\ x)\x0a                        (filter (eq ButtonClicked) event)\x0a                        0\x0a                        # map (append \"Val: \" <<< show)\x0a                    )\x0a                )\x0a            ]\x0a        , D.div_\x0a            [ D.input\x0a                ( oneOfMap bang\x0a                    [ D.Xtype := \"range\"\x0a                    , D.OnInput := cb \\e -> for_\x0a                        ( target e\x0a                            >>= fromEventTarget\x0a                            >>= fromElement\x0a                        )\x0a                        ( valueAsNumber\x0a                            >=> push <<< SliderMoved\x0a                        )\x0a                    ]\x0a                )\x0a                blank\x0a            , D.div_\x0a                [ text\x0a                    ( (bang \"Val: 50\") <|>\x0a                        ( filterMap\x0a                            ( case _ of\x0a                                SliderMoved n -> Just n\x0a                                _ -> Nothing\x0a                            )\x0a                            event\x0a                            # map (append \"Val: \" <<< show)\x0a                        )\x0a                    )\x0a                ]\x0a            ]\x0a        ]\x0a  )\x0a") ]) ])),
          result: Deku_Pursx.nut(Deku_Control.plantEventElementEventEve(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bus(function (push) {
              return function (event) {
                  return Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Button.button(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(ButtonClicked.value))))))([ Deku_Control.text_("Click") ]), Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))([ Deku_Control.text(Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang("Val: 0"))(Data_Functor.map(FRP_Event.functorEvent)((function () {
                      var $12 = Data_Semigroup.append(Data_Semigroup.semigroupString)("Val: ");
                      ...
                      var $16 = Data_Semigroup.append(Data_Semigroup.semigroupString)("Val: ");
                      var $17 = Data_Show.show(Data_Show.showNumber);
                      return function ($18) {
                          return $16($17($18));
                      };
                  })())(Data_Filterable.filterMap(FRP_Event.filterableEvent)(function (v) {
                      if (v instanceof SliderMoved) {
                          return new Data_Maybe.Just(v.value0);
                      };
                      return Data_Maybe.Nothing.value;
                  })(event)))) ]) ]) ]);
...
(function($PS) {
  ...
  var PageChanged = (function () {
      function PageChanged(value0) {
          this.value0 = value0;
      };
      PageChanged.create = function (value0) {
          return new PageChanged(value0);
      };
      return PageChanged;
  })();
  var genericXPage_ = {
      to: function (x) {
          ...
          throw new Error("Failed pattern match at Deku.Example.Docs.Events2 (line 24, column 1 - line 24, column 32): " + [ x.constructor.name ]);
      },
      from: function (x) {
  ...
  var showXPage = {
      show: Data_Show_Generic.genericShow(genericXPage_)(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsNoArguments)({
          reflectSymbol: function () {
              return "Home";
          }
  ...
  var events2 = function (dpage) {
      return Deku_Pursx.makePursx({
          reflectSymbol: function () {
              return "<div>\x0a  <h1>Events 2</h1>\x0a\x0a  <h2>Streaming the DOM</h2>\x0a  <p>\x0a    Up until now, our DOM has been static. This is OK in some cases, but in many cases, we need a dynamic DOM: one whose elements are inserted and removed based on user interaction. In Deku, we achieve this with <code>Event</code>-s.\x0a  </p>\x0a\x0a  <p>\x0a    The example below shows a small navigation bar that inserts a new node in the DOM and removes the previous one whenever an element of the bar is clicked.\x0a  </p>\x0a\x0a  ~code~\x0a\x0a  <p>And here's what it produces:</p>\x0a\x0a  <blockquote> ~result~ </blockquote>\x0a\x0a  <h2>Eventful children</h2>\x0a\x0a  <p>In the previous examples, the children of DOM nodes have been an array elements. For example, we've seen things like <code>D.div_ [text_ \"hello \", text_ \"world\"]</code>. In this example, the bottom-most <code>D.div_</code> contains an <code>Event</code> instead of an <code>Array</code>. Now, whenever the event is fired, the new node will update in the DOM.</p>\x0a\x0a  <h2>Next steps</h2>\x0a  <p>In this section, we saw how to make our DOM more dynamic by using an <code>Event</code> in the place of an <code>Array</code> of children. In the next section, we'll expand this concept to a situation where an <a ~next~ style=\"cursor:pointer;\">enclosing element needs to hold an indeterminate number of children, like a todo list</a>.</p>\x0a</div>";
          }
      })()()(Deku_Pursx.pursxToElementConsElt()(Deku_Pursx.pursxToElementConsAttr()(Deku_Pursx.pursxToElementConsElt()(Deku_Pursx.pursxToElementNil)({
          reflectSymbol: function () {
              return "result";
          ...
          code: Deku_Pursx.nut(Deku_Control.plantElementEventEventStr(Type_Equality.refl)(Type_Equality.refl))(Deku_DOM_Elt_Pre.pre_(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Code.code_(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))([ Deku_Control.text_("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Control.Alt (alt, (<|>))\x0aimport Data.Filterable (filterMap)\x0aimport Data.Foldable (oneOfMap)\x0aimport Data.Generic.Rep (class Generic)\x0aimport Data.Maybe (Maybe(..))\x0aimport Data.Profunctor (lcmap)\x0aimport Data.Show.Generic (genericShow)\x0aimport Deku.Attribute (cb, (:=))\x0aimport Deku.Control (text_)\x0aimport Deku.DOM as D\x0aimport Deku.Toplevel (runInBody1)\x0aimport Effect (Effect)\x0aimport FRP.Event (bus, bang)\x0a\x0adata Page = Home | About | Contact\x0aderive instance Generic Page _\x0ainstance Show Page where\x0a  show = genericShow\x0adata UIEvents = UIShown | PageChanged Page\x0a\x0amain :: Effect Unit\x0amain = runInBody1\x0a  ( bus \\push -> lcmap (alt (bang UIShown)) \\event -> do\x0a      D.div_\x0a        [ D.div_\x0a            $ map\x0a              ( \\page -> D.span_\x0a                  [ D.a\x0a                      ( oneOfMap bang\x0a                          [ D.OnClick :=\x0a                              cb (const $ push (PageChanged page))\x0a                          , D.Style := \"cursor:pointer;\"\x0a                          ]\x0a                      )\x0a                      [ text_ (show page) ]\x0a                  , text_ \" | \"\x0a                  ]\x0a              )\x0a              [ Home, About, Contact ]\x0a        , D.div_ $\x0a            ( bang Home <|> filterMap\x0a                ( case _ of\x0a                    PageChanged p -> Just p\x0a                    _ -> Nothing\x0a                )\x0a                event\x0a            ) <#> case _ of\x0a              Home -> text_ \"I'm a home page.\"\x0a              About -> text_ \"This page is about me.\"\x0a              Contact -> text_ \"Here's some contact info.\"\x0a        ]\x0a  )\x0a") ]) ])),
          result: Deku_Pursx.nut(Deku_Control.plantEventElementEventEve(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bus(function (push) {
              return Data_Profunctor.lcmap(Data_Profunctor.profunctorFn)(Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang(UIShown.value)))(function (event) {
                  return Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))(Data_Functor.map(Data_Functor.functorArray)(function (page) {
                      return Deku_DOM_Elt_Span.span_(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_A.a(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(FRP_Event.plusEvent)(FRP_Event.bang)([ Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(new PageChanged(page))))), Deku_Attribute.attr(Deku_DOM_Attr_Style.attrA_StyleString)(Deku_DOM_Attr_Style.Style.value)("cursor:pointer;") ]))([ Deku_Control.text_(Data_Show.show(showXPage)(page)) ]), Deku_Control.text_(" | ") ]);
                  })([ Home.value, About.value, Contact.value ])), Deku_DOM_Elt_Div.div_(Deku_Control.plantEventElementEventEve(Type_Equality.refl)(Type_Equality.refl))(Data_Functor.mapFlipped(FRP_Event.functorEvent)(Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang(Home.value))(Data_Filterable.filterMap(FRP_Event.filterableEvent)(function (v) {
                      if (v instanceof PageChanged) {
                          return new Data_Maybe.Just(v.value0);
                      };
                      return Data_Maybe.Nothing.value;
                  })(event)))(function (v) {
                      if (v instanceof Home) {
                          return Deku_Control.text_("I'm a home page.");
                      };
                      if (v instanceof About) {
                          return Deku_Control.text_("This page is about me.");
                      };
                      if (v instanceof Contact) {
                          return Deku_Control.text_("Here's some contact info.");
                      };
                      throw new Error("Failed pattern match at Deku.Example.Docs.Events2 (line 147, column 19 - line 150, column 59): " + [ v.constructor.name ]);
                  })) ]);
              });
          })),
          next: FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.Events3.value))(Deku_Example_Docs_Util.scrollToTop)))))
      });
  };
  exports["events2"] = events2;
})(PS);
...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["Deku.Example.Docs.Events3"] = $PS["Deku.Example.Docs.Events3"] || {};
  var exports = $PS["Deku.Example.Docs.Events3"];
  var Control_Alt = $PS["Control.Alt"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var px = Type_Proxy["Proxy"].value;
  var events3 = function (dpage) {
      return Deku_Pursx.makePursx({
          reflectSymbol: function () {
              return "<div>\x0a  <h1>Events 3</h1>\x0a\x0a  <h2>Dynamic children</h2>\x0a  <p>\x0a    Up until now, our DOM has been static. This is OK in some cases, but in many cases, we need a dynamic DOM: one whose elements are inserted and removed based on user interaction. In Deku, we achieve this with <code>Event</code>-s.\x0a  </p>\x0a\x0a  <p>\x0a    The code below creates a todo list that allows a user to add, prioritize, and remove elements.\x0a  </p>\x0a\x0a  ~code~\x0a\x0a  <p>And here's what it produces:</p>\x0a\x0a  <blockquote> ~result~ </blockquote>\x0a\x0a  <h2>Events of events</h2>\x0a\x0a  <p>In the previous section, we saw how DOM element constructors like <code>div_</code> can accept an <code>Event</code> instead of an array. They <i>also</i> can accept an event of events. In this case, the outer event represents a dynamic element, and the inner event changes the contents of that element. Instead of using an element directly, we return <code>StreamingElt</code>. <code>StreamingElt</code> has three constructors:</p>\x0a\x0a  <ul>\x0a    <li><code>Elt</code>, which takes an element.</li>\x0a    <li><code>SendToTop</code>, which sends the current element to the top of its parent.</li>\x0a    <li><code>Remove</code>, which removes the element from its parent.</li>\x0a  </ul>\x0a\x0a  <h2>Next steps</h2>\x0a  <p>In this section, we used nested events to insert and remove elements from a parent. In the next section, we'll see how we can use <a ~next~ style=\"cursor:pointer;\">portals to move an element to a different place of the DOM</a>.</p>\x0a</div>";
          }
      })()()(Deku_Pursx.pursxToElementConsElt()(Deku_Pursx.pursxToElementConsAttr()(Deku_Pursx.pursxToElementConsElt()(Deku_Pursx.pursxToElementNil)({
          reflectSymbol: function () {
              return "result";
              ...
              return Data_Profunctor.lcmap(Data_Profunctor.profunctorFn)(Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang(Data_Unit.unit)))(function (event) {
                  return Deku_Control.portal(Data_Functor.map(Data_Vec.functorVec)(function (i) {
                      ...
                      return function (v2) {
                          ...
                          var ev = FRP_Event_Class.mapAccum(FRP_Event.eventIsEvent)(function (v3) {
                              return function (x) {
                                  return new Data_Tuple.Tuple(!x, (function () {
                                      if (x) {
                                          return p0;
                                      };
                                      return p1;
...
(function($PS) {
  ...
  var Deku_Example_Docs_Events3 = $PS["Deku.Example.Docs.Events3"];
      ...
      return function (event) {
          var page = function (dpage) {
              return function (v) {
                  ...
                  if (v instanceof Deku_Example_Docs_Types.Events3) {
                      return Deku_Example_Docs_Events3.events3(dpage);
                  };
                  if (v instanceof Deku_Example_Docs_Types.Portals) {
                      return Deku_Example_Docs_Portals1.portals1(dpage);
                  };
                  throw new Error("Failed pattern match at Deku.Example.Docs (line 92, column 3 - line 92, column 64): " + [ dpage.constructor.name, v.constructor.name ]);
              };
          };
          return [ Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))(Data_Functor.map(Data_Functor.functorArray)(function (v) {
              return Deku_DOM_Elt_Span.span_(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_A.a(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(FRP_Event.plusEvent)(FRP_Event_Class.bang(FRP_Event.eventIsEvent))([ Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(v.value0)))), Deku_Attribute.attr(Deku_DOM_Attr_Style.attrA_StyleString)(Deku_DOM_Attr_Style.Style.value)("cursor:pointer;") ]))([ Deku_Control.text_(v.value1.value0) ]), Deku_DOM_Elt_Span.span(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))(FRP_Event_Class.bang(FRP_Event.eventIsEvent)(Deku_Attribute.attr(Deku_DOM_Attr_Style.attrSpan_StyleString)(Deku_DOM_Attr_Style.Style.value)((function () {
                  if (v.value1.value1) {
                      return "";
                  };
                  return "display:none;";
              })())))([ Deku_Control.text_(" | ") ]) ]);
          })([ new Data_Tuple.Tuple(Deku_Example_Docs_Types.Intro.value, new Data_Tuple.Tuple("Home", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.HelloWorld.value, new Data_Tuple.Tuple("Hello world", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.SimpleComponent.value, new Data_Tuple.Tuple("Component", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.PURSX1.value, new Data_Tuple.Tuple("Pursx 1", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.Events.value, new Data_Tuple.Tuple("Events 1", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.Effects.value, new Data_Tuple.Tuple("Effects", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.PURSX2.value, new Data_Tuple.Tuple("Pursx 2", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.Events2.value, new Data_Tuple.Tuple("Events 2", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.Events3.value, new Data_Tuple.Tuple("Events 3", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.Portals.value, new Data_Tuple.Tuple("Portals", false)) ])), Deku_DOM_Elt_Div.div_(Deku_Control.plantEventElementEventEve(Type_Equality.refl)(Type_Equality.refl))(Data_Functor.map(FRP_Event.functorEvent)(page(push))(event)) ];
      };
  };
