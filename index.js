  ...
  var clickCb = function (push) {
      return Deku_Graph_Attribute.cb(Data_Function["const"](function __do() {
          ...
          return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
              ...
              throw new Error("Failed pattern match at Deku.Example.Docs.Effects (line 227, column 9 - line 233, column 48): " + [ result.constructor.name ]);
          }))();
      }));
  };
  var sg = function (dt) {
          ...
          return function (v) {
              return Deku_Control_Functions.loopUsingSceneSG(Data_Monoid_Additive.monoidAdditive(Data_Semiring.semiringInt))(dictDOMInterpret)(Deku_Create.createSGAll())()(function (v1) {
                  ...
                  return function (v1) {
                      ...
                      throw new Error("Failed pattern match at Deku.Example.Docs.Effects (line 249, column 32 - line 270, column 26): " + [ e.constructor.name ]);
                  };
              });
          };
      };
          ...
          return function (v) {
              return Deku_Control_Functions.loopUsingSceneSG(Data_Monoid_Additive.monoidAdditive(Data_Semiring.semiringInt))(dictDOMInterpret)(Deku_Create.createSGAll())()(function (v1) {
                  ...
                  return function (nclicks) {
                      ...
                      throw new Error("Failed pattern match at Deku.Example.Docs.Events (line 309, column 22 - line 321, column 17): " + [ e.constructor.name ]);
                  };
              });
          };
      };
                  ...
                  return function (v1) {
                      return Deku_Control_Functions.u({
                          head: Deku_Graph_DOM.div([  ])({
                              ...
                              })())(new Data_Tuple.Tuple(Deku_Graph_DOM.p([  ])(Deku_Graph_DOM_Shorthand.text("We'll spice up the previous example by adding an event listener to our button. When we do, Deku will keep track of how many times we clicked it. The same goes for a range slider, whose current value is displayed underneath it.")), new Data_Tuple.Tuple(Deku_Graph_DOM.pre([  ])(Deku_Graph_DOM_Shorthand.code([  ])(Deku_Graph_DOM_Shorthand.text("module Deku.Example.Docs.Example.Events where\x0a\x0aimport Prelude\x0a\x0aimport Data.Either (Either(..))\x0aimport Data.Foldable (for_)\x0aimport Deku.Change (change)\x0aimport Data.Tuple.Nested ((/\\))\x0aimport Deku.Control.Functions ((@>))\x0aimport Deku.Control.Types (Frame0, Scene)\x0aimport Deku.Graph.Attribute (cb)\x0aimport Deku.Graph.DOM ((:=), root)\x0aimport Deku.Graph.DOM as D\x0aimport Deku.Graph.DOM.Shorthand as S\x0aimport Deku.Interpret (class DOMInterpret, makeFFIDOMSnapshot)\x0aimport Deku.Run (defaultOptions, run)\x0aimport Effect (Effect)\x0aimport FRP.Event (subscribe)\x0aimport Web.DOM (Element)\x0aimport Web.DOM.Element (fromEventTarget)\x0aimport Web.Event.Event (target)\x0aimport Web.HTML (window)\x0aimport Web.HTML.HTMLDocument (body)\x0aimport Web.HTML.HTMLElement (toElement)\x0aimport Web.HTML.HTMLInputElement (fromElement, valueAsNumber)\x0aimport Web.HTML.Window (document)\x0a\x0adata UIEvents = ButtonClicked | SliderMoved Number\x0a\x0ascene\x0a  :: forall env dom engine res\x0a   . Monoid res\x0a  => DOMInterpret dom engine\x0a  => Element\x0a  -> Scene env dom engine Frame0 UIEvents res\x0ascene elt =\x0a  ( \\_ push ->\x0a       root elt\x0a          ( { div1: D.div []\x0a                { button: D.button\x0a                    [ D.OnClick :=\x0a                        cb (const $ push ButtonClicked)\x0a                    ]\x0a                    (S.text \"Click\")\x0a                , count: D.div [] (S.text \"Val: 0\")\x0a                }\x0a            , div2: D.div []\x0a                { slider: D.input\x0a                    [ D.Xtype := \"range\"\x0a                    , D.OnInput := cb \\e -> for_\x0a                        ( target e\x0a                            >>= fromEventTarget\x0a                            >>= fromElement\x0a                        )\x0a                        ( valueAsNumber\x0a                            >=> push <<< SliderMoved\x0a                        )\x0a                    ]\x0a                    {}\x0a                , val: D.div [] (S.text \"Val: 50\")\x0a                }\x0a            }\x0a          )\x0a      /\\ 0\x0a  ) @> \\e nclicks -> case e of\x0a    Left _ -> pure nclicks\x0a    Right ButtonClicked ->\x0a      let\x0a        c = nclicks + 1\x0a      in\x0a        change\x0a          { \"root.div1.count.t\": \"Val: \" <> show c\x0a          , \"root.div1.button.t\":\x0a              if mod c 2 == 0 then \"Click\" else \"me\"\x0a          } $> c\x0a    Right (SliderMoved n) ->\x0a      change\x0a        { \"root.div2.val.t\": \"Val: \" <> show n\x0a        } $> nclicks\x0a\x0amain :: Effect Unit\x0amain = do\x0a  b' <- window >>= document >>= body\x0a  for_ (toElement <$> b') \\elt -> do\x0a    ffi <- makeFFIDOMSnapshot\x0a    subscribe\x0a      ( run (pure unit) (pure unit) defaultOptions ffi\x0a          (scene elt)\x0a\x0a      )\x0a      (_.res >>> pure)\x0a"))), new Data_Tuple.Tuple(Deku_Graph_DOM.p([  ])(Deku_Util.detup(Deku_Util.detupTuple(Data_Typelevel_Num_Ops.typelevelSucc(Data_Typelevel_Num_Sets.posD1)()(Data_Typelevel_Num_Ops.divMod10D0D0)()(Data_Typelevel_Num_Ops.divMod10D1D0))(Deku_Util.detupUnit)()()()({
                                  reflectSymbol: function () {
                                      return "@0";
                                  }
                              })())(new Data_Tuple.Tuple(Deku_Graph_DOM.text("Here's what it produces:"), Data_Unit.unit))), new Data_Tuple.Tuple(Deku_Graph_DOM.blockquote([  ])({
              ...
              return function (v1) {
                  return Deku_Control_Functions.u({
                      head: Deku_Graph_DOM.div([  ])({
                          ...
                          })())(new Data_Tuple.Tuple(Deku_Graph_DOM.p([  ])(Deku_Graph_DOM_Shorthand.text("Here is \"hello world\" in Deku. In this and all the following sections, we'll start with a full example, and we'll pick it apart afterwards.")), new Data_Tuple.Tuple(Deku_Graph_DOM.pre([  ])(Deku_Graph_DOM_Shorthand.code([  ])(Deku_Graph_DOM_Shorthand.text("module Deku.Example.Docs.Example.HelloWorld where\x0a\x0aimport Prelude\x0a\x0aimport Data.Foldable (for_)\x0aimport Deku.Control.Functions (freeze, u, (@>))\x0aimport Deku.Graph.DOM (root)\x0aimport Deku.Graph.DOM.Shorthand as S\x0aimport Deku.Interpret (makeFFIDOMSnapshot)\x0aimport Deku.Run (defaultOptions, run)\x0aimport Effect (Effect)\x0aimport FRP.Event (subscribe)\x0aimport Web.HTML (window)\x0aimport Web.HTML.HTMLDocument (body)\x0aimport Web.HTML.HTMLElement (toElement)\x0aimport Web.HTML.Window (document)\x0a\x0amain :: Effect Unit\x0amain = do\x0a  b' <- window >>= document >>= body\x0a  for_ (toElement <$> b') \\elt -> do\x0a    ffi <- makeFFIDOMSnapshot\x0a    subscribe\x0a      ( run (pure unit) (pure unit) defaultOptions ffi\x0a          $\x0a            ( \\_ _ -> u $ root elt (S.text \"Hello world\")\x0a            ) @> freeze\x0a\x0a      )\x0a      (_.res >>> pure)\x0a"))), new Data_Tuple.Tuple(Deku_Graph_DOM.p([  ])(Deku_Util.detup(Deku_Util.detupTuple(Data_Typelevel_Num_Ops.typelevelSucc(Data_Typelevel_Num_Sets.posD1)()(Data_Typelevel_Num_Ops.divMod10D0D0)()(Data_Typelevel_Num_Ops.divMod10D1D0))(Deku_Util.detupTuple(Data_Typelevel_Num_Ops.typelevelSucc(Data_Typelevel_Num_Sets.posD2)()(Data_Typelevel_Num_Ops.divMod10D1D0)()(Data_Typelevel_Num_Ops.divMod10D2D0))(Deku_Util.detupTuple(Data_Typelevel_Num_Ops.typelevelSucc(Data_Typelevel_Num_Sets.posD3)()(Data_Typelevel_Num_Ops.divMod10D2D0)()(Data_Typelevel_Num_Ops.divMod10D3D0))(Deku_Util.detupUnit)()()()({
                              reflectSymbol: function () {
                                  return "@2";
                              }
                          })())()()()({
