...
})(PS["FRP.Event.Variant"] = PS["FRP.Event.Variant"] || {});
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["FRP.Event.Variant"] = $PS["FRP.Event.Variant"] || {};
  var exports = $PS["FRP.Event.Variant"];
  var $foreign = $PS["FRP.Event.Variant"];
  var Data_Unit = $PS["Data.Unit"];
  var FRP_Event = $PS["FRP.Event"];
  var Record = $PS["Record"];
  var Type_Proxy = $PS["Type.Proxy"];                
  var vBusNilRowRowRow = {
      vb: function (v) {
          return function (v1) {
              return function (v2) {
                  return {};
  ...
  var vBusCons = function (dictIsSymbol) {
      return function (dictCons) {
  ...
  exports["vbus"] = vbus;
  exports["vBusNilRowRowRow"] = vBusNilRowRowRow;
  exports["vBusCons"] = vBusCons;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var FRP_Event = $PS["FRP.Event"];
  var FRP_Event_Class = $PS["FRP.Event.Class"];
  var FRP_Event_Variant = $PS["FRP.Event.Variant"];
  var Type_Equality = $PS["Type.Equality"];
  var Type_Proxy = $PS["Type.Proxy"];
  ...
  var events = function (dpage) {
      return Deku_Pursx.makePursx({
          ...
          })()()(FRP_Event_Variant.vBusNilRowRowRow)()()()())()()()())()()()())(Type_Proxy["Proxy"].value)(function (push) {
              return function (event) {
