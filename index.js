      ...
      return function (v) {
          return function (v1) {
              ...
              return Data_Variant.match()()()({
                  fixedChildren: function (v2) {
                      return Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(FRP_Event.plusEvent)(element)(v2);
                  },
                  eventfulElement: function (v2) {
                      return FRP_Event_Class.keepLatest(FRP_Event.eventIsEvent)(Data_Functor.map(FRP_Event.functorEvent)(__internalDekuFlatten(parent)(v))(v2));
                  },
                  element: element,
                  dynamicChildren: function (v2) {
                                      ...
                                      var c0 = FRP_Event.subscribe(inner)(function (kid$prime) {
                                          return function __do() {
                                              ...
                                              if (kid$prime instanceof Deku_Core.SendToTop && stage instanceof Middle) {
                                                  return Control_Bind.bind(Effect.bindEffect)(Effect_Ref.read(myId))(Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(function ($23) {
                                                      return k(v.sendToTop((function (v3) {
                                                          return {
                                                              id: v3
                                                          };
                                                      })($23)));
                                              ...
                                              if (kid$prime instanceof Deku_Core.Insert && stage instanceof Begin) {
...
(function($PS) {
  ...
  var plantEventEventChildDomab = function (dictTypeEquals) {
      return function (dictTypeEquals1) {
          return {
              plant: function (i) {
                  return Deku_Core.Domable(Data_Variant.inj()({
                      reflectSymbol: function () {
                          return "dynamicChildren";
                      }
                  })(Type_Proxy["Proxy"].value)(Type_Equality.proof(Type_Equality.refl)(Safe_Coerce.coerce()(i))));
              }
          };
      };
  };
      ...
      return function (dictTypeEquals1) {
          return {
              plant: function (i) {
                  ...
                  })(Type_Proxy["Proxy"].value)(Type_Equality.proof(dictTypeEquals1)(Safe_Coerce.coerce()(i))));
              }
          };
      };
  };
      ...
      return function (id) {
          return function (atts) {
              return Data_Functor.map(FRP_Event.functorEvent)(function ($98) {
                  ...
                  })(Deku_Attribute.unsafeUnAttribute($98)));
              })(atts);
          };
      };
  };
  ...
  var switcher = function (f) {
      return function (event) {
          ...
          return plant(plantEventEventChildDomab(Type_Equality.refl)(Type_Equality.refl))(FRP_Event_Class.keepLatest(FRP_Event.eventIsEvent)(FRP_Event.memoize(counter(event))(function (cenv) {
              return Data_Functor.map(FRP_Event.functorEvent)(function (v) {
                  return Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang(Deku_Core.Insert.create(f(v.value0))))(Data_Functor.map(FRP_Event.functorEvent)(Data_Function["const"](Deku_Core.Remove.value))(Data_Filterable.filter(FRP_Event.filterableEvent)((function () {
                      var $99 = Data_Eq.eq(Data_Eq.eqInt)(v.value1 + 1 | 0);
                      return function ($100) {
                          return $99(Data_Tuple.snd($100));
                      };
                  })())(cenv)));
              })(cenv);
          })));
                      ...
                      return function (v) {
                          return FRP_Event.makeEvent(function (k) {
                              return function __do() {
                                  ...
                                  var realized = Deku_Internal["__internalDekuFlatten"](psr.parent)(v)(deleteMeASAP(Type_Equality.refl)(Type_Equality.refl)(closure(injectable)(function (v1) {
                                      return v1;
                                  })));
  ...
  var plantDomableDomable = function (dictTypeEquals) {
      return function (dictTypeEquals1) {
          return {
              plant: function (i) {
                  return deleteMeASAP(dictTypeEquals)(dictTypeEquals1)(i);
              }
          };
      };
  };
      ...
      return function (dictTypeEquals1) {
          return {
              plant: function (i) {
                  return Deku_Core.Domable(Data_Variant.inj()({
                      reflectSymbol: function () {
                          return "eventfulElement";
                      }
                  })(Type_Proxy["Proxy"].value)(Data_Functor.map(FRP_Event.functorEvent)(deleteMeASAP(dictTypeEquals)(dictTypeEquals1))(i)));
              }
          };
      };
  };
              ...
              return FRP_Event.makeEvent(function (k) {
                  return function __do() {
                      ...
                      return FRP_Event.subscribe(Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang(v.makeRoot({
                          id: me,
                          root: root
                      })))(Deku_Internal["__internalDekuFlatten"](me)(v)(deleteMeASAP(Type_Equality.refl)(Type_Equality.refl)(children))))(k)();
                  };
              });
          };
      };
  ...
  var dekuA = function (root) {
      return function (children) {
          return deku(root)(plant(plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))(children));
      };
  };
  var blank = (function () {
      var go = function (v) {
  ...
  exports["plantEventEventChildDomab"] = plantEventEventChildDomab;
  exports["plantDomableDomable"] = plantDomableDomable;
  exports["plantEventDomableDomable"] = plantEventDomableDomable;
  exports["plantElementDomable"] = plantElementDomable;
  exports["plantArrayElementDomable"] = plantArrayElementDomable;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
...
(function($PS) {
  ...
  var attrOnClickEffectUnit = {
      attr: function (v) {
          return function (value) {
              return Deku_Attribute.unsafeAttribute({
                  key: "click",
                  value: Deku_Attribute["cb'"](Data_Function["const"](Data_Functor.voidLeft(Effect.functorEffect)(value)(true)))
              });
          };
      }
  };
  ...
  exports["attrOnClickEffectUnit"] = attrOnClickEffectUnit;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
...
(function($PS) {
  ...
  var pursxToElementConsInsert = function (dictCons) {
      return function (dictPursxToElement) {
          return function (dictIsSymbol) {
              return {
                  pursxToElement: function (pxScope) {
  ...
  exports["pursxToElementConsInsert"] = pursxToElementConsInsert;
...
(function($PS) {
  ...
  var components = function (dpage) {
      return Deku_Pursx.makePursx({
      ...
      })()()(Deku_Pursx.pursxToElementConsInsert()(Deku_Pursx.pursxToElementConsAttr()(Deku_Pursx.pursxToElementConsInsert()(Deku_Pursx.pursxToElementNil)({
          reflectSymbol: function () {
              return "result";
          }
      }))({
          ...
          code: Deku_Pursx.nut(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))(Deku_DOM_Elt_Pre.pre_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Code.code_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_Control.text_("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Deku.Attribute ((:=))\x0aimport Deku.Control (blank, text_)\x0aimport Deku.DOM as D\x0aimport Deku.Toplevel (runInBodyA)\x0aimport Effect (Effect)\x0aimport FRP.Event.Class (bang)\x0a\x0amain :: Effect Unit\x0amain = runInBodyA\x0a  ( [ D.button_ [ text_ \"I do nothing\" ]\x0a    , D.ul_ $ map (D.li_ <<< text_) [ \"A\", \"B\", \"C\" ]\x0a    , D.div_\x0a        [ D.a (bang $ D.Href := \"https://example.com\")\x0a            [ text_ \"foo \" ]\x0a        , D.i_ [ text_ \" bar \" ]\x0a        , D.span (bang $ D.Style := \"font-weight: 800;\")\x0a            [ text_ \" baz\" ]\x0a        ]\x0a    , D.div_\x0a        [ D.div_\x0a            [ D.div_ [ D.input (bang $ D.Xtype := \"range\") blank ]\x0a            ]\x0a        ]\x0a    ]\x0a  )") ]) ])),
          result: Deku_Pursx.nut(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))(Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Button.button_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_Control.text_("I do nothing") ]), Deku_DOM_Elt_Ul.ul_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))(Data_Functor.map(Data_Functor.functorArray)((function () {
              var $0 = Deku_DOM_Elt_Li.li_(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl));
              return function ($1) {
                  return $0(Deku_Control.text_($1));
              };
          })())([ "A", "B", "C" ])), Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_A.a(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_Href.attrA_HrefString)(Deku_DOM_Attr_Href.Href.value)("https://example.com")))([ Deku_Control.text_("foo ") ]), Deku_DOM_Elt_I.i_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_Control.text_(" bar ") ]), Deku_DOM_Elt_Span.span(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_Style.attrSpan_StyleString)(Deku_DOM_Attr_Style.Style.value)("font-weight: 800;")))([ Deku_Control.text_(" baz") ]) ]), Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Input.input(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_Xtype.attrInput_XtypeString)(Deku_DOM_Attr_Xtype.Xtype.value)("range")))(Deku_Control.blank) ]) ]) ]) ])),
...
(function($PS) {
  ...
  var effects = function (dpage) {
      return Deku_Pursx.makePursx({
          ...
          result: Deku_Pursx.nut(Deku_Control.plantEventDomableDomable(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bus(function (push) {
              return function (event) {
                  return Deku_Control.plant(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))((function () {
                      ...
                      return Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Button.button(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(clickCb(push))))([ Deku_Control.text(Control_Alt.alt(FRP_Event.altEvent)(Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang(clickText))(Data_Functor.voidLeft(FRP_Event.functorEvent)(loading)("Loading...")))(Data_Functor.voidLeft(FRP_Event.functorEvent)(result)(clickText))) ]) ]), Deku_DOM_Elt_Div.div(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))(Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_Style.attrDiv_StyleString)(Deku_DOM_Attr_Style.Style.value)("display: none;")))(Data_Functor.voidLeft(FRP_Event.functorEvent)(Data_Compactable.compact(FRP_Event.compactableEvent)(FRP_Event_Class.mapAccum(FRP_Event.eventIsEvent)(function (v) {
                          return function (b) {
                      ...
                      })(result)(true)))(Deku_Attribute.attr(Deku_DOM_Attr_Style.attrDiv_StyleString)(Deku_DOM_Attr_Style.Style.value)("display: block;"))))([ Deku_DOM_Elt_Pre.pre_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Code.code_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_Control.text(Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang(""))(result)) ]) ]) ]) ]);
                  })());
              };
          })),
...
(function($PS) {
  ...
  var events = function (dpage) {
      return Deku_Pursx.makePursx({
          ...
          code: Deku_Pursx.nut(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))(Deku_DOM_Elt_Pre.pre_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Code.code_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_Control.text_("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Affjax as AX\x0aimport Affjax.ResponseFormat as ResponseFormat\x0aimport Control.Alt ((<|>))\x0aimport Data.Argonaut.Core (stringifyWithIndent)\x0aimport Data.Either (Either(..))\x0aimport Data.Filterable (compact, filterMap)\x0aimport Data.HTTP.Method (Method(..))\x0aimport Data.Maybe (Maybe(..))\x0aimport Data.Profunctor (lcmap)\x0aimport Data.Tuple.Nested ((/\\))\x0aimport Deku.Attribute (Cb, cb, (:=))\x0aimport Deku.Control (plant, text)\x0aimport Deku.DOM as D\x0aimport Deku.Toplevel (runInBody)\x0aimport Effect (Effect)\x0aimport Effect.Aff (launchAff_)\x0aimport Effect.Class (liftEffect)\x0aimport FRP.Event (bang, bus, mapAccum)\x0a\x0adata UIAction = Initial | Loading | Result String\x0a\x0aclickCb :: (UIAction -> Effect Unit) -> Cb\x0aclickCb push = cb\x0a  ( const do\x0a      push Loading\x0a      launchAff_ $ do\x0a        result <- AX.request\x0a          ( AX.defaultRequest\x0a              { url = \"https://randomuser.me/api/\"\x0a              , method = Left GET\x0a              , responseFormat = ResponseFormat.json\x0a              }\x0a          )\x0a        case result of\x0a          Left err -> liftEffect $ push\x0a            $ Result\x0a              ( \"GET /api response failed to decode: \" <>\x0a                  AX.printError err\x0a              )\x0a          Right response -> liftEffect $ push $ Result $\x0a            stringifyWithIndent 2 response.body\x0a  )\x0a\x0aclickText = \"Click to get some random user data.\" :: String\x0a\x0amain :: Effect Unit\x0amain = runInBody\x0a  ( plant $ bus \\push -> lcmap (bang Initial <|> _)\x0a      \\event ->\x0a        let\x0a          loadingOrResult = filterMap\x0a            ( case _ of\x0a                Loading -> Just $ Left unit\x0a                Result s -> Just $ Right s\x0a                _ -> Nothing\x0a            )\x0a            event\x0a          loading = filterMap\x0a            ( case _ of\x0a                Left _ -> Just unit\x0a                _ -> Nothing\x0a            )\x0a            loadingOrResult\x0a          result = filterMap\x0a            ( case _ of\x0a                Right s -> Just s\x0a                _ -> Nothing\x0a            )\x0a            loadingOrResult\x0a        in\x0a          plant\x0a            [ D.div_\x0a                [ D.button (bang (D.OnClick := clickCb push))\x0a                    [ text\x0a                        ( bang clickText\x0a                            <|> (loading $> \"Loading...\")\x0a                            <|> (result $> clickText)\x0a                        )\x0a                    ]\x0a                ]\x0a            , D.div\x0a                ( (bang (D.Style := \"display: none;\")) <|>\x0a                    ( compact\x0a                        ( mapAccum\x0a                            ( \\_ b -> (b && false) /\\\x0a                                if b then Just unit else Nothing\x0a                            )\x0a                            result\x0a                            true\x0a                        ) $> (D.Style := \"display: block;\")\x0a                    )\x0a                )\x0a                [ D.pre_ [ D.code_ [ text (bang \"\" <|> result) ] ] ]\x0a            ]\x0a  )\x0a") ]) ])),
          result: Deku_Pursx.nut(Deku_Control.plantEventDomableDomable(Type_Equality.refl)(Type_Equality.refl))(FRP_Event_VBus.vbus()(FRP_Event_VBus.vbusCons2({
              reflectSymbol: function () {
              ...
              return function (event) {
                  return Deku_Control.plant(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))(Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Button.button(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push.buttonClicked(Data_Unit.unit))))))([ Deku_Control.text_("Click") ]), Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_Control.text(Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang("Val: 0"))(Data_Functor.map(FRP_Event.functorEvent)((function () {
                  ...
                  }))(Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang(Data_Unit.unit))(event.buttonClicked))(0)))) ]), Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Input.input(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(FRP_Event.plusEvent)(FRP_Event.bang)([ Deku_Attribute.attr(Deku_DOM_Attr_Xtype.attrInput_XtypeString)(Deku_DOM_Attr_Xtype.Xtype.value)("range"), Deku_Attribute.attr(Deku_DOM_Attr_OnInput.attrOnInputCb)(Deku_DOM_Attr_OnInput.OnInput.value)(Deku_Attribute.cb(function (e) {
                  ...
                  })) ]))(Deku_Control.blank), Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_Control.text(Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang("Val: 50"))(Data_Functor.map(FRP_Event.functorEvent)((function () {
...
(function($PS) {
  ...
  var events2 = function (dpage) {
      return Deku_Pursx.makePursx({
          ...
          code: Deku_Pursx.nut(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))(Deku_DOM_Elt_Pre.pre_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Code.code_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_Control.text_("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Control.Alt ((<|>))\x0aimport Data.Filterable (filterMap)\x0aimport Data.Foldable (for_, oneOfMap)\x0aimport Data.Maybe (Maybe(..))\x0aimport Data.Profunctor (lcmap)\x0aimport Data.Tuple.Nested ((/\\))\x0aimport Deku.Attribute (cb, (:=))\x0aimport Deku.Control (blank, plant, text_)\x0aimport Deku.Core (Child(..))\x0aimport Deku.DOM as D\x0aimport Deku.Toplevel (runInBody1)\x0aimport Effect (Effect)\x0aimport FRP.Event (bang, bus, keepLatest, mapAccum)\x0aimport Web.Event.Event (target)\x0aimport Web.HTML.HTMLInputElement (fromEventTarget, value)\x0aimport Web.UIEvent.KeyboardEvent (code, fromEvent)\x0a\x0adata MainUIAction\x0a  = UIShown\x0a  | AddTodo\x0a  | ChangeText String\x0a\x0adata TodoAction = Prioritize | Delete\x0a\x0amain :: Effect Unit\x0amain = runInBody1\x0a  ( bus \\push -> lcmap (bang UIShown <|> _) \\event -> plant do\x0a      let\x0a        top =\x0a          [ D.input\x0a              ( oneOfMap bang\x0a                  [ D.OnInput := cb \\e -> for_\x0a                      ( target e\x0a                          >>= fromEventTarget\x0a                      )\x0a                      ( value\x0a                          >=> push <<< ChangeText\x0a                      )\x0a                  , D.OnKeyup := cb\x0a                      \\e -> for_ (fromEvent e) \\evt -> do\x0a                        when (code evt == \"Enter\") $ do\x0a                          push AddTodo\x0a                  ]\x0a              )\x0a              blank\x0a          , D.button\x0a              (bang $ D.OnClick :=  push AddTodo)\x0a              (text_ \"Add\")\x0a          ]\x0a      D.div_\x0a        [ D.div_ top\x0a        , D.div_ $\x0a            ( \\txt -> keepLatest $ bus \\p' e' ->\x0a                ( bang $ Insert $ D.div_\x0a                    [ text_ txt\x0a                    , D.button\x0a                        ( bang\x0a                            $ D.OnClick := p' SendToTop\x0a                        )\x0a                        [ text_ \"Prioritize\" ]\x0a                    , D.button\x0a                        ( bang\x0a                            $ D.OnClick :=  p' Remove\x0a                        )\x0a                        [ text_ \"Delete\" ]\x0a                    ]\x0a                ) <|> e'\x0a            ) <$>\x0a              filterMap\x0a                ( \\(tf /\\ s) ->\x0a                    if tf then Just s else Nothing\x0a                )\x0a                ( mapAccum\x0a                    ( \\a b -> case a of\x0a                        ChangeText s -> s /\\ (false /\\ s)\x0a                        AddTodo -> b /\\ (true /\\ b)\x0a                        _ -> \"\" /\\ (false /\\ \"\")\x0a                    )\x0a                    event\x0a                    \"\"\x0a                )\x0a        ]\x0a  )\x0a") ]) ])),
          result: Deku_Pursx.nut(Deku_Control.plantEventDomableDomable(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bus(function (push) {
              return Data_Profunctor.lcmap(Data_Profunctor.profunctorFn)(Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang(UIShown.value)))(function (event) {
                  return Deku_Control.plant(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))(Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Input.input(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(FRP_Event.plusEvent)(FRP_Event.bang)([ Deku_Attribute.attr(Deku_DOM_Attr_Style.attrInput_StyleString)(Deku_DOM_Attr_Style.Style.value)("border-style:solid;border-width: 1px;border-color: black;"), Deku_Attribute.attr(Deku_DOM_Attr_OnInput.attrOnInputCb)(Deku_DOM_Attr_OnInput.OnInput.value)(Deku_Attribute.cb(function (e) {
                  ...
                  })) ]))(Deku_Control.blank), Deku_DOM_Elt_Button.button(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))(Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_Style.attrButton_StyleString)(Deku_DOM_Attr_Style.Style.value)("margin: 5px;")))(FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(AddTodo.value)))))))(Deku_Control.text_("Add")) ]), Deku_DOM_Elt_Div.div_(Deku_Control.plantEventEventChildDomab(Type_Equality.refl)(Type_Equality.refl))(Data_Functor.map(FRP_Event.functorEvent)(function (txt) {
                      return FRP_Event_Class.keepLatest(FRP_Event.eventIsEvent)(FRP_Event.bus(function (p$prime) {
                          return function (e$prime) {
                              return Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang(Deku_Core.Insert.create(Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Span.span(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_Style.attrSpan_StyleString)(Deku_DOM_Attr_Style.Style.value)("margin: 5px;")))(Deku_Control.text_(txt)), Deku_DOM_Elt_Button.button(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))(Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_Style.attrButton_StyleString)(Deku_DOM_Attr_Style.Style.value)("margin: 5px;")))(FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](p$prime(Deku_Core.SendToTop.value)))))))([ Deku_Control.text_("Prioritize") ]), Deku_DOM_Elt_Button.button(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))(Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_Style.attrButton_StyleString)(Deku_DOM_Attr_Style.Style.value)("margin: 5px;")))(FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](p$prime(Deku_Core.Remove.value)))))))([ Deku_Control.text_("Delete") ]) ]))))(e$prime);
                          };
                      }));
...
(function($PS) {
  ...
  var helloWorld = function (dpage) {
      return Deku_Pursx.makePursx({
          ...
          result: Deku_Pursx.nut(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))(Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_Control.text_("Hello world") ])),
...
(function($PS) {
  ...
  var portals1 = function (v) {
      return Deku_Pursx.makePursx({
      ...
      })()()(Deku_Pursx.pursxToElementConsInsert()(Deku_Pursx.pursxToElementConsInsert()(Deku_Pursx.pursxToElementNil)({
          reflectSymbol: function () {
              return "result";
          }
      }))({
          ...
          code: Deku_Pursx.nut(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))(Deku_DOM_Elt_Pre.pre_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Code.code_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_Control.text_("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Control.Alt ((<|>))\x0aimport Data.Foldable (oneOfMap)\x0aimport Data.Profunctor (lcmap)\x0aimport Data.Tuple.Nested ((/\\), type (/\\))\x0aimport Data.Typelevel.Num (d0, d1)\x0aimport Data.Vec (index, (+>))\x0aimport Data.Vec as V\x0aimport Deku.Attribute ((:=))\x0aimport Deku.Control (blank, plant, portal, switcher, text_)\x0aimport Deku.DOM as D\x0aimport Deku.Toplevel (runInBody1)\x0aimport Effect (Effect)\x0aimport FRP.Event (Event, bang, bus, fold, mapAccum)\x0a\x0acounter :: forall a. Event a \u2192 Event (a /\\ Int)\x0acounter event = mapAccum f event 0\x0a  where\x0a  f a b = (b + 1) /\\ (a /\\ b)\x0a\x0amain :: Effect Unit\x0amain = runInBody1\x0a  ( bus \\push -> lcmap  (bang unit <|> _) \\event -> do\x0a      plant $ portal\x0a        ( map\x0a            ( \\i -> D.video\x0a                (oneOfMap bang [ D.Controls := \"true\", D.Width := \"250\" ])\x0a                ( D.source\x0a                    (oneOfMap bang [ D.Src := i, D.Xtype := \"video/mp4\" ])\x0a                    blank\x0a                )\x0a            )\x0a            ( \"https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4\"\x0a                +> \"https://www.w3schools.com/jsref/movie.mp4\"\x0a                +> V.empty\x0a            )\x0a        )\x0a        \\v _ -> do\x0a          let\x0a            p0 = index v d0\x0a            p1 = index v d1\x0a            ev = fold (const not) event\x0a            flips = switcher (if _ then p0 else p1) <<< ev\x0a          plant $ D.div_\x0a            [ D.button (bang $ D.OnClick := push unit)\x0a                [ text_ \"Switch videos\" ]\x0a            , D.div_ [ D.span_ (flips true), D.span_ (flips false) ]\x0a            ]\x0a  )\x0a") ]) ])),
          result: Deku_Pursx.nut(Deku_Control.plantEventEventChildDomab(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bus(function (push) {
              return Data_Profunctor.lcmap(Data_Profunctor.profunctorFn)(Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang(Data_Unit.unit)))(function (event) {
                  return FRP_Event.bang(Deku_Core.Insert.create(Deku_Control.portal(Data_Functor.map(Data_Vec.functorVec)(function (i) {
                      return Deku_DOM_Elt_Video.video(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(FRP_Event.plusEvent)(FRP_Event.bang)([ Deku_Attribute.attr(Deku_DOM_Attr_Controls.attrVideo_ControlsString)(Deku_DOM_Attr_Controls.Controls.value)("true"), Deku_Attribute.attr(Deku_DOM_Attr_Width.attrVideo_WidthString)(Deku_DOM_Attr_Width.Width.value)("250") ]))(Deku_DOM_Elt_Source.source(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(FRP_Event.plusEvent)(FRP_Event.bang)([ Deku_Attribute.attr(Deku_DOM_Attr_Src.attrSource_SrcString)(Deku_DOM_Attr_Src.Src.value)(i), Deku_Attribute.attr(Deku_DOM_Attr_Xtype.attrSource_XtypeString)(Deku_DOM_Attr_Xtype.Xtype.value)("video/mp4") ]))(Deku_Control.blank));
                      ...
                      return function (v2) {
                          ...
                          return Deku_Control.plant(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))(Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Button.button(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(Data_Unit.unit))))))([ Deku_Control.text_("Switch videos") ]), Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Span.span_(Deku_Control.plantDomableDomable(Type_Equality.refl)(Type_Equality.refl))(flips(true)), Deku_DOM_Elt_Span.span_(Deku_Control.plantDomableDomable(Type_Equality.refl)(Type_Equality.refl))(flips(false)) ]) ]));
                      };
                  })));
              });
          }))
...
(function($PS) {
  ...
  var pursx1 = function (dpage) {
      return Deku_Pursx.makePursx({
          ...
          result: Deku_Pursx.nut(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))(Deku_Pursx.psx({
              reflectSymbol: function () {
      ...
      return Deku_Pursx["makePursx'"]({
          ...
          result: Deku_Pursx.nut(Deku_Control.plantEventEventChildDomab(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bus(function (push) {
              return function (event) {
                  return FRP_Event.bang(Deku_Core.Insert.create(Deku_Pursx.makePursx({
                  ...
                  })()()(Deku_Pursx.pursxToElementConsAttr()(Deku_Pursx.pursxToElementConsInsert()(Deku_Pursx.pursxToElementNil)({
                      reflectSymbol: function () {
                          return "somethingNew";
                      }
                  }))({
                      ...
                      somethingNew: Deku_Pursx.nut(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))(Deku_DOM_Elt_Button.button(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickEffectUnit)(Deku_DOM_Attr_OnClick.OnClick.value)(push(new Data_Maybe.Just(Data_Unit.unit)))))([ Deku_Control.text(Control_Alt.alt(FRP_Event.altEvent)(Data_Functor.voidLeft(FRP_Event.functorEvent)(Data_Compactable.compact(FRP_Event.compactableEvent)(event))("Thanks for clicking me!"))(FRP_Event.bang("I was dynamically inserted"))) ]))
                  })));
              };
          })),
...
(function($PS) {
  ...
  var scene = function (push) {
      return function (event) {
          ...
          return [ Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))(Data_Functor.map(Data_Functor.functorArray)(function (v) {
              return Deku_DOM_Elt_Span.span_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_A.a(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(FRP_Event.plusEvent)(FRP_Event.bang)([ Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(v.value0)))), Deku_Attribute.attr(Deku_DOM_Attr_Style.attrA_StyleString)(Deku_DOM_Attr_Style.Style.value)("cursor:pointer;") ]))([ Deku_Control.text_(v.value1.value0) ]), Deku_DOM_Elt_Span.span(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_Style.attrSpan_StyleString)(Deku_DOM_Attr_Style.Style.value)((function () {
                  if (v.value1.value1) {
                      return "";
                  };
                  return "display:none;";
              })())))([ Deku_Control.text_(" | ") ]) ]);
          })([ new Data_Tuple.Tuple(Deku_Example_Docs_Types.Intro.value, new Data_Tuple.Tuple("Home", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.HelloWorld.value, new Data_Tuple.Tuple("Hello world", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.SimpleComponent.value, new Data_Tuple.Tuple("Component", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.PURSX1.value, new Data_Tuple.Tuple("Pursx 1", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.Events.value, new Data_Tuple.Tuple("Events 1", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.Effects.value, new Data_Tuple.Tuple("Effects", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.PURSX2.value, new Data_Tuple.Tuple("Pursx 2", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.Events2.value, new Data_Tuple.Tuple("Events 2", true)), new Data_Tuple.Tuple(Deku_Example_Docs_Types.Portals.value, new Data_Tuple.Tuple("Portals", false)) ])), Deku_DOM_Elt_Div.div_(Deku_Control.plantDomableDomable(Type_Equality.refl)(Type_Equality.refl))(Deku_Control.switcher(page(push))(event)) ];
      };
  };
