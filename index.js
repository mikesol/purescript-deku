...
(function($PS) {
  ...
  var Unsafe_Coerce = $PS["Unsafe.Coerce"];
  var plantEventEventChildEvent = function (dictTypeEquals) {
  ...
  var plantEventElementEventEve = function (dictTypeEquals) {
      return function (dictTypeEquals1) {
          return {
              plant: function (i) {
                  return Type_Equality.proof(Type_Equality.refl)(Safe_Coerce.coerce()(FRP_Event.bang(Data_Functor.map(FRP_Event.functorEvent)(Deku_Core.Insert.create)(i))));
              }
          };
      };
  };
  var plantElementEventEventChi = function (dictTypeEquals) {
      return function (dictTypeEquals1) {
          return {
              plant: function (i) {
                  return Type_Equality.proof(Type_Equality.refl)(Safe_Coerce.coerce()(FRP_Event.bang(FRP_Event.bang(Deku_Core.Insert.create(i)))));
              }
          };
      };
  };
  var plantArrayElementEventEve = function (dictTypeEquals) {
      return function (dictTypeEquals1) {
          return {
              plant: function (i) {
                  return Type_Equality.proof(Type_Equality.refl)(Safe_Coerce.coerce()(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(FRP_Event.plusEvent)(FRP_Event.bang)(Data_Functor.map(Data_Functor.functorArray)(function ($92) {
                      return FRP_Event.bang(Deku_Core.Insert.create($92));
                  })(i))));
              }
          };
      };
  ...
  var unsafeSetAttribute = function (v) {
      return function (id) {
          return function (atts) {
              return Data_Functor.map(FRP_Event.functorEvent)(function ($94) {
                  ...
                  })(Deku_Attribute.unsafeUnAttribute($94)));
              })(atts);
          };
      };
  };
          ...
          return FRP_Event_Class.keepLatest(FRP_Event.eventIsEvent)(FRP_Event.memoize(counter(event))(function (cenv) {
              return Data_Functor.map(FRP_Event.functorEvent)(function (v) {
                  return Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang(Deku_Core.Insert.create(f(v.value0))))(Data_Functor.map(FRP_Event.functorEvent)(Data_Function["const"](Deku_Core.Remove.value))(Data_Filterable.filter(FRP_Event.filterableEvent)((function () {
                      var $95 = Data_Eq.eq(Data_Eq.eqInt)(v.value1 + 1 | 0);
                      return function ($96) {
                          return $95(Data_Tuple.snd($96));
                      };
                  })())(cenv)));
              })(cenv);
          }));
  ...
  var dekuA = function (root) {
      return function (children) {
          return deku(root)(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(FRP_Event.plusEvent)(FRP_Event.bang)(Data_Functor.map(Data_Functor.functorArray)(function ($97) {
              return FRP_Event.bang(Deku_Core.Insert.create($97));
          })(children)));
      };
  };
  var blank = (function () {
  ...
  exports["plantEventEventChildEvent"] = plantEventEventChildEvent;
  exports["plantEventElementEventEve"] = plantEventElementEventEve;
  exports["plantElementEventEventChi"] = plantElementEventEventChi;
...
(function($PS) {
  ...
  var events = function (dpage) {
      return Deku_Pursx.makePursx({
          ...
          code: Deku_Pursx.nut(Deku_Control.plantElementEventEventChi(Type_Equality.refl)(Type_Equality.refl))(Deku_DOM_Elt_Pre.pre_(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Code.code_(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))([ Deku_Control.text_("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Control.Alt ((<|>))\x0aimport Data.Foldable (for_, oneOfMap)\x0aimport Deku.Attribute (cb, (:=))\x0aimport Deku.Control (blank, text, text_)\x0aimport Deku.DOM as D\x0aimport Deku.Toplevel (runInBody1)\x0aimport Effect (Effect)\x0aimport FRP.Event (bang, fold)\x0aimport FRP.Event.VBus (V, vbus)\x0aimport Type.Proxy (Proxy(..))\x0aimport Web.DOM.Element (fromEventTarget)\x0aimport Web.Event.Event (target)\x0aimport Web.HTML.HTMLInputElement (fromElement, valueAsNumber)\x0a\x0atype UIEvents = V\x0a  ( uiShow :: Unit\x0a  , buttonClicked :: Unit\x0a  , sliderMoved :: Number\x0a  )\x0a\x0amain :: Effect Unit\x0amain = runInBody1\x0a  ( vbus (Proxy :: _ UIEvents) \\push event -> do\x0a      D.div_\x0a        [ D.button\x0a            ( bang\x0a                ( D.OnClick :=\x0a                    cb (const $ push.buttonClicked unit)\x0a                )\x0a            )\x0a            [ text_ \"Click\" ]\x0a        , D.div_\x0a            [ text\x0a                ( bang \"Val: 0\" <|>\x0a                    ( append \"Val: \" <<< show\x0a                        <$> fold\x0a                          (const (add 1))\x0a                          (bang unit <|> event.buttonClicked)\x0a                          (-1)\x0a                    )\x0a                )\x0a            ]\x0a        , D.div_\x0a            [ D.input\x0a                ( oneOfMap bang\x0a                    [ D.Xtype := \"range\"\x0a                    , D.OnInput := cb \\e -> for_\x0a                        ( target e\x0a                            >>= fromEventTarget\x0a                            >>= fromElement\x0a                        )\x0a                        ( valueAsNumber\x0a                            >=> push.sliderMoved\x0a                        )\x0a                    ]\x0a                )\x0a                blank\x0a            , D.div_\x0a                [ text\x0a                    ( bang \"Val: 50\" <|>\x0a                        ( append \"Val: \" <<< show\x0a                            <$> event.sliderMoved\x0a                        )\x0a                    )\x0a                ]\x0a            ]\x0a        ]\x0a  )\x0a") ]) ])),
...
(function($PS) {
  ...
  var helloWorld = function (dpage) {
      return Deku_Pursx.makePursx({
          ...
          result: Deku_Pursx.nut(Deku_Control.plantElementEventEventChi(Type_Equality.refl)(Type_Equality.refl))(Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))([ Deku_Control.text_("Hello world") ])),
...
(function($PS) {
  ...
  var portals1 = function (v) {
      return Deku_Pursx.makePursx({
          ...
          result: Deku_Pursx.nut(Deku_Control.plantEventEventChildEvent(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bus(function (push) {
              return Data_Profunctor.lcmap(Data_Profunctor.profunctorFn)(Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang(Data_Unit.unit)))(function (event) {
                  return FRP_Event.bang(Deku_Core.Insert.create(Deku_Control.portal(Data_Functor.map(Data_Vec.functorVec)(function (i) {
                      return Deku_DOM_Elt_Video.video(Deku_Control.plantElementEventEventChi(Type_Equality.refl)(Type_Equality.refl))(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(FRP_Event.plusEvent)(FRP_Event.bang)([ Deku_Attribute.attr(Deku_DOM_Attr_Controls.attrVideo_ControlsString)(Deku_DOM_Attr_Controls.Controls.value)("true"), Deku_Attribute.attr(Deku_DOM_Attr_Width.attrVideo_WidthString)(Deku_DOM_Attr_Width.Width.value)("250") ]))(Deku_DOM_Elt_Source.source(Deku_Control.plantElementEventEventChi(Type_Equality.refl)(Type_Equality.refl))(Data_Foldable.oneOfMap(Data_Foldable.foldableArray)(FRP_Event.plusEvent)(FRP_Event.bang)([ Deku_Attribute.attr(Deku_DOM_Attr_Src.attrSource_SrcString)(Deku_DOM_Attr_Src.Src.value)(i), Deku_Attribute.attr(Deku_DOM_Attr_Xtype.attrSource_XtypeString)(Deku_DOM_Attr_Xtype.Xtype.value)("video/mp4") ]))(Deku_Control.blank));
                      ...
                      return function (v2) {
                          ...
                          return Deku_Control.plant(Deku_Control.plantElementEventEventChi(Type_Equality.refl)(Type_Equality.refl))(Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Button.button(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(Data_Unit.unit))))))([ Deku_Control.text_("Switch videos") ]), Deku_DOM_Elt_Div.div_(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Span.span_(Deku_Control.plantEventEventChildEvent(Type_Equality.refl)(Type_Equality.refl))(flips(true)), Deku_DOM_Elt_Span.span_(Deku_Control.plantEventEventChildEvent(Type_Equality.refl)(Type_Equality.refl))(flips(false)) ]) ]));
                      };
                  })));
              });
          }))
...
(function($PS) {
  ...
  var pursx1 = function (dpage) {
      return Deku_Pursx.makePursx({
          ...
          result: Deku_Pursx.nut(Deku_Control.plantElementEventEventChi(Type_Equality.refl)(Type_Equality.refl))(Deku_Pursx.psx({
              reflectSymbol: function () {
          ...
          result: Deku_Pursx.nut(Deku_Control.plantEventEventChildEvent(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bus(function (push) {
              return function (event) {
                  return FRP_Event.bang(Deku_Core.Insert.create(Deku_Pursx.makePursx({
                      ...
                      somethingNew: Deku_Pursx.nut(Deku_Control.plantElementEventEventChi(Type_Equality.refl)(Type_Equality.refl))(Deku_DOM_Elt_Button.button(Deku_Control.plantArrayElementEventEve(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(new Data_Maybe.Just(Data_Unit.unit)))))))([ Deku_Control.text(Control_Alt.alt(FRP_Event.altEvent)(Data_Functor.voidLeft(FRP_Event.functorEvent)(Data_Compactable.compact(FRP_Event.compactableEvent)(event))("Thanks for clicking me!"))(FRP_Event.bang("I was dynamically inserted"))) ]))
                  })));
              };
          })),
