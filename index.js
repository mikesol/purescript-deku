...
(function($PS) {
          ...
          return Data_Function["const"](f({
              ...
              instructions: (function () {
                  var instructions = Data_Functor.map(Data_Functor.functorArray)(function (v1) {
                      ...
                      throw new Error("Failed pattern match at Deku.Interpret (line 108, column 23 - line 110, column 53): " + [ i.env.constructor.name ]);
                  })(v.envs));
                  return instructions;
              })()
          }));
  ...
  var freeDOMInterpret = {
      connectXToY: function ($170) {
          return Data_Function["const"](Deku_Rendered.iConnectXToY($170));
      },
      disconnectXFromY: function ($171) {
          return Data_Function["const"](Deku_Rendered.iDisconnectXFromY($171));
      },
      destroyUnit: function ($172) {
          return Data_Function["const"](Deku_Rendered.iDestroyUnit($172));
      },
      makeElement: function ($173) {
          return Data_Function["const"](Deku_Rendered.iMakeElement($173));
      },
      makeRoot: function ($174) {
          return Data_Function["const"](Deku_Rendered.iMakeRoot($174));
      },
      makeText: function ($175) {
          return Data_Function["const"](Deku_Rendered.iMakeText($175));
      },
      makeTumult: function ($176) {
          return Data_Function["const"](Deku_Rendered.iMakeTumult($176));
      },
      massiveCreate: function ($177) {
          return Data_Function["const"](Deku_Rendered.iMassiveCreate($177));
      },
      makeSubgraph: handleSubgraph(Deku_Rendered.iMakeSubgraph),
      setAttribute: function ($178) {
          return Data_Function["const"](Deku_Rendered.iSetAttribute($178));
      },
      ...
      massiveChange: function ($179) {
          return Data_Function["const"](Deku_Rendered.iMassiveChange($179));
      },
      setText: function ($180) {
          return Data_Function["const"](Deku_Rendered.iSetText($180));
      },
      setTumult: function ($181) {
          return Data_Function["const"](Deku_Rendered.iSetTumult($181));
      }
  };
...
(function($PS) {
                          ...
                          changeRL_: function (dictDOMInterpret) {
                              return function (v) {
                                  return function (w) {
                                      ...
                                      return changeRL_(dictChangeRL)(dictDOMInterpret)(Type_Proxy["Proxy"].value)(Data_Functor.voidLeft(Deku_Control_Types.functorDOM)(change$prime(dictChange$prime)(dictDOMInterpret)(Type_Proxy["Proxy"].value)(Data_Functor.voidLeft(Deku_Control_Types.functorDOM)(w)(Record.get(dictIsSymbol)()(Type_Proxy["Proxy"].value)(v1.value))))(v1.value));
                                  };
                              };
                          }
                      };
  ...
  var ichange = function (dictDOMInterpret) {
      return function (dictChange) {
          return function (r) {
              var $1068 = change(dictChange)(dictDOMInterpret);
              var $1069 = Data_Functor.voidRight(Deku_Control_Types.functorDOM)(r);
              ...
              return function (push) {
                  return function (started) {
                      ...
                      if (e instanceof Data_Either.Right && e.value0 instanceof Data_Either.Left) {
                          return Data_Functor.voidLeft(Deku_Control_Indexed.functorIxDOM)(Deku_Change.ichange(dictDOMInterpret)(Deku_Change.changeAll()(Deku_Change.changeRL_Cons({
                              reflectSymbol: function () {
                      ...
                      if (e instanceof Data_Either.Right && e.value0 instanceof Data_Either.Right) {
                          return Data_Functor.voidLeft(Deku_Control_Indexed.functorIxDOM)(Control_Apply.applySecond(Deku_Control_Indexed.applyIxDOM)(Control_Applicative.when(Deku_Control_Indexed.applicativeIxDOM)(!started)(Deku_Change.ichange(dictDOMInterpret)(Deku_Change.changeAll()(Deku_Change.changeRL_Cons({
                              reflectSymbol: function () {
                                  return "div.div2";
                              }
                          ...
                          })))(Deku_Change.ichange(dictDOMInterpret)(Deku_Change.changeAll()(Deku_Change.changeRL_Cons({
                              reflectSymbol: function () {
                                  return "div.div1.button";
                              }
                          })()()(Deku_Change.changeButton_({
          ...
          return Deku_Control_Functions.istart(Data_Monoid_Additive.monoidAdditive(Data_Semiring.semiringInt))(dictDOMInterpret)(Deku_Control_Types.isSceneSubScene)(function (v1) {
              ...
              return function (v1) {
                  return function (nclicks) {
                      ...
                      throw new Error("Failed pattern match at Deku.Example.Docs.Events (line 340, column 31 - line 352, column 17): " + [ e.constructor.name ]);
                  };
              };
          }));
      };
...
(function($PS) {
  // Generated by purs version 0.14.4
  "use strict";
  $PS["Deku.Tumult.Make"] = $PS["Deku.Tumult.Make"] || {};
  var exports = $PS["Deku.Tumult.Make"];     
  var E = (function () {
...
(function($PS) {
  ...
  var Deku_Graph_Attribute = $PS["Deku.Graph.Attribute"];
  var Deku_Interpret = $PS["Deku.Interpret"];
  var Deku_Tumult_Make = $PS["Deku.Tumult.Make"];
  var Foreign_Object = $PS["Foreign.Object"];
  var Type_Proxy = $PS["Type.Proxy"];                
  var toXML = function (v) {
      if (v instanceof Deku_Tumult_Make.E) {
      ...
      if (v instanceof Deku_Tumult_Make.T) {
          return v.value0;
      };
      throw new Error("Failed pattern match at Deku.SSR (line 196, column 1 - line 196, column 28): " + [ v.constructor.name ]);
  };
  var mcUnsubgraph = function (v) {
  ...
  var expandMassiveCreate = function (v) {
      if (v instanceof Data_List_Types.Cons) {
          return Data_Semigroup.append(Data_List_Types.semigroupList)(Data_Variant.on()({
              ...
              return Data_List.fromFoldable(Data_Foldable.foldableArray)($foreign.massiveCreate_(mcUnsubgraph)(Deku_Interpret.makeSubgraph(Deku_Interpret.freeDOMInterpret))(Deku_Interpret.makeTumult(Deku_Interpret.freeDOMInterpret))(Deku_Interpret.makeRoot(Deku_Interpret.freeDOMInterpret))(Deku_Interpret.makeElement(Deku_Interpret.freeDOMInterpret))(Deku_Interpret.makeText(Deku_Interpret.freeDOMInterpret))(Deku_Interpret.connectXToY(Deku_Interpret.freeDOMInterpret))(tc)(Data_Unit.unit));
          })(function (v1) {
      ...
      throw new Error("Failed pattern match at Deku.SSR (line 158, column 1 - line 158, column 60): " + [ v.constructor.name ]);
  };
  var doMakeStep = function (v) {
      ...
      throw new Error("Failed pattern match at Deku.SSR (line 80, column 1 - line 80, column 51): " + [ v.constructor.name ]);
  };
  var doConnectStep = function (v) {
      return function (adj) {
              ...
              return Data_Variant.on()({
                  ...
                  return doConnectStep(v.value1)(Foreign_Object.update(function (a$prime) {
                      return Data_Maybe.Just.create((function () {
                          ...
                          throw new Error("Failed pattern match at Deku.SSR (line 112, column 29 - line 114, column 81): " + [ a$prime.constructor.name ]);
                      })());
                  })(v1.toId)(adj));
              })(function (v1) {
          ...
          throw new Error("Failed pattern match at Deku.SSR (line 103, column 1 - line 103, column 74): " + [ v.constructor.name, adj.constructor.name ]);
      };
  };
      ...
      return function (adjacencies) {
          return function (indecents) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Foreign_Object.lookup(needle)(adjacencies))(function (v) {
                  if (v instanceof Data_Either.Left) {
                      return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(new Deku_Tumult_Make.T(v.value0));
                  };
                  if (v instanceof Data_Either.Right) {
                      return Data_Functor.map(Data_Maybe.functorMaybe)(Deku_Tumult_Make.E.create(v.value0.tag)(v.value0.attributes))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(Data_Array.fromFoldable(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(function (id) {
                  ...
                  throw new Error("Failed pattern match at Deku.SSR (line 127, column 33 - line 139, column 10): " + [ v.constructor.name ]);
              });
          };
      };
  };
  ...
  var resolveAllSubgraphs = function (v) {
      if (v instanceof Data_List_Types.Cons) {
          return Foreign_Object.union(Data_Variant.on()({
              ...
              return applySubgraph(v1.terminus)(v1.id)(v1.instructions);
          })(Data_Function["const"](Foreign_Object.empty))(v.value0))(resolveAllSubgraphs(v.value1));
      };
      if (v instanceof Data_List_Types.Nil) {
          return Foreign_Object.empty;
      };
      throw new Error("Failed pattern match at Deku.SSR (line 58, column 1 - line 58, column 59): " + [ v.constructor.name ]);
  };
  var applySubgraph = function (terminus) {
      return function (id) {
          return function (aaI) {
              var v = Data_Functor.map(Data_Maybe.functorMaybe)(Deku_Tumult_Make.E.create("div")([  ]))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(Data_Functor.map(Data_Functor.functorArray)(function (iss) {
                  return ssr$prime(terminus)(false)(iss);
              })(aaI)));
              if (v instanceof Data_Maybe.Nothing) {
                  return Foreign_Object.empty;
              };
              ...
              throw new Error("Failed pattern match at Deku.SSR (line 45, column 3 - line 56, column 29): " + [ v.constructor.name ]);
          };
      };
  };
  var ssr = function (a) {
              ...
              return function (v1) {
                  return function (v2) {
                      ...
                      if (e instanceof Data_Either.Right && e.value0 instanceof Sg0) {
                          return Deku_Change.ichange(dictDOMInterpret)(Deku_Change.changeAll()(Deku_Change.changeRL_Cons({
                              reflectSymbol: function () {
                                  return "div.sub";
                              }
  ...
  var page = function (dpage) {
      return function (dictDOMInterpret) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Deku.Example.Docs (line 113, column 1 - line 113, column 67): " + [ dpage.constructor.name, v.constructor.name ]);
          };
      };
  };
      ...
      return Deku_Control_Functions_Graph.istart()(Data_Monoid.monoidUnit)(Deku_Interpret.effectfulDOMInterpret)(function (v) {
          ...
          return function (v) {
              return function (oldPg) {
                  ...
                  if (e instanceof Data_Either.Right) {
                      return Data_Functor.voidRight(Deku_Control_Indexed.functorIxDOM)(e.value0)(Control_Applicative.when(Deku_Control_Indexed.applicativeIxDOM)(Data_Eq.notEq(Deku_Example_Docs_Types.eqPage)(oldPg)(e.value0))(Deku_Change.ichange(Deku_Interpret.effectfulDOMInterpret)(Deku_Change.changeAll()(Deku_Change.changeRL_Cons({
                          reflectSymbol: function () {
                  ...
                  throw new Error("Failed pattern match at Deku.Example.Docs (line 97, column 25 - line 109, column 16): " + [ e.constructor.name ]);
              };
          };
      }));
  };
