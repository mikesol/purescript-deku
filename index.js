      ...
      return function (v) {
          return Deku_Control_Functions.loopUsingSceneSG(Data_Monoid_Additive.monoidAdditive(Data_Semiring.semiringInt))(dictDOMInterpret)(Deku_Create.createSGAll())(function (v1) {
              return function (push) {
                  return new Data_Tuple.Tuple(Deku_Graph_DOM_Shorthand.div([  ])({
                      div1: Deku_Graph_DOM.div([  ])({
                          button: Deku_Graph_DOM.button([ Deku_Graph_DOM.attr(Deku_Graph_DOM.attrOnClickCb)(Deku_Graph_DOM.OnClick.value)(Deku_Graph_Attribute.cb(Data_Function["const"](push(ButtonClicked.value)))) ])(Deku_Graph_DOM_Shorthand.text("Click")),
              ...
              return function (v1) {
                  return Deku_Control_Functions.u({
                      head: Deku_Graph_DOM.div([  ])({
                          ...
                          })())(new Data_Tuple.Tuple(Deku_Graph_DOM.span([  ])(Deku_Graph_DOM_Shorthand.text("In this section, saw how to react to events using the ")), new Data_Tuple.Tuple(Deku_Graph_DOM.code([  ])(Deku_Graph_DOM_Shorthand.text("iloop")), new Data_Tuple.Tuple(Deku_Graph_DOM.text(" function in combination with "), new Data_Tuple.Tuple(Deku_Graph_DOM.code([  ])(Deku_Graph_DOM_Shorthand.text("change")), new Data_Tuple.Tuple(Deku_Graph_DOM.text(". In the next section, we'll use a similar mechanism to deal with arbitrary "), new Data_Tuple.Tuple(Deku_Graph_DOM.a([ Deku_Graph_DOM.attr(Deku_Graph_DOM.attrOnClickCb)(Deku_Graph_DOM.OnClick.value)(Deku_Graph_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.Effects.value))(Deku_Example_Docs_Util.scrollToTop)))), Deku_Graph_DOM.attr(Deku_Graph_DOM.attrA_StyleString)(Deku_Graph_DOM.Style.value)("cursor:pointer;") ])(Deku_Graph_DOM_Shorthand.text("effects")), new Data_Tuple.Tuple(Deku_Graph_DOM.span([  ])(Deku_Graph_DOM_Shorthand.text(".")), Data_Unit.unit))))))))), Data_Unit.unit))))))))))))))))
                      })
                  });
              };
          })(Deku_Control_Functions.freeze(Deku_Control_Monadic.applicativeMDOM));
...
(function($PS) {
  ...
  var hashableSgs = {
      hash: (function () {
          var $47 = Data_Hashable.hash(Data_Hashable.hashableString);
          var $48 = Data_Show.show(showSgs);
          return function ($49) {
              return $47($48($49));
          };
      })(),
  ...
  var sub = function (raise) {
      return function (dictDOMInterpret) {
          return function (v) {
              if (v instanceof Sg0) {
                  return Deku_Control_Functions.loopUsingSceneSG(Data_Monoid_Additive.monoidAdditive(Data_Semiring.semiringInt))(dictDOMInterpret)(Deku_Create.createSGAll())(function (v1) {
                      return function (push) {
                          return new Data_Tuple.Tuple(Deku_Graph_DOM_Shorthand.div([  ])({
                              div1: Deku_Graph_DOM.div([  ])({
                                  button0: Deku_Graph_DOM.button([ Deku_Graph_DOM.attr(Deku_Graph_DOM.attrOnClickCb)(Deku_Graph_DOM.OnClick.value)(Deku_Graph_Attribute.cb(Data_Function["const"](raise(Sg0.value)))) ])(Deku_Graph_DOM_Shorthand.text("Send to B")),
                                  count0: Deku_Graph_DOM.div([  ])(Deku_Graph_DOM_Shorthand.text("A: 0")),
                                  button1: Deku_Graph_DOM.button([ Deku_Graph_DOM.attr(Deku_Graph_DOM.attrOnClickCb)(Deku_Graph_DOM.OnClick.value)(Deku_Graph_Attribute.cb(Data_Function["const"](push(Data_Unit.unit)))) ])(Deku_Graph_DOM_Shorthand.text("Send to C")),
              ...
              if (v instanceof Sg1) {
                  return Deku_Control_Functions.loopUsingSceneSG(Data_Monoid_Additive.monoidAdditive(Data_Semiring.semiringInt))(dictDOMInterpret)(Deku_Create.createSGAll())(function (v1) {
                      return function (push) {
                          return new Data_Tuple.Tuple(Deku_Graph_DOM_Shorthand.div([  ])({
                              div1: Deku_Graph_DOM.div([  ])({
                                  button0: Deku_Graph_DOM.a([ Deku_Graph_DOM.attr(Deku_Graph_DOM.attrOnClickCb)(Deku_Graph_DOM.OnClick.value)(Deku_Graph_Attribute.cb(Data_Function["const"](raise(Sg1.value)))), Deku_Graph_DOM.attr(Deku_Graph_DOM.attrA_StyleString)(Deku_Graph_DOM.Style.value)("cursor:pointer;") ])(Deku_Graph_DOM_Shorthand.text("Send to A")),
                                  count0: Deku_Graph_DOM.div([  ])(Deku_Graph_DOM_Shorthand.text("B: 0")),
                                  button1: Deku_Graph_DOM.a([ Deku_Graph_DOM.attr(Deku_Graph_DOM.attrOnClickCb)(Deku_Graph_DOM.OnClick.value)(Deku_Graph_Attribute.cb(Data_Function["const"](push(Data_Unit.unit)))), Deku_Graph_DOM.attr(Deku_Graph_DOM.attrA_StyleString)(Deku_Graph_DOM.Style.value)("cursor:pointer;") ])(Deku_Graph_DOM_Shorthand.text("Send to D")),
              ...
              throw new Error("Failed pattern match at Deku.Example.Docs.Subgraphs (line 33, column 1 - line 33, column 57): " + [ raise.constructor.name, v.constructor.name ]);
          };
      };
  };
  var sg = function (dictDOMInterpret) {
              ...
              return function (v1) {
                  return Deku_Control_Functions.u({
                      head: Deku_Graph_DOM.div([  ])({
                          ...
                          })())(new Data_Tuple.Tuple(Deku_Graph_DOM.text("In addition to webpage rendering, Deku supports basic server-side rendering capabilities. Let's see how in the "), new Data_Tuple.Tuple(Deku_Graph_DOM.a([ Deku_Graph_DOM.attr(Deku_Graph_DOM.attrOnClickCb)(Deku_Graph_DOM.OnClick.value)(Deku_Graph_Attribute.cb(Data_Function["const"](Control_Apply.applySecond(Effect.applyEffect)(dpage(Deku_Example_Docs_Types.SSR.value))(Deku_Example_Docs_Util.scrollToTop)))), Deku_Graph_DOM.attr(Deku_Graph_DOM.attrA_StyleString)(Deku_Graph_DOM.Style.value)("cursor:pointer;") ])(Deku_Graph_DOM_Shorthand.text("SSR section")), new Data_Tuple.Tuple(Deku_Graph_DOM.span([  ])(Deku_Graph_DOM_Shorthand.text(".")), Data_Unit.unit)))))), Data_Unit.unit)))))))))))))))))))))))
                      })
                  });
              };
          })(Deku_Control_Functions.freeze(Deku_Control_Monadic.applicativeMDOM));
  ...
  var page = function (dpage) {
      return function (dictDOMInterpret) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Deku.Example.Docs (line 104, column 1 - line 104, column 60): " + [ dpage.constructor.name, v.constructor.name ]);
          };
      };
  };
  var scene = function (elt) {
      return Deku_Control_Functions.loopUsingSceneG(Data_Monoid.monoidUnit)(Deku_Interpret.effectfulDOMInterpret)(Deku_Create.createAll())(function (v) {
                  ...
                  main: Deku_Graph_DOM.main([  ])({
                      topbar: Deku_Graph_DOM.div([  ])(Deku_Graph_DOM_Shorthand.div([  ])((function () {
                          var sections = Data_Functor.map(Data_Vec.functorVec)(function (v1) {
                              ...
                              })())(new Data_Tuple.Tuple(Deku_Graph_DOM.a([ Deku_Graph_DOM.attr(Deku_Graph_DOM.attrOnClickCb)(Deku_Graph_DOM.OnClick.value)(Deku_Graph_Attribute.cb(Data_Function["const"](push(v1.value0)))), Deku_Graph_DOM.attr(Deku_Graph_DOM.attrA_StyleString)(Deku_Graph_DOM.Style.value)("cursor:pointer;") ])(Deku_Graph_DOM_Shorthand.text(v1.value1.value0)), new Data_Tuple.Tuple(Deku_Graph_DOM.span([ Deku_Graph_DOM.attr(Deku_Graph_DOM.attrSpan_StyleString)(Deku_Graph_DOM.Style.value)((function () {
                                  if (v1.value1.value1) {
                                      return "";
                                  };
                                  return "display:none;";
          ...
          return function (oldPg) {
              ...
              throw new Error("Failed pattern match at Deku.Example.Docs (line 89, column 19 - line 101, column 12): " + [ e.constructor.name ]);
          };
      });
  };
