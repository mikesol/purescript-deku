...
(function($PS) {
  ...
  exports["foldableWithIndexVec"] = foldableWithIndexVec;
...
(function($PS) {
  ...
  var instructionWeight = function (v) {
      return Data_Variant.match()()()({
          ...
          setSingleSubgraph: Data_Function["const"](8),
          setTumult: Data_Function["const"](9)
      })(v);
  };
  var instructionId = function (v) {
      return Data_Variant.match()()()({
          disconnectXFromY: function ($51) {
              return Data_Maybe.Just.create((function (v2) {
                  return v2.fromId;
              })($51));
          },
          destroyUnit: function ($52) {
              return Data_Maybe.Just.create((function (v2) {
                  return v2.id;
              })($52));
          },
          makeElement: function ($53) {
              return Data_Maybe.Just.create((function (v2) {
                  return v2.id;
              })($53));
          },
          makeText: function ($54) {
              return Data_Maybe.Just.create((function (v2) {
                  return v2.id;
              })($54));
          },
          makeRoot: function ($55) {
              return Data_Maybe.Just.create((function (v2) {
                  return v2.id;
              })($55));
          },
          makeSubgraph: function ($56) {
              return Data_Maybe.Just.create((function (v2) {
                  return v2.id;
              })($56));
          },
          massiveCreate: Data_Function["const"](Data_Maybe.Nothing.value),
          makeTumult: function ($57) {
              return Data_Maybe.Just.create((function (v2) {
                  return v2.id;
              })($57));
          },
          connectXToY: function ($58) {
              return Data_Maybe.Just.create((function (v2) {
                  return v2.fromId;
              })($58));
          },
          setAttribute: function ($59) {
              return Data_Maybe.Just.create((function (v2) {
                  return v2.id;
              })($59));
          },
          ...
          setSubgraph: function ($61) {
              return Data_Maybe.Just.create((function (v2) {
                  return v2.id;
              })($61));
          },
          massiveChange: Data_Function["const"](Data_Maybe.Nothing.value),
          setSingleSubgraph: function ($62) {
              return Data_Maybe.Just.create((function (v2) {
                  return v2.id;
              })($62));
          },
          setTumult: function ($63) {
              return Data_Maybe.Just.create((function (v2) {
                  return v2.id;
              })($63));
          }
  ...
  var iSetSingleSubgraph = (function () {
      var $70 = Data_Variant.inj()({
          reflectSymbol: function () {
              return "setSingleSubgraph";
          }
      })(Type_Proxy["Proxy"].value);
      return function ($71) {
  ...
  var eqInstruction = {
      eq: function (x) {
          return function (y) {
              ...
              }))(Data_Variant.eqVariantCons(Data_Variant.eqVariantCons(Data_Variant.eqVariantCons(Data_Variant.eqVariantCons(Data_Variant.eqVariantCons(Data_Variant.eqVariantCons(Data_Variant.eqVariantCons(Data_Variant.eqVariantCons(Data_Variant.eqVariantCons(Data_Variant.eqVariantCons(Data_Variant.eqVariantCons(Data_Variant.eqVariantCons(Data_Variant.eqVariantCons(Data_Variant.eqVariantCons(Data_Variant.eqVariantCons(Data_Variant.eqVariantNil)(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()({
                  reflectSymbol: function () {
                      return "terminus";
                  }
              })(Data_Eq.eqString))()({
      ...
      compare: function (v) {
          return function (v1) {
              ...
              var c2 = function (v3) {
                  ...
                  if (v4 instanceof Data_Ordering.EQ) {
                      return Data_Ord.compare(Data_Variant.ordVariant()(Data_Variant_Internal.variantTagsCons(Data_Variant_Internal.variantTagsCons(Data_Variant_Internal.variantTagsCons(Data_Variant_Internal.variantTagsCons(Data_Variant_Internal.variantTagsCons(Data_Variant_Internal.variantTagsCons(Data_Variant_Internal.variantTagsCons(Data_Variant_Internal.variantTagsCons(Data_Variant_Internal.variantTagsCons(Data_Variant_Internal.variantTagsCons(Data_Variant_Internal.variantTagsCons(Data_Variant_Internal.variantTagsCons(Data_Variant_Internal.variantTagsCons(Data_Variant_Internal.variantTagsCons(Data_Variant_Internal.variantTagsCons(Data_Variant_Internal.variantTagsNil)({
                          reflectSymbol: function () {
                              return "setTumult";
                          }
                      }))({
                      ...
                      })(Data_Eq.eqString))))(Data_Variant.ordVariantCons(Data_Variant.ordVariantCons(Data_Variant.ordVariantCons(Data_Variant.ordVariantCons(Data_Variant.ordVariantCons(Data_Variant.ordVariantCons(Data_Variant.ordVariantCons(Data_Variant.ordVariantCons(Data_Variant.ordVariantCons(Data_Variant.ordVariantCons(Data_Variant.ordVariantCons(Data_Variant.ordVariantCons(Data_Variant.ordVariantCons(Data_Variant.ordVariantCons(Data_Variant.ordVariantCons(Data_Variant.ordVariantNil)(Data_Ord.ordRecord()(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordNil)()({
                          reflectSymbol: function () {
                              return "terminus";
                          }
                      })(Data_Ord.ordString))()({
  ...
  exports["iSetSingleSubgraph"] = iSetSingleSubgraph;
...
(function($PS) {
  ...
  var Type_Proxy = $PS["Type.Proxy"];                
  var du = function (u) {
      var $42 = Data_Set.insert(Deku_Rendered.ordInstruction);
      return function ($43) {
          return $42(Deku_Rendered.iDestroyUnit((function (v) {
              return {
                  unit: u,
                  id: v
              };
  ...
  var derogative = (function () {
      var $44 = Data_Variant.match()()()({
          ...
          connectXToY: (function () {
              var $47 = Data_Set.insert(Deku_Rendered.ordInstruction);
              return function ($48) {
                  return $47(Deku_Rendered.iDisconnectXFromY($48));
              };
          })(),
          ...
          setSingleSubgraph: Data_Function["const"](Control_Category.identity(Control_Category.categoryFn)),
                              ...
                              return function (t1) {
                                  return function (set) {
                                      return function (v) {
                                          ...
                                          throw new Error("Failed pattern match at Deku.Tumult.Reconciliation (line 64, column 5 - line 67, column 25): " + [ v1.constructor.name ]);
                                      };
                                  };
                              };
                          };
          ...
          var go = function (v) {
              return function (v1) {
                  return function (set) {
                              ...
                              connectXToY: function (a) {
                                  return Data_Variant.on()({
                                      ...
                                      var o = (function () {
                                          ...
                                          throw new Error("Failed pattern match at Deku.Tumult.Reconciliation (line 109, column 21 - line 128, column 49): " + [  ]);
                                      })();
                                      return o;
                                  })(udef)(v1.value0);
                              },
                      ...
                      throw new Error("Failed pattern match at Deku.Tumult.Reconciliation (line 91, column 3 - line 95, column 23): " + [ v.constructor.name, v1.constructor.name, set.constructor.name ]);
                  };
              };
          };
                                      ...
                                      return function (t1) {
                                          return function (set) {
                                              return function (setf) {
                                                  ...
                                                  throw new Error("Failed pattern match at Deku.Tumult.Reconciliation (line 69, column 3 - line 85, column 23): " + [ a.constructor.name, b.constructor.name, l0.constructor.name, h0.constructor.name, t0.constructor.name, l1.constructor.name, h1.constructor.name, t1.constructor.name, set.constructor.name, setf.constructor.name ]);
                                              };
                                          };
                                      };
                                  };
...
(function($PS) {
  ...
  var setSingleSubgraph = function (dict) {
      return dict.setSingleSubgraph;
  };
  ...
  var freeDOMInterpret = {
      connectXToY: function ($173) {
          return Data_Function["const"](Deku_Rendered.iConnectXToY($173));
      },
      disconnectXFromY: function ($174) {
          return Data_Function["const"](Deku_Rendered.iDisconnectXFromY($174));
      },
      destroyUnit: function ($175) {
          return Data_Function["const"](Deku_Rendered.iDestroyUnit($175));
      },
      makeElement: function ($176) {
          return Data_Function["const"](Deku_Rendered.iMakeElement($176));
      },
      makeRoot: function ($177) {
          return Data_Function["const"](Deku_Rendered.iMakeRoot($177));
      },
      makeText: function ($178) {
          return Data_Function["const"](Deku_Rendered.iMakeText($178));
      },
      makeTumult: function ($179) {
          return Data_Function["const"](Deku_Rendered.iMakeTumult($179));
      },
      massiveCreate: function ($180) {
          return Data_Function["const"](Deku_Rendered.iMassiveCreate($180));
      },
      makeSubgraph: function (v) {
          return function (v1) {
              return Deku_Rendered.iMakeSubgraph({
                  id: v.id,
                  instructions: Data_Lazy.defer(function (v2) {
                      return [  ];
                  })
              });
          };
      },
      setAttribute: function ($181) {
          return Data_Function["const"](Deku_Rendered.iSetAttribute($181));
      },
      setSingleSubgraph: function (v) {
          return function (v1) {
              return Deku_Rendered.iSetSingleSubgraph({
                  id: v.id
              });
          };
      },
      ...
      massiveChange: function ($182) {
          return Data_Function["const"](Deku_Rendered.iMassiveChange($182));
      },
      setText: function ($183) {
          return Data_Function["const"](Deku_Rendered.iSetText($183));
      },
      setTumult: function ($184) {
          return Data_Function["const"](Deku_Rendered.iSetTumult($184));
      }
  };
  ...
  var effectfulDOMInterpret = {
      ...
      makeSubgraph: function (v) {
          return function (dom) {
              return function __do() {
                  var evts = Data_Traversable.sequence(Data_Vec.traversableVec)(Effect.applicativeEffect)(Data_Functor.voidLeft(Data_Vec.functorVec)(v.envs)(FRP_Event.create))();
                  var funks = Data_Functor.mapFlipped(Data_Vec.functorVec)(evts)(function (evt) {
                      return function (eop) {
                  ...
                  Data_FoldableWithIndex.traverseWithIndex_(Effect.applicativeEffect)(Data_Vec.foldableWithIndexVec)(function (i) {
                      return function (evt) {
                          return FRP_Event.subscribe(evt.event)(function (p) {
                              return $foreign.setSingleSubgraph_(v.id)(i)(new Data_Either.Right(p))(dom);
                          });
                      };
                  })(evts)();
                  return $foreign.makeSubgraph_(v.id)(v.terminus)(Data_Vec.toArray(v.envs))(v.scenes)(Data_Vec.toArray(funks))(dom)();
              };
          };
      },
      makeTumult: function (v) {
      ...
      setSubgraph: function (v) {
          return function (dom) {
              return $foreign.setSubgraph_(v.id)(Data_Functor.map(Data_Functor.functorArray)(Data_Either.Left.create)(Data_Vec.toArray(v.envs)))(dom);
          };
      },
      setSingleSubgraph: function (v) {
          return function (dom) {
              return $foreign.setSingleSubgraph_(v.id)(v.index)(new Data_Either.Left(v.env))(dom);
          };
      },
      setTumult: function (v) {
          return function (toFFI) {
  ...
  var mixedDOMInterpret = {
      ...
      setSingleSubgraph: function (v) {
          return function (v1) {
              return new Data_Tuple.Tuple(setSingleSubgraph(freeDOMInterpret)({
                  id: v.id,
                  index: v.index,
                  env: v.env
              })(v1.value0), setSingleSubgraph(effectfulDOMInterpret)({
                  id: v.id,
                  index: v.index,
                  env: v.env
              })(v1.value1));
...
(function($PS) {
  ...
  var root = (function () {
      var $1996 = Control_Semigroupoid.compose(Control_Semigroupoid.semigroupoidFn)(function ($1998) {
          return (function (v) {
              return {
                  root: v
              };
      ...
      return function ($1997) {
          return $1996((function (v) {
              return function (v1) {
                  return {
                      element: v,
                      children: v1
  ...
  var makeElt = function (elt) {
      return function (tag) {
          var $1999 = Control_Semigroupoid.compose(Control_Semigroupoid.semigroupoidFn)(Element);
          return function ($2000) {
              return $1999((function (v) {
                  return function (v1) {
                      return {
                          element: v,
                          children: v1
          ...
          return function (push) {
              return function (v) {
                  ...
                  if (e instanceof Data_Either.Right) {
                      return Deku_Change.ichange_(Deku_Interpret.mixedDOMInterpret)(Deku_Change.change_All()(Deku_Change.changeRL_Cons({
                          reflectSymbol: function () {
                              return "root.hello";
                          }
