                      ...
                      var cancelOuter = FRP_Event.subscribe(children)(function (inner) {
                          return function __do() {
                              ...
                              var c0 = FRP_Event.subscribe(inner)(function (kid$prime) {
                                  return function __do() {
                                      var newScope = v.ids();
                                      if (kid$prime instanceof Deku_Core.SendToTop) {
                                          return Control_Bind.bind(Effect.bindEffect)(Effect_Ref.read(prevId))(Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(function ($13) {
                                      ...
                                      if (kid$prime instanceof Deku_Core.Remove) {
                                      ...
                                      if (kid$prime instanceof Deku_Core.Elt) {
                                          ...
                                          var cncl = Effect_AVar.take(av)(function (q) {
                                              ...
                                              throw new Error("Failed pattern match at Deku.Internal (line 73, column 44 - line 78, column 45): " + [ q.constructor.name ]);
                                          })();
                                          return cncl();
                                      };
                                      throw new Error("Failed pattern match at Deku.Internal (line 39, column 13 - line 81, column 21): " + [ kid$prime.constructor.name ]);
                                  };
                              })();
                          ...
                          return function __do() {
                              ...
                              return function __do() {
                                  ...
                                  var cncl2 = Effect_AVar.take(av2)(function (q) {
                                      ...
                                      throw new Error("Failed pattern match at Deku.Control (line 162, column 36 - line 164, column 35): " + [ q.constructor.name ]);
                                  })();
                                  return cncl2();
                              };
                          };
                                      ...
                                      return function (v1) {
                                          return FRP_Event.makeEvent(function (k1) {
                                              return function __do() {
                                                  var me = v1.ids();
                                                  v.raiseId(me)();
                                                  return FRP_Event.subscribe(FRP_Event.makeEvent(function (k2) {
                                                      return function __do() {
                                                          var pxScope = v1.ids();
                                                          var v2 = pursxToElement(dictPursxToElement)(pxScope)(Type_Proxy["Proxy"].value)(r);
                                                          return FRP_Event.subscribe(Control_Alt.alt(FRP_Event.altEvent)(FRP_Event.bang(v1.makePursx({
                                                              id: me,
                                                              parent: v.parent,
                                                              cache: v2.cache,
                                                              scope: pxScope,
