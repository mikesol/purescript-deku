...
(function($PS) {
  ...
  var showSgs = {
      show: function (v) {
          ...
          throw new Error("Failed pattern match at Deku.Example.Docs.Portals (line 31, column 1 - line 33, column 19): " + [ v.constructor.name ]);
      }
  };
  var eqSgs = {
      eq: function (x) {
                      ...
                      return Data_Exists.mkExists(function (v) {
                          return function (v1) {
                              return Deku_DOM.div_(dictIsEvent)([ gateway0(Data_Functor.map((dictIsEvent.Filterable1()).Functor1())((function () {
                                  ...
                                  throw new Error("Failed pattern match at Deku.Example.Docs.Portals (line 52, column 13 - line 54, column 25): " + [ sg.constructor.name ]);
                                  ...
                                  throw new Error("Failed pattern match at Deku.Example.Docs.Portals (line 60, column 13 - line 62, column 30): " + [ sg.constructor.name ]);
                              })())(event)) ]);
                          };
                      });
                  };
      ...
      return function (dictIsEvent) {
          return function (raise) {
              return function (v) {
                  ...
                  throw new Error("Failed pattern match at Deku.Example.Docs.Subgraphs (line 43, column 1 - line 48, column 37): " + [ raise.constructor.name, v.constructor.name ]);
              };
          };
      };
  };
                      ...
                      return Data_Exists.mkExists(function (push) {
                          return function (event$prime) {
                              ...
                              return Deku_Subgraph.subgraph(hashableSgs)(dictIsEvent)(Control_Alt.alt(((dictIsEvent.Alternative0()).Plus1()).Alt0())(Control_Alt.alt(((dictIsEvent.Alternative0()).Plus1()).Alt0())(Control_Applicative.pure((dictIsEvent.Alternative0()).Applicative0())(new Data_Tuple.Tuple(Sg0.value, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit))))(Control_Applicative.pure((dictIsEvent.Alternative0()).Applicative0())(new Data_Tuple.Tuple(Sg1.value, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit)))))(Data_Functor.map((dictIsEvent.Filterable1()).Functor1())(function (v1) {
                                  ...
                                  throw new Error("Failed pattern match at Deku.Example.Docs.Subgraphs (line 251, column 25 - line 253, column 60): " + [ v1.constructor.name ]);
              ...
              return function (event) {
                  var page = function (dpage) {
                      return function (v) {
                          ...
                          throw new Error("Failed pattern match at Deku.Example.Docs (line 105, column 3 - line 105, column 68): " + [ dpage.constructor.name, v.constructor.name ]);
                      };
                  };
                  return Deku_Control.flatten((dictIsEvent.Alternative0()).Plus1())([ Deku_DOM.div_(dictIsEvent)(Data_Functor.map(Data_Functor.functorArray)(function (v) {
                      ...
                      return Control_Alt.alt(((dictIsEvent.Alternative0()).Plus1()).Alt0())((function () {
                          ...
                          throw new Error("Failed pattern match at Deku.Example.Docs (line 94, column 21 - line 96, column 51): " + [ v.value0.constructor.name ]);
