...
(function($PS) {
  ...
  var events2 = function (dpage) {
      return Deku_Pursx.makePursx({
          ...
          code: Deku_Pursx.nut(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))(Deku_DOM_Elt_Pre.pre_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_DOM_Elt_Code.code_(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))([ Deku_Control.text_("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Control.Alt ((<|>))\x0aimport Data.Filterable (filterMap)\x0aimport Data.Foldable (for_, oneOfMap)\x0aimport Data.Maybe (Maybe(..))\x0aimport Data.Profunctor (lcmap)\x0aimport Data.Tuple.Nested ((/\\))\x0aimport Deku.Attribute (cb, (:=))\x0aimport Deku.Control (blank, text_)\x0aimport Deku.Core (Child(..))\x0aimport Deku.DOM as D\x0aimport Deku.Toplevel (runInBody1)\x0aimport Effect (Effect)\x0aimport FRP.Event (bang, bus, keepLatest, mapAccum)\x0aimport Web.Event.Event (target)\x0aimport Web.HTML.HTMLInputElement (fromEventTarget, value)\x0aimport Web.UIEvent.KeyboardEvent (code, fromEvent)\x0a\x0adata MainUIAction\x0a  = UIShown\x0a  | AddTodo\x0a  | ChangeText String\x0a\x0adata TodoAction = Prioritize | Delete\x0a\x0amain :: Effect Unit\x0amain = runInBody1\x0a  ( bus \\push -> lcmap (bang UIShown <|> _) \\event -> do\x0a      let\x0a        top =\x0a          [ D.input\x0a              ( oneOfMap bang\x0a                  [ D.OnInput := cb \\e -> for_\x0a                      ( target e\x0a                          >>= fromEventTarget\x0a                      )\x0a                      ( value\x0a                          >=> push <<< ChangeText\x0a                      )\x0a                  , D.OnKeyup := cb\x0a                      \\e -> for_ (fromEvent e) \\evt -> do\x0a                        when (code evt == \"Enter\") $ do\x0a                          push AddTodo\x0a                  ]\x0a              )\x0a              blank\x0a          , D.button\x0a              (bang $ D.OnClick := cb (const $ push AddTodo))\x0a              (text_ \"Add\")\x0a          ]\x0a      D.div_\x0a        [ D.div_ top\x0a        , D.div_ $\x0a            ( \\txt -> keepLatest $ bus \\p' e' ->\x0a                ( bang $ Insert $ D.div_\x0a                    [ text_ txt\x0a                    , D.button\x0a                        ( bang\x0a                            $ D.OnClick\x0a                              := cb (const $ p' SendToTop)\x0a                        )\x0a                        [ text_ \"Prioritize\" ]\x0a                    , D.button\x0a                        ( bang\x0a                            $ D.OnClick\x0a                              := cb (const $ p' Remove)\x0a                        )\x0a                        [ text_ \"Delete\" ]\x0a                    ]\x0a                ) <|> e'\x0a            ) <$>\x0a              filterMap\x0a                ( \\(tf /\\ s) ->\x0a                    if tf then Just s else Nothing\x0a                )\x0a                ( mapAccum\x0a                    ( \\a b -> case a of\x0a                        ChangeText s -> s /\\ (false /\\ s)\x0a                        AddTodo -> b /\\ (true /\\ b)\x0a                        _ -> \"\" /\\ (false /\\ \"\")\x0a                    )\x0a                    event\x0a                    \"\"\x0a                )\x0a        ]\x0a  )\x0a") ]) ])),
          result: Deku_Pursx.nut(Deku_Control.plantEventDomableDomable(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bus(function (push) {
          ...
          result: Deku_Pursx.nut(Deku_Control.plantEventEventChildDomab(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bus(function (push) {
              return function (event) {
                  return FRP_Event.bang(Deku_Core.Insert.create(Deku_Pursx.makePursx({
                      ...
                      somethingNew: Deku_Pursx.nut(Deku_Control.plantElementDomable(Type_Equality.refl)(Type_Equality.refl))(Deku_DOM_Elt_Button.button(Deku_Control.plantArrayElementDomable(Type_Equality.refl)(Type_Equality.refl))(FRP_Event.bang(Deku_Attribute.attr(Deku_DOM_Attr_OnClick.attrOnClickCb)(Deku_DOM_Attr_OnClick.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(new Data_Maybe.Just(Data_Unit.unit)))))))([ Deku_Control.text(Control_Alt.alt(FRP_Event.altEvent)(Data_Functor.voidLeft(FRP_Event.functorEvent)(Data_Compactable.compact(FRP_Event.compactableEvent)(event))("Thanks for clicking me!"))(FRP_Event.bang("I was dynamically inserted"))) ]))
                  })));
              };
          })),
