          ...
          return function (v) {
              return Deku_Control_Functions.loopUsingSceneSG(Data_Monoid_Additive.monoidAdditive(Data_Semiring.semiringInt))(dictDOMInterpret)(Deku_Create.createSGAll())()(function (v1) {
                  ...
                  return function (nclicks) {
                      ...
                      throw new Error("Failed pattern match at Deku.Example.Docs.Events (line 267, column 22 - line 279, column 17): " + [ e.constructor.name ]);
                  };
              });
          };
      };
                  ...
                  return function (v1) {
                      return Deku_Control_Functions.u({
                          head: Deku_Graph_DOM.div([  ])({
                              ...
                              })())()(Deku_Graph_DOM.p([  ])(Deku_Graph_DOM_Shorthand.text("We'll spice up the previous example by adding an event listener to our button. When we do, Deku will keep track of how many times we clicked it. The same goes for a range slider, whose current value is displayed underneath it.")))(new Data_Tuple.Tuple(Deku_Graph_DOM.pre([  ])(Deku_Graph_DOM_Shorthand.code([  ])(Deku_Graph_DOM_Shorthand.text("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Data.Foldable (for_)\x0aimport Deku.Toplevel ((\ud83d\ude80))\x0aimport Deku.Change (change)\x0aimport Data.Tuple.Nested ((/\\))\x0aimport Deku.Graph.Attribute (cb)\x0aimport Deku.Graph.DOM ((:=))\x0aimport Deku.Graph.DOM as D\x0aimport Deku.Graph.DOM.Shorthand as S\x0aimport Effect (Effect)\x0aimport Web.DOM.Element (fromEventTarget)\x0aimport Web.Event.Event (target)\x0aimport Web.HTML.HTMLInputElement (fromElement, valueAsNumber)\x0a\x0adata UIEvents = ButtonClicked | SliderMoved Number\x0a\x0amain :: Effect Unit\x0amain =\x0a  ( \\push ->\x0a\x0a      { div1: D.div []\x0a          { button: D.button\x0a              [ D.OnClick :=\x0a                  cb (const $ push ButtonClicked)\x0a              ]\x0a              (S.text \"Click\")\x0a          , count: D.div [] (S.text \"Val: 0\")\x0a          }\x0a      , div2: D.div []\x0a          { slider: D.input\x0a              [ D.Xtype := \"range\"\x0a              , D.OnInput := cb \\e -> for_\x0a                  ( target e\x0a                      >>= fromEventTarget\x0a                      >>= fromElement\x0a                  )\x0a                  ( valueAsNumber\x0a                      >=> push <<< SliderMoved\x0a                  )\x0a              ]\x0a              {}\x0a          , val: D.div [] (S.text \"Val: 50\")\x0a          }\x0a      } /\\ 0\x0a  ) \ud83d\ude80 \\e nclicks -> case e of\x0a    ButtonClicked ->\x0a      let\x0a        c = nclicks + 1\x0a      in\x0a        change\x0a          { \"root.div1.count.t\": \"Val: \" <> show c\x0a          , \"root.div1.button.t\":\x0a              if mod c 2 == 0 then \"Click\" else \"me\"\x0a          } $> c\x0a    SliderMoved n ->\x0a      change\x0a        { \"root.div2.val.t\": \"Val: \" <> show n\x0a        } $> nclicks\x0a"))), new Data_Tuple.Tuple(Deku_Graph_DOM.p([  ])(Deku_Graph_DOM_Shorthand.text("Here's what it produces:")), new Data_Tuple.Tuple(Deku_Graph_DOM.blockquote([  ])({
                                  example: Deku_Graph_DOM.subgraph(Data_Hashable.hashableInt)(Data_Map_Internal.singleton(0)(new Data_Maybe.Just(Data_Unit.unit)))(function (dictDOMInterpret1) {
                                      return sg(dt)(dictDOMInterpret1);
                                  })
