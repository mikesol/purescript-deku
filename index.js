                      ...
                      return function (v) {
                          return FRP_Event_Class.keepLatest(dictIsEvent)(Data_Functor.map((dictIsEvent.Filterable1()).Functor1())(function (id) {
                              return Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(FRP_Event_Class.bang(dictIsEvent)(v.makeSubgraph({
                                  ...
                                  throw new Error("Failed pattern match at Deku.Subgraph (line 40, column 36 - line 44, column 54): " + [ v1.value1.constructor.name ]);
                              })(mods));
      ...
      return function (dictPlus) {
          return function (dpage) {
              return Deku_Pursx.makePursx({
                  ...
                  result: Deku_Pursx.nut(Deku_Subgraph.subgraph(Data_Hashable.hashableUnit)(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Data_Unit.unit, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit))))(function (v) {
...
(function($PS) {
  ...
  var showSgs = {
      show: function (v) {
          ...
          throw new Error("Failed pattern match at Deku.Example.Docs.Portals (line 32, column 1 - line 34, column 19): " + [ v.constructor.name ]);
      }
  };
  var eqSgs = {
      eq: function (x) {
                      ...
                      return Data_Exists.mkExists(function (v) {
                          return function (v1) {
                              return Deku_DOM.div_(dictIsEvent)([ gateway0(Data_Functor.map((dictIsEvent.Filterable1()).Functor1())((function () {
                                  ...
                                  throw new Error("Failed pattern match at Deku.Example.Docs.Portals (line 53, column 13 - line 55, column 25): " + [ sg.constructor.name ]);
                                  ...
                                  throw new Error("Failed pattern match at Deku.Example.Docs.Portals (line 61, column 13 - line 63, column 30): " + [ sg.constructor.name ]);
                              })())(event)) ]);
                          };
                      });
                  };
      ...
      return function (dictPlus) {
          return function (dpage) {
              return Deku_Pursx.makePursx({
                  ...
                  code: Deku_Pursx.nut(Deku_DOM.pre_(dictIsEvent)([ Deku_DOM.code_(dictIsEvent)([ Deku_Control.text_(dictIsEvent)("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Control.Alt ((<|>))\x0aimport Data.Exists (mkExists)\x0aimport Data.Hashable (class Hashable, hash)\x0aimport Data.Tuple.Nested ((/\\))\x0aimport Deku.Attribute (Attribute, cb, (:=))\x0aimport Deku.Control (flatten, text_)\x0aimport Deku.Core (Element, Subgraph, SubgraphF(..))\x0aimport Deku.DOM as D\x0aimport Deku.Portal (portal)\x0aimport Deku.Subgraph (SubgraphAction(..), (@@))\x0aimport Deku.Toplevel ((\ud83d\ude80))\x0aimport Effect (Effect)\x0aimport FRP.Event (class IsEvent)\x0aimport FRP.Event.Class (bang)\x0a\x0adata UIEvents = UIShown | ButtonClicked | SliderMoved Number\x0aderive instance Eq UIEvents\x0a\x0adata Sgs = Sg0 | Sg1\x0aderive instance Eq Sgs\x0aderive instance Ord Sgs\x0ainstance Show Sgs where\x0a  show Sg0 = \"Sg0\"\x0a  show Sg1 = \"Sg1\"\x0ainstance Hashable Sgs where\x0a  hash = show >>> hash\x0a\x0amySub\x0a  :: forall env event payload\x0a   . IsEvent event => event Boolean\x0a  -> (event Boolean -> Element event payload)\x0a  -> (event Boolean -> Element event payload)\x0a  -> Subgraph Sgs env event payload\x0amySub event gateway0 gateway1 sg = mkExists $ SubgraphF \\_ _ -> D.div_\x0a  [ gateway0\x0a      ( map\x0a          ( case sg of\x0a              Sg0 -> identity\x0a              Sg1 -> not\x0a          )\x0a          event\x0a      )\x0a  , gateway1\x0a      ( map\x0a          ( case sg of\x0a              Sg0 -> not\x0a              Sg1 -> identity\x0a          )\x0a          event\x0a      )\x0a  ]\x0a\x0aimg0' :: forall event. IsEvent event => event (Attribute D.Img_)\x0aimg0' = bang $ D.Src := \"https://picsum.photos/200\"\x0aimg1' :: forall event. IsEvent event => event (Attribute D.Img_)\x0aimg1' = bang $ D.Src := \"https://picsum.photos/300\"\x0a\x0amain :: Effect Unit\x0amain = false \ud83d\ude80 \\push event ->\x0a  portal (D.img img0' []) \\img0 ->\x0a    portal (D.img img1' []) \\img1 ->\x0a      let eventBool = event <|> bang false in\x0a      flatten\x0a        [ ( bang (Sg0 /\\ InsertOrUpdate unit)\x0a              <|> bang (Sg1 /\\ InsertOrUpdate unit)\x0a          ) @@ mySub eventBool img0 img1\x0a        , D.button (map (\\e -> D.OnClick :=\x0a        cb (const (push $ not e))) eventBool)\x0a            [ text_ \"Shift images between portals\" ]\x0a        ]") ]) ])),
                  result: Deku_Pursx.nut(Deku_Subgraph.subgraph(Data_Hashable.hashableUnit)(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Data_Unit.unit, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit))))(function (v) {
                      return Data_Exists.mkExists(function (push) {
                          return function (event$prime) {
                              var event = Data_Compactable.compact((dictIsEvent.Filterable1()).Compactable0())(Data_Functor.map((dictIsEvent.Filterable1()).Functor1())(Data_Either.hush)(event$prime));
                              return Deku_Portal.portal(dictIsEvent)(Deku_DOM.img(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrImg_SrcString)(Deku_DOM.Src.value)("https://picsum.photos/200")))([  ]))(function (img0) {
                                  return Deku_Portal.portal(dictIsEvent)(Deku_DOM.img(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrImg_SrcString)(Deku_DOM.Src.value)("https://picsum.photos/300")))([  ]))(function (img1) {
                                      ...
                                      return Deku_Control.flatten(dictIsEvent.Plus0())([ Deku_Subgraph.subgraph(hashableSgs)(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Sg0.value, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit))))(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Sg1.value, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit)))))(mySub(dictIsEvent)(eventBool)(img0)(img1)), Deku_DOM.button(dictIsEvent)(Data_Functor.map((dictIsEvent.Filterable1()).Functor1())(function (e) {
...
(function($PS) {
  ...
  var showSgs = {
      show: function (v) {
          ...
          throw new Error("Failed pattern match at Deku.Example.Docs.Subgraphs (line 33, column 1 - line 35, column 19): " + [ v.constructor.name ]);
      }
  };
  var eqSgs = {
      eq: function (x) {
                      ...
                      return Data_Exists.mkExists(function (push) {
                          return function (event) {
                              ...
                              return Deku_DOM.div_(dictIsEvent)([ Deku_DOM.div_(dictIsEvent)([ Deku_DOM.button(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](raise(Sg0.value))))))([ Deku_Control.text_(dictIsEvent)("Send to B") ]), Deku_DOM.div_(dictIsEvent)([ Deku_Control.text(dictIsEvent)(Data_Functor.map(dictFilterable.Functor1())((function () {
                                  var $45 = Data_Semigroup.append(Data_Semigroup.semigroupString)("A: ");
                                  var $46 = Data_Show.show(Data_Show.showInt);
                                  return function ($47) {
                                      return $45($46($47));
                                  };
                              })())(counter(dictIsEvent)(v1.left))) ]), Deku_DOM.button(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](push(Data_Unit.unit))))))([ Deku_Control.text_(dictIsEvent)("Send to C") ]), Deku_DOM.div_(dictIsEvent)([ Deku_Control.text(dictIsEvent)(Data_Functor.map(dictFilterable.Functor1())((function () {
                                  var $48 = Data_Semigroup.append(Data_Semigroup.semigroupString)("C: ");
                                  var $49 = Data_Show.show(Data_Show.showInt);
                                  return function ($50) {
                                      return $48($49($50));
                                  };
                              })())(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(Data_Functor.map(dictFilterable.Functor1())(Data_Semiring.add(Data_Semiring.semiringInt)(1))(counter(dictIsEvent)(v1.right)))(FRP_Event_Class.bang(dictIsEvent)(0)))) ]), Deku_DOM.hr_(dictIsEvent)([  ]) ]) ]);
                          };
                      });
                  };
                  if (v instanceof Sg1) {
                      return Data_Exists.mkExists(function (push) {
                          return function (event) {
                              ...
                              return Deku_DOM.div_(dictIsEvent)([ Deku_DOM.div_(dictIsEvent)([ Deku_DOM.button(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(Deku_Attribute.attr(Deku_DOM.attrOnClickCb)(Deku_DOM.OnClick.value)(Deku_Attribute.cb(Data_Function["const"](raise(Sg1.value))))))([ Deku_Control.text_(dictIsEvent)("Send to A") ]), Deku_DOM.div_(dictIsEvent)([ Deku_Control.text(dictIsEvent)(Data_Functor.map(dictFilterable.Functor1())((function () {
                                  var $51 = Data_Semigroup.append(Data_Semigroup.semigroupString)("B: ");
                                  ...
                                  var $54 = Data_Semigroup.append(Data_Semigroup.semigroupString)("D: ");
                                  var $55 = Data_Show.show(Data_Show.showInt);
                                  return function ($56) {
                                      return $54($55($56));
                                  };
                              })())(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(Data_Functor.map(dictFilterable.Functor1())(Data_Semiring.add(Data_Semiring.semiringInt)(1))(counter(dictIsEvent)(v1.right)))(FRP_Event_Class.bang(dictIsEvent)(0)))) ]) ]) ]);
                          };
                      });
                  };
                  throw new Error("Failed pattern match at Deku.Example.Docs.Subgraphs (line 44, column 1 - line 49, column 37): " + [ raise.constructor.name, v.constructor.name ]);
              };
          };
      };
  };
      ...
      return function (dictPlus) {
          return function (dpage) {
              return Deku_Pursx.makePursx({
                  ...
                  code: Deku_Pursx.nut(Deku_DOM.pre_(dictIsEvent)([ Deku_DOM.code_(dictIsEvent)([ Deku_Control.text_(dictIsEvent)("module Main where\x0a\x0aimport Prelude\x0a\x0aimport Control.Alt ((<|>))\x0aimport Data.Exists (mkExists)\x0aimport Data.Filterable (class Filterable, compact, partitionMap)\x0aimport Data.Hashable (class Hashable, hash)\x0aimport Data.Maybe (Maybe(..))\x0aimport Data.Tuple (snd)\x0aimport Data.Tuple.Nested ((/\\))\x0aimport Deku.Attribute (cb, (:=))\x0aimport Deku.Control (text, text_)\x0aimport Deku.Core (Subgraph, SubgraphF(..))\x0aimport Deku.DOM as D\x0aimport Deku.Subgraph (SubgraphAction(..), (@@))\x0aimport Deku.Toplevel ((\ud83d\ude80))\x0aimport Effect (Effect)\x0aimport FRP.Event (class IsEvent, mapAccum)\x0a\x0adata UIevents = UIShown | ButtonClicked | SliderMoved Number\x0aderive instance Eq UIevents\x0a\x0adata Sgs = Sg0 | Sg1\x0aderive instance Eq Sgs\x0aderive instance Ord Sgs\x0ainstance Show Sgs where\x0a  show Sg0 = \"Sg0\"\x0a  show Sg1 = \"Sg1\"\x0ainstance Hashable Sgs where\x0a  hash = show >>> hash\x0a\x0acounter :: forall event a. IsEvent event => event a \u2192 event Int\x0acounter event = map snd $ mapAccum f event 0\x0a  where\x0a  f a b = (b + 1) /\\ (a /\\ b)\x0a\x0amySub\x0a  :: forall event payload\x0a   . Filterable event\x0a  => IsEvent event\x0a  => (Sgs -> Effect Unit)\x0a  -> Subgraph Sgs Unit event payload\x0amySub raise Sg0 = mkExists $ SubgraphF \\push event ->\x0a  let\x0a    { left, right } = partitionMap identity event\x0a  in\x0a    D.div_\x0a      [ D.div_\x0a          [ D.button\x0a              (bang $ D.OnClick := cb (const $ raise Sg0))\x0a              [ text_ \"Send to B\" ]\x0a          , D.div_ [ text (map (append \"A: \" <<< show) (counter left)) ]\x0a          , D.button\x0a              (bang $ D.OnClick := cb (const $ push unit))\x0a              [ text_ \"Send to C\" ]\x0a          , D.div_ [ text (map (append \"C: \" <<< show) (counter right)) ]\x0a          , D.hr_ []\x0a          ]\x0a      ]\x0amySub raise Sg1 = mkExists $ SubgraphF \\push event ->\x0a  let\x0a    { left, right } = partitionMap identity event\x0a  in\x0a    D.div_\x0a      [ D.div_\x0a          [ D.button\x0a              (bang $ D.OnClick := cb (const $ raise Sg0))\x0a              [ text_ \"Send to A\" ]\x0a          , D.div_ [ text (map (append \"B: \" <<< show) (counter (left))) ]\x0a          , D.button\x0a              (bang $ D.OnClick := cb (const $ push unit))\x0a              [ text_ \"Send to D\" ]\x0a          , D.div_ [ text (map (append \"D: \" <<< show) (counter right)) ]\x0a          ]\x0a      ]\x0a\x0amain :: Effect Unit\x0amain = Nothing \ud83d\ude80 \\push event ->\x0a  ( bang (Sg0 /\\ InsertOrUpdate unit)\x0a      <|> bang (Sg1 /\\ InsertOrUpdate unit)\x0a      <|>\x0a        ( compact event # map\x0a            ( case _ of\x0a                Sg0 -> Sg1 /\\ InsertOrUpdate unit\x0a                Sg1 -> Sg0 /\\ InsertOrUpdate unit\x0a            )\x0a        )\x0a  ) @@ mySub (push <<< Just)") ]) ])),
                  result: Deku_Pursx.nut(Deku_Subgraph.subgraph(Data_Hashable.hashableUnit)(dictIsEvent)(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Data_Unit.unit, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit))))(function (v) {
                      return Data_Exists.mkExists(function (push) {
                          return function (event$prime) {
                              var event = Data_Compactable.compact((dictIsEvent.Filterable1()).Compactable0())(Data_Functor.map((dictIsEvent.Filterable1()).Functor1())(Data_Either.hush)(event$prime));
                              return Deku_Subgraph.subgraph(hashableSgs)(dictIsEvent)(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(Control_Alt.alt((dictIsEvent.Plus0()).Alt0())(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Sg0.value, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit))))(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(Sg1.value, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit)))))(Data_Functor.map((dictIsEvent.Filterable1()).Functor1())(function (v1) {
                                  ...
                                  throw new Error("Failed pattern match at Deku.Example.Docs.Subgraphs (line 252, column 25 - line 254, column 60): " + [ v1.constructor.name ]);
                              })(Data_Compactable.compact((dictIsEvent.Filterable1()).Compactable0())(event))))(mySub(dictIsEvent.Filterable1())(dictIsEvent)(function ($57) {
                                  return push(Data_Maybe.Just.create($57));
                              }));
                          };
                      });
                  })),
              ...
              return function (event) {
                  var page = function (dpage) {
                      return function (v) {
                          ...
                          throw new Error("Failed pattern match at Deku.Example.Docs (line 106, column 3 - line 106, column 68): " + [ dpage.constructor.name, v.constructor.name ]);
                      };
                  };
                  return Deku_Control.flatten(dictIsEvent.Plus0())([ Deku_DOM.div_(dictIsEvent)(Data_Functor.map(Data_Functor.functorArray)(function (v) {
                      ...
                      })())(FRP_Event_Class.bang(dictIsEvent)(new Data_Tuple.Tuple(v.value1, new Deku_Subgraph.InsertOrUpdate(Data_Unit.unit))));
