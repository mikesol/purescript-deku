...
generate html svg mathml = do
    FS.createDir "deku-dom-indexed/src/Deku/DOM/Indexed"

    ExceptT $ attempt
        $ writeTextFile UTF8  "./deku-dom-indexed/src/Deku/DOM/Indexed/Index.purs"
        $ printModule
        $ unsafePartial
    ...
    ExceptT $ attempt
        $ writeTextFile UTF8  "./deku-dom-indexed/src/Deku/DOM/Indexed/Self.purs"
        $ printModule
        $ unsafePartial
    ...
    generateSpec "./deku-dom-indexed/src/Deku/DOM/Indexed.purs" "Deku.DOM.Indexed"
    ...
    generateSpec "./deku-dom-indexed/src/Deku/DOM/Indexed/SVG.purs" "Deku.DOM.Indexed.SVG"
