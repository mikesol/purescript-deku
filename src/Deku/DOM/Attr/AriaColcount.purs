...
instance Attr Circle_ AriaColcount (Event.Event Unit -> Event.Event  String ) where
  attr AriaColcount eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-colcount", value: prop' value })) eventValue)
...
instance Attr Ellipse_ AriaColcount  String  where
  attr AriaColcount value = unsafeAttribute (  
    { key: "aria-colcount", value: prop' value  } <$ _)
instance Attr Ellipse_ AriaColcount (Event.Event Unit -> Event.Event  String ) where
  attr AriaColcount eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-colcount", value: prop' value })) eventValue)
...
instance Attr ForeignObject_ AriaColcount  String  where
  attr AriaColcount value = unsafeAttribute (  
    { key: "aria-colcount", value: prop' value  } <$ _)
instance Attr ForeignObject_ AriaColcount (Event.Event Unit -> Event.Event  String ) where
  attr AriaColcount eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-colcount", value: prop' value })) eventValue)
...
instance Attr G_ AriaColcount  String  where
  attr AriaColcount value = unsafeAttribute (  
    { key: "aria-colcount", value: prop' value  } <$ _)
instance Attr G_ AriaColcount (Event.Event Unit -> Event.Event  String ) where
  attr AriaColcount eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-colcount", value: prop' value })) eventValue)
...
instance Attr Line_ AriaColcount  String  where
  attr AriaColcount value = unsafeAttribute (  
    { key: "aria-colcount", value: prop' value  } <$ _)
instance Attr Line_ AriaColcount (Event.Event Unit -> Event.Event  String ) where
  attr AriaColcount eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-colcount", value: prop' value })) eventValue)
...
instance Attr Marker_ AriaColcount  String  where
  attr AriaColcount value = unsafeAttribute (  
    { key: "aria-colcount", value: prop' value  } <$ _)
instance Attr Marker_ AriaColcount (Event.Event Unit -> Event.Event  String ) where
  attr AriaColcount eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-colcount", value: prop' value })) eventValue)
...
instance Attr Path_ AriaColcount  String  where
  attr AriaColcount value = unsafeAttribute (  
    { key: "aria-colcount", value: prop' value  } <$ _)
instance Attr Path_ AriaColcount (Event.Event Unit -> Event.Event  String ) where
  attr AriaColcount eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-colcount", value: prop' value })) eventValue)
...
instance Attr Polygon_ AriaColcount  String  where
  attr AriaColcount value = unsafeAttribute (  
    { key: "aria-colcount", value: prop' value  } <$ _)
instance Attr Polygon_ AriaColcount (Event.Event Unit -> Event.Event  String ) where
  attr AriaColcount eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-colcount", value: prop' value })) eventValue)
...
instance Attr Polyline_ AriaColcount  String  where
  attr AriaColcount value = unsafeAttribute (  
    { key: "aria-colcount", value: prop' value  } <$ _)
instance Attr Polyline_ AriaColcount (Event.Event Unit -> Event.Event  String ) where
  attr AriaColcount eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-colcount", value: prop' value })) eventValue)
...
instance Attr Rect_ AriaColcount  String  where
  attr AriaColcount value = unsafeAttribute (  
    { key: "aria-colcount", value: prop' value  } <$ _)
instance Attr Rect_ AriaColcount (Event.Event Unit -> Event.Event  String ) where
  attr AriaColcount eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-colcount", value: prop' value })) eventValue)
...
instance Attr Svg_ AriaColcount  String  where
  attr AriaColcount value = unsafeAttribute (  
    { key: "aria-colcount", value: prop' value  } <$ _)
instance Attr Svg_ AriaColcount (Event.Event Unit -> Event.Event  String ) where
  attr AriaColcount eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-colcount", value: prop' value })) eventValue)
...
instance Attr Symbol_ AriaColcount  String  where
  attr AriaColcount value = unsafeAttribute (  
    { key: "aria-colcount", value: prop' value  } <$ _)
instance Attr Symbol_ AriaColcount (Event.Event Unit -> Event.Event  String ) where
  attr AriaColcount eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-colcount", value: prop' value })) eventValue)
...
instance Attr Text_ AriaColcount  String  where
  attr AriaColcount value = unsafeAttribute (  
    { key: "aria-colcount", value: prop' value  } <$ _)
instance Attr Text_ AriaColcount (Event.Event Unit -> Event.Event  String ) where
  attr AriaColcount eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-colcount", value: prop' value })) eventValue)
...
instance Attr TextPath_ AriaColcount  String  where
  attr AriaColcount value = unsafeAttribute (  
    { key: "aria-colcount", value: prop' value  } <$ _)
instance Attr TextPath_ AriaColcount (Event.Event Unit -> Event.Event  String ) where
  attr AriaColcount eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-colcount", value: prop' value })) eventValue)
...
instance Attr Tspan_ AriaColcount  String  where
  attr AriaColcount value = unsafeAttribute (  
    { key: "aria-colcount", value: prop' value  } <$ _)
instance Attr Tspan_ AriaColcount (Event.Event Unit -> Event.Event  String ) where
  attr AriaColcount eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-colcount", value: prop' value })) eventValue)
...
instance Attr Use_ AriaColcount  String  where
  attr AriaColcount value = unsafeAttribute (  
    { key: "aria-colcount", value: prop' value  } <$ _)
instance Attr Use_ AriaColcount (Event.Event Unit -> Event.Event  String ) where
  attr AriaColcount eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-colcount", value: prop' value })) eventValue)
...
instance Attr View_ AriaColcount  String  where
  attr AriaColcount value = unsafeAttribute (  
    { key: "aria-colcount", value: prop' value  } <$ _)
instance Attr View_ AriaColcount (Event.Event Unit -> Event.Event  String ) where
  attr AriaColcount eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-colcount", value: prop' value })) eventValue)
...
instance Attr everything AriaColcount (Event.Event Unit -> Event.Event  Unit ) where
  attr AriaColcount eventValue = unsafeAttribute (map (map (
    \_ -> { key: "aria-colcount", value: unset' })) eventValue)
