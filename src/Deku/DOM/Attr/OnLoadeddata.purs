...
instance Attr anything OnLoadeddata (Event.Event Unit -> Event.Event  Cb ) where
  attr OnLoadeddata eventValue = unsafeAttribute (map (map (
    \value -> { key: "loadeddata", value: cb' value })) eventValue)
...
instance Attr anything OnLoadeddata (Event.Event Unit -> Event.Event  (Effect Unit) ) where
  attr OnLoadeddata eventValue = unsafeAttribute (map (map (
    \value -> { key: "loadeddata", value: cb' (Cb (const (value $> true))) })) eventValue)
...
instance Attr anything OnLoadeddata (Event.Event Unit -> Event.Event  (Effect Boolean) ) where
  attr OnLoadeddata eventValue = unsafeAttribute (map (map (
    \value -> { key: "loadeddata", value: cb' (Cb (const value)) })) eventValue) 
...
instance Attr everything OnLoadeddata (Event.Event Unit -> Event.Event  Unit ) where
  attr OnLoadeddata eventValue = unsafeAttribute (map (map (
    \_ -> { key: "loadeddata", value: unset' })) eventValue)
