...
instance Attr Blockquote_ Cite (Event.Event Unit -> Event.Event  String ) where
  attr Cite eventValue = unsafeAttribute (map (map ( \value ->
    { key: "cite", value: prop' value })) eventValue)
...
instance Attr Del_ Cite  String  where
  attr Cite value = unsafeAttribute (  
    { key: "cite", value: prop' value  } <$ _)
instance Attr Del_ Cite (Event.Event Unit -> Event.Event  String ) where
  attr Cite eventValue = unsafeAttribute (map (map ( \value ->
    { key: "cite", value: prop' value })) eventValue)
...
instance Attr Ins_ Cite  String  where
  attr Cite value = unsafeAttribute (  
    { key: "cite", value: prop' value  } <$ _)
instance Attr Ins_ Cite (Event.Event Unit -> Event.Event  String ) where
  attr Cite eventValue = unsafeAttribute (map (map ( \value ->
    { key: "cite", value: prop' value })) eventValue)
...
instance Attr Q_ Cite  String  where
  attr Cite value = unsafeAttribute (  
    { key: "cite", value: prop' value  } <$ _)
instance Attr Q_ Cite (Event.Event Unit -> Event.Event  String ) where
  attr Cite eventValue = unsafeAttribute (map (map ( \value ->
    { key: "cite", value: prop' value })) eventValue)
...
instance Attr everything Cite (Event.Event Unit -> Event.Event  Unit ) where
  attr Cite eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "cite", value: unset' })) eventValue)
