...
instance Attr FeBlend_ ColorProfile String where
  attr ColorProfile bothValues  = unsafeAttribute $ Both { key: "color-profile", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "color-profile", value:  prop' value  })
  pureAttr ColorProfile value  = unsafeAttribute $ This { key: "color-profile", value:  prop' value  }
  unpureAttr ColorProfile eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "color-profile", value:  prop' value  }
...
instance Attr everything ColorProfile Unit where
  attr ColorProfile bothValues  = unsafeAttribute $ Both { key: "color-profile", value:  unset'  } (snd bothValues <#> \_ -> { key: "color-profile", value:  unset'  })
  pureAttr ColorProfile _  = unsafeAttribute $ This { key: "color-profile", value:  unset'  }
  unpureAttr ColorProfile eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "color-profile", value:  unset'  }
