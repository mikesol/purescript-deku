...
instance Attr FeBlend_ MarkerEnd (Event.Event Unit -> Event.Event  String ) where
  attr MarkerEnd eventValue = unsafeAttribute (map (map (
    \value -> { key: "marker-end", value: prop' value })) eventValue)
...
instance Attr FeColorMatrix_ MarkerEnd  String  where
  attr MarkerEnd value = unsafeAttribute (  
    { key: "marker-end", value: prop' value  } <$ _)
instance Attr FeColorMatrix_ MarkerEnd (Event.Event Unit -> Event.Event  String ) where
  attr MarkerEnd eventValue = unsafeAttribute (map (map (
    \value -> { key: "marker-end", value: prop' value })) eventValue)
...
instance Attr FeComponentTransfer_ MarkerEnd  String  where
  attr MarkerEnd value = unsafeAttribute (  
    { key: "marker-end", value: prop' value  } <$ _)
instance Attr FeComponentTransfer_ MarkerEnd (Event.Event Unit -> Event.Event  String ) where
  attr MarkerEnd eventValue = unsafeAttribute (map (map (
    \value -> { key: "marker-end", value: prop' value })) eventValue)
...
instance Attr FeComposite_ MarkerEnd  String  where
  attr MarkerEnd value = unsafeAttribute (  
    { key: "marker-end", value: prop' value  } <$ _)
instance Attr FeComposite_ MarkerEnd (Event.Event Unit -> Event.Event  String ) where
  attr MarkerEnd eventValue = unsafeAttribute (map (map (
    \value -> { key: "marker-end", value: prop' value })) eventValue)
...
instance Attr FeConvolveMatrix_ MarkerEnd  String  where
  attr MarkerEnd value = unsafeAttribute (  
    { key: "marker-end", value: prop' value  } <$ _)
instance Attr FeConvolveMatrix_ MarkerEnd (Event.Event Unit -> Event.Event  String ) where
  attr MarkerEnd eventValue = unsafeAttribute (map (map (
    \value -> { key: "marker-end", value: prop' value })) eventValue)
...
instance Attr FeDiffuseLighting_ MarkerEnd  String  where
  attr MarkerEnd value = unsafeAttribute (  
    { key: "marker-end", value: prop' value  } <$ _)
instance Attr FeDiffuseLighting_ MarkerEnd (Event.Event Unit -> Event.Event  String ) where
  attr MarkerEnd eventValue = unsafeAttribute (map (map (
    \value -> { key: "marker-end", value: prop' value })) eventValue)
...
instance Attr FeDisplacementMap_ MarkerEnd  String  where
  attr MarkerEnd value = unsafeAttribute (  
    { key: "marker-end", value: prop' value  } <$ _)
instance Attr FeDisplacementMap_ MarkerEnd (Event.Event Unit -> Event.Event  String ) where
  attr MarkerEnd eventValue = unsafeAttribute (map (map (
    \value -> { key: "marker-end", value: prop' value })) eventValue)
...
instance Attr FeFlood_ MarkerEnd  String  where
  attr MarkerEnd value = unsafeAttribute (  
    { key: "marker-end", value: prop' value  } <$ _)
instance Attr FeFlood_ MarkerEnd (Event.Event Unit -> Event.Event  String ) where
  attr MarkerEnd eventValue = unsafeAttribute (map (map (
    \value -> { key: "marker-end", value: prop' value })) eventValue)
...
instance Attr FeGaussianBlur_ MarkerEnd  String  where
  attr MarkerEnd value = unsafeAttribute (  
    { key: "marker-end", value: prop' value  } <$ _)
instance Attr FeGaussianBlur_ MarkerEnd (Event.Event Unit -> Event.Event  String ) where
  attr MarkerEnd eventValue = unsafeAttribute (map (map (
    \value -> { key: "marker-end", value: prop' value })) eventValue)
...
instance Attr FeImage_ MarkerEnd  String  where
  attr MarkerEnd value = unsafeAttribute (  
    { key: "marker-end", value: prop' value  } <$ _)
instance Attr FeImage_ MarkerEnd (Event.Event Unit -> Event.Event  String ) where
  attr MarkerEnd eventValue = unsafeAttribute (map (map (
    \value -> { key: "marker-end", value: prop' value })) eventValue)
...
instance Attr FeMerge_ MarkerEnd  String  where
  attr MarkerEnd value = unsafeAttribute (  
    { key: "marker-end", value: prop' value  } <$ _)
instance Attr FeMerge_ MarkerEnd (Event.Event Unit -> Event.Event  String ) where
  attr MarkerEnd eventValue = unsafeAttribute (map (map (
    \value -> { key: "marker-end", value: prop' value })) eventValue)
...
instance Attr FeMorphology_ MarkerEnd  String  where
  attr MarkerEnd value = unsafeAttribute (  
    { key: "marker-end", value: prop' value  } <$ _)
instance Attr FeMorphology_ MarkerEnd (Event.Event Unit -> Event.Event  String ) where
  attr MarkerEnd eventValue = unsafeAttribute (map (map (
    \value -> { key: "marker-end", value: prop' value })) eventValue)
...
instance Attr FeOffset_ MarkerEnd  String  where
  attr MarkerEnd value = unsafeAttribute (  
    { key: "marker-end", value: prop' value  } <$ _)
instance Attr FeOffset_ MarkerEnd (Event.Event Unit -> Event.Event  String ) where
  attr MarkerEnd eventValue = unsafeAttribute (map (map (
    \value -> { key: "marker-end", value: prop' value })) eventValue)
...
instance Attr FeSpecularLighting_ MarkerEnd  String  where
  attr MarkerEnd value = unsafeAttribute (  
    { key: "marker-end", value: prop' value  } <$ _)
instance Attr FeSpecularLighting_ MarkerEnd (Event.Event Unit -> Event.Event  String ) where
  attr MarkerEnd eventValue = unsafeAttribute (map (map (
    \value -> { key: "marker-end", value: prop' value })) eventValue)
...
instance Attr FeTile_ MarkerEnd  String  where
  attr MarkerEnd value = unsafeAttribute (  
    { key: "marker-end", value: prop' value  } <$ _)
instance Attr FeTile_ MarkerEnd (Event.Event Unit -> Event.Event  String ) where
  attr MarkerEnd eventValue = unsafeAttribute (map (map (
    \value -> { key: "marker-end", value: prop' value })) eventValue)
...
instance Attr FeTurbulence_ MarkerEnd  String  where
  attr MarkerEnd value = unsafeAttribute (  
    { key: "marker-end", value: prop' value  } <$ _)
instance Attr FeTurbulence_ MarkerEnd (Event.Event Unit -> Event.Event  String ) where
  attr MarkerEnd eventValue = unsafeAttribute (map (map (
    \value -> { key: "marker-end", value: prop' value })) eventValue)
...
instance Attr Filter_ MarkerEnd  String  where
  attr MarkerEnd value = unsafeAttribute (  
    { key: "marker-end", value: prop' value  } <$ _)
instance Attr Filter_ MarkerEnd (Event.Event Unit -> Event.Event  String ) where
  attr MarkerEnd eventValue = unsafeAttribute (map (map (
    \value -> { key: "marker-end", value: prop' value })) eventValue)
...
instance Attr Image_ MarkerEnd  String  where
  attr MarkerEnd value = unsafeAttribute (  
    { key: "marker-end", value: prop' value  } <$ _)
instance Attr Image_ MarkerEnd (Event.Event Unit -> Event.Event  String ) where
  attr MarkerEnd eventValue = unsafeAttribute (map (map (
    \value -> { key: "marker-end", value: prop' value })) eventValue)
...
instance Attr Switch_ MarkerEnd  String  where
  attr MarkerEnd value = unsafeAttribute (  
    { key: "marker-end", value: prop' value  } <$ _)
instance Attr Switch_ MarkerEnd (Event.Event Unit -> Event.Event  String ) where
  attr MarkerEnd eventValue = unsafeAttribute (map (map (
    \value -> { key: "marker-end", value: prop' value })) eventValue)
...
instance Attr everything MarkerEnd (Event.Event Unit -> Event.Event  Unit ) where
  attr MarkerEnd eventValue = unsafeAttribute (map (map (
    \_ -> { key: "marker-end", value: unset' })) eventValue)
