...
instance Attr Circle_ AriaRowspan String where
  attr AriaRowspan bothValues  = unsafeAttribute $ Both { key: "aria-rowspan", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "aria-rowspan", value:  prop' value  })
  pureAttr AriaRowspan value  = unsafeAttribute $ This { key: "aria-rowspan", value:  prop' value  }
  unpureAttr AriaRowspan eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "aria-rowspan", value:  prop' value  }
...
instance Attr everything AriaRowspan Unit where
  attr AriaRowspan bothValues  = unsafeAttribute $ Both { key: "aria-rowspan", value:  unset'  } (snd bothValues <#> \_ -> { key: "aria-rowspan", value:  unset'  })
  pureAttr AriaRowspan _  = unsafeAttribute $ This { key: "aria-rowspan", value:  unset'  }
  unpureAttr AriaRowspan eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "aria-rowspan", value:  unset'  }
