...
instance Attr Circle_ AriaRowspan (Event.Event Unit -> Event.Event  String ) where
  attr AriaRowspan eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-rowspan", value: prop' value })) eventValue)
...
instance Attr Ellipse_ AriaRowspan  String  where
  attr AriaRowspan value = unsafeAttribute (  
    { key: "aria-rowspan", value: prop' value  } <$ _)
instance Attr Ellipse_ AriaRowspan (Event.Event Unit -> Event.Event  String ) where
  attr AriaRowspan eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-rowspan", value: prop' value })) eventValue)
...
instance Attr ForeignObject_ AriaRowspan  String  where
  attr AriaRowspan value = unsafeAttribute (  
    { key: "aria-rowspan", value: prop' value  } <$ _)
instance Attr ForeignObject_ AriaRowspan (Event.Event Unit -> Event.Event  String ) where
  attr AriaRowspan eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-rowspan", value: prop' value })) eventValue)
...
instance Attr G_ AriaRowspan  String  where
  attr AriaRowspan value = unsafeAttribute (  
    { key: "aria-rowspan", value: prop' value  } <$ _)
instance Attr G_ AriaRowspan (Event.Event Unit -> Event.Event  String ) where
  attr AriaRowspan eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-rowspan", value: prop' value })) eventValue)
...
instance Attr Line_ AriaRowspan  String  where
  attr AriaRowspan value = unsafeAttribute (  
    { key: "aria-rowspan", value: prop' value  } <$ _)
instance Attr Line_ AriaRowspan (Event.Event Unit -> Event.Event  String ) where
  attr AriaRowspan eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-rowspan", value: prop' value })) eventValue)
...
instance Attr Marker_ AriaRowspan  String  where
  attr AriaRowspan value = unsafeAttribute (  
    { key: "aria-rowspan", value: prop' value  } <$ _)
instance Attr Marker_ AriaRowspan (Event.Event Unit -> Event.Event  String ) where
  attr AriaRowspan eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-rowspan", value: prop' value })) eventValue)
...
instance Attr Path_ AriaRowspan  String  where
  attr AriaRowspan value = unsafeAttribute (  
    { key: "aria-rowspan", value: prop' value  } <$ _)
instance Attr Path_ AriaRowspan (Event.Event Unit -> Event.Event  String ) where
  attr AriaRowspan eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-rowspan", value: prop' value })) eventValue)
...
instance Attr Polygon_ AriaRowspan  String  where
  attr AriaRowspan value = unsafeAttribute (  
    { key: "aria-rowspan", value: prop' value  } <$ _)
instance Attr Polygon_ AriaRowspan (Event.Event Unit -> Event.Event  String ) where
  attr AriaRowspan eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-rowspan", value: prop' value })) eventValue)
...
instance Attr Polyline_ AriaRowspan  String  where
  attr AriaRowspan value = unsafeAttribute (  
    { key: "aria-rowspan", value: prop' value  } <$ _)
instance Attr Polyline_ AriaRowspan (Event.Event Unit -> Event.Event  String ) where
  attr AriaRowspan eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-rowspan", value: prop' value })) eventValue)
...
instance Attr Rect_ AriaRowspan  String  where
  attr AriaRowspan value = unsafeAttribute (  
    { key: "aria-rowspan", value: prop' value  } <$ _)
instance Attr Rect_ AriaRowspan (Event.Event Unit -> Event.Event  String ) where
  attr AriaRowspan eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-rowspan", value: prop' value })) eventValue)
...
instance Attr Svg_ AriaRowspan  String  where
  attr AriaRowspan value = unsafeAttribute (  
    { key: "aria-rowspan", value: prop' value  } <$ _)
instance Attr Svg_ AriaRowspan (Event.Event Unit -> Event.Event  String ) where
  attr AriaRowspan eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-rowspan", value: prop' value })) eventValue)
...
instance Attr Symbol_ AriaRowspan  String  where
  attr AriaRowspan value = unsafeAttribute (  
    { key: "aria-rowspan", value: prop' value  } <$ _)
instance Attr Symbol_ AriaRowspan (Event.Event Unit -> Event.Event  String ) where
  attr AriaRowspan eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-rowspan", value: prop' value })) eventValue)
...
instance Attr Text_ AriaRowspan  String  where
  attr AriaRowspan value = unsafeAttribute (  
    { key: "aria-rowspan", value: prop' value  } <$ _)
instance Attr Text_ AriaRowspan (Event.Event Unit -> Event.Event  String ) where
  attr AriaRowspan eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-rowspan", value: prop' value })) eventValue)
...
instance Attr TextPath_ AriaRowspan  String  where
  attr AriaRowspan value = unsafeAttribute (  
    { key: "aria-rowspan", value: prop' value  } <$ _)
instance Attr TextPath_ AriaRowspan (Event.Event Unit -> Event.Event  String ) where
  attr AriaRowspan eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-rowspan", value: prop' value })) eventValue)
...
instance Attr Tspan_ AriaRowspan  String  where
  attr AriaRowspan value = unsafeAttribute (  
    { key: "aria-rowspan", value: prop' value  } <$ _)
instance Attr Tspan_ AriaRowspan (Event.Event Unit -> Event.Event  String ) where
  attr AriaRowspan eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-rowspan", value: prop' value })) eventValue)
...
instance Attr Use_ AriaRowspan  String  where
  attr AriaRowspan value = unsafeAttribute (  
    { key: "aria-rowspan", value: prop' value  } <$ _)
instance Attr Use_ AriaRowspan (Event.Event Unit -> Event.Event  String ) where
  attr AriaRowspan eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-rowspan", value: prop' value })) eventValue)
...
instance Attr View_ AriaRowspan  String  where
  attr AriaRowspan value = unsafeAttribute (  
    { key: "aria-rowspan", value: prop' value  } <$ _)
instance Attr View_ AriaRowspan (Event.Event Unit -> Event.Event  String ) where
  attr AriaRowspan eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-rowspan", value: prop' value })) eventValue)
...
instance Attr everything AriaRowspan (Event.Event Unit -> Event.Event  Unit ) where
  attr AriaRowspan eventValue = unsafeAttribute (map (map (
    \_ -> { key: "aria-rowspan", value: unset' })) eventValue)
