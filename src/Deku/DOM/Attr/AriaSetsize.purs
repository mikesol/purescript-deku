...
instance Attr Circle_ AriaSetsize String where
  attr AriaSetsize bothValues  = unsafeAttribute $ Both { key: "aria-setsize", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "aria-setsize", value:  prop' value  })
  pureAttr AriaSetsize value  = unsafeAttribute $ This { key: "aria-setsize", value:  prop' value  }
  unpureAttr AriaSetsize eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "aria-setsize", value:  prop' value  }
...
instance Attr everything AriaSetsize Unit where
  attr AriaSetsize bothValues  = unsafeAttribute $ Both { key: "aria-setsize", value:  unset'  } (snd bothValues <#> \_ -> { key: "aria-setsize", value:  unset'  })
  pureAttr AriaSetsize _  = unsafeAttribute $ This { key: "aria-setsize", value:  unset'  }
  unpureAttr AriaSetsize eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "aria-setsize", value:  unset'  }
