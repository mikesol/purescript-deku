...
instance Attr Animate_ Values (Event.Event Unit -> Event.Event  String ) where
  attr Values eventValue = unsafeAttribute (map (map (
    \value -> { key: "values", value: prop' value })) eventValue)
...
instance Attr AnimateMotion_ Values  String  where
  attr Values value = unsafeAttribute (  
    { key: "values", value: prop' value  } <$ _)
instance Attr AnimateMotion_ Values (Event.Event Unit -> Event.Event  String ) where
  attr Values eventValue = unsafeAttribute (map (map (
    \value -> { key: "values", value: prop' value })) eventValue)
...
instance Attr AnimateTransform_ Values  String  where
  attr Values value = unsafeAttribute (  
    { key: "values", value: prop' value  } <$ _)
instance Attr AnimateTransform_ Values (Event.Event Unit -> Event.Event  String ) where
  attr Values eventValue = unsafeAttribute (map (map (
    \value -> { key: "values", value: prop' value })) eventValue)
...
instance Attr FeColorMatrix_ Values  String  where
  attr Values value = unsafeAttribute (  
    { key: "values", value: prop' value  } <$ _)
instance Attr FeColorMatrix_ Values (Event.Event Unit -> Event.Event  String ) where
  attr Values eventValue = unsafeAttribute (map (map (
    \value -> { key: "values", value: prop' value })) eventValue)
...
instance Attr everything Values (Event.Event Unit -> Event.Event  Unit ) where
  attr Values eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "values", value: unset' })) eventValue)
