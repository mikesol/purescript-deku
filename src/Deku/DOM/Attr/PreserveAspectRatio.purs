...
instance Attr FeImage_ PreserveAspectRatio (Event.Event Unit -> Event.Event  String ) where
  attr PreserveAspectRatio eventValue = unsafeAttribute (map (map ( \value -> { key: "preserveAspectRatio", value: prop' value })) eventValue)
...
instance Attr Image_ PreserveAspectRatio  String  where
  attr PreserveAspectRatio value = unsafeAttribute (  
    { key: "preserveAspectRatio", value: prop' value  } <$ _)
instance Attr Image_ PreserveAspectRatio (Event.Event Unit -> Event.Event  String ) where
  attr PreserveAspectRatio eventValue = unsafeAttribute (map (map ( \value -> { key: "preserveAspectRatio", value: prop' value })) eventValue)
...
instance Attr Marker_ PreserveAspectRatio  String  where
  attr PreserveAspectRatio value = unsafeAttribute (  
    { key: "preserveAspectRatio", value: prop' value  } <$ _)
instance Attr Marker_ PreserveAspectRatio (Event.Event Unit -> Event.Event  String ) where
  attr PreserveAspectRatio eventValue = unsafeAttribute (map (map ( \value -> { key: "preserveAspectRatio", value: prop' value })) eventValue)
...
instance Attr Pattern_ PreserveAspectRatio  String  where
  attr PreserveAspectRatio value = unsafeAttribute (  
    { key: "preserveAspectRatio", value: prop' value  } <$ _)
instance Attr Pattern_ PreserveAspectRatio (Event.Event Unit -> Event.Event  String ) where
  attr PreserveAspectRatio eventValue = unsafeAttribute (map (map ( \value -> { key: "preserveAspectRatio", value: prop' value })) eventValue)
...
instance Attr Svg_ PreserveAspectRatio  String  where
  attr PreserveAspectRatio value = unsafeAttribute (  
    { key: "preserveAspectRatio", value: prop' value  } <$ _)
instance Attr Svg_ PreserveAspectRatio (Event.Event Unit -> Event.Event  String ) where
  attr PreserveAspectRatio eventValue = unsafeAttribute (map (map ( \value -> { key: "preserveAspectRatio", value: prop' value })) eventValue)
...
instance Attr Symbol_ PreserveAspectRatio  String  where
  attr PreserveAspectRatio value = unsafeAttribute (  
    { key: "preserveAspectRatio", value: prop' value  } <$ _)
instance Attr Symbol_ PreserveAspectRatio (Event.Event Unit -> Event.Event  String ) where
  attr PreserveAspectRatio eventValue = unsafeAttribute (map (map ( \value -> { key: "preserveAspectRatio", value: prop' value })) eventValue)
...
instance Attr View_ PreserveAspectRatio  String  where
  attr PreserveAspectRatio value = unsafeAttribute (  
    { key: "preserveAspectRatio", value: prop' value  } <$ _)
instance Attr View_ PreserveAspectRatio (Event.Event Unit -> Event.Event  String ) where
  attr PreserveAspectRatio eventValue = unsafeAttribute (map (map ( \value -> { key: "preserveAspectRatio", value: prop' value })) eventValue)
...
instance Attr everything PreserveAspectRatio (Event.Event Unit -> Event.Event  Unit ) where
  attr PreserveAspectRatio eventValue = unsafeAttribute (map (map ( \_ -> { key: "preserveAspectRatio", value: unset' })) eventValue)
