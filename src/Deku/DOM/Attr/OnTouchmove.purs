...
instance Attr anything OnTouchmove (Event.Event Unit -> Event.Event  Cb ) where
  attr OnTouchmove eventValue = unsafeAttribute (map (map (
    \value -> { key: "touchmove", value: cb' value })) eventValue)
...
instance Attr anything OnTouchmove (Event.Event Unit -> Event.Event  (Effect Unit) ) where
  attr OnTouchmove eventValue = unsafeAttribute (map (map (
    \value -> { key: "touchmove", value: cb' (Cb (const (value $> true))) })) eventValue)
...
instance Attr anything OnTouchmove (Event.Event Unit -> Event.Event  (Effect Boolean) ) where
  attr OnTouchmove eventValue = unsafeAttribute (map (map (
    \value -> { key: "touchmove", value: cb' (Cb (const value)) })) eventValue) 
...
instance Attr everything OnTouchmove (Event.Event Unit -> Event.Event  Unit ) where
  attr OnTouchmove eventValue = unsafeAttribute (map (map (
    \_ -> { key: "touchmove", value: unset' })) eventValue)
