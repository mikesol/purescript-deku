...
instance Attr Button_ Disabled (Event.Event Unit -> Event.Event  String ) where
  attr Disabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "disabled", value: prop' value })) eventValue)
...
instance Attr Fieldset_ Disabled  String  where
  attr Disabled value = unsafeAttribute (  
    { key: "disabled", value: prop' value  } <$ _)
instance Attr Fieldset_ Disabled (Event.Event Unit -> Event.Event  String ) where
  attr Disabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "disabled", value: prop' value })) eventValue)
...
instance Attr Input_ Disabled  String  where
  attr Disabled value = unsafeAttribute (  
    { key: "disabled", value: prop' value  } <$ _)
instance Attr Input_ Disabled (Event.Event Unit -> Event.Event  String ) where
  attr Disabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "disabled", value: prop' value })) eventValue)
...
instance Attr Optgroup_ Disabled  String  where
  attr Disabled value = unsafeAttribute (  
    { key: "disabled", value: prop' value  } <$ _)
instance Attr Optgroup_ Disabled (Event.Event Unit -> Event.Event  String ) where
  attr Disabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "disabled", value: prop' value })) eventValue)
...
instance Attr Option_ Disabled  String  where
  attr Disabled value = unsafeAttribute (  
    { key: "disabled", value: prop' value  } <$ _)
instance Attr Option_ Disabled (Event.Event Unit -> Event.Event  String ) where
  attr Disabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "disabled", value: prop' value })) eventValue)
...
instance Attr Select_ Disabled  String  where
  attr Disabled value = unsafeAttribute (  
    { key: "disabled", value: prop' value  } <$ _)
instance Attr Select_ Disabled (Event.Event Unit -> Event.Event  String ) where
  attr Disabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "disabled", value: prop' value })) eventValue)
...
instance Attr Textarea_ Disabled  String  where
  attr Disabled value = unsafeAttribute (  
    { key: "disabled", value: prop' value  } <$ _)
instance Attr Textarea_ Disabled (Event.Event Unit -> Event.Event  String ) where
  attr Disabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "disabled", value: prop' value })) eventValue)
...
instance Attr everything Disabled (Event.Event Unit -> Event.Event  Unit ) where
  attr Disabled eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "disabled", value: unset' })) eventValue)
