...
instance Attr Circle_ AriaDisabled (Event.Event Unit -> Event.Event  String ) where
  attr AriaDisabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-disabled", value: prop' value })) eventValue)
...
instance Attr Ellipse_ AriaDisabled  String  where
  attr AriaDisabled value = unsafeAttribute (  
    { key: "aria-disabled", value: prop' value  } <$ _)
instance Attr Ellipse_ AriaDisabled (Event.Event Unit -> Event.Event  String ) where
  attr AriaDisabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-disabled", value: prop' value })) eventValue)
...
instance Attr ForeignObject_ AriaDisabled  String  where
  attr AriaDisabled value = unsafeAttribute (  
    { key: "aria-disabled", value: prop' value  } <$ _)
instance Attr ForeignObject_ AriaDisabled (Event.Event Unit -> Event.Event  String ) where
  attr AriaDisabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-disabled", value: prop' value })) eventValue)
...
instance Attr G_ AriaDisabled  String  where
  attr AriaDisabled value = unsafeAttribute (  
    { key: "aria-disabled", value: prop' value  } <$ _)
instance Attr G_ AriaDisabled (Event.Event Unit -> Event.Event  String ) where
  attr AriaDisabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-disabled", value: prop' value })) eventValue)
...
instance Attr Line_ AriaDisabled  String  where
  attr AriaDisabled value = unsafeAttribute (  
    { key: "aria-disabled", value: prop' value  } <$ _)
instance Attr Line_ AriaDisabled (Event.Event Unit -> Event.Event  String ) where
  attr AriaDisabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-disabled", value: prop' value })) eventValue)
...
instance Attr Marker_ AriaDisabled  String  where
  attr AriaDisabled value = unsafeAttribute (  
    { key: "aria-disabled", value: prop' value  } <$ _)
instance Attr Marker_ AriaDisabled (Event.Event Unit -> Event.Event  String ) where
  attr AriaDisabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-disabled", value: prop' value })) eventValue)
...
instance Attr Path_ AriaDisabled  String  where
  attr AriaDisabled value = unsafeAttribute (  
    { key: "aria-disabled", value: prop' value  } <$ _)
instance Attr Path_ AriaDisabled (Event.Event Unit -> Event.Event  String ) where
  attr AriaDisabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-disabled", value: prop' value })) eventValue)
...
instance Attr Polygon_ AriaDisabled  String  where
  attr AriaDisabled value = unsafeAttribute (  
    { key: "aria-disabled", value: prop' value  } <$ _)
instance Attr Polygon_ AriaDisabled (Event.Event Unit -> Event.Event  String ) where
  attr AriaDisabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-disabled", value: prop' value })) eventValue)
...
instance Attr Polyline_ AriaDisabled  String  where
  attr AriaDisabled value = unsafeAttribute (  
    { key: "aria-disabled", value: prop' value  } <$ _)
instance Attr Polyline_ AriaDisabled (Event.Event Unit -> Event.Event  String ) where
  attr AriaDisabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-disabled", value: prop' value })) eventValue)
...
instance Attr Rect_ AriaDisabled  String  where
  attr AriaDisabled value = unsafeAttribute (  
    { key: "aria-disabled", value: prop' value  } <$ _)
instance Attr Rect_ AriaDisabled (Event.Event Unit -> Event.Event  String ) where
  attr AriaDisabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-disabled", value: prop' value })) eventValue)
...
instance Attr Svg_ AriaDisabled  String  where
  attr AriaDisabled value = unsafeAttribute (  
    { key: "aria-disabled", value: prop' value  } <$ _)
instance Attr Svg_ AriaDisabled (Event.Event Unit -> Event.Event  String ) where
  attr AriaDisabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-disabled", value: prop' value })) eventValue)
...
instance Attr Symbol_ AriaDisabled  String  where
  attr AriaDisabled value = unsafeAttribute (  
    { key: "aria-disabled", value: prop' value  } <$ _)
instance Attr Symbol_ AriaDisabled (Event.Event Unit -> Event.Event  String ) where
  attr AriaDisabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-disabled", value: prop' value })) eventValue)
...
instance Attr Text_ AriaDisabled  String  where
  attr AriaDisabled value = unsafeAttribute (  
    { key: "aria-disabled", value: prop' value  } <$ _)
instance Attr Text_ AriaDisabled (Event.Event Unit -> Event.Event  String ) where
  attr AriaDisabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-disabled", value: prop' value })) eventValue)
...
instance Attr TextPath_ AriaDisabled  String  where
  attr AriaDisabled value = unsafeAttribute (  
    { key: "aria-disabled", value: prop' value  } <$ _)
instance Attr TextPath_ AriaDisabled (Event.Event Unit -> Event.Event  String ) where
  attr AriaDisabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-disabled", value: prop' value })) eventValue)
...
instance Attr Tspan_ AriaDisabled  String  where
  attr AriaDisabled value = unsafeAttribute (  
    { key: "aria-disabled", value: prop' value  } <$ _)
instance Attr Tspan_ AriaDisabled (Event.Event Unit -> Event.Event  String ) where
  attr AriaDisabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-disabled", value: prop' value })) eventValue)
...
instance Attr Use_ AriaDisabled  String  where
  attr AriaDisabled value = unsafeAttribute (  
    { key: "aria-disabled", value: prop' value  } <$ _)
instance Attr Use_ AriaDisabled (Event.Event Unit -> Event.Event  String ) where
  attr AriaDisabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-disabled", value: prop' value })) eventValue)
...
instance Attr View_ AriaDisabled  String  where
  attr AriaDisabled value = unsafeAttribute (  
    { key: "aria-disabled", value: prop' value  } <$ _)
instance Attr View_ AriaDisabled (Event.Event Unit -> Event.Event  String ) where
  attr AriaDisabled eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-disabled", value: prop' value })) eventValue)
...
instance Attr everything AriaDisabled (Event.Event Unit -> Event.Event  Unit ) where
  attr AriaDisabled eventValue = unsafeAttribute (map (map (
    \_ -> { key: "aria-disabled", value: unset' })) eventValue)
