...
instance Attr Animate_ Dur  String  where
  attr Dur value = unsafeAttribute $ This $ { key: "dur", value: prop' value }
...
instance Attr Animate_ Dur (ST.ST Global.Global  String ) where
  attr Dur iValue = unsafeAttribute $ This $ iValue # \value ->
    { key: "dur", value: prop' value }
...
instance Attr everything Dur  Unit  where
  attr Dur _ = unsafeAttribute $ This $ { key: "dur", value: unset' }
...
instance Attr everything Dur (ST.ST Global.Global  Unit ) where
  attr Dur iValue = unsafeAttribute $ This $ iValue # \_ ->
    { key: "dur", value: unset' }
