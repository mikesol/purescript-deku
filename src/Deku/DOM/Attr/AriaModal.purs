...
instance Attr Circle_ AriaModal (Event.Event Unit -> Event.Event  String ) where
  attr AriaModal eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-modal", value: prop' value })) eventValue)
...
instance Attr Ellipse_ AriaModal  String  where
  attr AriaModal value = unsafeAttribute (  
    { key: "aria-modal", value: prop' value  } <$ _)
instance Attr Ellipse_ AriaModal (Event.Event Unit -> Event.Event  String ) where
  attr AriaModal eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-modal", value: prop' value })) eventValue)
...
instance Attr ForeignObject_ AriaModal  String  where
  attr AriaModal value = unsafeAttribute (  
    { key: "aria-modal", value: prop' value  } <$ _)
instance Attr ForeignObject_ AriaModal (Event.Event Unit -> Event.Event  String ) where
  attr AriaModal eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-modal", value: prop' value })) eventValue)
...
instance Attr G_ AriaModal  String  where
  attr AriaModal value = unsafeAttribute (  
    { key: "aria-modal", value: prop' value  } <$ _)
instance Attr G_ AriaModal (Event.Event Unit -> Event.Event  String ) where
  attr AriaModal eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-modal", value: prop' value })) eventValue)
...
instance Attr Line_ AriaModal  String  where
  attr AriaModal value = unsafeAttribute (  
    { key: "aria-modal", value: prop' value  } <$ _)
instance Attr Line_ AriaModal (Event.Event Unit -> Event.Event  String ) where
  attr AriaModal eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-modal", value: prop' value })) eventValue)
...
instance Attr Marker_ AriaModal  String  where
  attr AriaModal value = unsafeAttribute (  
    { key: "aria-modal", value: prop' value  } <$ _)
instance Attr Marker_ AriaModal (Event.Event Unit -> Event.Event  String ) where
  attr AriaModal eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-modal", value: prop' value })) eventValue)
...
instance Attr Path_ AriaModal  String  where
  attr AriaModal value = unsafeAttribute (  
    { key: "aria-modal", value: prop' value  } <$ _)
instance Attr Path_ AriaModal (Event.Event Unit -> Event.Event  String ) where
  attr AriaModal eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-modal", value: prop' value })) eventValue)
...
instance Attr Polygon_ AriaModal  String  where
  attr AriaModal value = unsafeAttribute (  
    { key: "aria-modal", value: prop' value  } <$ _)
instance Attr Polygon_ AriaModal (Event.Event Unit -> Event.Event  String ) where
  attr AriaModal eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-modal", value: prop' value })) eventValue)
...
instance Attr Polyline_ AriaModal  String  where
  attr AriaModal value = unsafeAttribute (  
    { key: "aria-modal", value: prop' value  } <$ _)
instance Attr Polyline_ AriaModal (Event.Event Unit -> Event.Event  String ) where
  attr AriaModal eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-modal", value: prop' value })) eventValue)
...
instance Attr Rect_ AriaModal  String  where
  attr AriaModal value = unsafeAttribute (  
    { key: "aria-modal", value: prop' value  } <$ _)
instance Attr Rect_ AriaModal (Event.Event Unit -> Event.Event  String ) where
  attr AriaModal eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-modal", value: prop' value })) eventValue)
...
instance Attr Svg_ AriaModal  String  where
  attr AriaModal value = unsafeAttribute (  
    { key: "aria-modal", value: prop' value  } <$ _)
instance Attr Svg_ AriaModal (Event.Event Unit -> Event.Event  String ) where
  attr AriaModal eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-modal", value: prop' value })) eventValue)
...
instance Attr Symbol_ AriaModal  String  where
  attr AriaModal value = unsafeAttribute (  
    { key: "aria-modal", value: prop' value  } <$ _)
instance Attr Symbol_ AriaModal (Event.Event Unit -> Event.Event  String ) where
  attr AriaModal eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-modal", value: prop' value })) eventValue)
...
instance Attr Text_ AriaModal  String  where
  attr AriaModal value = unsafeAttribute (  
    { key: "aria-modal", value: prop' value  } <$ _)
instance Attr Text_ AriaModal (Event.Event Unit -> Event.Event  String ) where
  attr AriaModal eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-modal", value: prop' value })) eventValue)
...
instance Attr TextPath_ AriaModal  String  where
  attr AriaModal value = unsafeAttribute (  
    { key: "aria-modal", value: prop' value  } <$ _)
instance Attr TextPath_ AriaModal (Event.Event Unit -> Event.Event  String ) where
  attr AriaModal eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-modal", value: prop' value })) eventValue)
...
instance Attr Tspan_ AriaModal  String  where
  attr AriaModal value = unsafeAttribute (  
    { key: "aria-modal", value: prop' value  } <$ _)
instance Attr Tspan_ AriaModal (Event.Event Unit -> Event.Event  String ) where
  attr AriaModal eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-modal", value: prop' value })) eventValue)
...
instance Attr Use_ AriaModal  String  where
  attr AriaModal value = unsafeAttribute (  
    { key: "aria-modal", value: prop' value  } <$ _)
instance Attr Use_ AriaModal (Event.Event Unit -> Event.Event  String ) where
  attr AriaModal eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-modal", value: prop' value })) eventValue)
...
instance Attr View_ AriaModal  String  where
  attr AriaModal value = unsafeAttribute (  
    { key: "aria-modal", value: prop' value  } <$ _)
instance Attr View_ AriaModal (Event.Event Unit -> Event.Event  String ) where
  attr AriaModal eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-modal", value: prop' value })) eventValue)
...
instance Attr everything AriaModal (Event.Event Unit -> Event.Event  Unit ) where
  attr AriaModal eventValue = unsafeAttribute (map (map (
    \_ -> { key: "aria-modal", value: unset' })) eventValue)
