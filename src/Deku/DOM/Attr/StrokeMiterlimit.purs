...
instance Attr Circle_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr ClipPath_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr ClipPath_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr Defs_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr Defs_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr Ellipse_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr Ellipse_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr FeBlend_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr FeBlend_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr FeColorMatrix_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr FeColorMatrix_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr FeComponentTransfer_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr FeComponentTransfer_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr FeComposite_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr FeComposite_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr FeConvolveMatrix_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr FeConvolveMatrix_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr FeDiffuseLighting_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr FeDiffuseLighting_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr FeDisplacementMap_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr FeDisplacementMap_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr FeFlood_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr FeFlood_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr FeGaussianBlur_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr FeGaussianBlur_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr FeImage_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr FeImage_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr FeMerge_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr FeMerge_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr FeMorphology_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr FeMorphology_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr FeOffset_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr FeOffset_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr FeSpecularLighting_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr FeSpecularLighting_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr FeTile_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr FeTile_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr FeTurbulence_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr FeTurbulence_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr Filter_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr Filter_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr ForeignObject_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr ForeignObject_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr G_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr G_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr Image_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr Image_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr Line_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr Line_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr LinearGradient_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr LinearGradient_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr Marker_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr Marker_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr Mask_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr Mask_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr Path_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr Path_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr Pattern_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr Pattern_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr Polygon_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr Polygon_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr Polyline_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr Polyline_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr RadialGradient_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr RadialGradient_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr Rect_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr Rect_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr Svg_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr Svg_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr Switch_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr Switch_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr Symbol_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr Symbol_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr Text_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr Text_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr TextPath_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr TextPath_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr Tspan_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr Tspan_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr Use_ StrokeMiterlimit  String  where
  attr StrokeMiterlimit value = unsafeAttribute (  
    { key: "stroke-miterlimit", value: prop' value  } <$ _)
instance Attr Use_ StrokeMiterlimit (Event.Event Unit -> Event.Event  String ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-miterlimit", value: prop' value })) eventValue)
...
instance Attr everything StrokeMiterlimit (Event.Event Unit -> Event.Event  Unit ) where
  attr StrokeMiterlimit eventValue = unsafeAttribute (map (map ( \_ -> { key: "stroke-miterlimit", value: unset' })) eventValue)
