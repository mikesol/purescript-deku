...
instance Attr A_ Challenge String where
  attr Challenge bothValues  = unsafeAttribute $ Both { key: "challenge", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "challenge", value:  prop' value  })
  pureAttr Challenge value  = unsafeAttribute $ This { key: "challenge", value:  prop' value  }
  unpureAttr Challenge eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "challenge", value:  prop' value  }
...
instance Attr everything Challenge Unit where
  attr Challenge bothValues  = unsafeAttribute $ Both { key: "challenge", value:  unset'  } (snd bothValues <#> \_ -> { key: "challenge", value:  unset'  })
  pureAttr Challenge _  = unsafeAttribute $ This { key: "challenge", value:  unset'  }
  unpureAttr Challenge eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "challenge", value:  unset'  }
