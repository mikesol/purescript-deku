...
instance Attr A_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr A_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
instance Attr A_ Class (Event.Event  String ) where
  attr Class eventValue = unsafeAttribute \_ -> eventValue <#>
    \value -> { key: "class", value: prop' value }
instance Attr Abbr_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Abbr_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Acronym_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Acronym_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Address_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Address_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Applet_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Applet_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Area_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Area_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Article_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Article_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Aside_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Aside_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Audio_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Audio_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr B_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr B_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Base_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Base_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Basefont_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Basefont_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Bdi_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Bdi_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Bdo_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Bdo_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Big_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Big_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Blockquote_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Blockquote_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Body_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Body_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Br_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Br_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Button_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Button_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Canvas_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Canvas_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Caption_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Caption_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Center_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Center_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Cite_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Cite_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Code_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Code_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Col_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Col_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Colgroup_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Colgroup_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Xdata_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Xdata_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Datalist_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Datalist_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Dd_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Dd_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Del_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Del_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Details_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Details_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Dfn_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Dfn_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Dialog_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Dialog_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Dir_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Dir_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Div_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Div_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Dl_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Dl_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Dt_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Dt_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Em_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Em_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Embed_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Embed_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Fieldset_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Fieldset_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Figcaption_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Figcaption_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Figure_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Figure_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Font_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Font_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Footer_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Footer_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Form_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Form_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Frame_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Frame_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Frameset_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Frameset_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr H1_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr H1_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr H2_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr H2_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr H3_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr H3_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr H4_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr H4_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr H5_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr H5_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr H6_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr H6_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Head_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Head_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Header_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Header_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Hr_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Hr_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Html_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Html_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr I_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr I_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Iframe_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Iframe_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Img_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Img_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Input_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Input_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Ins_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Ins_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Kbd_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Kbd_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Label_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Label_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Legend_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Legend_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Li_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Li_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Link_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Link_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Main_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Main_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Map_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Map_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Mark_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Mark_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Meta_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Meta_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Meter_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Meter_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Nav_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Nav_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Noframes_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Noframes_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Noscript_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Noscript_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Object_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Object_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Ol_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Ol_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Optgroup_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Optgroup_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Option_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Option_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Output_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Output_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr P_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr P_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Param_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Param_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Picture_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Picture_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Pre_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Pre_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Progress_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Progress_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Q_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Q_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Rp_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Rp_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Rt_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Rt_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Ruby_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Ruby_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr S_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr S_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Samp_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Samp_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Script_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Script_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Section_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Section_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Select_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Select_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Small_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Small_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Source_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Source_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Span_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Span_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Strike_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Strike_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Strong_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Strong_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Style_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Style_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Sub_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Sub_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Summary_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Summary_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Sup_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Sup_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Svg_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Svg_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Table_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Table_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Tbody_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Tbody_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Td_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Td_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Template_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Template_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Textarea_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Textarea_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Tfoot_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Tfoot_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Th_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Th_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Thead_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Thead_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Time_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Time_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Title_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Title_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Tr_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Tr_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Track_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Track_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Tt_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Tt_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr U_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr U_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Ul_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Ul_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Var_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Var_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Video_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Video_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Wbr_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Wbr_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Animate_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Animate_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr AnimateMotion_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr AnimateMotion_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Circle_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Circle_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr ClipPath_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr ClipPath_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Defs_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Defs_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Desc_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Desc_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Ellipse_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Ellipse_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr FeBlend_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr FeBlend_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr FeColorMatrix_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr FeColorMatrix_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr FeComponentTransfer_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr FeComponentTransfer_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr FeComposite_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr FeComposite_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr FeConvolveMatrix_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr FeConvolveMatrix_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr FeDiffuseLighting_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr FeDiffuseLighting_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr FeDisplacementMap_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr FeDisplacementMap_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr FeDropShadow_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr FeDropShadow_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr FeFlood_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr FeFlood_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr FeGaussianBlur_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr FeGaussianBlur_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr FeImage_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr FeImage_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr FeMerge_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr FeMerge_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr FeMorphology_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr FeMorphology_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr FeOffset_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr FeOffset_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr FeSpecularLighting_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr FeSpecularLighting_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr FeTile_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr FeTile_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr FeTurbulence_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr FeTurbulence_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Filter_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Filter_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr ForeignObject_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr ForeignObject_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr G_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr G_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Image_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Image_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Line_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Line_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr LinearGradient_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr LinearGradient_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Marker_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Marker_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Mask_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Mask_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Path_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Path_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Pattern_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Pattern_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Polygon_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Polygon_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Polyline_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Polyline_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr RadialGradient_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr RadialGradient_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Rect_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Rect_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Set_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Set_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Stop_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Stop_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Switch_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Switch_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Symbol_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Symbol_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Text_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Text_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr TextPath_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr TextPath_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Tspan_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Tspan_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr Use_ Class  String  where
  attr Class value = unsafeAttribute (  
    { key: "class", value: prop' value  } <$ _)
instance Attr Use_ Class (Event.Event Unit -> Event.Event  String ) where
  attr Class eventValue = unsafeAttribute (map (map (
    \value -> { key: "class", value: prop' value })) eventValue)
...
instance Attr everything Class  Unit  where
  attr Class _ = unsafeAttribute (  { key: "class", value: unset'  } <$ _)
instance Attr everything Class (Event.Event Unit -> Event.Event  Unit ) where
  attr Class eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "class", value: unset' })) eventValue)
instance Attr everything Class (Event.Event  Unit ) where
  attr Class eventValue = unsafeAttribute \_ -> eventValue <#> \_ ->
