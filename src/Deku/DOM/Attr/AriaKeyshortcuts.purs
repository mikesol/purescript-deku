...
instance Attr Circle_ AriaKeyshortcuts (Event.Event Unit -> Event.Event  String ) where
  attr AriaKeyshortcuts eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-keyshortcuts", value: prop' value })) eventValue)
...
instance Attr Ellipse_ AriaKeyshortcuts  String  where
  attr AriaKeyshortcuts value = unsafeAttribute (  
    { key: "aria-keyshortcuts", value: prop' value  } <$ _)
instance Attr Ellipse_ AriaKeyshortcuts (Event.Event Unit -> Event.Event  String ) where
  attr AriaKeyshortcuts eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-keyshortcuts", value: prop' value })) eventValue)
...
instance Attr ForeignObject_ AriaKeyshortcuts  String  where
  attr AriaKeyshortcuts value = unsafeAttribute (  
    { key: "aria-keyshortcuts", value: prop' value  } <$ _)
instance Attr ForeignObject_ AriaKeyshortcuts (Event.Event Unit -> Event.Event  String ) where
  attr AriaKeyshortcuts eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-keyshortcuts", value: prop' value })) eventValue)
...
instance Attr G_ AriaKeyshortcuts  String  where
  attr AriaKeyshortcuts value = unsafeAttribute (  
    { key: "aria-keyshortcuts", value: prop' value  } <$ _)
instance Attr G_ AriaKeyshortcuts (Event.Event Unit -> Event.Event  String ) where
  attr AriaKeyshortcuts eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-keyshortcuts", value: prop' value })) eventValue)
...
instance Attr Line_ AriaKeyshortcuts  String  where
  attr AriaKeyshortcuts value = unsafeAttribute (  
    { key: "aria-keyshortcuts", value: prop' value  } <$ _)
instance Attr Line_ AriaKeyshortcuts (Event.Event Unit -> Event.Event  String ) where
  attr AriaKeyshortcuts eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-keyshortcuts", value: prop' value })) eventValue)
...
instance Attr Marker_ AriaKeyshortcuts  String  where
  attr AriaKeyshortcuts value = unsafeAttribute (  
    { key: "aria-keyshortcuts", value: prop' value  } <$ _)
instance Attr Marker_ AriaKeyshortcuts (Event.Event Unit -> Event.Event  String ) where
  attr AriaKeyshortcuts eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-keyshortcuts", value: prop' value })) eventValue)
...
instance Attr Path_ AriaKeyshortcuts  String  where
  attr AriaKeyshortcuts value = unsafeAttribute (  
    { key: "aria-keyshortcuts", value: prop' value  } <$ _)
instance Attr Path_ AriaKeyshortcuts (Event.Event Unit -> Event.Event  String ) where
  attr AriaKeyshortcuts eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-keyshortcuts", value: prop' value })) eventValue)
...
instance Attr Polygon_ AriaKeyshortcuts  String  where
  attr AriaKeyshortcuts value = unsafeAttribute (  
    { key: "aria-keyshortcuts", value: prop' value  } <$ _)
instance Attr Polygon_ AriaKeyshortcuts (Event.Event Unit -> Event.Event  String ) where
  attr AriaKeyshortcuts eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-keyshortcuts", value: prop' value })) eventValue)
...
instance Attr Polyline_ AriaKeyshortcuts  String  where
  attr AriaKeyshortcuts value = unsafeAttribute (  
    { key: "aria-keyshortcuts", value: prop' value  } <$ _)
instance Attr Polyline_ AriaKeyshortcuts (Event.Event Unit -> Event.Event  String ) where
  attr AriaKeyshortcuts eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-keyshortcuts", value: prop' value })) eventValue)
...
instance Attr Rect_ AriaKeyshortcuts  String  where
  attr AriaKeyshortcuts value = unsafeAttribute (  
    { key: "aria-keyshortcuts", value: prop' value  } <$ _)
instance Attr Rect_ AriaKeyshortcuts (Event.Event Unit -> Event.Event  String ) where
  attr AriaKeyshortcuts eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-keyshortcuts", value: prop' value })) eventValue)
...
instance Attr Svg_ AriaKeyshortcuts  String  where
  attr AriaKeyshortcuts value = unsafeAttribute (  
    { key: "aria-keyshortcuts", value: prop' value  } <$ _)
instance Attr Svg_ AriaKeyshortcuts (Event.Event Unit -> Event.Event  String ) where
  attr AriaKeyshortcuts eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-keyshortcuts", value: prop' value })) eventValue)
...
instance Attr Symbol_ AriaKeyshortcuts  String  where
  attr AriaKeyshortcuts value = unsafeAttribute (  
    { key: "aria-keyshortcuts", value: prop' value  } <$ _)
instance Attr Symbol_ AriaKeyshortcuts (Event.Event Unit -> Event.Event  String ) where
  attr AriaKeyshortcuts eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-keyshortcuts", value: prop' value })) eventValue)
...
instance Attr Text_ AriaKeyshortcuts  String  where
  attr AriaKeyshortcuts value = unsafeAttribute (  
    { key: "aria-keyshortcuts", value: prop' value  } <$ _)
instance Attr Text_ AriaKeyshortcuts (Event.Event Unit -> Event.Event  String ) where
  attr AriaKeyshortcuts eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-keyshortcuts", value: prop' value })) eventValue)
...
instance Attr TextPath_ AriaKeyshortcuts  String  where
  attr AriaKeyshortcuts value = unsafeAttribute (  
    { key: "aria-keyshortcuts", value: prop' value  } <$ _)
instance Attr TextPath_ AriaKeyshortcuts (Event.Event Unit -> Event.Event  String ) where
  attr AriaKeyshortcuts eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-keyshortcuts", value: prop' value })) eventValue)
...
instance Attr Tspan_ AriaKeyshortcuts  String  where
  attr AriaKeyshortcuts value = unsafeAttribute (  
    { key: "aria-keyshortcuts", value: prop' value  } <$ _)
instance Attr Tspan_ AriaKeyshortcuts (Event.Event Unit -> Event.Event  String ) where
  attr AriaKeyshortcuts eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-keyshortcuts", value: prop' value })) eventValue)
...
instance Attr Use_ AriaKeyshortcuts  String  where
  attr AriaKeyshortcuts value = unsafeAttribute (  
    { key: "aria-keyshortcuts", value: prop' value  } <$ _)
instance Attr Use_ AriaKeyshortcuts (Event.Event Unit -> Event.Event  String ) where
  attr AriaKeyshortcuts eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-keyshortcuts", value: prop' value })) eventValue)
...
instance Attr View_ AriaKeyshortcuts  String  where
  attr AriaKeyshortcuts value = unsafeAttribute (  
    { key: "aria-keyshortcuts", value: prop' value  } <$ _)
instance Attr View_ AriaKeyshortcuts (Event.Event Unit -> Event.Event  String ) where
  attr AriaKeyshortcuts eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-keyshortcuts", value: prop' value })) eventValue)
...
instance Attr everything AriaKeyshortcuts (Event.Event Unit -> Event.Event  Unit ) where
  attr AriaKeyshortcuts eventValue = unsafeAttribute (map (map ( \_ -> { key: "aria-keyshortcuts", value: unset' })) eventValue)
