...
instance Attr Applet_ Alt (Event.Event Unit -> Event.Event  String ) where
  attr Alt eventValue = unsafeAttribute (map (map ( \value ->
    { key: "alt", value: prop' value })) eventValue)
...
instance Attr Area_ Alt  String  where
  attr Alt value = unsafeAttribute (  { key: "alt", value: prop' value  } <$ _)
instance Attr Area_ Alt (Event.Event Unit -> Event.Event  String ) where
  attr Alt eventValue = unsafeAttribute (map (map ( \value ->
    { key: "alt", value: prop' value })) eventValue)
...
instance Attr Img_ Alt  String  where
  attr Alt value = unsafeAttribute (  { key: "alt", value: prop' value  } <$ _)
instance Attr Img_ Alt (Event.Event Unit -> Event.Event  String ) where
  attr Alt eventValue = unsafeAttribute (map (map ( \value ->
    { key: "alt", value: prop' value })) eventValue)
...
instance Attr Input_ Alt  String  where
  attr Alt value = unsafeAttribute (  { key: "alt", value: prop' value  } <$ _)
instance Attr Input_ Alt (Event.Event Unit -> Event.Event  String ) where
  attr Alt eventValue = unsafeAttribute (map (map ( \value ->
    { key: "alt", value: prop' value })) eventValue)
...
instance Attr everything Alt (Event.Event Unit -> Event.Event  Unit ) where
  attr Alt eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "alt", value: unset' })) eventValue)
