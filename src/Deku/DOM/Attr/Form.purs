...
instance Attr Button_ Form (Event.Event Unit -> Event.Event  String ) where
  attr Form eventValue = unsafeAttribute (map (map ( \value ->
    { key: "form", value: prop' value })) eventValue)
...
instance Attr Fieldset_ Form  String  where
  attr Form value = unsafeAttribute (  
    { key: "form", value: prop' value  } <$ _)
instance Attr Fieldset_ Form (Event.Event Unit -> Event.Event  String ) where
  attr Form eventValue = unsafeAttribute (map (map ( \value ->
    { key: "form", value: prop' value })) eventValue)
...
instance Attr Input_ Form  String  where
  attr Form value = unsafeAttribute (  
    { key: "form", value: prop' value  } <$ _)
instance Attr Input_ Form (Event.Event Unit -> Event.Event  String ) where
  attr Form eventValue = unsafeAttribute (map (map ( \value ->
    { key: "form", value: prop' value })) eventValue)
...
instance Attr Label_ Form  String  where
  attr Form value = unsafeAttribute (  
    { key: "form", value: prop' value  } <$ _)
instance Attr Label_ Form (Event.Event Unit -> Event.Event  String ) where
  attr Form eventValue = unsafeAttribute (map (map ( \value ->
    { key: "form", value: prop' value })) eventValue)
...
instance Attr Meter_ Form  String  where
  attr Form value = unsafeAttribute (  
    { key: "form", value: prop' value  } <$ _)
instance Attr Meter_ Form (Event.Event Unit -> Event.Event  String ) where
  attr Form eventValue = unsafeAttribute (map (map ( \value ->
    { key: "form", value: prop' value })) eventValue)
...
instance Attr Object_ Form  String  where
  attr Form value = unsafeAttribute (  
    { key: "form", value: prop' value  } <$ _)
instance Attr Object_ Form (Event.Event Unit -> Event.Event  String ) where
  attr Form eventValue = unsafeAttribute (map (map ( \value ->
    { key: "form", value: prop' value })) eventValue)
...
instance Attr Output_ Form  String  where
  attr Form value = unsafeAttribute (  
    { key: "form", value: prop' value  } <$ _)
instance Attr Output_ Form (Event.Event Unit -> Event.Event  String ) where
  attr Form eventValue = unsafeAttribute (map (map ( \value ->
    { key: "form", value: prop' value })) eventValue)
...
instance Attr Progress_ Form  String  where
  attr Form value = unsafeAttribute (  
    { key: "form", value: prop' value  } <$ _)
instance Attr Progress_ Form (Event.Event Unit -> Event.Event  String ) where
  attr Form eventValue = unsafeAttribute (map (map ( \value ->
    { key: "form", value: prop' value })) eventValue)
...
instance Attr Select_ Form  String  where
  attr Form value = unsafeAttribute (  
    { key: "form", value: prop' value  } <$ _)
instance Attr Select_ Form (Event.Event Unit -> Event.Event  String ) where
  attr Form eventValue = unsafeAttribute (map (map ( \value ->
    { key: "form", value: prop' value })) eventValue)
...
instance Attr Textarea_ Form  String  where
  attr Form value = unsafeAttribute (  
    { key: "form", value: prop' value  } <$ _)
instance Attr Textarea_ Form (Event.Event Unit -> Event.Event  String ) where
  attr Form eventValue = unsafeAttribute (map (map ( \value ->
    { key: "form", value: prop' value })) eventValue)
...
instance Attr everything Form (Event.Event Unit -> Event.Event  Unit ) where
  attr Form eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "form", value: unset' })) eventValue)
