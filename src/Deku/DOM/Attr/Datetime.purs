...
instance Attr Del_ Datetime (Event.Event Unit -> Event.Event  String ) where
  attr Datetime eventValue = unsafeAttribute (map (map (
    \value -> { key: "datetime", value: prop' value })) eventValue)
...
instance Attr Ins_ Datetime  String  where
  attr Datetime value = unsafeAttribute (  
    { key: "datetime", value: prop' value  } <$ _)
instance Attr Ins_ Datetime (Event.Event Unit -> Event.Event  String ) where
  attr Datetime eventValue = unsafeAttribute (map (map (
    \value -> { key: "datetime", value: prop' value })) eventValue)
...
instance Attr Time_ Datetime  String  where
  attr Datetime value = unsafeAttribute (  
    { key: "datetime", value: prop' value  } <$ _)
instance Attr Time_ Datetime (Event.Event Unit -> Event.Event  String ) where
  attr Datetime eventValue = unsafeAttribute (map (map (
    \value -> { key: "datetime", value: prop' value })) eventValue)
...
instance Attr everything Datetime (Event.Event Unit -> Event.Event  Unit ) where
  attr Datetime eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "datetime", value: unset' })) eventValue)
