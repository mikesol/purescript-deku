...
instance Attr FeBlend_ In  String  where
  attr In value = unsafeAttribute $ This $ { key: "in", value: prop' value }
...
instance Attr FeBlend_ In (ST.ST Global.Global  String ) where
  attr In iValue = unsafeAttribute $ This $ iValue # \value ->
    { key: "in", value: prop' value }
...
instance Attr everything In  Unit  where
  attr In _ = unsafeAttribute $ This $ { key: "in", value: unset' }
...
instance Attr everything In (ST.ST Global.Global  Unit ) where
  attr In iValue = unsafeAttribute $ This $ iValue # \_ ->
    { key: "in", value: unset' }
