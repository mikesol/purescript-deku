...
instance Attr Circle_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr ClipPath_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr ClipPath_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr Defs_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr Defs_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr Ellipse_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr Ellipse_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr FeBlend_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr FeBlend_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr FeColorMatrix_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr FeColorMatrix_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr FeComponentTransfer_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr FeComponentTransfer_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr FeComposite_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr FeComposite_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr FeConvolveMatrix_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr FeConvolveMatrix_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr FeDiffuseLighting_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr FeDiffuseLighting_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr FeDisplacementMap_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr FeDisplacementMap_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr FeFlood_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr FeFlood_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr FeGaussianBlur_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr FeGaussianBlur_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr FeImage_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr FeImage_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr FeMerge_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr FeMerge_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr FeMorphology_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr FeMorphology_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr FeOffset_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr FeOffset_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr FeSpecularLighting_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr FeSpecularLighting_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr FeTile_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr FeTile_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr FeTurbulence_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr FeTurbulence_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr Filter_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr Filter_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr ForeignObject_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr ForeignObject_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr G_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr G_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr Image_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr Image_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr Line_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr Line_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr LinearGradient_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr LinearGradient_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr Marker_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr Marker_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr Mask_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr Mask_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr Path_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr Path_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr Pattern_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr Pattern_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr Polygon_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr Polygon_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr Polyline_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr Polyline_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr RadialGradient_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr RadialGradient_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr Rect_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr Rect_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr Svg_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr Svg_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr Switch_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr Switch_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr Symbol_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr Symbol_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr Text_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr Text_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr TextPath_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr TextPath_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr Tspan_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr Tspan_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr Use_ StrokeDasharray  String  where
  attr StrokeDasharray value = unsafeAttribute (  
    { key: "stroke-dasharray", value: prop' value  } <$ _)
instance Attr Use_ StrokeDasharray (Event.Event Unit -> Event.Event  String ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \value -> { key: "stroke-dasharray", value: prop' value })) eventValue)
...
instance Attr everything StrokeDasharray (Event.Event Unit -> Event.Event  Unit ) where
  attr StrokeDasharray eventValue = unsafeAttribute (map (map ( \_ -> { key: "stroke-dasharray", value: unset' })) eventValue)
