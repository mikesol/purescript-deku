...
instance Attr Circle_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr ClipPath_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr ClipPath_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr Defs_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr Defs_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr Ellipse_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr Ellipse_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr FeBlend_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr FeBlend_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr FeColorMatrix_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr FeColorMatrix_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr FeComponentTransfer_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr FeComponentTransfer_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr FeComposite_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr FeComposite_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr FeConvolveMatrix_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr FeConvolveMatrix_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr FeDiffuseLighting_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr FeDiffuseLighting_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr FeDisplacementMap_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr FeDisplacementMap_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr FeFlood_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr FeFlood_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr FeGaussianBlur_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr FeGaussianBlur_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr FeImage_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr FeImage_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr FeMerge_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr FeMerge_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr FeMorphology_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr FeMorphology_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr FeOffset_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr FeOffset_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr FeSpecularLighting_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr FeSpecularLighting_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr FeTile_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr FeTile_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr FeTurbulence_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr FeTurbulence_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr Filter_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr Filter_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr ForeignObject_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr ForeignObject_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr G_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr G_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr Image_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr Image_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr Line_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr Line_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr LinearGradient_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr LinearGradient_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr Marker_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr Marker_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr Mask_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr Mask_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr Path_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr Path_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr Pattern_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr Pattern_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr Polygon_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr Polygon_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr Polyline_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr Polyline_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr RadialGradient_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr RadialGradient_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr Rect_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr Rect_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr Svg_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr Svg_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr Switch_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr Switch_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr Symbol_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr Symbol_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr Text_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr Text_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr TextPath_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr TextPath_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr Tspan_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr Tspan_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr Use_ Mask  String  where
  attr Mask value = unsafeAttribute (  
    { key: "mask", value: prop' value  } <$ _)
instance Attr Use_ Mask (Event.Event Unit -> Event.Event  String ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \value ->
    { key: "mask", value: prop' value })) eventValue)
...
instance Attr everything Mask (Event.Event Unit -> Event.Event  Unit ) where
  attr Mask eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "mask", value: unset' })) eventValue)
