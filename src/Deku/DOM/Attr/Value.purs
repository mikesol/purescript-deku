...
instance Attr Textarea_ Value (Event.Event Unit -> Event.Event  String ) where
  attr Value eventValue = unsafeAttribute (map (map (
    \value -> { key: "value", value: prop' value })) eventValue)
...
instance Attr Button_ Value  String  where
  attr Value value = unsafeAttribute (  
    { key: "value", value: prop' value  } <$ _)
instance Attr Button_ Value (Event.Event Unit -> Event.Event  String ) where
  attr Value eventValue = unsafeAttribute (map (map (
    \value -> { key: "value", value: prop' value })) eventValue)
...
instance Attr Input_ Value  String  where
  attr Value value = unsafeAttribute (  
    { key: "value", value: prop' value  } <$ _)
instance Attr Input_ Value (Event.Event Unit -> Event.Event  String ) where
  attr Value eventValue = unsafeAttribute (map (map (
    \value -> { key: "value", value: prop' value })) eventValue)
...
instance Attr Li_ Value  String  where
  attr Value value = unsafeAttribute (  
    { key: "value", value: prop' value  } <$ _)
instance Attr Li_ Value (Event.Event Unit -> Event.Event  String ) where
  attr Value eventValue = unsafeAttribute (map (map (
    \value -> { key: "value", value: prop' value })) eventValue)
...
instance Attr Meter_ Value  String  where
  attr Value value = unsafeAttribute (  
    { key: "value", value: prop' value  } <$ _)
instance Attr Meter_ Value (Event.Event Unit -> Event.Event  String ) where
  attr Value eventValue = unsafeAttribute (map (map (
    \value -> { key: "value", value: prop' value })) eventValue)
...
instance Attr Option_ Value  String  where
  attr Value value = unsafeAttribute (  
    { key: "value", value: prop' value  } <$ _)
instance Attr Option_ Value (Event.Event Unit -> Event.Event  String ) where
  attr Value eventValue = unsafeAttribute (map (map (
    \value -> { key: "value", value: prop' value })) eventValue)
...
instance Attr Progress_ Value  String  where
  attr Value value = unsafeAttribute (  
    { key: "value", value: prop' value  } <$ _)
instance Attr Progress_ Value (Event.Event Unit -> Event.Event  String ) where
  attr Value eventValue = unsafeAttribute (map (map (
    \value -> { key: "value", value: prop' value })) eventValue)
...
instance Attr Param_ Value  String  where
  attr Value value = unsafeAttribute (  
    { key: "value", value: prop' value  } <$ _)
instance Attr Param_ Value (Event.Event Unit -> Event.Event  String ) where
  attr Value eventValue = unsafeAttribute (map (map (
    \value -> { key: "value", value: prop' value })) eventValue)
...
instance Attr everything Value (Event.Event Unit -> Event.Event  Unit ) where
  attr Value eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "value", value: unset' })) eventValue)
