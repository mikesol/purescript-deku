...
instance Attr Circle_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr Defs_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr Defs_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr Ellipse_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr Ellipse_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr FeBlend_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr FeBlend_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr FeColorMatrix_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr FeColorMatrix_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr FeComponentTransfer_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr FeComponentTransfer_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr FeComposite_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr FeComposite_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr FeConvolveMatrix_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr FeConvolveMatrix_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr FeDiffuseLighting_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr FeDiffuseLighting_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr FeDisplacementMap_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr FeDisplacementMap_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr FeFlood_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr FeFlood_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr FeGaussianBlur_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr FeGaussianBlur_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr FeImage_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr FeImage_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr FeMerge_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr FeMerge_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr FeMorphology_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr FeMorphology_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr FeOffset_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr FeOffset_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr FeSpecularLighting_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr FeSpecularLighting_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr FeTile_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr FeTile_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr FeTurbulence_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr FeTurbulence_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr Filter_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr Filter_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr ForeignObject_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr ForeignObject_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr G_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr G_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr Image_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr Image_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr Line_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr Line_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr LinearGradient_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr LinearGradient_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr Marker_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr Marker_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr Path_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr Path_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr Pattern_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr Pattern_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr Polygon_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr Polygon_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr Polyline_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr Polyline_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr RadialGradient_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr RadialGradient_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr Rect_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr Rect_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr Svg_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr Svg_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr Switch_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr Switch_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr Symbol_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr Symbol_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr Text_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr Text_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr TextPath_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr TextPath_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr Tspan_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr Tspan_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr Use_ ColorRendering  String  where
  attr ColorRendering value = unsafeAttribute (  
    { key: "color-rendering", value: prop' value  } <$ _)
instance Attr Use_ ColorRendering (Event.Event Unit -> Event.Event  String ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \value -> { key: "color-rendering", value: prop' value })) eventValue)
...
instance Attr everything ColorRendering (Event.Event Unit -> Event.Event  Unit ) where
  attr ColorRendering eventValue = unsafeAttribute (map (map (
    \_ -> { key: "color-rendering", value: unset' })) eventValue)
