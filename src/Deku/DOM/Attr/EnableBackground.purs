...
instance Attr FeBlend_ EnableBackground (Event.Event Unit -> Event.Event  String ) where
  attr EnableBackground eventValue = unsafeAttribute (map (map ( \value -> { key: "enable-background", value: prop' value })) eventValue)
...
instance Attr FeColorMatrix_ EnableBackground  String  where
  attr EnableBackground value = unsafeAttribute (  
    { key: "enable-background", value: prop' value  } <$ _)
instance Attr FeColorMatrix_ EnableBackground (Event.Event Unit -> Event.Event  String ) where
  attr EnableBackground eventValue = unsafeAttribute (map (map ( \value -> { key: "enable-background", value: prop' value })) eventValue)
...
instance Attr FeComponentTransfer_ EnableBackground  String  where
  attr EnableBackground value = unsafeAttribute (  
    { key: "enable-background", value: prop' value  } <$ _)
instance Attr FeComponentTransfer_ EnableBackground (Event.Event Unit -> Event.Event  String ) where
  attr EnableBackground eventValue = unsafeAttribute (map (map ( \value -> { key: "enable-background", value: prop' value })) eventValue)
...
instance Attr FeComposite_ EnableBackground  String  where
  attr EnableBackground value = unsafeAttribute (  
    { key: "enable-background", value: prop' value  } <$ _)
instance Attr FeComposite_ EnableBackground (Event.Event Unit -> Event.Event  String ) where
  attr EnableBackground eventValue = unsafeAttribute (map (map ( \value -> { key: "enable-background", value: prop' value })) eventValue)
...
instance Attr FeConvolveMatrix_ EnableBackground  String  where
  attr EnableBackground value = unsafeAttribute (  
    { key: "enable-background", value: prop' value  } <$ _)
instance Attr FeConvolveMatrix_ EnableBackground (Event.Event Unit -> Event.Event  String ) where
  attr EnableBackground eventValue = unsafeAttribute (map (map ( \value -> { key: "enable-background", value: prop' value })) eventValue)
...
instance Attr FeDiffuseLighting_ EnableBackground  String  where
  attr EnableBackground value = unsafeAttribute (  
    { key: "enable-background", value: prop' value  } <$ _)
instance Attr FeDiffuseLighting_ EnableBackground (Event.Event Unit -> Event.Event  String ) where
  attr EnableBackground eventValue = unsafeAttribute (map (map ( \value -> { key: "enable-background", value: prop' value })) eventValue)
...
instance Attr FeDisplacementMap_ EnableBackground  String  where
  attr EnableBackground value = unsafeAttribute (  
    { key: "enable-background", value: prop' value  } <$ _)
instance Attr FeDisplacementMap_ EnableBackground (Event.Event Unit -> Event.Event  String ) where
  attr EnableBackground eventValue = unsafeAttribute (map (map ( \value -> { key: "enable-background", value: prop' value })) eventValue)
...
instance Attr FeFlood_ EnableBackground  String  where
  attr EnableBackground value = unsafeAttribute (  
    { key: "enable-background", value: prop' value  } <$ _)
instance Attr FeFlood_ EnableBackground (Event.Event Unit -> Event.Event  String ) where
  attr EnableBackground eventValue = unsafeAttribute (map (map ( \value -> { key: "enable-background", value: prop' value })) eventValue)
...
instance Attr FeGaussianBlur_ EnableBackground  String  where
  attr EnableBackground value = unsafeAttribute (  
    { key: "enable-background", value: prop' value  } <$ _)
instance Attr FeGaussianBlur_ EnableBackground (Event.Event Unit -> Event.Event  String ) where
  attr EnableBackground eventValue = unsafeAttribute (map (map ( \value -> { key: "enable-background", value: prop' value })) eventValue)
...
instance Attr FeImage_ EnableBackground  String  where
  attr EnableBackground value = unsafeAttribute (  
    { key: "enable-background", value: prop' value  } <$ _)
instance Attr FeImage_ EnableBackground (Event.Event Unit -> Event.Event  String ) where
  attr EnableBackground eventValue = unsafeAttribute (map (map ( \value -> { key: "enable-background", value: prop' value })) eventValue)
...
instance Attr FeMerge_ EnableBackground  String  where
  attr EnableBackground value = unsafeAttribute (  
    { key: "enable-background", value: prop' value  } <$ _)
instance Attr FeMerge_ EnableBackground (Event.Event Unit -> Event.Event  String ) where
  attr EnableBackground eventValue = unsafeAttribute (map (map ( \value -> { key: "enable-background", value: prop' value })) eventValue)
...
instance Attr FeMorphology_ EnableBackground  String  where
  attr EnableBackground value = unsafeAttribute (  
    { key: "enable-background", value: prop' value  } <$ _)
instance Attr FeMorphology_ EnableBackground (Event.Event Unit -> Event.Event  String ) where
  attr EnableBackground eventValue = unsafeAttribute (map (map ( \value -> { key: "enable-background", value: prop' value })) eventValue)
...
instance Attr FeOffset_ EnableBackground  String  where
  attr EnableBackground value = unsafeAttribute (  
    { key: "enable-background", value: prop' value  } <$ _)
instance Attr FeOffset_ EnableBackground (Event.Event Unit -> Event.Event  String ) where
  attr EnableBackground eventValue = unsafeAttribute (map (map ( \value -> { key: "enable-background", value: prop' value })) eventValue)
...
instance Attr FeSpecularLighting_ EnableBackground  String  where
  attr EnableBackground value = unsafeAttribute (  
    { key: "enable-background", value: prop' value  } <$ _)
instance Attr FeSpecularLighting_ EnableBackground (Event.Event Unit -> Event.Event  String ) where
  attr EnableBackground eventValue = unsafeAttribute (map (map ( \value -> { key: "enable-background", value: prop' value })) eventValue)
...
instance Attr FeTile_ EnableBackground  String  where
  attr EnableBackground value = unsafeAttribute (  
    { key: "enable-background", value: prop' value  } <$ _)
instance Attr FeTile_ EnableBackground (Event.Event Unit -> Event.Event  String ) where
  attr EnableBackground eventValue = unsafeAttribute (map (map ( \value -> { key: "enable-background", value: prop' value })) eventValue)
...
instance Attr FeTurbulence_ EnableBackground  String  where
  attr EnableBackground value = unsafeAttribute (  
    { key: "enable-background", value: prop' value  } <$ _)
instance Attr FeTurbulence_ EnableBackground (Event.Event Unit -> Event.Event  String ) where
  attr EnableBackground eventValue = unsafeAttribute (map (map ( \value -> { key: "enable-background", value: prop' value })) eventValue)
...
instance Attr Filter_ EnableBackground  String  where
  attr EnableBackground value = unsafeAttribute (  
    { key: "enable-background", value: prop' value  } <$ _)
instance Attr Filter_ EnableBackground (Event.Event Unit -> Event.Event  String ) where
  attr EnableBackground eventValue = unsafeAttribute (map (map ( \value -> { key: "enable-background", value: prop' value })) eventValue)
...
instance Attr Image_ EnableBackground  String  where
  attr EnableBackground value = unsafeAttribute (  
    { key: "enable-background", value: prop' value  } <$ _)
instance Attr Image_ EnableBackground (Event.Event Unit -> Event.Event  String ) where
  attr EnableBackground eventValue = unsafeAttribute (map (map ( \value -> { key: "enable-background", value: prop' value })) eventValue)
...
instance Attr Switch_ EnableBackground  String  where
  attr EnableBackground value = unsafeAttribute (  
    { key: "enable-background", value: prop' value  } <$ _)
instance Attr Switch_ EnableBackground (Event.Event Unit -> Event.Event  String ) where
  attr EnableBackground eventValue = unsafeAttribute (map (map ( \value -> { key: "enable-background", value: prop' value })) eventValue)
...
instance Attr everything EnableBackground (Event.Event Unit -> Event.Event  Unit ) where
  attr EnableBackground eventValue = unsafeAttribute (map (map ( \_ -> { key: "enable-background", value: unset' })) eventValue)
