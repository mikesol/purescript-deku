...
instance Attr FeDropShadow_ Dy String where
  attr Dy bothValues = unsafeAttribute $ Both
    { key: "dy", value: prop' (fst bothValues) }
    (snd bothValues <#> \value -> { key: "dy", value: prop' value })
  pureAttr Dy value = unsafeAttribute $ This { key: "dy", value: prop' value }
  unpureAttr Dy eventValue = unsafeAttribute $ That $ eventValue <#> \value ->
...
instance Attr everything Dy Unit where
  attr Dy bothValues = unsafeAttribute $ Both { key: "dy", value: unset' }
    (snd bothValues <#> \_ -> { key: "dy", value: unset' })
  pureAttr Dy _ = unsafeAttribute $ This { key: "dy", value: unset' }
  unpureAttr Dy eventValue = unsafeAttribute $ That $ eventValue <#> \_ ->
    { key: "dy", value: unset' }
