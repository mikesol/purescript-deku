...
instance Attr A_ Target (Event.Event Unit -> Event.Event  String ) where
  attr Target eventValue = unsafeAttribute (map (map (
    \value -> { key: "target", value: prop' value })) eventValue)
...
instance Attr Area_ Target  String  where
  attr Target value = unsafeAttribute (  
    { key: "target", value: prop' value  } <$ _)
instance Attr Area_ Target (Event.Event Unit -> Event.Event  String ) where
  attr Target eventValue = unsafeAttribute (map (map (
    \value -> { key: "target", value: prop' value })) eventValue)
...
instance Attr Base_ Target  String  where
  attr Target value = unsafeAttribute (  
    { key: "target", value: prop' value  } <$ _)
instance Attr Base_ Target (Event.Event Unit -> Event.Event  String ) where
  attr Target eventValue = unsafeAttribute (map (map (
    \value -> { key: "target", value: prop' value })) eventValue)
...
instance Attr Form_ Target  String  where
  attr Target value = unsafeAttribute (  
    { key: "target", value: prop' value  } <$ _)
instance Attr Form_ Target (Event.Event Unit -> Event.Event  String ) where
  attr Target eventValue = unsafeAttribute (map (map (
    \value -> { key: "target", value: prop' value })) eventValue)
...
instance Attr everything Target (Event.Event Unit -> Event.Event  Unit ) where
  attr Target eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "target", value: unset' })) eventValue)
