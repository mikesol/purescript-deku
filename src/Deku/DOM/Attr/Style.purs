...
instance Attr A_ Style String where
  attr Style bothValues  = unsafeAttribute $ Both { key: "style", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "style", value:  prop' value  })
  pureAttr Style value  = unsafeAttribute $ This { key: "style", value:  prop' value  }
  unpureAttr Style eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "style", value:  prop' value  }
...
instance Attr everything Style Unit where
  attr Style bothValues  = unsafeAttribute $ Both { key: "style", value:  unset'  } (snd bothValues <#> \_ -> { key: "style", value:  unset'  })
  pureAttr Style _  = unsafeAttribute $ This { key: "style", value:  unset'  }
  unpureAttr Style eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "style", value:  unset'  }
