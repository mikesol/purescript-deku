...
instance Attr A_ Href (Event.Event Unit -> Event.Event  String ) where
  attr Href eventValue = unsafeAttribute (map (map ( \value ->
    { key: "href", value: prop' value })) eventValue)
...
instance Attr Area_ Href  String  where
  attr Href value = unsafeAttribute (  
    { key: "href", value: prop' value  } <$ _)
instance Attr Area_ Href (Event.Event Unit -> Event.Event  String ) where
  attr Href eventValue = unsafeAttribute (map (map ( \value ->
    { key: "href", value: prop' value })) eventValue)
...
instance Attr Base_ Href  String  where
  attr Href value = unsafeAttribute (  
    { key: "href", value: prop' value  } <$ _)
instance Attr Base_ Href (Event.Event Unit -> Event.Event  String ) where
  attr Href eventValue = unsafeAttribute (map (map ( \value ->
    { key: "href", value: prop' value })) eventValue)
...
instance Attr Link_ Href  String  where
  attr Href value = unsafeAttribute (  
    { key: "href", value: prop' value  } <$ _)
instance Attr Link_ Href (Event.Event Unit -> Event.Event  String ) where
  attr Href eventValue = unsafeAttribute (map (map ( \value ->
    { key: "href", value: prop' value })) eventValue)
...
instance Attr Image_ Href  String  where
  attr Href value = unsafeAttribute (  
    { key: "href", value: prop' value  } <$ _)
instance Attr Image_ Href (Event.Event Unit -> Event.Event  String ) where
  attr Href eventValue = unsafeAttribute (map (map ( \value ->
    { key: "href", value: prop' value })) eventValue)
...
instance Attr LinearGradient_ Href  String  where
  attr Href value = unsafeAttribute (  
    { key: "href", value: prop' value  } <$ _)
instance Attr LinearGradient_ Href (Event.Event Unit -> Event.Event  String ) where
  attr Href eventValue = unsafeAttribute (map (map ( \value ->
    { key: "href", value: prop' value })) eventValue)
...
instance Attr Pattern_ Href  String  where
  attr Href value = unsafeAttribute (  
    { key: "href", value: prop' value  } <$ _)
instance Attr Pattern_ Href (Event.Event Unit -> Event.Event  String ) where
  attr Href eventValue = unsafeAttribute (map (map ( \value ->
    { key: "href", value: prop' value })) eventValue)
...
instance Attr RadialGradient_ Href  String  where
  attr Href value = unsafeAttribute (  
    { key: "href", value: prop' value  } <$ _)
instance Attr RadialGradient_ Href (Event.Event Unit -> Event.Event  String ) where
  attr Href eventValue = unsafeAttribute (map (map ( \value ->
    { key: "href", value: prop' value })) eventValue)
...
instance Attr TextPath_ Href  String  where
  attr Href value = unsafeAttribute (  
    { key: "href", value: prop' value  } <$ _)
instance Attr TextPath_ Href (Event.Event Unit -> Event.Event  String ) where
  attr Href eventValue = unsafeAttribute (map (map ( \value ->
    { key: "href", value: prop' value })) eventValue)
...
instance Attr Use_ Href  String  where
  attr Href value = unsafeAttribute (  
    { key: "href", value: prop' value  } <$ _)
instance Attr Use_ Href (Event.Event Unit -> Event.Event  String ) where
  attr Href eventValue = unsafeAttribute (map (map ( \value ->
    { key: "href", value: prop' value })) eventValue)
...
instance Attr everything Href (Event.Event Unit -> Event.Event  Unit ) where
  attr Href eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "href", value: unset' })) eventValue)
