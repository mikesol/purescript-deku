...
instance Attr Animate_ Accumulate (Event.Event Unit -> Event.Event  String ) where
  attr Accumulate eventValue = unsafeAttribute (map (map (
    \value -> { key: "accumulate", value: prop' value })) eventValue)
...
instance Attr AnimateMotion_ Accumulate  String  where
  attr Accumulate value = unsafeAttribute (  
    { key: "accumulate", value: prop' value  } <$ _)
instance Attr AnimateMotion_ Accumulate (Event.Event Unit -> Event.Event  String ) where
  attr Accumulate eventValue = unsafeAttribute (map (map (
    \value -> { key: "accumulate", value: prop' value })) eventValue)
...
instance Attr AnimateTransform_ Accumulate  String  where
  attr Accumulate value = unsafeAttribute (  
    { key: "accumulate", value: prop' value  } <$ _)
instance Attr AnimateTransform_ Accumulate (Event.Event Unit -> Event.Event  String ) where
  attr Accumulate eventValue = unsafeAttribute (map (map (
    \value -> { key: "accumulate", value: prop' value })) eventValue)
...
instance Attr everything Accumulate (Event.Event Unit -> Event.Event  Unit ) where
  attr Accumulate eventValue = unsafeAttribute (map (map (
    \_ -> { key: "accumulate", value: unset' })) eventValue)
