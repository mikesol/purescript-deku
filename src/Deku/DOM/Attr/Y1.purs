...
instance Attr Line_ Y1  String  where
  attr Y1 value = unsafeAttribute $ This $ { key: "y1", value: prop' value }
...
instance Attr Line_ Y1 (ST.ST Global.Global  String ) where
  attr Y1 iValue = unsafeAttribute $ This $ iValue # \value ->
    { key: "y1", value: prop' value }
...
instance Attr everything Y1  Unit  where
  attr Y1 _ = unsafeAttribute $ This $ { key: "y1", value: unset' }
...
instance Attr everything Y1 (ST.ST Global.Global  Unit ) where
  attr Y1 iValue = unsafeAttribute $ This $ iValue # \_ ->
    { key: "y1", value: unset' }
