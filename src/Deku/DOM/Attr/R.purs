...
instance Attr Circle_ R  String  where
  attr R value = unsafeAttribute $ This $ { key: "r", value: prop' value }
...
instance Attr Circle_ R (ST.ST Global.Global  String ) where
  attr R iValue = unsafeAttribute $ This $ iValue # \value ->
    { key: "r", value: prop' value }
...
instance Attr everything R  Unit  where
  attr R _ = unsafeAttribute $ This $ { key: "r", value: unset' }
...
instance Attr everything R (ST.ST Global.Global  Unit ) where
  attr R iValue = unsafeAttribute $ This $ iValue # \_ ->
    { key: "r", value: unset' }
