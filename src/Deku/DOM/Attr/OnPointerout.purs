...
instance Attr anything OnPointerout (Event.Event Unit -> Event.Event  Cb ) where
  attr OnPointerout eventValue = unsafeAttribute (map (map (
    \value -> { key: "pointerout", value: cb' value })) eventValue)
...
instance Attr anything OnPointerout (Event.Event Unit -> Event.Event  (Effect Unit) ) where
  attr OnPointerout eventValue = unsafeAttribute (map (map (
    \value -> { key: "pointerout", value: cb' (Cb (const (value $> true))) })) eventValue)
...
instance Attr anything OnPointerout (Event.Event Unit -> Event.Event  (Effect Boolean) ) where
  attr OnPointerout eventValue = unsafeAttribute (map (map (
    \value -> { key: "pointerout", value: cb' (Cb (const value)) })) eventValue) 
...
instance Attr everything OnPointerout (Event.Event Unit -> Event.Event  Unit ) where
  attr OnPointerout eventValue = unsafeAttribute (map (map (
    \_ -> { key: "pointerout", value: unset' })) eventValue)
