...
instance Attr FeBlend_ GlyphOrientationVertical (Event.Event Unit -> Event.Event  String ) where
  attr GlyphOrientationVertical eventValue = unsafeAttribute (map (map ( \value ->
      { key: "glyph-orientation-vertical", value: prop' value })) eventValue)
...
instance Attr FeColorMatrix_ GlyphOrientationVertical  String  where
  attr GlyphOrientationVertical value = unsafeAttribute (  
    { key: "glyph-orientation-vertical", value: prop' value  } <$ _)
instance Attr FeColorMatrix_ GlyphOrientationVertical (Event.Event Unit -> Event.Event  String ) where
  attr GlyphOrientationVertical eventValue = unsafeAttribute (map (map ( \value ->
      { key: "glyph-orientation-vertical", value: prop' value })) eventValue)
...
instance Attr FeComponentTransfer_ GlyphOrientationVertical  String  where
  attr GlyphOrientationVertical value = unsafeAttribute (  
    { key: "glyph-orientation-vertical", value: prop' value  } <$ _)
instance Attr FeComponentTransfer_ GlyphOrientationVertical (Event.Event Unit -> Event.Event  String ) where
  attr GlyphOrientationVertical eventValue = unsafeAttribute (map (map ( \value ->
      { key: "glyph-orientation-vertical", value: prop' value })) eventValue)
...
instance Attr FeComposite_ GlyphOrientationVertical  String  where
  attr GlyphOrientationVertical value = unsafeAttribute (  
    { key: "glyph-orientation-vertical", value: prop' value  } <$ _)
instance Attr FeComposite_ GlyphOrientationVertical (Event.Event Unit -> Event.Event  String ) where
  attr GlyphOrientationVertical eventValue = unsafeAttribute (map (map ( \value ->
      { key: "glyph-orientation-vertical", value: prop' value })) eventValue)
...
instance Attr FeConvolveMatrix_ GlyphOrientationVertical  String  where
  attr GlyphOrientationVertical value = unsafeAttribute (  
    { key: "glyph-orientation-vertical", value: prop' value  } <$ _)
instance Attr FeConvolveMatrix_ GlyphOrientationVertical (Event.Event Unit -> Event.Event  String ) where
  attr GlyphOrientationVertical eventValue = unsafeAttribute (map (map ( \value ->
      { key: "glyph-orientation-vertical", value: prop' value })) eventValue)
...
instance Attr FeDiffuseLighting_ GlyphOrientationVertical  String  where
  attr GlyphOrientationVertical value = unsafeAttribute (  
    { key: "glyph-orientation-vertical", value: prop' value  } <$ _)
instance Attr FeDiffuseLighting_ GlyphOrientationVertical (Event.Event Unit -> Event.Event  String ) where
  attr GlyphOrientationVertical eventValue = unsafeAttribute (map (map ( \value ->
      { key: "glyph-orientation-vertical", value: prop' value })) eventValue)
...
instance Attr FeDisplacementMap_ GlyphOrientationVertical  String  where
  attr GlyphOrientationVertical value = unsafeAttribute (  
    { key: "glyph-orientation-vertical", value: prop' value  } <$ _)
instance Attr FeDisplacementMap_ GlyphOrientationVertical (Event.Event Unit -> Event.Event  String ) where
  attr GlyphOrientationVertical eventValue = unsafeAttribute (map (map ( \value ->
      { key: "glyph-orientation-vertical", value: prop' value })) eventValue)
...
instance Attr FeFlood_ GlyphOrientationVertical  String  where
  attr GlyphOrientationVertical value = unsafeAttribute (  
    { key: "glyph-orientation-vertical", value: prop' value  } <$ _)
instance Attr FeFlood_ GlyphOrientationVertical (Event.Event Unit -> Event.Event  String ) where
  attr GlyphOrientationVertical eventValue = unsafeAttribute (map (map ( \value ->
      { key: "glyph-orientation-vertical", value: prop' value })) eventValue)
...
instance Attr FeGaussianBlur_ GlyphOrientationVertical  String  where
  attr GlyphOrientationVertical value = unsafeAttribute (  
    { key: "glyph-orientation-vertical", value: prop' value  } <$ _)
instance Attr FeGaussianBlur_ GlyphOrientationVertical (Event.Event Unit -> Event.Event  String ) where
  attr GlyphOrientationVertical eventValue = unsafeAttribute (map (map ( \value ->
      { key: "glyph-orientation-vertical", value: prop' value })) eventValue)
...
instance Attr FeImage_ GlyphOrientationVertical  String  where
  attr GlyphOrientationVertical value = unsafeAttribute (  
    { key: "glyph-orientation-vertical", value: prop' value  } <$ _)
instance Attr FeImage_ GlyphOrientationVertical (Event.Event Unit -> Event.Event  String ) where
  attr GlyphOrientationVertical eventValue = unsafeAttribute (map (map ( \value ->
      { key: "glyph-orientation-vertical", value: prop' value })) eventValue)
...
instance Attr FeMerge_ GlyphOrientationVertical  String  where
  attr GlyphOrientationVertical value = unsafeAttribute (  
    { key: "glyph-orientation-vertical", value: prop' value  } <$ _)
instance Attr FeMerge_ GlyphOrientationVertical (Event.Event Unit -> Event.Event  String ) where
  attr GlyphOrientationVertical eventValue = unsafeAttribute (map (map ( \value ->
      { key: "glyph-orientation-vertical", value: prop' value })) eventValue)
...
instance Attr FeMorphology_ GlyphOrientationVertical  String  where
  attr GlyphOrientationVertical value = unsafeAttribute (  
    { key: "glyph-orientation-vertical", value: prop' value  } <$ _)
instance Attr FeMorphology_ GlyphOrientationVertical (Event.Event Unit -> Event.Event  String ) where
  attr GlyphOrientationVertical eventValue = unsafeAttribute (map (map ( \value ->
      { key: "glyph-orientation-vertical", value: prop' value })) eventValue)
...
instance Attr FeOffset_ GlyphOrientationVertical  String  where
  attr GlyphOrientationVertical value = unsafeAttribute (  
    { key: "glyph-orientation-vertical", value: prop' value  } <$ _)
instance Attr FeOffset_ GlyphOrientationVertical (Event.Event Unit -> Event.Event  String ) where
  attr GlyphOrientationVertical eventValue = unsafeAttribute (map (map ( \value ->
      { key: "glyph-orientation-vertical", value: prop' value })) eventValue)
...
instance Attr FeSpecularLighting_ GlyphOrientationVertical  String  where
  attr GlyphOrientationVertical value = unsafeAttribute (  
    { key: "glyph-orientation-vertical", value: prop' value  } <$ _)
instance Attr FeSpecularLighting_ GlyphOrientationVertical (Event.Event Unit -> Event.Event  String ) where
  attr GlyphOrientationVertical eventValue = unsafeAttribute (map (map ( \value ->
      { key: "glyph-orientation-vertical", value: prop' value })) eventValue)
...
instance Attr FeTile_ GlyphOrientationVertical  String  where
  attr GlyphOrientationVertical value = unsafeAttribute (  
    { key: "glyph-orientation-vertical", value: prop' value  } <$ _)
instance Attr FeTile_ GlyphOrientationVertical (Event.Event Unit -> Event.Event  String ) where
  attr GlyphOrientationVertical eventValue = unsafeAttribute (map (map ( \value ->
      { key: "glyph-orientation-vertical", value: prop' value })) eventValue)
...
instance Attr FeTurbulence_ GlyphOrientationVertical  String  where
  attr GlyphOrientationVertical value = unsafeAttribute (  
    { key: "glyph-orientation-vertical", value: prop' value  } <$ _)
instance Attr FeTurbulence_ GlyphOrientationVertical (Event.Event Unit -> Event.Event  String ) where
  attr GlyphOrientationVertical eventValue = unsafeAttribute (map (map ( \value ->
      { key: "glyph-orientation-vertical", value: prop' value })) eventValue)
...
instance Attr Filter_ GlyphOrientationVertical  String  where
  attr GlyphOrientationVertical value = unsafeAttribute (  
    { key: "glyph-orientation-vertical", value: prop' value  } <$ _)
instance Attr Filter_ GlyphOrientationVertical (Event.Event Unit -> Event.Event  String ) where
  attr GlyphOrientationVertical eventValue = unsafeAttribute (map (map ( \value ->
      { key: "glyph-orientation-vertical", value: prop' value })) eventValue)
...
instance Attr Image_ GlyphOrientationVertical  String  where
  attr GlyphOrientationVertical value = unsafeAttribute (  
    { key: "glyph-orientation-vertical", value: prop' value  } <$ _)
instance Attr Image_ GlyphOrientationVertical (Event.Event Unit -> Event.Event  String ) where
  attr GlyphOrientationVertical eventValue = unsafeAttribute (map (map ( \value ->
      { key: "glyph-orientation-vertical", value: prop' value })) eventValue)
...
instance Attr Switch_ GlyphOrientationVertical  String  where
  attr GlyphOrientationVertical value = unsafeAttribute (  
    { key: "glyph-orientation-vertical", value: prop' value  } <$ _)
instance Attr Switch_ GlyphOrientationVertical (Event.Event Unit -> Event.Event  String ) where
  attr GlyphOrientationVertical eventValue = unsafeAttribute (map (map ( \value ->
      { key: "glyph-orientation-vertical", value: prop' value })) eventValue)
...
instance Attr everything GlyphOrientationVertical (Event.Event Unit -> Event.Event  Unit ) where
  attr GlyphOrientationVertical eventValue = unsafeAttribute (map (map ( \_ -> { key: "glyph-orientation-vertical", value: unset' })) eventValue)
