...
instance Attr Circle_ AriaValuemax (Event.Event Unit -> Event.Event  String ) where
  attr AriaValuemax eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-valuemax", value: prop' value })) eventValue)
...
instance Attr Ellipse_ AriaValuemax  String  where
  attr AriaValuemax value = unsafeAttribute (  
    { key: "aria-valuemax", value: prop' value  } <$ _)
instance Attr Ellipse_ AriaValuemax (Event.Event Unit -> Event.Event  String ) where
  attr AriaValuemax eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-valuemax", value: prop' value })) eventValue)
...
instance Attr ForeignObject_ AriaValuemax  String  where
  attr AriaValuemax value = unsafeAttribute (  
    { key: "aria-valuemax", value: prop' value  } <$ _)
instance Attr ForeignObject_ AriaValuemax (Event.Event Unit -> Event.Event  String ) where
  attr AriaValuemax eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-valuemax", value: prop' value })) eventValue)
...
instance Attr G_ AriaValuemax  String  where
  attr AriaValuemax value = unsafeAttribute (  
    { key: "aria-valuemax", value: prop' value  } <$ _)
instance Attr G_ AriaValuemax (Event.Event Unit -> Event.Event  String ) where
  attr AriaValuemax eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-valuemax", value: prop' value })) eventValue)
...
instance Attr Line_ AriaValuemax  String  where
  attr AriaValuemax value = unsafeAttribute (  
    { key: "aria-valuemax", value: prop' value  } <$ _)
instance Attr Line_ AriaValuemax (Event.Event Unit -> Event.Event  String ) where
  attr AriaValuemax eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-valuemax", value: prop' value })) eventValue)
...
instance Attr Marker_ AriaValuemax  String  where
  attr AriaValuemax value = unsafeAttribute (  
    { key: "aria-valuemax", value: prop' value  } <$ _)
instance Attr Marker_ AriaValuemax (Event.Event Unit -> Event.Event  String ) where
  attr AriaValuemax eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-valuemax", value: prop' value })) eventValue)
...
instance Attr Path_ AriaValuemax  String  where
  attr AriaValuemax value = unsafeAttribute (  
    { key: "aria-valuemax", value: prop' value  } <$ _)
instance Attr Path_ AriaValuemax (Event.Event Unit -> Event.Event  String ) where
  attr AriaValuemax eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-valuemax", value: prop' value })) eventValue)
...
instance Attr Polygon_ AriaValuemax  String  where
  attr AriaValuemax value = unsafeAttribute (  
    { key: "aria-valuemax", value: prop' value  } <$ _)
instance Attr Polygon_ AriaValuemax (Event.Event Unit -> Event.Event  String ) where
  attr AriaValuemax eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-valuemax", value: prop' value })) eventValue)
...
instance Attr Polyline_ AriaValuemax  String  where
  attr AriaValuemax value = unsafeAttribute (  
    { key: "aria-valuemax", value: prop' value  } <$ _)
instance Attr Polyline_ AriaValuemax (Event.Event Unit -> Event.Event  String ) where
  attr AriaValuemax eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-valuemax", value: prop' value })) eventValue)
...
instance Attr Rect_ AriaValuemax  String  where
  attr AriaValuemax value = unsafeAttribute (  
    { key: "aria-valuemax", value: prop' value  } <$ _)
instance Attr Rect_ AriaValuemax (Event.Event Unit -> Event.Event  String ) where
  attr AriaValuemax eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-valuemax", value: prop' value })) eventValue)
...
instance Attr Svg_ AriaValuemax  String  where
  attr AriaValuemax value = unsafeAttribute (  
    { key: "aria-valuemax", value: prop' value  } <$ _)
instance Attr Svg_ AriaValuemax (Event.Event Unit -> Event.Event  String ) where
  attr AriaValuemax eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-valuemax", value: prop' value })) eventValue)
...
instance Attr Symbol_ AriaValuemax  String  where
  attr AriaValuemax value = unsafeAttribute (  
    { key: "aria-valuemax", value: prop' value  } <$ _)
instance Attr Symbol_ AriaValuemax (Event.Event Unit -> Event.Event  String ) where
  attr AriaValuemax eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-valuemax", value: prop' value })) eventValue)
...
instance Attr Text_ AriaValuemax  String  where
  attr AriaValuemax value = unsafeAttribute (  
    { key: "aria-valuemax", value: prop' value  } <$ _)
instance Attr Text_ AriaValuemax (Event.Event Unit -> Event.Event  String ) where
  attr AriaValuemax eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-valuemax", value: prop' value })) eventValue)
...
instance Attr TextPath_ AriaValuemax  String  where
  attr AriaValuemax value = unsafeAttribute (  
    { key: "aria-valuemax", value: prop' value  } <$ _)
instance Attr TextPath_ AriaValuemax (Event.Event Unit -> Event.Event  String ) where
  attr AriaValuemax eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-valuemax", value: prop' value })) eventValue)
...
instance Attr Tspan_ AriaValuemax  String  where
  attr AriaValuemax value = unsafeAttribute (  
    { key: "aria-valuemax", value: prop' value  } <$ _)
instance Attr Tspan_ AriaValuemax (Event.Event Unit -> Event.Event  String ) where
  attr AriaValuemax eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-valuemax", value: prop' value })) eventValue)
...
instance Attr Use_ AriaValuemax  String  where
  attr AriaValuemax value = unsafeAttribute (  
    { key: "aria-valuemax", value: prop' value  } <$ _)
instance Attr Use_ AriaValuemax (Event.Event Unit -> Event.Event  String ) where
  attr AriaValuemax eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-valuemax", value: prop' value })) eventValue)
...
instance Attr View_ AriaValuemax  String  where
  attr AriaValuemax value = unsafeAttribute (  
    { key: "aria-valuemax", value: prop' value  } <$ _)
instance Attr View_ AriaValuemax (Event.Event Unit -> Event.Event  String ) where
  attr AriaValuemax eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-valuemax", value: prop' value })) eventValue)
...
instance Attr everything AriaValuemax (Event.Event Unit -> Event.Event  Unit ) where
  attr AriaValuemax eventValue = unsafeAttribute (map (map (
    \_ -> { key: "aria-valuemax", value: unset' })) eventValue)
