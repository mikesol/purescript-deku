...
instance Attr FeBlend_ TransformOrigin (Event.Event Unit -> Event.Event  String ) where
  attr TransformOrigin eventValue = unsafeAttribute (map (map ( \value -> { key: "transform-origin", value: prop' value })) eventValue)
...
instance Attr FeColorMatrix_ TransformOrigin  String  where
  attr TransformOrigin value = unsafeAttribute (  
    { key: "transform-origin", value: prop' value  } <$ _)
instance Attr FeColorMatrix_ TransformOrigin (Event.Event Unit -> Event.Event  String ) where
  attr TransformOrigin eventValue = unsafeAttribute (map (map ( \value -> { key: "transform-origin", value: prop' value })) eventValue)
...
instance Attr FeComponentTransfer_ TransformOrigin  String  where
  attr TransformOrigin value = unsafeAttribute (  
    { key: "transform-origin", value: prop' value  } <$ _)
instance Attr FeComponentTransfer_ TransformOrigin (Event.Event Unit -> Event.Event  String ) where
  attr TransformOrigin eventValue = unsafeAttribute (map (map ( \value -> { key: "transform-origin", value: prop' value })) eventValue)
...
instance Attr FeComposite_ TransformOrigin  String  where
  attr TransformOrigin value = unsafeAttribute (  
    { key: "transform-origin", value: prop' value  } <$ _)
instance Attr FeComposite_ TransformOrigin (Event.Event Unit -> Event.Event  String ) where
  attr TransformOrigin eventValue = unsafeAttribute (map (map ( \value -> { key: "transform-origin", value: prop' value })) eventValue)
...
instance Attr FeConvolveMatrix_ TransformOrigin  String  where
  attr TransformOrigin value = unsafeAttribute (  
    { key: "transform-origin", value: prop' value  } <$ _)
instance Attr FeConvolveMatrix_ TransformOrigin (Event.Event Unit -> Event.Event  String ) where
  attr TransformOrigin eventValue = unsafeAttribute (map (map ( \value -> { key: "transform-origin", value: prop' value })) eventValue)
...
instance Attr FeDiffuseLighting_ TransformOrigin  String  where
  attr TransformOrigin value = unsafeAttribute (  
    { key: "transform-origin", value: prop' value  } <$ _)
instance Attr FeDiffuseLighting_ TransformOrigin (Event.Event Unit -> Event.Event  String ) where
  attr TransformOrigin eventValue = unsafeAttribute (map (map ( \value -> { key: "transform-origin", value: prop' value })) eventValue)
...
instance Attr FeDisplacementMap_ TransformOrigin  String  where
  attr TransformOrigin value = unsafeAttribute (  
    { key: "transform-origin", value: prop' value  } <$ _)
instance Attr FeDisplacementMap_ TransformOrigin (Event.Event Unit -> Event.Event  String ) where
  attr TransformOrigin eventValue = unsafeAttribute (map (map ( \value -> { key: "transform-origin", value: prop' value })) eventValue)
...
instance Attr FeFlood_ TransformOrigin  String  where
  attr TransformOrigin value = unsafeAttribute (  
    { key: "transform-origin", value: prop' value  } <$ _)
instance Attr FeFlood_ TransformOrigin (Event.Event Unit -> Event.Event  String ) where
  attr TransformOrigin eventValue = unsafeAttribute (map (map ( \value -> { key: "transform-origin", value: prop' value })) eventValue)
...
instance Attr FeGaussianBlur_ TransformOrigin  String  where
  attr TransformOrigin value = unsafeAttribute (  
    { key: "transform-origin", value: prop' value  } <$ _)
instance Attr FeGaussianBlur_ TransformOrigin (Event.Event Unit -> Event.Event  String ) where
  attr TransformOrigin eventValue = unsafeAttribute (map (map ( \value -> { key: "transform-origin", value: prop' value })) eventValue)
...
instance Attr FeImage_ TransformOrigin  String  where
  attr TransformOrigin value = unsafeAttribute (  
    { key: "transform-origin", value: prop' value  } <$ _)
instance Attr FeImage_ TransformOrigin (Event.Event Unit -> Event.Event  String ) where
  attr TransformOrigin eventValue = unsafeAttribute (map (map ( \value -> { key: "transform-origin", value: prop' value })) eventValue)
...
instance Attr FeMerge_ TransformOrigin  String  where
  attr TransformOrigin value = unsafeAttribute (  
    { key: "transform-origin", value: prop' value  } <$ _)
instance Attr FeMerge_ TransformOrigin (Event.Event Unit -> Event.Event  String ) where
  attr TransformOrigin eventValue = unsafeAttribute (map (map ( \value -> { key: "transform-origin", value: prop' value })) eventValue)
...
instance Attr FeMorphology_ TransformOrigin  String  where
  attr TransformOrigin value = unsafeAttribute (  
    { key: "transform-origin", value: prop' value  } <$ _)
instance Attr FeMorphology_ TransformOrigin (Event.Event Unit -> Event.Event  String ) where
  attr TransformOrigin eventValue = unsafeAttribute (map (map ( \value -> { key: "transform-origin", value: prop' value })) eventValue)
...
instance Attr FeOffset_ TransformOrigin  String  where
  attr TransformOrigin value = unsafeAttribute (  
    { key: "transform-origin", value: prop' value  } <$ _)
instance Attr FeOffset_ TransformOrigin (Event.Event Unit -> Event.Event  String ) where
  attr TransformOrigin eventValue = unsafeAttribute (map (map ( \value -> { key: "transform-origin", value: prop' value })) eventValue)
...
instance Attr FeSpecularLighting_ TransformOrigin  String  where
  attr TransformOrigin value = unsafeAttribute (  
    { key: "transform-origin", value: prop' value  } <$ _)
instance Attr FeSpecularLighting_ TransformOrigin (Event.Event Unit -> Event.Event  String ) where
  attr TransformOrigin eventValue = unsafeAttribute (map (map ( \value -> { key: "transform-origin", value: prop' value })) eventValue)
...
instance Attr FeTile_ TransformOrigin  String  where
  attr TransformOrigin value = unsafeAttribute (  
    { key: "transform-origin", value: prop' value  } <$ _)
instance Attr FeTile_ TransformOrigin (Event.Event Unit -> Event.Event  String ) where
  attr TransformOrigin eventValue = unsafeAttribute (map (map ( \value -> { key: "transform-origin", value: prop' value })) eventValue)
...
instance Attr FeTurbulence_ TransformOrigin  String  where
  attr TransformOrigin value = unsafeAttribute (  
    { key: "transform-origin", value: prop' value  } <$ _)
instance Attr FeTurbulence_ TransformOrigin (Event.Event Unit -> Event.Event  String ) where
  attr TransformOrigin eventValue = unsafeAttribute (map (map ( \value -> { key: "transform-origin", value: prop' value })) eventValue)
...
instance Attr Filter_ TransformOrigin  String  where
  attr TransformOrigin value = unsafeAttribute (  
    { key: "transform-origin", value: prop' value  } <$ _)
instance Attr Filter_ TransformOrigin (Event.Event Unit -> Event.Event  String ) where
  attr TransformOrigin eventValue = unsafeAttribute (map (map ( \value -> { key: "transform-origin", value: prop' value })) eventValue)
...
instance Attr Image_ TransformOrigin  String  where
  attr TransformOrigin value = unsafeAttribute (  
    { key: "transform-origin", value: prop' value  } <$ _)
instance Attr Image_ TransformOrigin (Event.Event Unit -> Event.Event  String ) where
  attr TransformOrigin eventValue = unsafeAttribute (map (map ( \value -> { key: "transform-origin", value: prop' value })) eventValue)
...
instance Attr Switch_ TransformOrigin  String  where
  attr TransformOrigin value = unsafeAttribute (  
    { key: "transform-origin", value: prop' value  } <$ _)
instance Attr Switch_ TransformOrigin (Event.Event Unit -> Event.Event  String ) where
  attr TransformOrigin eventValue = unsafeAttribute (map (map ( \value -> { key: "transform-origin", value: prop' value })) eventValue)
...
instance Attr everything TransformOrigin (Event.Event Unit -> Event.Event  Unit ) where
  attr TransformOrigin eventValue = unsafeAttribute (map (map ( \_ -> { key: "transform-origin", value: unset' })) eventValue)
