...
instance Attr Circle_ AriaInvalid String where
  attr AriaInvalid bothValues  = unsafeAttribute $ Both { key: "aria-invalid", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "aria-invalid", value:  prop' value  })
  pureAttr AriaInvalid value  = unsafeAttribute $ This { key: "aria-invalid", value:  prop' value  }
  unpureAttr AriaInvalid eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "aria-invalid", value:  prop' value  }
...
instance Attr everything AriaInvalid Unit where
  attr AriaInvalid bothValues  = unsafeAttribute $ Both { key: "aria-invalid", value:  unset'  } (snd bothValues <#> \_ -> { key: "aria-invalid", value:  unset'  })
  pureAttr AriaInvalid _  = unsafeAttribute $ This { key: "aria-invalid", value:  unset'  }
  unpureAttr AriaInvalid eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "aria-invalid", value:  unset'  }
