...
instance Attr Circle_ AriaSelected String where
  attr AriaSelected bothValues  = unsafeAttribute $ Both { key: "aria-selected", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "aria-selected", value:  prop' value  })
  pureAttr AriaSelected value  = unsafeAttribute $ This { key: "aria-selected", value:  prop' value  }
  unpureAttr AriaSelected eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "aria-selected", value:  prop' value  }
...
instance Attr everything AriaSelected Unit where
  attr AriaSelected bothValues  = unsafeAttribute $ Both { key: "aria-selected", value:  unset'  } (snd bothValues <#> \_ -> { key: "aria-selected", value:  unset'  })
  pureAttr AriaSelected _  = unsafeAttribute $ This { key: "aria-selected", value:  unset'  }
  unpureAttr AriaSelected eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "aria-selected", value:  unset'  }
