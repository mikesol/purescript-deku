...
instance Attr anything OnPointerlockerror (Event.Event Unit -> Event.Event  Cb ) where
  attr OnPointerlockerror eventValue = unsafeAttribute (map (map ( \value -> { key: "pointerlockerror", value: cb' value })) eventValue)
...
instance Attr anything OnPointerlockerror (Event.Event Unit -> Event.Event  (Effect Unit) ) where
  attr OnPointerlockerror eventValue = unsafeAttribute (map (map ( \value ->
      { key: "pointerlockerror", value: cb' (Cb (const (value $> true))) })) eventValue)
...
instance Attr anything OnPointerlockerror (Event.Event Unit -> Event.Event  (Effect Boolean) ) where
  attr OnPointerlockerror eventValue = unsafeAttribute (map (map ( \value -> { key: "pointerlockerror", value: cb' (Cb (const value)) })) eventValue) 
...
instance Attr everything OnPointerlockerror (Event.Event Unit -> Event.Event  Unit ) where
  attr OnPointerlockerror eventValue = unsafeAttribute (map (map ( \_ -> { key: "pointerlockerror", value: unset' })) eventValue)
