...
instance Attr Circle_ AriaLabelledby (Event.Event Unit -> Event.Event  String ) where
  attr AriaLabelledby eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-labelledby", value: prop' value })) eventValue)
...
instance Attr Ellipse_ AriaLabelledby  String  where
  attr AriaLabelledby value = unsafeAttribute (  
    { key: "aria-labelledby", value: prop' value  } <$ _)
instance Attr Ellipse_ AriaLabelledby (Event.Event Unit -> Event.Event  String ) where
  attr AriaLabelledby eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-labelledby", value: prop' value })) eventValue)
...
instance Attr ForeignObject_ AriaLabelledby  String  where
  attr AriaLabelledby value = unsafeAttribute (  
    { key: "aria-labelledby", value: prop' value  } <$ _)
instance Attr ForeignObject_ AriaLabelledby (Event.Event Unit -> Event.Event  String ) where
  attr AriaLabelledby eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-labelledby", value: prop' value })) eventValue)
...
instance Attr G_ AriaLabelledby  String  where
  attr AriaLabelledby value = unsafeAttribute (  
    { key: "aria-labelledby", value: prop' value  } <$ _)
instance Attr G_ AriaLabelledby (Event.Event Unit -> Event.Event  String ) where
  attr AriaLabelledby eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-labelledby", value: prop' value })) eventValue)
...
instance Attr Line_ AriaLabelledby  String  where
  attr AriaLabelledby value = unsafeAttribute (  
    { key: "aria-labelledby", value: prop' value  } <$ _)
instance Attr Line_ AriaLabelledby (Event.Event Unit -> Event.Event  String ) where
  attr AriaLabelledby eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-labelledby", value: prop' value })) eventValue)
...
instance Attr Marker_ AriaLabelledby  String  where
  attr AriaLabelledby value = unsafeAttribute (  
    { key: "aria-labelledby", value: prop' value  } <$ _)
instance Attr Marker_ AriaLabelledby (Event.Event Unit -> Event.Event  String ) where
  attr AriaLabelledby eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-labelledby", value: prop' value })) eventValue)
...
instance Attr Path_ AriaLabelledby  String  where
  attr AriaLabelledby value = unsafeAttribute (  
    { key: "aria-labelledby", value: prop' value  } <$ _)
instance Attr Path_ AriaLabelledby (Event.Event Unit -> Event.Event  String ) where
  attr AriaLabelledby eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-labelledby", value: prop' value })) eventValue)
...
instance Attr Polygon_ AriaLabelledby  String  where
  attr AriaLabelledby value = unsafeAttribute (  
    { key: "aria-labelledby", value: prop' value  } <$ _)
instance Attr Polygon_ AriaLabelledby (Event.Event Unit -> Event.Event  String ) where
  attr AriaLabelledby eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-labelledby", value: prop' value })) eventValue)
...
instance Attr Polyline_ AriaLabelledby  String  where
  attr AriaLabelledby value = unsafeAttribute (  
    { key: "aria-labelledby", value: prop' value  } <$ _)
instance Attr Polyline_ AriaLabelledby (Event.Event Unit -> Event.Event  String ) where
  attr AriaLabelledby eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-labelledby", value: prop' value })) eventValue)
...
instance Attr Rect_ AriaLabelledby  String  where
  attr AriaLabelledby value = unsafeAttribute (  
    { key: "aria-labelledby", value: prop' value  } <$ _)
instance Attr Rect_ AriaLabelledby (Event.Event Unit -> Event.Event  String ) where
  attr AriaLabelledby eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-labelledby", value: prop' value })) eventValue)
...
instance Attr Svg_ AriaLabelledby  String  where
  attr AriaLabelledby value = unsafeAttribute (  
    { key: "aria-labelledby", value: prop' value  } <$ _)
instance Attr Svg_ AriaLabelledby (Event.Event Unit -> Event.Event  String ) where
  attr AriaLabelledby eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-labelledby", value: prop' value })) eventValue)
...
instance Attr Symbol_ AriaLabelledby  String  where
  attr AriaLabelledby value = unsafeAttribute (  
    { key: "aria-labelledby", value: prop' value  } <$ _)
instance Attr Symbol_ AriaLabelledby (Event.Event Unit -> Event.Event  String ) where
  attr AriaLabelledby eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-labelledby", value: prop' value })) eventValue)
...
instance Attr Text_ AriaLabelledby  String  where
  attr AriaLabelledby value = unsafeAttribute (  
    { key: "aria-labelledby", value: prop' value  } <$ _)
instance Attr Text_ AriaLabelledby (Event.Event Unit -> Event.Event  String ) where
  attr AriaLabelledby eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-labelledby", value: prop' value })) eventValue)
...
instance Attr TextPath_ AriaLabelledby  String  where
  attr AriaLabelledby value = unsafeAttribute (  
    { key: "aria-labelledby", value: prop' value  } <$ _)
instance Attr TextPath_ AriaLabelledby (Event.Event Unit -> Event.Event  String ) where
  attr AriaLabelledby eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-labelledby", value: prop' value })) eventValue)
...
instance Attr Tspan_ AriaLabelledby  String  where
  attr AriaLabelledby value = unsafeAttribute (  
    { key: "aria-labelledby", value: prop' value  } <$ _)
instance Attr Tspan_ AriaLabelledby (Event.Event Unit -> Event.Event  String ) where
  attr AriaLabelledby eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-labelledby", value: prop' value })) eventValue)
...
instance Attr Use_ AriaLabelledby  String  where
  attr AriaLabelledby value = unsafeAttribute (  
    { key: "aria-labelledby", value: prop' value  } <$ _)
instance Attr Use_ AriaLabelledby (Event.Event Unit -> Event.Event  String ) where
  attr AriaLabelledby eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-labelledby", value: prop' value })) eventValue)
...
instance Attr View_ AriaLabelledby  String  where
  attr AriaLabelledby value = unsafeAttribute (  
    { key: "aria-labelledby", value: prop' value  } <$ _)
instance Attr View_ AriaLabelledby (Event.Event Unit -> Event.Event  String ) where
  attr AriaLabelledby eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-labelledby", value: prop' value })) eventValue)
...
instance Attr everything AriaLabelledby (Event.Event Unit -> Event.Event  Unit ) where
  attr AriaLabelledby eventValue = unsafeAttribute (map (map (
    \_ -> { key: "aria-labelledby", value: unset' })) eventValue)
