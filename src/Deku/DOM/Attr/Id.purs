...
instance Attr A_ Id  String  where
  attr Id value = unsafeAttribute $ This $ pure $ { key: "id", value: prop' value }
...
instance Attr A_ Id (ST.ST Global.Global  String ) where
  attr Id stValue = unsafeAttribute $ This $ stValue <#> \value ->
    { key: "id", value: prop' value }
...
instance Attr everything Id  Unit  where
  attr Id _ = unsafeAttribute $ This $ pure $ { key: "id", value: unset' }
...
instance Attr everything Id (ST.ST Global.Global  Unit ) where
  attr Id stValue = unsafeAttribute $ This $ stValue <#> \_ ->
    { key: "id", value: unset' }
