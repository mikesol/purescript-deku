...
instance Attr A_ Id String where
  attr Id bothValues  = unsafeAttribute $ Both { key: "id", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "id", value:  prop' value  })
  pureAttr Id value  = unsafeAttribute $ This { key: "id", value:  prop' value  }
  unpureAttr Id eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "id", value:  prop' value  }
...
instance Attr everything Id Unit where
  attr Id bothValues  = unsafeAttribute $ Both { key: "id", value:  unset'  } (snd bothValues <#> \_ -> { key: "id", value:  unset'  })
  pureAttr Id _  = unsafeAttribute $ This { key: "id", value:  unset'  }
  unpureAttr Id eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "id", value:  unset'  }
