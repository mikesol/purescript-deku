...
instance Attr Animate_ Additive (Event.Event Unit -> Event.Event  String ) where
  attr Additive eventValue = unsafeAttribute (map (map (
    \value -> { key: "additive", value: prop' value })) eventValue)
...
instance Attr AnimateMotion_ Additive  String  where
  attr Additive value = unsafeAttribute (  
    { key: "additive", value: prop' value  } <$ _)
instance Attr AnimateMotion_ Additive (Event.Event Unit -> Event.Event  String ) where
  attr Additive eventValue = unsafeAttribute (map (map (
    \value -> { key: "additive", value: prop' value })) eventValue)
...
instance Attr AnimateTransform_ Additive  String  where
  attr Additive value = unsafeAttribute (  
    { key: "additive", value: prop' value  } <$ _)
instance Attr AnimateTransform_ Additive (Event.Event Unit -> Event.Event  String ) where
  attr Additive eventValue = unsafeAttribute (map (map (
    \value -> { key: "additive", value: prop' value })) eventValue)
...
instance Attr everything Additive (Event.Event Unit -> Event.Event  Unit ) where
  attr Additive eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "additive", value: unset' })) eventValue)
