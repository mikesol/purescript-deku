...
instance Attr Form_ Method (Event.Event Unit -> Event.Event  String ) where
  attr Method eventValue = unsafeAttribute (map (map (
    \value -> { key: "method", value: prop' value })) eventValue)
...
instance Attr TextPath_ Method  String  where
  attr Method value = unsafeAttribute (  
    { key: "method", value: prop' value  } <$ _)
instance Attr TextPath_ Method (Event.Event Unit -> Event.Event  String ) where
  attr Method eventValue = unsafeAttribute (map (map (
    \value -> { key: "method", value: prop' value })) eventValue)
...
instance Attr everything Method (Event.Event Unit -> Event.Event  Unit ) where
  attr Method eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "method", value: unset' })) eventValue)
