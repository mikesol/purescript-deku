...
instance Attr Circle_ Opacity String where
  attr Opacity bothValues  = unsafeAttribute $ Both { key: "opacity", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "opacity", value:  prop' value  })
  pureAttr Opacity value  = unsafeAttribute $ This { key: "opacity", value:  prop' value  }
  unpureAttr Opacity eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "opacity", value:  prop' value  }
...
instance Attr everything Opacity Unit where
  attr Opacity bothValues  = unsafeAttribute $ Both { key: "opacity", value:  unset'  } (snd bothValues <#> \_ -> { key: "opacity", value:  unset'  })
  pureAttr Opacity _  = unsafeAttribute $ This { key: "opacity", value:  unset'  }
  unpureAttr Opacity eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "opacity", value:  unset'  }
