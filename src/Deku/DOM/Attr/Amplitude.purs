...
instance Attr FeFuncA_ Amplitude (Event.Event Unit -> Event.Event  String ) where
  attr Amplitude eventValue = unsafeAttribute (map (map (
    \value -> { key: "amplitude", value: prop' value })) eventValue)
...
instance Attr FeFuncB_ Amplitude  String  where
  attr Amplitude value = unsafeAttribute (  
    { key: "amplitude", value: prop' value  } <$ _)
instance Attr FeFuncB_ Amplitude (Event.Event Unit -> Event.Event  String ) where
  attr Amplitude eventValue = unsafeAttribute (map (map (
    \value -> { key: "amplitude", value: prop' value })) eventValue)
...
instance Attr FeFuncG_ Amplitude  String  where
  attr Amplitude value = unsafeAttribute (  
    { key: "amplitude", value: prop' value  } <$ _)
instance Attr FeFuncG_ Amplitude (Event.Event Unit -> Event.Event  String ) where
  attr Amplitude eventValue = unsafeAttribute (map (map (
    \value -> { key: "amplitude", value: prop' value })) eventValue)
...
instance Attr FeFuncR_ Amplitude  String  where
  attr Amplitude value = unsafeAttribute (  
    { key: "amplitude", value: prop' value  } <$ _)
instance Attr FeFuncR_ Amplitude (Event.Event Unit -> Event.Event  String ) where
  attr Amplitude eventValue = unsafeAttribute (map (map (
    \value -> { key: "amplitude", value: prop' value })) eventValue)
...
instance Attr everything Amplitude (Event.Event Unit -> Event.Event  Unit ) where
  attr Amplitude eventValue = unsafeAttribute (map (map (
    \_ -> { key: "amplitude", value: unset' })) eventValue)
