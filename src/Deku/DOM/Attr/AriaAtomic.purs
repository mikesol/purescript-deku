...
instance Attr Circle_ AriaAtomic (Event.Event Unit -> Event.Event  String ) where
  attr AriaAtomic eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-atomic", value: prop' value })) eventValue)
...
instance Attr Ellipse_ AriaAtomic  String  where
  attr AriaAtomic value = unsafeAttribute (  
    { key: "aria-atomic", value: prop' value  } <$ _)
instance Attr Ellipse_ AriaAtomic (Event.Event Unit -> Event.Event  String ) where
  attr AriaAtomic eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-atomic", value: prop' value })) eventValue)
...
instance Attr ForeignObject_ AriaAtomic  String  where
  attr AriaAtomic value = unsafeAttribute (  
    { key: "aria-atomic", value: prop' value  } <$ _)
instance Attr ForeignObject_ AriaAtomic (Event.Event Unit -> Event.Event  String ) where
  attr AriaAtomic eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-atomic", value: prop' value })) eventValue)
...
instance Attr G_ AriaAtomic  String  where
  attr AriaAtomic value = unsafeAttribute (  
    { key: "aria-atomic", value: prop' value  } <$ _)
instance Attr G_ AriaAtomic (Event.Event Unit -> Event.Event  String ) where
  attr AriaAtomic eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-atomic", value: prop' value })) eventValue)
...
instance Attr Line_ AriaAtomic  String  where
  attr AriaAtomic value = unsafeAttribute (  
    { key: "aria-atomic", value: prop' value  } <$ _)
instance Attr Line_ AriaAtomic (Event.Event Unit -> Event.Event  String ) where
  attr AriaAtomic eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-atomic", value: prop' value })) eventValue)
...
instance Attr Marker_ AriaAtomic  String  where
  attr AriaAtomic value = unsafeAttribute (  
    { key: "aria-atomic", value: prop' value  } <$ _)
instance Attr Marker_ AriaAtomic (Event.Event Unit -> Event.Event  String ) where
  attr AriaAtomic eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-atomic", value: prop' value })) eventValue)
...
instance Attr Path_ AriaAtomic  String  where
  attr AriaAtomic value = unsafeAttribute (  
    { key: "aria-atomic", value: prop' value  } <$ _)
instance Attr Path_ AriaAtomic (Event.Event Unit -> Event.Event  String ) where
  attr AriaAtomic eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-atomic", value: prop' value })) eventValue)
...
instance Attr Polygon_ AriaAtomic  String  where
  attr AriaAtomic value = unsafeAttribute (  
    { key: "aria-atomic", value: prop' value  } <$ _)
instance Attr Polygon_ AriaAtomic (Event.Event Unit -> Event.Event  String ) where
  attr AriaAtomic eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-atomic", value: prop' value })) eventValue)
...
instance Attr Polyline_ AriaAtomic  String  where
  attr AriaAtomic value = unsafeAttribute (  
    { key: "aria-atomic", value: prop' value  } <$ _)
instance Attr Polyline_ AriaAtomic (Event.Event Unit -> Event.Event  String ) where
  attr AriaAtomic eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-atomic", value: prop' value })) eventValue)
...
instance Attr Rect_ AriaAtomic  String  where
  attr AriaAtomic value = unsafeAttribute (  
    { key: "aria-atomic", value: prop' value  } <$ _)
instance Attr Rect_ AriaAtomic (Event.Event Unit -> Event.Event  String ) where
  attr AriaAtomic eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-atomic", value: prop' value })) eventValue)
...
instance Attr Svg_ AriaAtomic  String  where
  attr AriaAtomic value = unsafeAttribute (  
    { key: "aria-atomic", value: prop' value  } <$ _)
instance Attr Svg_ AriaAtomic (Event.Event Unit -> Event.Event  String ) where
  attr AriaAtomic eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-atomic", value: prop' value })) eventValue)
...
instance Attr Symbol_ AriaAtomic  String  where
  attr AriaAtomic value = unsafeAttribute (  
    { key: "aria-atomic", value: prop' value  } <$ _)
instance Attr Symbol_ AriaAtomic (Event.Event Unit -> Event.Event  String ) where
  attr AriaAtomic eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-atomic", value: prop' value })) eventValue)
...
instance Attr Text_ AriaAtomic  String  where
  attr AriaAtomic value = unsafeAttribute (  
    { key: "aria-atomic", value: prop' value  } <$ _)
instance Attr Text_ AriaAtomic (Event.Event Unit -> Event.Event  String ) where
  attr AriaAtomic eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-atomic", value: prop' value })) eventValue)
...
instance Attr TextPath_ AriaAtomic  String  where
  attr AriaAtomic value = unsafeAttribute (  
    { key: "aria-atomic", value: prop' value  } <$ _)
instance Attr TextPath_ AriaAtomic (Event.Event Unit -> Event.Event  String ) where
  attr AriaAtomic eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-atomic", value: prop' value })) eventValue)
...
instance Attr Tspan_ AriaAtomic  String  where
  attr AriaAtomic value = unsafeAttribute (  
    { key: "aria-atomic", value: prop' value  } <$ _)
instance Attr Tspan_ AriaAtomic (Event.Event Unit -> Event.Event  String ) where
  attr AriaAtomic eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-atomic", value: prop' value })) eventValue)
...
instance Attr Use_ AriaAtomic  String  where
  attr AriaAtomic value = unsafeAttribute (  
    { key: "aria-atomic", value: prop' value  } <$ _)
instance Attr Use_ AriaAtomic (Event.Event Unit -> Event.Event  String ) where
  attr AriaAtomic eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-atomic", value: prop' value })) eventValue)
...
instance Attr View_ AriaAtomic  String  where
  attr AriaAtomic value = unsafeAttribute (  
    { key: "aria-atomic", value: prop' value  } <$ _)
instance Attr View_ AriaAtomic (Event.Event Unit -> Event.Event  String ) where
  attr AriaAtomic eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-atomic", value: prop' value })) eventValue)
...
instance Attr everything AriaAtomic (Event.Event Unit -> Event.Event  Unit ) where
  attr AriaAtomic eventValue = unsafeAttribute (map (map (
    \_ -> { key: "aria-atomic", value: unset' })) eventValue)
