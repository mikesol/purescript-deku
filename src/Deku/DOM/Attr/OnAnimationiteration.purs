...
instance Attr anything OnAnimationiteration (Event.Event Unit -> Event.Event  Cb ) where
  attr OnAnimationiteration eventValue = unsafeAttribute (map (map ( \value -> { key: "animationiteration", value: cb' value })) eventValue)
...
instance Attr anything OnAnimationiteration (Event.Event Unit -> Event.Event  (Effect Unit) ) where
  attr OnAnimationiteration eventValue = unsafeAttribute (map (map ( \value ->
      { key: "animationiteration", value: cb' (Cb (const (value $> true))) })) eventValue)
...
instance Attr anything OnAnimationiteration (Event.Event Unit -> Event.Event  (Effect Boolean) ) where
  attr OnAnimationiteration eventValue = unsafeAttribute (map (map ( \value ->
      { key: "animationiteration", value: cb' (Cb (const value)) })) eventValue) 
...
instance Attr everything OnAnimationiteration (Event.Event Unit -> Event.Event  Unit ) where
  attr OnAnimationiteration eventValue = unsafeAttribute (map (map ( \_ -> { key: "animationiteration", value: unset' })) eventValue)
