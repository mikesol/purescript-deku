...
instance Attr Circle_ VectorEffect String where
  attr VectorEffect bothValues = unsafeAttribute $ Both
    { key: "vector-effect", value: prop' (fst bothValues) }
    (snd bothValues <#> \value -> { key: "vector-effect", value: prop' value })
  pureAttr VectorEffect value = unsafeAttribute $ This
    { key: "vector-effect", value: prop' value }
  unpureAttr VectorEffect eventValue = unsafeAttribute $ That $ eventValue <#>
...
instance Attr everything VectorEffect Unit where
  attr VectorEffect bothValues = unsafeAttribute $ Both
    ...
    (snd bothValues <#> \_ -> { key: "vector-effect", value: unset' })
  pureAttr VectorEffect _ = unsafeAttribute $ This
    { key: "vector-effect", value: unset' }
  unpureAttr VectorEffect eventValue = unsafeAttribute $ That $ eventValue <#>
