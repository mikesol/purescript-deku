...
instance Attr Circle_ AriaValuenow String where
  attr AriaValuenow bothValues  = unsafeAttribute $ Both { key: "aria-valuenow", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "aria-valuenow", value:  prop' value  })
  pureAttr AriaValuenow value  = unsafeAttribute $ This { key: "aria-valuenow", value:  prop' value  }
  unpureAttr AriaValuenow eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "aria-valuenow", value:  prop' value  }
...
instance Attr everything AriaValuenow Unit where
  attr AriaValuenow bothValues  = unsafeAttribute $ Both { key: "aria-valuenow", value:  unset'  } (snd bothValues <#> \_ -> { key: "aria-valuenow", value:  unset'  })
  pureAttr AriaValuenow _  = unsafeAttribute $ This { key: "aria-valuenow", value:  unset'  }
  unpureAttr AriaValuenow eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "aria-valuenow", value:  unset'  }
