...
instance Attr AnimateTransform_ RequiredFeatures String where
  attr RequiredFeatures bothValues  = unsafeAttribute $ Both { key: "requiredFeatures", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "requiredFeatures", value:  prop' value  })
  pureAttr RequiredFeatures value  = unsafeAttribute $ This { key: "requiredFeatures", value:  prop' value  }
  unpureAttr RequiredFeatures eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "requiredFeatures", value:  prop' value  }
...
instance Attr everything RequiredFeatures Unit where
  attr RequiredFeatures bothValues  = unsafeAttribute $ Both { key: "requiredFeatures", value:  unset'  } (snd bothValues <#> \_ -> { key: "requiredFeatures", value:  unset'  })
  pureAttr RequiredFeatures _  = unsafeAttribute $ This { key: "requiredFeatures", value:  unset'  }
  unpureAttr RequiredFeatures eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "requiredFeatures", value:  unset'  }
