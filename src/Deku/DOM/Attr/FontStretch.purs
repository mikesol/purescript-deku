...
instance Attr FeBlend_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr FeColorMatrix_ FontStretch  String  where
  attr FontStretch value = unsafeAttribute (  
    { key: "font-stretch", value: prop' value  } <$ _)
instance Attr FeColorMatrix_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr FeComponentTransfer_ FontStretch  String  where
  attr FontStretch value = unsafeAttribute (  
    { key: "font-stretch", value: prop' value  } <$ _)
instance Attr FeComponentTransfer_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr FeComposite_ FontStretch  String  where
  attr FontStretch value = unsafeAttribute (  
    { key: "font-stretch", value: prop' value  } <$ _)
instance Attr FeComposite_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr FeConvolveMatrix_ FontStretch  String  where
  attr FontStretch value = unsafeAttribute (  
    { key: "font-stretch", value: prop' value  } <$ _)
instance Attr FeConvolveMatrix_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr FeDiffuseLighting_ FontStretch  String  where
  attr FontStretch value = unsafeAttribute (  
    { key: "font-stretch", value: prop' value  } <$ _)
instance Attr FeDiffuseLighting_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr FeDisplacementMap_ FontStretch  String  where
  attr FontStretch value = unsafeAttribute (  
    { key: "font-stretch", value: prop' value  } <$ _)
instance Attr FeDisplacementMap_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr FeFlood_ FontStretch  String  where
  attr FontStretch value = unsafeAttribute (  
    { key: "font-stretch", value: prop' value  } <$ _)
instance Attr FeFlood_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr FeGaussianBlur_ FontStretch  String  where
  attr FontStretch value = unsafeAttribute (  
    { key: "font-stretch", value: prop' value  } <$ _)
instance Attr FeGaussianBlur_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr FeImage_ FontStretch  String  where
  attr FontStretch value = unsafeAttribute (  
    { key: "font-stretch", value: prop' value  } <$ _)
instance Attr FeImage_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr FeMerge_ FontStretch  String  where
  attr FontStretch value = unsafeAttribute (  
    { key: "font-stretch", value: prop' value  } <$ _)
instance Attr FeMerge_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr FeMorphology_ FontStretch  String  where
  attr FontStretch value = unsafeAttribute (  
    { key: "font-stretch", value: prop' value  } <$ _)
instance Attr FeMorphology_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr FeOffset_ FontStretch  String  where
  attr FontStretch value = unsafeAttribute (  
    { key: "font-stretch", value: prop' value  } <$ _)
instance Attr FeOffset_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr FeSpecularLighting_ FontStretch  String  where
  attr FontStretch value = unsafeAttribute (  
    { key: "font-stretch", value: prop' value  } <$ _)
instance Attr FeSpecularLighting_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr FeTile_ FontStretch  String  where
  attr FontStretch value = unsafeAttribute (  
    { key: "font-stretch", value: prop' value  } <$ _)
instance Attr FeTile_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr FeTurbulence_ FontStretch  String  where
  attr FontStretch value = unsafeAttribute (  
    { key: "font-stretch", value: prop' value  } <$ _)
instance Attr FeTurbulence_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr Filter_ FontStretch  String  where
  attr FontStretch value = unsafeAttribute (  
    { key: "font-stretch", value: prop' value  } <$ _)
instance Attr Filter_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr Image_ FontStretch  String  where
  attr FontStretch value = unsafeAttribute (  
    { key: "font-stretch", value: prop' value  } <$ _)
instance Attr Image_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr Switch_ FontStretch  String  where
  attr FontStretch value = unsafeAttribute (  
    { key: "font-stretch", value: prop' value  } <$ _)
instance Attr Switch_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr Text_ FontStretch  String  where
  attr FontStretch value = unsafeAttribute (  
    { key: "font-stretch", value: prop' value  } <$ _)
instance Attr Text_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr Tspan_ FontStretch  String  where
  attr FontStretch value = unsafeAttribute (  
    { key: "font-stretch", value: prop' value  } <$ _)
instance Attr Tspan_ FontStretch (Event.Event Unit -> Event.Event  String ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \value -> { key: "font-stretch", value: prop' value })) eventValue)
...
instance Attr everything FontStretch (Event.Event Unit -> Event.Event  Unit ) where
  attr FontStretch eventValue = unsafeAttribute (map (map (
    \_ -> { key: "font-stretch", value: unset' })) eventValue)
