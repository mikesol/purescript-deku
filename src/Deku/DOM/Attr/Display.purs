...
instance Attr Circle_ Display String where
  attr Display bothValues  = unsafeAttribute $ Both { key: "display", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "display", value:  prop' value  })
  pureAttr Display value  = unsafeAttribute $ This { key: "display", value:  prop' value  }
  unpureAttr Display eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "display", value:  prop' value  }
...
instance Attr everything Display Unit where
  attr Display bothValues  = unsafeAttribute $ Both { key: "display", value:  unset'  } (snd bothValues <#> \_ -> { key: "display", value:  unset'  })
  pureAttr Display _  = unsafeAttribute $ This { key: "display", value:  unset'  }
  unpureAttr Display eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "display", value:  unset'  }
