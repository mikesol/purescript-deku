...
instance Attr AnimateTransform_ XmlSpace String where
  attr XmlSpace bothValues  = unsafeAttribute $ Both { key: "xml:space", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "xml:space", value:  prop' value  })
  pureAttr XmlSpace value  = unsafeAttribute $ This { key: "xml:space", value:  prop' value  }
  unpureAttr XmlSpace eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "xml:space", value:  prop' value  }
...
instance Attr everything XmlSpace Unit where
  attr XmlSpace bothValues  = unsafeAttribute $ Both { key: "xml:space", value:  unset'  } (snd bothValues <#> \_ -> { key: "xml:space", value:  unset'  })
  pureAttr XmlSpace _  = unsafeAttribute $ This { key: "xml:space", value:  unset'  }
  unpureAttr XmlSpace eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "xml:space", value:  unset'  }
