...
instance Attr A_ Hidden String where
  attr Hidden bothValues  = unsafeAttribute $ Both { key: "hidden", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "hidden", value:  prop' value  })
  pureAttr Hidden value  = unsafeAttribute $ This { key: "hidden", value:  prop' value  }
  unpureAttr Hidden eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "hidden", value:  prop' value  }
...
instance Attr everything Hidden Unit where
  attr Hidden bothValues  = unsafeAttribute $ Both { key: "hidden", value:  unset'  } (snd bothValues <#> \_ -> { key: "hidden", value:  unset'  })
  pureAttr Hidden _  = unsafeAttribute $ This { key: "hidden", value:  unset'  }
  unpureAttr Hidden eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "hidden", value:  unset'  }
