...
instance Attr A_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr A_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
instance Attr A_ Hidden (Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute \_ -> eventValue <#>
    \value -> { key: "hidden", value: prop' value }
instance Attr Abbr_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Abbr_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Acronym_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Acronym_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Address_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Address_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Applet_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Applet_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Area_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Area_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Article_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Article_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Aside_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Aside_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Audio_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Audio_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr B_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr B_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Base_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Base_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Basefont_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Basefont_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Bdi_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Bdi_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Bdo_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Bdo_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Big_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Big_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Blockquote_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Blockquote_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Body_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Body_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Br_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Br_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Button_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Button_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Canvas_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Canvas_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Caption_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Caption_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Center_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Center_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Cite_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Cite_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Code_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Code_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Col_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Col_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Colgroup_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Colgroup_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Xdata_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Xdata_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Datalist_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Datalist_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Dd_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Dd_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Del_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Del_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Details_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Details_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Dfn_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Dfn_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Dialog_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Dialog_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Dir_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Dir_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Div_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Div_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Dl_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Dl_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Dt_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Dt_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Em_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Em_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Embed_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Embed_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Fieldset_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Fieldset_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Figcaption_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Figcaption_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Figure_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Figure_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Font_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Font_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Footer_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Footer_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Form_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Form_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Frame_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Frame_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Frameset_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Frameset_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr H1_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr H1_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr H2_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr H2_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr H3_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr H3_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr H4_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr H4_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr H5_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr H5_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr H6_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr H6_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Head_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Head_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Header_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Header_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Hr_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Hr_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Html_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Html_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr I_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr I_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Iframe_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Iframe_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Img_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Img_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Input_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Input_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Ins_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Ins_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Kbd_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Kbd_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Label_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Label_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Legend_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Legend_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Li_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Li_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Link_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Link_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Main_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Main_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Map_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Map_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Mark_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Mark_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Meta_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Meta_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Meter_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Meter_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Nav_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Nav_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Noframes_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Noframes_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Noscript_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Noscript_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Object_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Object_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Ol_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Ol_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Optgroup_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Optgroup_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Option_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Option_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Output_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Output_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr P_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr P_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Param_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Param_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Picture_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Picture_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Pre_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Pre_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Progress_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Progress_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Q_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Q_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Rp_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Rp_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Rt_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Rt_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Ruby_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Ruby_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr S_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr S_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Samp_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Samp_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Script_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Script_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Section_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Section_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Select_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Select_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Small_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Small_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Source_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Source_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Span_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Span_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Strike_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Strike_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Strong_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Strong_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Style_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Style_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Sub_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Sub_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Summary_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Summary_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Sup_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Sup_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Svg_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Svg_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Table_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Table_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Tbody_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Tbody_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Td_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Td_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Template_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Template_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Textarea_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Textarea_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Tfoot_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Tfoot_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Th_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Th_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Thead_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Thead_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Time_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Time_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Title_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Title_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Tr_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Tr_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Track_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Track_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Tt_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Tt_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr U_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr U_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Ul_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Ul_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Var_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Var_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Video_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Video_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr Wbr_ Hidden  String  where
  attr Hidden value = unsafeAttribute (  
    { key: "hidden", value: prop' value  } <$ _)
instance Attr Wbr_ Hidden (Event.Event Unit -> Event.Event  String ) where
  attr Hidden eventValue = unsafeAttribute (map (map (
    \value -> { key: "hidden", value: prop' value })) eventValue)
...
instance Attr everything Hidden  Unit  where
  attr Hidden _ = unsafeAttribute (  { key: "hidden", value: unset'  } <$ _)
instance Attr everything Hidden (Event.Event Unit -> Event.Event  Unit ) where
  attr Hidden eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "hidden", value: unset' })) eventValue)
instance Attr everything Hidden (Event.Event  Unit ) where
  attr Hidden eventValue = unsafeAttribute \_ -> eventValue <#> \_ ->
