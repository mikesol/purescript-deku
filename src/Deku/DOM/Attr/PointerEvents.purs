...
instance Attr Circle_ PointerEvents String where
  attr PointerEvents bothValues  = unsafeAttribute $ Both { key: "pointer-events", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "pointer-events", value:  prop' value  })
  pureAttr PointerEvents value  = unsafeAttribute $ This { key: "pointer-events", value:  prop' value  }
  unpureAttr PointerEvents eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "pointer-events", value:  prop' value  }
...
instance Attr everything PointerEvents Unit where
  attr PointerEvents bothValues  = unsafeAttribute $ Both { key: "pointer-events", value:  unset'  } (snd bothValues <#> \_ -> { key: "pointer-events", value:  unset'  })
  pureAttr PointerEvents _  = unsafeAttribute $ This { key: "pointer-events", value:  unset'  }
  unpureAttr PointerEvents eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "pointer-events", value:  unset'  }
