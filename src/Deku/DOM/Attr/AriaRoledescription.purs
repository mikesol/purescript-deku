...
instance Attr Circle_ AriaRoledescription (Event.Event Unit -> Event.Event  String ) where
  attr AriaRoledescription eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-roledescription", value: prop' value })) eventValue)
...
instance Attr Ellipse_ AriaRoledescription  String  where
  attr AriaRoledescription value = unsafeAttribute (  
    { key: "aria-roledescription", value: prop' value  } <$ _)
instance Attr Ellipse_ AriaRoledescription (Event.Event Unit -> Event.Event  String ) where
  attr AriaRoledescription eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-roledescription", value: prop' value })) eventValue)
...
instance Attr ForeignObject_ AriaRoledescription  String  where
  attr AriaRoledescription value = unsafeAttribute (  
    { key: "aria-roledescription", value: prop' value  } <$ _)
instance Attr ForeignObject_ AriaRoledescription (Event.Event Unit -> Event.Event  String ) where
  attr AriaRoledescription eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-roledescription", value: prop' value })) eventValue)
...
instance Attr G_ AriaRoledescription  String  where
  attr AriaRoledescription value = unsafeAttribute (  
    { key: "aria-roledescription", value: prop' value  } <$ _)
instance Attr G_ AriaRoledescription (Event.Event Unit -> Event.Event  String ) where
  attr AriaRoledescription eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-roledescription", value: prop' value })) eventValue)
...
instance Attr Line_ AriaRoledescription  String  where
  attr AriaRoledescription value = unsafeAttribute (  
    { key: "aria-roledescription", value: prop' value  } <$ _)
instance Attr Line_ AriaRoledescription (Event.Event Unit -> Event.Event  String ) where
  attr AriaRoledescription eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-roledescription", value: prop' value })) eventValue)
...
instance Attr Marker_ AriaRoledescription  String  where
  attr AriaRoledescription value = unsafeAttribute (  
    { key: "aria-roledescription", value: prop' value  } <$ _)
instance Attr Marker_ AriaRoledescription (Event.Event Unit -> Event.Event  String ) where
  attr AriaRoledescription eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-roledescription", value: prop' value })) eventValue)
...
instance Attr Path_ AriaRoledescription  String  where
  attr AriaRoledescription value = unsafeAttribute (  
    { key: "aria-roledescription", value: prop' value  } <$ _)
instance Attr Path_ AriaRoledescription (Event.Event Unit -> Event.Event  String ) where
  attr AriaRoledescription eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-roledescription", value: prop' value })) eventValue)
...
instance Attr Polygon_ AriaRoledescription  String  where
  attr AriaRoledescription value = unsafeAttribute (  
    { key: "aria-roledescription", value: prop' value  } <$ _)
instance Attr Polygon_ AriaRoledescription (Event.Event Unit -> Event.Event  String ) where
  attr AriaRoledescription eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-roledescription", value: prop' value })) eventValue)
...
instance Attr Polyline_ AriaRoledescription  String  where
  attr AriaRoledescription value = unsafeAttribute (  
    { key: "aria-roledescription", value: prop' value  } <$ _)
instance Attr Polyline_ AriaRoledescription (Event.Event Unit -> Event.Event  String ) where
  attr AriaRoledescription eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-roledescription", value: prop' value })) eventValue)
...
instance Attr Rect_ AriaRoledescription  String  where
  attr AriaRoledescription value = unsafeAttribute (  
    { key: "aria-roledescription", value: prop' value  } <$ _)
instance Attr Rect_ AriaRoledescription (Event.Event Unit -> Event.Event  String ) where
  attr AriaRoledescription eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-roledescription", value: prop' value })) eventValue)
...
instance Attr Svg_ AriaRoledescription  String  where
  attr AriaRoledescription value = unsafeAttribute (  
    { key: "aria-roledescription", value: prop' value  } <$ _)
instance Attr Svg_ AriaRoledescription (Event.Event Unit -> Event.Event  String ) where
  attr AriaRoledescription eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-roledescription", value: prop' value })) eventValue)
...
instance Attr Symbol_ AriaRoledescription  String  where
  attr AriaRoledescription value = unsafeAttribute (  
    { key: "aria-roledescription", value: prop' value  } <$ _)
instance Attr Symbol_ AriaRoledescription (Event.Event Unit -> Event.Event  String ) where
  attr AriaRoledescription eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-roledescription", value: prop' value })) eventValue)
...
instance Attr Text_ AriaRoledescription  String  where
  attr AriaRoledescription value = unsafeAttribute (  
    { key: "aria-roledescription", value: prop' value  } <$ _)
instance Attr Text_ AriaRoledescription (Event.Event Unit -> Event.Event  String ) where
  attr AriaRoledescription eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-roledescription", value: prop' value })) eventValue)
...
instance Attr TextPath_ AriaRoledescription  String  where
  attr AriaRoledescription value = unsafeAttribute (  
    { key: "aria-roledescription", value: prop' value  } <$ _)
instance Attr TextPath_ AriaRoledescription (Event.Event Unit -> Event.Event  String ) where
  attr AriaRoledescription eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-roledescription", value: prop' value })) eventValue)
...
instance Attr Tspan_ AriaRoledescription  String  where
  attr AriaRoledescription value = unsafeAttribute (  
    { key: "aria-roledescription", value: prop' value  } <$ _)
instance Attr Tspan_ AriaRoledescription (Event.Event Unit -> Event.Event  String ) where
  attr AriaRoledescription eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-roledescription", value: prop' value })) eventValue)
...
instance Attr Use_ AriaRoledescription  String  where
  attr AriaRoledescription value = unsafeAttribute (  
    { key: "aria-roledescription", value: prop' value  } <$ _)
instance Attr Use_ AriaRoledescription (Event.Event Unit -> Event.Event  String ) where
  attr AriaRoledescription eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-roledescription", value: prop' value })) eventValue)
...
instance Attr View_ AriaRoledescription  String  where
  attr AriaRoledescription value = unsafeAttribute (  
    { key: "aria-roledescription", value: prop' value  } <$ _)
instance Attr View_ AriaRoledescription (Event.Event Unit -> Event.Event  String ) where
  attr AriaRoledescription eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-roledescription", value: prop' value })) eventValue)
...
instance Attr everything AriaRoledescription (Event.Event Unit -> Event.Event  Unit ) where
  attr AriaRoledescription eventValue = unsafeAttribute (map (map ( \_ -> { key: "aria-roledescription", value: unset' })) eventValue)
