...
instance Attr Line_ X2  String  where
  attr X2 value = unsafeAttribute $ This $ { key: "x2", value: prop' value }
...
instance Attr Line_ X2 (ST.ST Global.Global  String ) where
  attr X2 iValue = unsafeAttribute $ This $ iValue # \value ->
    { key: "x2", value: prop' value }
...
instance Attr everything X2  Unit  where
  attr X2 _ = unsafeAttribute $ This $ { key: "x2", value: unset' }
...
instance Attr everything X2 (ST.ST Global.Global  Unit ) where
  attr X2 iValue = unsafeAttribute $ This $ iValue # \_ ->
    { key: "x2", value: unset' }
