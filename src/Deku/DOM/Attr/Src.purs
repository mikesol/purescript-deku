...
instance Attr Audio_ Src String where
  attr Src bothValues = unsafeAttribute $ Both
    { key: "src", value: prop' (fst bothValues) }
    (snd bothValues <#> \value -> { key: "src", value: prop' value })
  pureAttr Src value = unsafeAttribute $ This { key: "src", value: prop' value }
  unpureAttr Src eventValue = unsafeAttribute $ That $ eventValue <#> \value ->
...
instance Attr everything Src Unit where
  attr Src bothValues = unsafeAttribute $ Both { key: "src", value: unset' }
    (snd bothValues <#> \_ -> { key: "src", value: unset' })
  pureAttr Src _ = unsafeAttribute $ This { key: "src", value: unset' }
  unpureAttr Src eventValue = unsafeAttribute $ That $ eventValue <#> \_ ->
    { key: "src", value: unset' }
