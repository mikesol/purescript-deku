...
instance Attr A_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Abbr_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Abbr_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Acronym_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Acronym_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Address_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Address_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Applet_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Applet_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Area_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Area_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Article_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Article_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Aside_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Aside_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Audio_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Audio_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr B_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr B_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Base_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Base_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Basefont_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Basefont_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Bdi_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Bdi_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Bdo_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Bdo_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Big_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Big_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Blockquote_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Blockquote_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Body_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Body_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Br_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Br_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Button_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Button_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Canvas_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Canvas_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Caption_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Caption_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Center_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Center_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Cite_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Cite_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Code_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Code_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Col_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Col_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Colgroup_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Colgroup_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Xdata_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Xdata_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Datalist_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Datalist_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Dd_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Dd_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Del_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Del_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Details_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Details_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Dfn_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Dfn_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Dialog_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Dialog_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Dir_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Dir_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Div_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Div_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Dl_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Dl_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Dt_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Dt_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Em_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Em_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Embed_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Embed_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Fieldset_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Fieldset_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Figcaption_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Figcaption_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Figure_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Figure_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Font_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Font_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Footer_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Footer_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Form_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Form_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Frame_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Frame_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Frameset_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Frameset_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr H1_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr H1_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr H2_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr H2_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr H3_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr H3_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr H4_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr H4_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr H5_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr H5_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr H6_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr H6_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Head_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Head_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Header_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Header_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Hr_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Hr_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Html_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Html_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr I_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr I_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Iframe_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Iframe_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Img_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Img_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Input_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Input_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Ins_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Ins_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Kbd_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Kbd_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Label_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Label_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Legend_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Legend_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Li_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Li_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Link_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Link_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Main_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Main_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Map_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Map_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Mark_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Mark_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Meta_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Meta_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Meter_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Meter_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Nav_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Nav_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Noframes_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Noframes_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Noscript_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Noscript_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Object_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Object_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Ol_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Ol_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Optgroup_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Optgroup_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Option_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Option_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Output_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Output_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr P_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr P_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Param_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Param_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Picture_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Picture_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Pre_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Pre_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Progress_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Progress_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Q_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Q_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Rp_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Rp_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Rt_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Rt_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Ruby_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Ruby_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr S_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr S_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Samp_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Samp_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Script_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Script_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Section_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Section_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Select_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Select_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Small_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Small_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Source_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Source_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Span_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Span_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Strike_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Strike_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Strong_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Strong_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Style_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Style_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Sub_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Sub_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Summary_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Summary_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Sup_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Sup_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Svg_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Svg_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Table_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Table_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Tbody_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Tbody_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Td_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Td_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Template_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Template_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Textarea_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Textarea_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Tfoot_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Tfoot_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Th_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Th_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Thead_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Thead_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Time_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Time_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Title_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Title_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Tr_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Tr_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Track_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Track_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Tt_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Tt_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr U_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr U_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Ul_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Ul_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Var_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Var_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Video_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Video_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr Wbr_ Contenteditable  String  where
  attr Contenteditable value = unsafeAttribute (  
    { key: "contenteditable", value: prop' value  } <$ _)
instance Attr Wbr_ Contenteditable (Event.Event Unit -> Event.Event  String ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \value -> { key: "contenteditable", value: prop' value })) eventValue)
...
instance Attr everything Contenteditable (Event.Event Unit -> Event.Event  Unit ) where
  attr Contenteditable eventValue = unsafeAttribute (map (map ( \_ -> { key: "contenteditable", value: unset' })) eventValue)
