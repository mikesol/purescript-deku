...
instance Attr Circle_ AriaRelevant String where
  attr AriaRelevant bothValues  = unsafeAttribute $ Both { key: "aria-relevant", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "aria-relevant", value:  prop' value  })
  pureAttr AriaRelevant value  = unsafeAttribute $ This { key: "aria-relevant", value:  prop' value  }
  unpureAttr AriaRelevant eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "aria-relevant", value:  prop' value  }
...
instance Attr everything AriaRelevant Unit where
  attr AriaRelevant bothValues  = unsafeAttribute $ Both { key: "aria-relevant", value:  unset'  } (snd bothValues <#> \_ -> { key: "aria-relevant", value:  unset'  })
  pureAttr AriaRelevant _  = unsafeAttribute $ This { key: "aria-relevant", value:  unset'  }
  unpureAttr AriaRelevant eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "aria-relevant", value:  unset'  }
