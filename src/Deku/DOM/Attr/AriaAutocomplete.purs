...
instance Attr Circle_ AriaAutocomplete (Event.Event Unit -> Event.Event  String ) where
  attr AriaAutocomplete eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-autocomplete", value: prop' value })) eventValue)
...
instance Attr Ellipse_ AriaAutocomplete  String  where
  attr AriaAutocomplete value = unsafeAttribute (  
    { key: "aria-autocomplete", value: prop' value  } <$ _)
instance Attr Ellipse_ AriaAutocomplete (Event.Event Unit -> Event.Event  String ) where
  attr AriaAutocomplete eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-autocomplete", value: prop' value })) eventValue)
...
instance Attr ForeignObject_ AriaAutocomplete  String  where
  attr AriaAutocomplete value = unsafeAttribute (  
    { key: "aria-autocomplete", value: prop' value  } <$ _)
instance Attr ForeignObject_ AriaAutocomplete (Event.Event Unit -> Event.Event  String ) where
  attr AriaAutocomplete eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-autocomplete", value: prop' value })) eventValue)
...
instance Attr G_ AriaAutocomplete  String  where
  attr AriaAutocomplete value = unsafeAttribute (  
    { key: "aria-autocomplete", value: prop' value  } <$ _)
instance Attr G_ AriaAutocomplete (Event.Event Unit -> Event.Event  String ) where
  attr AriaAutocomplete eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-autocomplete", value: prop' value })) eventValue)
...
instance Attr Line_ AriaAutocomplete  String  where
  attr AriaAutocomplete value = unsafeAttribute (  
    { key: "aria-autocomplete", value: prop' value  } <$ _)
instance Attr Line_ AriaAutocomplete (Event.Event Unit -> Event.Event  String ) where
  attr AriaAutocomplete eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-autocomplete", value: prop' value })) eventValue)
...
instance Attr Marker_ AriaAutocomplete  String  where
  attr AriaAutocomplete value = unsafeAttribute (  
    { key: "aria-autocomplete", value: prop' value  } <$ _)
instance Attr Marker_ AriaAutocomplete (Event.Event Unit -> Event.Event  String ) where
  attr AriaAutocomplete eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-autocomplete", value: prop' value })) eventValue)
...
instance Attr Path_ AriaAutocomplete  String  where
  attr AriaAutocomplete value = unsafeAttribute (  
    { key: "aria-autocomplete", value: prop' value  } <$ _)
instance Attr Path_ AriaAutocomplete (Event.Event Unit -> Event.Event  String ) where
  attr AriaAutocomplete eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-autocomplete", value: prop' value })) eventValue)
...
instance Attr Polygon_ AriaAutocomplete  String  where
  attr AriaAutocomplete value = unsafeAttribute (  
    { key: "aria-autocomplete", value: prop' value  } <$ _)
instance Attr Polygon_ AriaAutocomplete (Event.Event Unit -> Event.Event  String ) where
  attr AriaAutocomplete eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-autocomplete", value: prop' value })) eventValue)
...
instance Attr Polyline_ AriaAutocomplete  String  where
  attr AriaAutocomplete value = unsafeAttribute (  
    { key: "aria-autocomplete", value: prop' value  } <$ _)
instance Attr Polyline_ AriaAutocomplete (Event.Event Unit -> Event.Event  String ) where
  attr AriaAutocomplete eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-autocomplete", value: prop' value })) eventValue)
...
instance Attr Rect_ AriaAutocomplete  String  where
  attr AriaAutocomplete value = unsafeAttribute (  
    { key: "aria-autocomplete", value: prop' value  } <$ _)
instance Attr Rect_ AriaAutocomplete (Event.Event Unit -> Event.Event  String ) where
  attr AriaAutocomplete eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-autocomplete", value: prop' value })) eventValue)
...
instance Attr Svg_ AriaAutocomplete  String  where
  attr AriaAutocomplete value = unsafeAttribute (  
    { key: "aria-autocomplete", value: prop' value  } <$ _)
instance Attr Svg_ AriaAutocomplete (Event.Event Unit -> Event.Event  String ) where
  attr AriaAutocomplete eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-autocomplete", value: prop' value })) eventValue)
...
instance Attr Symbol_ AriaAutocomplete  String  where
  attr AriaAutocomplete value = unsafeAttribute (  
    { key: "aria-autocomplete", value: prop' value  } <$ _)
instance Attr Symbol_ AriaAutocomplete (Event.Event Unit -> Event.Event  String ) where
  attr AriaAutocomplete eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-autocomplete", value: prop' value })) eventValue)
...
instance Attr Text_ AriaAutocomplete  String  where
  attr AriaAutocomplete value = unsafeAttribute (  
    { key: "aria-autocomplete", value: prop' value  } <$ _)
instance Attr Text_ AriaAutocomplete (Event.Event Unit -> Event.Event  String ) where
  attr AriaAutocomplete eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-autocomplete", value: prop' value })) eventValue)
...
instance Attr TextPath_ AriaAutocomplete  String  where
  attr AriaAutocomplete value = unsafeAttribute (  
    { key: "aria-autocomplete", value: prop' value  } <$ _)
instance Attr TextPath_ AriaAutocomplete (Event.Event Unit -> Event.Event  String ) where
  attr AriaAutocomplete eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-autocomplete", value: prop' value })) eventValue)
...
instance Attr Tspan_ AriaAutocomplete  String  where
  attr AriaAutocomplete value = unsafeAttribute (  
    { key: "aria-autocomplete", value: prop' value  } <$ _)
instance Attr Tspan_ AriaAutocomplete (Event.Event Unit -> Event.Event  String ) where
  attr AriaAutocomplete eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-autocomplete", value: prop' value })) eventValue)
...
instance Attr Use_ AriaAutocomplete  String  where
  attr AriaAutocomplete value = unsafeAttribute (  
    { key: "aria-autocomplete", value: prop' value  } <$ _)
instance Attr Use_ AriaAutocomplete (Event.Event Unit -> Event.Event  String ) where
  attr AriaAutocomplete eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-autocomplete", value: prop' value })) eventValue)
...
instance Attr View_ AriaAutocomplete  String  where
  attr AriaAutocomplete value = unsafeAttribute (  
    { key: "aria-autocomplete", value: prop' value  } <$ _)
instance Attr View_ AriaAutocomplete (Event.Event Unit -> Event.Event  String ) where
  attr AriaAutocomplete eventValue = unsafeAttribute (map (map ( \value -> { key: "aria-autocomplete", value: prop' value })) eventValue)
...
instance Attr everything AriaAutocomplete (Event.Event Unit -> Event.Event  Unit ) where
  attr AriaAutocomplete eventValue = unsafeAttribute (map (map ( \_ -> { key: "aria-autocomplete", value: unset' })) eventValue)
