...
instance Attr anything OnPointerlockchange  (Zora Unit) where
  attr OnPointerlockchange  value = unsafeAttribute { key: "pointerlockchange ", value: cb' (Cb (const (runImpure (value $> true)))) }
instance Attr anything OnPointerlockchange  (Zora Boolean) where
  attr OnPointerlockchange  value = unsafeAttribute { key: "pointerlockchange ", value: cb' (Cb (const (runImpure value))) }