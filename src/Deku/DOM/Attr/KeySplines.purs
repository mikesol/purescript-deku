...
instance Attr Animate_ KeySplines (Event.Event Unit -> Event.Event  String ) where
  attr KeySplines eventValue = unsafeAttribute (map (map (
    \value -> { key: "keySplines", value: prop' value })) eventValue)
...
instance Attr AnimateMotion_ KeySplines  String  where
  attr KeySplines value = unsafeAttribute (  
    { key: "keySplines", value: prop' value  } <$ _)
instance Attr AnimateMotion_ KeySplines (Event.Event Unit -> Event.Event  String ) where
  attr KeySplines eventValue = unsafeAttribute (map (map (
    \value -> { key: "keySplines", value: prop' value })) eventValue)
...
instance Attr AnimateTransform_ KeySplines  String  where
  attr KeySplines value = unsafeAttribute (  
    { key: "keySplines", value: prop' value  } <$ _)
instance Attr AnimateTransform_ KeySplines (Event.Event Unit -> Event.Event  String ) where
  attr KeySplines eventValue = unsafeAttribute (map (map (
    \value -> { key: "keySplines", value: prop' value })) eventValue)
...
instance Attr everything KeySplines (Event.Event Unit -> Event.Event  Unit ) where
  attr KeySplines eventValue = unsafeAttribute (map (map (
    \_ -> { key: "keySplines", value: unset' })) eventValue)
