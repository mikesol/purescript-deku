...
instance Attr A_ Referrerpolicy (Event.Event Unit -> Event.Event  String ) where
  attr Referrerpolicy eventValue = unsafeAttribute (map (map (
    \value -> { key: "referrerpolicy", value: prop' value })) eventValue)
...
instance Attr Area_ Referrerpolicy  String  where
  attr Referrerpolicy value = unsafeAttribute (  
    { key: "referrerpolicy", value: prop' value  } <$ _)
instance Attr Area_ Referrerpolicy (Event.Event Unit -> Event.Event  String ) where
  attr Referrerpolicy eventValue = unsafeAttribute (map (map (
    \value -> { key: "referrerpolicy", value: prop' value })) eventValue)
...
instance Attr Iframe_ Referrerpolicy  String  where
  attr Referrerpolicy value = unsafeAttribute (  
    { key: "referrerpolicy", value: prop' value  } <$ _)
instance Attr Iframe_ Referrerpolicy (Event.Event Unit -> Event.Event  String ) where
  attr Referrerpolicy eventValue = unsafeAttribute (map (map (
    \value -> { key: "referrerpolicy", value: prop' value })) eventValue)
...
instance Attr Img_ Referrerpolicy  String  where
  attr Referrerpolicy value = unsafeAttribute (  
    { key: "referrerpolicy", value: prop' value  } <$ _)
instance Attr Img_ Referrerpolicy (Event.Event Unit -> Event.Event  String ) where
  attr Referrerpolicy eventValue = unsafeAttribute (map (map (
    \value -> { key: "referrerpolicy", value: prop' value })) eventValue)
...
instance Attr Link_ Referrerpolicy  String  where
  attr Referrerpolicy value = unsafeAttribute (  
    { key: "referrerpolicy", value: prop' value  } <$ _)
instance Attr Link_ Referrerpolicy (Event.Event Unit -> Event.Event  String ) where
  attr Referrerpolicy eventValue = unsafeAttribute (map (map (
    \value -> { key: "referrerpolicy", value: prop' value })) eventValue)
...
instance Attr Script_ Referrerpolicy  String  where
  attr Referrerpolicy value = unsafeAttribute (  
    { key: "referrerpolicy", value: prop' value  } <$ _)
instance Attr Script_ Referrerpolicy (Event.Event Unit -> Event.Event  String ) where
  attr Referrerpolicy eventValue = unsafeAttribute (map (map (
    \value -> { key: "referrerpolicy", value: prop' value })) eventValue)
...
instance Attr everything Referrerpolicy (Event.Event Unit -> Event.Event  Unit ) where
  attr Referrerpolicy eventValue = unsafeAttribute (map (map (
    \_ -> { key: "referrerpolicy", value: unset' })) eventValue)
