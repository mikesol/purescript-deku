...
instance Attr Applet_ Align (Event.Event Unit -> Event.Event  String ) where
  attr Align eventValue = unsafeAttribute (map (map (
    \value -> { key: "align", value: prop' value })) eventValue)
...
instance Attr Caption_ Align  String  where
  attr Align value = unsafeAttribute (  
    { key: "align", value: prop' value  } <$ _)
instance Attr Caption_ Align (Event.Event Unit -> Event.Event  String ) where
  attr Align eventValue = unsafeAttribute (map (map (
    \value -> { key: "align", value: prop' value })) eventValue)
...
instance Attr Col_ Align  String  where
  attr Align value = unsafeAttribute (  
    { key: "align", value: prop' value  } <$ _)
instance Attr Col_ Align (Event.Event Unit -> Event.Event  String ) where
  attr Align eventValue = unsafeAttribute (map (map (
    \value -> { key: "align", value: prop' value })) eventValue)
...
instance Attr Colgroup_ Align  String  where
  attr Align value = unsafeAttribute (  
    { key: "align", value: prop' value  } <$ _)
instance Attr Colgroup_ Align (Event.Event Unit -> Event.Event  String ) where
  attr Align eventValue = unsafeAttribute (map (map (
    \value -> { key: "align", value: prop' value })) eventValue)
...
instance Attr Hr_ Align  String  where
  attr Align value = unsafeAttribute (  
    { key: "align", value: prop' value  } <$ _)
instance Attr Hr_ Align (Event.Event Unit -> Event.Event  String ) where
  attr Align eventValue = unsafeAttribute (map (map (
    \value -> { key: "align", value: prop' value })) eventValue)
...
instance Attr Iframe_ Align  String  where
  attr Align value = unsafeAttribute (  
    { key: "align", value: prop' value  } <$ _)
instance Attr Iframe_ Align (Event.Event Unit -> Event.Event  String ) where
  attr Align eventValue = unsafeAttribute (map (map (
    \value -> { key: "align", value: prop' value })) eventValue)
...
instance Attr Img_ Align  String  where
  attr Align value = unsafeAttribute (  
    { key: "align", value: prop' value  } <$ _)
instance Attr Img_ Align (Event.Event Unit -> Event.Event  String ) where
  attr Align eventValue = unsafeAttribute (map (map (
    \value -> { key: "align", value: prop' value })) eventValue)
...
instance Attr Table_ Align  String  where
  attr Align value = unsafeAttribute (  
    { key: "align", value: prop' value  } <$ _)
instance Attr Table_ Align (Event.Event Unit -> Event.Event  String ) where
  attr Align eventValue = unsafeAttribute (map (map (
    \value -> { key: "align", value: prop' value })) eventValue)
...
instance Attr Tbody_ Align  String  where
  attr Align value = unsafeAttribute (  
    { key: "align", value: prop' value  } <$ _)
instance Attr Tbody_ Align (Event.Event Unit -> Event.Event  String ) where
  attr Align eventValue = unsafeAttribute (map (map (
    \value -> { key: "align", value: prop' value })) eventValue)
...
instance Attr Td_ Align  String  where
  attr Align value = unsafeAttribute (  
    { key: "align", value: prop' value  } <$ _)
instance Attr Td_ Align (Event.Event Unit -> Event.Event  String ) where
  attr Align eventValue = unsafeAttribute (map (map (
    \value -> { key: "align", value: prop' value })) eventValue)
...
instance Attr Tfoot_ Align  String  where
  attr Align value = unsafeAttribute (  
    { key: "align", value: prop' value  } <$ _)
instance Attr Tfoot_ Align (Event.Event Unit -> Event.Event  String ) where
  attr Align eventValue = unsafeAttribute (map (map (
    \value -> { key: "align", value: prop' value })) eventValue)
...
instance Attr Th_ Align  String  where
  attr Align value = unsafeAttribute (  
    { key: "align", value: prop' value  } <$ _)
instance Attr Th_ Align (Event.Event Unit -> Event.Event  String ) where
  attr Align eventValue = unsafeAttribute (map (map (
    \value -> { key: "align", value: prop' value })) eventValue)
...
instance Attr Thead_ Align  String  where
  attr Align value = unsafeAttribute (  
    { key: "align", value: prop' value  } <$ _)
instance Attr Thead_ Align (Event.Event Unit -> Event.Event  String ) where
  attr Align eventValue = unsafeAttribute (map (map (
    \value -> { key: "align", value: prop' value })) eventValue)
...
instance Attr Tr_ Align  String  where
  attr Align value = unsafeAttribute (  
    { key: "align", value: prop' value  } <$ _)
instance Attr Tr_ Align (Event.Event Unit -> Event.Event  String ) where
  attr Align eventValue = unsafeAttribute (map (map (
    \value -> { key: "align", value: prop' value })) eventValue)
...
instance Attr everything Align (Event.Event Unit -> Event.Event  Unit ) where
  attr Align eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "align", value: unset' })) eventValue)
