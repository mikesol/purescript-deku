...
instance Attr FeBlend_ TextAnchor String where
  attr TextAnchor bothValues  = unsafeAttribute $ Both { key: "text-anchor", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "text-anchor", value:  prop' value  })
  pureAttr TextAnchor value  = unsafeAttribute $ This { key: "text-anchor", value:  prop' value  }
  unpureAttr TextAnchor eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "text-anchor", value:  prop' value  }
...
instance Attr everything TextAnchor Unit where
  attr TextAnchor bothValues  = unsafeAttribute $ Both { key: "text-anchor", value:  unset'  } (snd bothValues <#> \_ -> { key: "text-anchor", value:  unset'  })
  pureAttr TextAnchor _  = unsafeAttribute $ This { key: "text-anchor", value:  unset'  }
  unpureAttr TextAnchor eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "text-anchor", value:  unset'  }
