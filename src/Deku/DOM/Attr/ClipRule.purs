...
instance Attr Circle_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr ClipPath_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr ClipPath_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr Defs_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr Defs_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr Ellipse_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr Ellipse_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr FeBlend_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr FeBlend_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr FeColorMatrix_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr FeColorMatrix_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr FeComponentTransfer_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr FeComponentTransfer_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr FeComposite_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr FeComposite_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr FeConvolveMatrix_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr FeConvolveMatrix_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr FeDiffuseLighting_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr FeDiffuseLighting_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr FeDisplacementMap_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr FeDisplacementMap_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr FeFlood_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr FeFlood_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr FeGaussianBlur_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr FeGaussianBlur_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr FeImage_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr FeImage_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr FeMerge_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr FeMerge_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr FeMorphology_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr FeMorphology_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr FeOffset_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr FeOffset_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr FeSpecularLighting_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr FeSpecularLighting_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr FeTile_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr FeTile_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr FeTurbulence_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr FeTurbulence_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr Filter_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr Filter_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr ForeignObject_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr ForeignObject_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr G_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr G_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr Image_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr Image_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr Line_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr Line_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr LinearGradient_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr LinearGradient_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr Marker_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr Marker_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr Mask_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr Mask_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr Path_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr Path_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr Pattern_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr Pattern_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr Polygon_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr Polygon_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr Polyline_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr Polyline_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr RadialGradient_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr RadialGradient_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr Rect_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr Rect_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr Svg_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr Svg_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr Switch_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr Switch_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr Symbol_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr Symbol_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr Text_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr Text_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr TextPath_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr TextPath_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr Tspan_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr Tspan_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr Use_ ClipRule  String  where
  attr ClipRule value = unsafeAttribute (  
    { key: "clip-rule", value: prop' value  } <$ _)
instance Attr Use_ ClipRule (Event.Event Unit -> Event.Event  String ) where
  attr ClipRule eventValue = unsafeAttribute (map (map (
    \value -> { key: "clip-rule", value: prop' value })) eventValue)
...
instance Attr everything ClipRule (Event.Event Unit -> Event.Event  Unit ) where
  attr ClipRule eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "clip-rule", value: unset' })) eventValue)
