...
instance Attr Circle_ AriaMultiline String where
  attr AriaMultiline bothValues  = unsafeAttribute $ Both { key: "aria-multiline", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "aria-multiline", value:  prop' value  })
  pureAttr AriaMultiline value  = unsafeAttribute $ This { key: "aria-multiline", value:  prop' value  }
  unpureAttr AriaMultiline eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "aria-multiline", value:  prop' value  }
...
instance Attr everything AriaMultiline Unit where
  attr AriaMultiline bothValues  = unsafeAttribute $ Both { key: "aria-multiline", value:  unset'  } (snd bothValues <#> \_ -> { key: "aria-multiline", value:  unset'  })
  pureAttr AriaMultiline _  = unsafeAttribute $ This { key: "aria-multiline", value:  unset'  }
  unpureAttr AriaMultiline eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "aria-multiline", value:  unset'  }
