...
instance Attr Animate_ AttributeName (Event.Event Unit -> Event.Event  String ) where
  attr AttributeName eventValue = unsafeAttribute (map (map (
    \value -> { key: "attributeName", value: prop' value })) eventValue)
...
instance Attr AnimateMotion_ AttributeName  String  where
  attr AttributeName value = unsafeAttribute (  
    { key: "attributeName", value: prop' value  } <$ _)
instance Attr AnimateMotion_ AttributeName (Event.Event Unit -> Event.Event  String ) where
  attr AttributeName eventValue = unsafeAttribute (map (map (
    \value -> { key: "attributeName", value: prop' value })) eventValue)
...
instance Attr AnimateTransform_ AttributeName  String  where
  attr AttributeName value = unsafeAttribute (  
    { key: "attributeName", value: prop' value  } <$ _)
instance Attr AnimateTransform_ AttributeName (Event.Event Unit -> Event.Event  String ) where
  attr AttributeName eventValue = unsafeAttribute (map (map (
    \value -> { key: "attributeName", value: prop' value })) eventValue)
...
instance Attr Set_ AttributeName  String  where
  attr AttributeName value = unsafeAttribute (  
    { key: "attributeName", value: prop' value  } <$ _)
instance Attr Set_ AttributeName (Event.Event Unit -> Event.Event  String ) where
  attr AttributeName eventValue = unsafeAttribute (map (map (
    \value -> { key: "attributeName", value: prop' value })) eventValue)
...
instance Attr everything AttributeName (Event.Event Unit -> Event.Event  Unit ) where
  attr AttributeName eventValue = unsafeAttribute (map (map (
    \_ -> { key: "attributeName", value: unset' })) eventValue)
