...
instance Attr FeBlend_ BaselineShift (Event.Event Unit -> Event.Event  String ) where
  attr BaselineShift eventValue = unsafeAttribute (map (map (
    \value -> { key: "baseline-shift", value: prop' value })) eventValue)
...
instance Attr FeColorMatrix_ BaselineShift  String  where
  attr BaselineShift value = unsafeAttribute (  
    { key: "baseline-shift", value: prop' value  } <$ _)
instance Attr FeColorMatrix_ BaselineShift (Event.Event Unit -> Event.Event  String ) where
  attr BaselineShift eventValue = unsafeAttribute (map (map (
    \value -> { key: "baseline-shift", value: prop' value })) eventValue)
...
instance Attr FeComponentTransfer_ BaselineShift  String  where
  attr BaselineShift value = unsafeAttribute (  
    { key: "baseline-shift", value: prop' value  } <$ _)
instance Attr FeComponentTransfer_ BaselineShift (Event.Event Unit -> Event.Event  String ) where
  attr BaselineShift eventValue = unsafeAttribute (map (map (
    \value -> { key: "baseline-shift", value: prop' value })) eventValue)
...
instance Attr FeComposite_ BaselineShift  String  where
  attr BaselineShift value = unsafeAttribute (  
    { key: "baseline-shift", value: prop' value  } <$ _)
instance Attr FeComposite_ BaselineShift (Event.Event Unit -> Event.Event  String ) where
  attr BaselineShift eventValue = unsafeAttribute (map (map (
    \value -> { key: "baseline-shift", value: prop' value })) eventValue)
...
instance Attr FeConvolveMatrix_ BaselineShift  String  where
  attr BaselineShift value = unsafeAttribute (  
    { key: "baseline-shift", value: prop' value  } <$ _)
instance Attr FeConvolveMatrix_ BaselineShift (Event.Event Unit -> Event.Event  String ) where
  attr BaselineShift eventValue = unsafeAttribute (map (map (
    \value -> { key: "baseline-shift", value: prop' value })) eventValue)
...
instance Attr FeDiffuseLighting_ BaselineShift  String  where
  attr BaselineShift value = unsafeAttribute (  
    { key: "baseline-shift", value: prop' value  } <$ _)
instance Attr FeDiffuseLighting_ BaselineShift (Event.Event Unit -> Event.Event  String ) where
  attr BaselineShift eventValue = unsafeAttribute (map (map (
    \value -> { key: "baseline-shift", value: prop' value })) eventValue)
...
instance Attr FeDisplacementMap_ BaselineShift  String  where
  attr BaselineShift value = unsafeAttribute (  
    { key: "baseline-shift", value: prop' value  } <$ _)
instance Attr FeDisplacementMap_ BaselineShift (Event.Event Unit -> Event.Event  String ) where
  attr BaselineShift eventValue = unsafeAttribute (map (map (
    \value -> { key: "baseline-shift", value: prop' value })) eventValue)
...
instance Attr FeFlood_ BaselineShift  String  where
  attr BaselineShift value = unsafeAttribute (  
    { key: "baseline-shift", value: prop' value  } <$ _)
instance Attr FeFlood_ BaselineShift (Event.Event Unit -> Event.Event  String ) where
  attr BaselineShift eventValue = unsafeAttribute (map (map (
    \value -> { key: "baseline-shift", value: prop' value })) eventValue)
...
instance Attr FeGaussianBlur_ BaselineShift  String  where
  attr BaselineShift value = unsafeAttribute (  
    { key: "baseline-shift", value: prop' value  } <$ _)
instance Attr FeGaussianBlur_ BaselineShift (Event.Event Unit -> Event.Event  String ) where
  attr BaselineShift eventValue = unsafeAttribute (map (map (
    \value -> { key: "baseline-shift", value: prop' value })) eventValue)
...
instance Attr FeImage_ BaselineShift  String  where
  attr BaselineShift value = unsafeAttribute (  
    { key: "baseline-shift", value: prop' value  } <$ _)
instance Attr FeImage_ BaselineShift (Event.Event Unit -> Event.Event  String ) where
  attr BaselineShift eventValue = unsafeAttribute (map (map (
    \value -> { key: "baseline-shift", value: prop' value })) eventValue)
...
instance Attr FeMerge_ BaselineShift  String  where
  attr BaselineShift value = unsafeAttribute (  
    { key: "baseline-shift", value: prop' value  } <$ _)
instance Attr FeMerge_ BaselineShift (Event.Event Unit -> Event.Event  String ) where
  attr BaselineShift eventValue = unsafeAttribute (map (map (
    \value -> { key: "baseline-shift", value: prop' value })) eventValue)
...
instance Attr FeMorphology_ BaselineShift  String  where
  attr BaselineShift value = unsafeAttribute (  
    { key: "baseline-shift", value: prop' value  } <$ _)
instance Attr FeMorphology_ BaselineShift (Event.Event Unit -> Event.Event  String ) where
  attr BaselineShift eventValue = unsafeAttribute (map (map (
    \value -> { key: "baseline-shift", value: prop' value })) eventValue)
...
instance Attr FeOffset_ BaselineShift  String  where
  attr BaselineShift value = unsafeAttribute (  
    { key: "baseline-shift", value: prop' value  } <$ _)
instance Attr FeOffset_ BaselineShift (Event.Event Unit -> Event.Event  String ) where
  attr BaselineShift eventValue = unsafeAttribute (map (map (
    \value -> { key: "baseline-shift", value: prop' value })) eventValue)
...
instance Attr FeSpecularLighting_ BaselineShift  String  where
  attr BaselineShift value = unsafeAttribute (  
    { key: "baseline-shift", value: prop' value  } <$ _)
instance Attr FeSpecularLighting_ BaselineShift (Event.Event Unit -> Event.Event  String ) where
  attr BaselineShift eventValue = unsafeAttribute (map (map (
    \value -> { key: "baseline-shift", value: prop' value })) eventValue)
...
instance Attr FeTile_ BaselineShift  String  where
  attr BaselineShift value = unsafeAttribute (  
    { key: "baseline-shift", value: prop' value  } <$ _)
instance Attr FeTile_ BaselineShift (Event.Event Unit -> Event.Event  String ) where
  attr BaselineShift eventValue = unsafeAttribute (map (map (
    \value -> { key: "baseline-shift", value: prop' value })) eventValue)
...
instance Attr FeTurbulence_ BaselineShift  String  where
  attr BaselineShift value = unsafeAttribute (  
    { key: "baseline-shift", value: prop' value  } <$ _)
instance Attr FeTurbulence_ BaselineShift (Event.Event Unit -> Event.Event  String ) where
  attr BaselineShift eventValue = unsafeAttribute (map (map (
    \value -> { key: "baseline-shift", value: prop' value })) eventValue)
...
instance Attr Filter_ BaselineShift  String  where
  attr BaselineShift value = unsafeAttribute (  
    { key: "baseline-shift", value: prop' value  } <$ _)
instance Attr Filter_ BaselineShift (Event.Event Unit -> Event.Event  String ) where
  attr BaselineShift eventValue = unsafeAttribute (map (map (
    \value -> { key: "baseline-shift", value: prop' value })) eventValue)
...
instance Attr Image_ BaselineShift  String  where
  attr BaselineShift value = unsafeAttribute (  
    { key: "baseline-shift", value: prop' value  } <$ _)
instance Attr Image_ BaselineShift (Event.Event Unit -> Event.Event  String ) where
  attr BaselineShift eventValue = unsafeAttribute (map (map (
    \value -> { key: "baseline-shift", value: prop' value })) eventValue)
...
instance Attr Switch_ BaselineShift  String  where
  attr BaselineShift value = unsafeAttribute (  
    { key: "baseline-shift", value: prop' value  } <$ _)
instance Attr Switch_ BaselineShift (Event.Event Unit -> Event.Event  String ) where
  attr BaselineShift eventValue = unsafeAttribute (map (map (
    \value -> { key: "baseline-shift", value: prop' value })) eventValue)
...
instance Attr everything BaselineShift (Event.Event Unit -> Event.Event  Unit ) where
  attr BaselineShift eventValue = unsafeAttribute (map (map (
    \_ -> { key: "baseline-shift", value: unset' })) eventValue)
