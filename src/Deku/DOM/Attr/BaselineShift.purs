...
instance Attr FeBlend_ BaselineShift String where
  attr BaselineShift bothValues  = unsafeAttribute $ Both { key: "baseline-shift", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "baseline-shift", value:  prop' value  })
  pureAttr BaselineShift value  = unsafeAttribute $ This { key: "baseline-shift", value:  prop' value  }
  unpureAttr BaselineShift eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "baseline-shift", value:  prop' value  }
...
instance Attr everything BaselineShift Unit where
  attr BaselineShift bothValues  = unsafeAttribute $ Both { key: "baseline-shift", value:  unset'  } (snd bothValues <#> \_ -> { key: "baseline-shift", value:  unset'  })
  pureAttr BaselineShift _  = unsafeAttribute $ This { key: "baseline-shift", value:  unset'  }
  unpureAttr BaselineShift eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "baseline-shift", value:  unset'  }
