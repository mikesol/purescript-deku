...
instance Attr FeFuncA_ TableValues (Event.Event Unit -> Event.Event  String ) where
  attr TableValues eventValue = unsafeAttribute (map (map (
    \value -> { key: "tableValues", value: prop' value })) eventValue)
...
instance Attr FeFuncB_ TableValues  String  where
  attr TableValues value = unsafeAttribute (  
    { key: "tableValues", value: prop' value  } <$ _)
instance Attr FeFuncB_ TableValues (Event.Event Unit -> Event.Event  String ) where
  attr TableValues eventValue = unsafeAttribute (map (map (
    \value -> { key: "tableValues", value: prop' value })) eventValue)
...
instance Attr FeFuncG_ TableValues  String  where
  attr TableValues value = unsafeAttribute (  
    { key: "tableValues", value: prop' value  } <$ _)
instance Attr FeFuncG_ TableValues (Event.Event Unit -> Event.Event  String ) where
  attr TableValues eventValue = unsafeAttribute (map (map (
    \value -> { key: "tableValues", value: prop' value })) eventValue)
...
instance Attr FeFuncR_ TableValues  String  where
  attr TableValues value = unsafeAttribute (  
    { key: "tableValues", value: prop' value  } <$ _)
instance Attr FeFuncR_ TableValues (Event.Event Unit -> Event.Event  String ) where
  attr TableValues eventValue = unsafeAttribute (map (map (
    \value -> { key: "tableValues", value: prop' value })) eventValue)
...
instance Attr everything TableValues (Event.Event Unit -> Event.Event  Unit ) where
  attr TableValues eventValue = unsafeAttribute (map (map (
    \_ -> { key: "tableValues", value: unset' })) eventValue)
