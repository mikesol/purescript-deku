...
instance Attr FeBlend_ Kerning (Event.Event Unit -> Event.Event  String ) where
  attr Kerning eventValue = unsafeAttribute (map (map (
    \value -> { key: "kerning", value: prop' value })) eventValue)
...
instance Attr FeColorMatrix_ Kerning  String  where
  attr Kerning value = unsafeAttribute (  
    { key: "kerning", value: prop' value  } <$ _)
instance Attr FeColorMatrix_ Kerning (Event.Event Unit -> Event.Event  String ) where
  attr Kerning eventValue = unsafeAttribute (map (map (
    \value -> { key: "kerning", value: prop' value })) eventValue)
...
instance Attr FeComponentTransfer_ Kerning  String  where
  attr Kerning value = unsafeAttribute (  
    { key: "kerning", value: prop' value  } <$ _)
instance Attr FeComponentTransfer_ Kerning (Event.Event Unit -> Event.Event  String ) where
  attr Kerning eventValue = unsafeAttribute (map (map (
    \value -> { key: "kerning", value: prop' value })) eventValue)
...
instance Attr FeComposite_ Kerning  String  where
  attr Kerning value = unsafeAttribute (  
    { key: "kerning", value: prop' value  } <$ _)
instance Attr FeComposite_ Kerning (Event.Event Unit -> Event.Event  String ) where
  attr Kerning eventValue = unsafeAttribute (map (map (
    \value -> { key: "kerning", value: prop' value })) eventValue)
...
instance Attr FeConvolveMatrix_ Kerning  String  where
  attr Kerning value = unsafeAttribute (  
    { key: "kerning", value: prop' value  } <$ _)
instance Attr FeConvolveMatrix_ Kerning (Event.Event Unit -> Event.Event  String ) where
  attr Kerning eventValue = unsafeAttribute (map (map (
    \value -> { key: "kerning", value: prop' value })) eventValue)
...
instance Attr FeDiffuseLighting_ Kerning  String  where
  attr Kerning value = unsafeAttribute (  
    { key: "kerning", value: prop' value  } <$ _)
instance Attr FeDiffuseLighting_ Kerning (Event.Event Unit -> Event.Event  String ) where
  attr Kerning eventValue = unsafeAttribute (map (map (
    \value -> { key: "kerning", value: prop' value })) eventValue)
...
instance Attr FeDisplacementMap_ Kerning  String  where
  attr Kerning value = unsafeAttribute (  
    { key: "kerning", value: prop' value  } <$ _)
instance Attr FeDisplacementMap_ Kerning (Event.Event Unit -> Event.Event  String ) where
  attr Kerning eventValue = unsafeAttribute (map (map (
    \value -> { key: "kerning", value: prop' value })) eventValue)
...
instance Attr FeFlood_ Kerning  String  where
  attr Kerning value = unsafeAttribute (  
    { key: "kerning", value: prop' value  } <$ _)
instance Attr FeFlood_ Kerning (Event.Event Unit -> Event.Event  String ) where
  attr Kerning eventValue = unsafeAttribute (map (map (
    \value -> { key: "kerning", value: prop' value })) eventValue)
...
instance Attr FeGaussianBlur_ Kerning  String  where
  attr Kerning value = unsafeAttribute (  
    { key: "kerning", value: prop' value  } <$ _)
instance Attr FeGaussianBlur_ Kerning (Event.Event Unit -> Event.Event  String ) where
  attr Kerning eventValue = unsafeAttribute (map (map (
    \value -> { key: "kerning", value: prop' value })) eventValue)
...
instance Attr FeImage_ Kerning  String  where
  attr Kerning value = unsafeAttribute (  
    { key: "kerning", value: prop' value  } <$ _)
instance Attr FeImage_ Kerning (Event.Event Unit -> Event.Event  String ) where
  attr Kerning eventValue = unsafeAttribute (map (map (
    \value -> { key: "kerning", value: prop' value })) eventValue)
...
instance Attr FeMerge_ Kerning  String  where
  attr Kerning value = unsafeAttribute (  
    { key: "kerning", value: prop' value  } <$ _)
instance Attr FeMerge_ Kerning (Event.Event Unit -> Event.Event  String ) where
  attr Kerning eventValue = unsafeAttribute (map (map (
    \value -> { key: "kerning", value: prop' value })) eventValue)
...
instance Attr FeMorphology_ Kerning  String  where
  attr Kerning value = unsafeAttribute (  
    { key: "kerning", value: prop' value  } <$ _)
instance Attr FeMorphology_ Kerning (Event.Event Unit -> Event.Event  String ) where
  attr Kerning eventValue = unsafeAttribute (map (map (
    \value -> { key: "kerning", value: prop' value })) eventValue)
...
instance Attr FeOffset_ Kerning  String  where
  attr Kerning value = unsafeAttribute (  
    { key: "kerning", value: prop' value  } <$ _)
instance Attr FeOffset_ Kerning (Event.Event Unit -> Event.Event  String ) where
  attr Kerning eventValue = unsafeAttribute (map (map (
    \value -> { key: "kerning", value: prop' value })) eventValue)
...
instance Attr FeSpecularLighting_ Kerning  String  where
  attr Kerning value = unsafeAttribute (  
    { key: "kerning", value: prop' value  } <$ _)
instance Attr FeSpecularLighting_ Kerning (Event.Event Unit -> Event.Event  String ) where
  attr Kerning eventValue = unsafeAttribute (map (map (
    \value -> { key: "kerning", value: prop' value })) eventValue)
...
instance Attr FeTile_ Kerning  String  where
  attr Kerning value = unsafeAttribute (  
    { key: "kerning", value: prop' value  } <$ _)
instance Attr FeTile_ Kerning (Event.Event Unit -> Event.Event  String ) where
  attr Kerning eventValue = unsafeAttribute (map (map (
    \value -> { key: "kerning", value: prop' value })) eventValue)
...
instance Attr FeTurbulence_ Kerning  String  where
  attr Kerning value = unsafeAttribute (  
    { key: "kerning", value: prop' value  } <$ _)
instance Attr FeTurbulence_ Kerning (Event.Event Unit -> Event.Event  String ) where
  attr Kerning eventValue = unsafeAttribute (map (map (
    \value -> { key: "kerning", value: prop' value })) eventValue)
...
instance Attr Filter_ Kerning  String  where
  attr Kerning value = unsafeAttribute (  
    { key: "kerning", value: prop' value  } <$ _)
instance Attr Filter_ Kerning (Event.Event Unit -> Event.Event  String ) where
  attr Kerning eventValue = unsafeAttribute (map (map (
    \value -> { key: "kerning", value: prop' value })) eventValue)
...
instance Attr Image_ Kerning  String  where
  attr Kerning value = unsafeAttribute (  
    { key: "kerning", value: prop' value  } <$ _)
instance Attr Image_ Kerning (Event.Event Unit -> Event.Event  String ) where
  attr Kerning eventValue = unsafeAttribute (map (map (
    \value -> { key: "kerning", value: prop' value })) eventValue)
...
instance Attr Switch_ Kerning  String  where
  attr Kerning value = unsafeAttribute (  
    { key: "kerning", value: prop' value  } <$ _)
instance Attr Switch_ Kerning (Event.Event Unit -> Event.Event  String ) where
  attr Kerning eventValue = unsafeAttribute (map (map (
    \value -> { key: "kerning", value: prop' value })) eventValue)
...
instance Attr everything Kerning (Event.Event Unit -> Event.Event  Unit ) where
  attr Kerning eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "kerning", value: unset' })) eventValue)
