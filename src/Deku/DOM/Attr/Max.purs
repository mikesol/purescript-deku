...
instance Attr Input_ Max String where
  attr Max bothValues = unsafeAttribute $ Both
    { key: "max", value: prop' (fst bothValues) }
    (snd bothValues <#> \value -> { key: "max", value: prop' value })
  pureAttr Max value = unsafeAttribute $ This { key: "max", value: prop' value }
  unpureAttr Max eventValue = unsafeAttribute $ That $ eventValue <#> \value ->
...
instance Attr everything Max Unit where
  attr Max bothValues = unsafeAttribute $ Both { key: "max", value: unset' }
    (snd bothValues <#> \_ -> { key: "max", value: unset' })
  pureAttr Max _ = unsafeAttribute $ This { key: "max", value: unset' }
  unpureAttr Max eventValue = unsafeAttribute $ That $ eventValue <#> \_ ->
    { key: "max", value: unset' }
