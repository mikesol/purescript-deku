...
instance Attr FeBlend_ TextDecoration (Event.Event Unit -> Event.Event  String ) where
  attr TextDecoration eventValue = unsafeAttribute (map (map (
    \value -> { key: "text-decoration", value: prop' value })) eventValue)
...
instance Attr FeColorMatrix_ TextDecoration  String  where
  attr TextDecoration value = unsafeAttribute (  
    { key: "text-decoration", value: prop' value  } <$ _)
instance Attr FeColorMatrix_ TextDecoration (Event.Event Unit -> Event.Event  String ) where
  attr TextDecoration eventValue = unsafeAttribute (map (map (
    \value -> { key: "text-decoration", value: prop' value })) eventValue)
...
instance Attr FeComponentTransfer_ TextDecoration  String  where
  attr TextDecoration value = unsafeAttribute (  
    { key: "text-decoration", value: prop' value  } <$ _)
instance Attr FeComponentTransfer_ TextDecoration (Event.Event Unit -> Event.Event  String ) where
  attr TextDecoration eventValue = unsafeAttribute (map (map (
    \value -> { key: "text-decoration", value: prop' value })) eventValue)
...
instance Attr FeComposite_ TextDecoration  String  where
  attr TextDecoration value = unsafeAttribute (  
    { key: "text-decoration", value: prop' value  } <$ _)
instance Attr FeComposite_ TextDecoration (Event.Event Unit -> Event.Event  String ) where
  attr TextDecoration eventValue = unsafeAttribute (map (map (
    \value -> { key: "text-decoration", value: prop' value })) eventValue)
...
instance Attr FeConvolveMatrix_ TextDecoration  String  where
  attr TextDecoration value = unsafeAttribute (  
    { key: "text-decoration", value: prop' value  } <$ _)
instance Attr FeConvolveMatrix_ TextDecoration (Event.Event Unit -> Event.Event  String ) where
  attr TextDecoration eventValue = unsafeAttribute (map (map (
    \value -> { key: "text-decoration", value: prop' value })) eventValue)
...
instance Attr FeDiffuseLighting_ TextDecoration  String  where
  attr TextDecoration value = unsafeAttribute (  
    { key: "text-decoration", value: prop' value  } <$ _)
instance Attr FeDiffuseLighting_ TextDecoration (Event.Event Unit -> Event.Event  String ) where
  attr TextDecoration eventValue = unsafeAttribute (map (map (
    \value -> { key: "text-decoration", value: prop' value })) eventValue)
...
instance Attr FeDisplacementMap_ TextDecoration  String  where
  attr TextDecoration value = unsafeAttribute (  
    { key: "text-decoration", value: prop' value  } <$ _)
instance Attr FeDisplacementMap_ TextDecoration (Event.Event Unit -> Event.Event  String ) where
  attr TextDecoration eventValue = unsafeAttribute (map (map (
    \value -> { key: "text-decoration", value: prop' value })) eventValue)
...
instance Attr FeFlood_ TextDecoration  String  where
  attr TextDecoration value = unsafeAttribute (  
    { key: "text-decoration", value: prop' value  } <$ _)
instance Attr FeFlood_ TextDecoration (Event.Event Unit -> Event.Event  String ) where
  attr TextDecoration eventValue = unsafeAttribute (map (map (
    \value -> { key: "text-decoration", value: prop' value })) eventValue)
...
instance Attr FeGaussianBlur_ TextDecoration  String  where
  attr TextDecoration value = unsafeAttribute (  
    { key: "text-decoration", value: prop' value  } <$ _)
instance Attr FeGaussianBlur_ TextDecoration (Event.Event Unit -> Event.Event  String ) where
  attr TextDecoration eventValue = unsafeAttribute (map (map (
    \value -> { key: "text-decoration", value: prop' value })) eventValue)
...
instance Attr FeImage_ TextDecoration  String  where
  attr TextDecoration value = unsafeAttribute (  
    { key: "text-decoration", value: prop' value  } <$ _)
instance Attr FeImage_ TextDecoration (Event.Event Unit -> Event.Event  String ) where
  attr TextDecoration eventValue = unsafeAttribute (map (map (
    \value -> { key: "text-decoration", value: prop' value })) eventValue)
...
instance Attr FeMerge_ TextDecoration  String  where
  attr TextDecoration value = unsafeAttribute (  
    { key: "text-decoration", value: prop' value  } <$ _)
instance Attr FeMerge_ TextDecoration (Event.Event Unit -> Event.Event  String ) where
  attr TextDecoration eventValue = unsafeAttribute (map (map (
    \value -> { key: "text-decoration", value: prop' value })) eventValue)
...
instance Attr FeMorphology_ TextDecoration  String  where
  attr TextDecoration value = unsafeAttribute (  
    { key: "text-decoration", value: prop' value  } <$ _)
instance Attr FeMorphology_ TextDecoration (Event.Event Unit -> Event.Event  String ) where
  attr TextDecoration eventValue = unsafeAttribute (map (map (
    \value -> { key: "text-decoration", value: prop' value })) eventValue)
...
instance Attr FeOffset_ TextDecoration  String  where
  attr TextDecoration value = unsafeAttribute (  
    { key: "text-decoration", value: prop' value  } <$ _)
instance Attr FeOffset_ TextDecoration (Event.Event Unit -> Event.Event  String ) where
  attr TextDecoration eventValue = unsafeAttribute (map (map (
    \value -> { key: "text-decoration", value: prop' value })) eventValue)
...
instance Attr FeSpecularLighting_ TextDecoration  String  where
  attr TextDecoration value = unsafeAttribute (  
    { key: "text-decoration", value: prop' value  } <$ _)
instance Attr FeSpecularLighting_ TextDecoration (Event.Event Unit -> Event.Event  String ) where
  attr TextDecoration eventValue = unsafeAttribute (map (map (
    \value -> { key: "text-decoration", value: prop' value })) eventValue)
...
instance Attr FeTile_ TextDecoration  String  where
  attr TextDecoration value = unsafeAttribute (  
    { key: "text-decoration", value: prop' value  } <$ _)
instance Attr FeTile_ TextDecoration (Event.Event Unit -> Event.Event  String ) where
  attr TextDecoration eventValue = unsafeAttribute (map (map (
    \value -> { key: "text-decoration", value: prop' value })) eventValue)
...
instance Attr FeTurbulence_ TextDecoration  String  where
  attr TextDecoration value = unsafeAttribute (  
    { key: "text-decoration", value: prop' value  } <$ _)
instance Attr FeTurbulence_ TextDecoration (Event.Event Unit -> Event.Event  String ) where
  attr TextDecoration eventValue = unsafeAttribute (map (map (
    \value -> { key: "text-decoration", value: prop' value })) eventValue)
...
instance Attr Filter_ TextDecoration  String  where
  attr TextDecoration value = unsafeAttribute (  
    { key: "text-decoration", value: prop' value  } <$ _)
instance Attr Filter_ TextDecoration (Event.Event Unit -> Event.Event  String ) where
  attr TextDecoration eventValue = unsafeAttribute (map (map (
    \value -> { key: "text-decoration", value: prop' value })) eventValue)
...
instance Attr Image_ TextDecoration  String  where
  attr TextDecoration value = unsafeAttribute (  
    { key: "text-decoration", value: prop' value  } <$ _)
instance Attr Image_ TextDecoration (Event.Event Unit -> Event.Event  String ) where
  attr TextDecoration eventValue = unsafeAttribute (map (map (
    \value -> { key: "text-decoration", value: prop' value })) eventValue)
...
instance Attr Switch_ TextDecoration  String  where
  attr TextDecoration value = unsafeAttribute (  
    { key: "text-decoration", value: prop' value  } <$ _)
instance Attr Switch_ TextDecoration (Event.Event Unit -> Event.Event  String ) where
  attr TextDecoration eventValue = unsafeAttribute (map (map (
    \value -> { key: "text-decoration", value: prop' value })) eventValue)
...
instance Attr everything TextDecoration (Event.Event Unit -> Event.Event  Unit ) where
  attr TextDecoration eventValue = unsafeAttribute (map (map (
    \_ -> { key: "text-decoration", value: unset' })) eventValue)
