...
instance Attr Circle_ Cursor String where
  attr Cursor bothValues  = unsafeAttribute $ Both { key: "cursor", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "cursor", value:  prop' value  })
  pureAttr Cursor value  = unsafeAttribute $ This { key: "cursor", value:  prop' value  }
  unpureAttr Cursor eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "cursor", value:  prop' value  }
...
instance Attr everything Cursor Unit where
  attr Cursor bothValues  = unsafeAttribute $ Both { key: "cursor", value:  unset'  } (snd bothValues <#> \_ -> { key: "cursor", value:  unset'  })
  pureAttr Cursor _  = unsafeAttribute $ This { key: "cursor", value:  unset'  }
  unpureAttr Cursor eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "cursor", value:  unset'  }
