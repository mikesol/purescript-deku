...
instance Attr anything OnPointerlockchange (Event.Event Unit -> Event.Event  Cb ) where
  attr OnPointerlockchange eventValue = unsafeAttribute (map (map ( \value -> { key: "pointerlockchange", value: cb' value })) eventValue)
...
instance Attr anything OnPointerlockchange (Event.Event Unit -> Event.Event  (Effect Unit) ) where
  attr OnPointerlockchange eventValue = unsafeAttribute (map (map ( \value ->
      { key: "pointerlockchange", value: cb' (Cb (const (value $> true))) })) eventValue)
...
instance Attr anything OnPointerlockchange (Event.Event Unit -> Event.Event  (Effect Boolean) ) where
  attr OnPointerlockchange eventValue = unsafeAttribute (map (map ( \value ->
      { key: "pointerlockchange", value: cb' (Cb (const value)) })) eventValue) 
...
instance Attr everything OnPointerlockchange (Event.Event Unit -> Event.Event  Unit ) where
  attr OnPointerlockchange eventValue = unsafeAttribute (map (map ( \_ -> { key: "pointerlockchange", value: unset' })) eventValue)
