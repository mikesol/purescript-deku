...
instance Attr Ellipse_ Rx  String  where
  attr Rx value = unsafeAttribute $ This $ { key: "rx", value: prop' value }
...
instance Attr Ellipse_ Rx (ST.ST Global.Global  String ) where
  attr Rx iValue = unsafeAttribute $ This $ iValue # \value ->
    { key: "rx", value: prop' value }
...
instance Attr everything Rx  Unit  where
  attr Rx _ = unsafeAttribute $ This $ { key: "rx", value: unset' }
...
instance Attr everything Rx (ST.ST Global.Global  Unit ) where
  attr Rx iValue = unsafeAttribute $ This $ iValue # \_ ->
    { key: "rx", value: unset' }
