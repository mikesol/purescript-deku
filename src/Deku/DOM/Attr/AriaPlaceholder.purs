...
instance Attr Circle_ AriaPlaceholder String where
  attr AriaPlaceholder bothValues  = unsafeAttribute $ Both { key: "aria-placeholder", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "aria-placeholder", value:  prop' value  })
  pureAttr AriaPlaceholder value  = unsafeAttribute $ This { key: "aria-placeholder", value:  prop' value  }
  unpureAttr AriaPlaceholder eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "aria-placeholder", value:  prop' value  }
...
instance Attr everything AriaPlaceholder Unit where
  attr AriaPlaceholder bothValues  = unsafeAttribute $ Both { key: "aria-placeholder", value:  unset'  } (snd bothValues <#> \_ -> { key: "aria-placeholder", value:  unset'  })
  pureAttr AriaPlaceholder _  = unsafeAttribute $ This { key: "aria-placeholder", value:  unset'  }
  unpureAttr AriaPlaceholder eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "aria-placeholder", value:  unset'  }
