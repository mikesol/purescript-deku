...
instance Attr FeFuncA_ Slope (Event.Event Unit -> Event.Event  String ) where
  attr Slope eventValue = unsafeAttribute (map (map (
    \value -> { key: "slope", value: prop' value })) eventValue)
...
instance Attr FeFuncB_ Slope  String  where
  attr Slope value = unsafeAttribute (  
    { key: "slope", value: prop' value  } <$ _)
instance Attr FeFuncB_ Slope (Event.Event Unit -> Event.Event  String ) where
  attr Slope eventValue = unsafeAttribute (map (map (
    \value -> { key: "slope", value: prop' value })) eventValue)
...
instance Attr FeFuncG_ Slope  String  where
  attr Slope value = unsafeAttribute (  
    { key: "slope", value: prop' value  } <$ _)
instance Attr FeFuncG_ Slope (Event.Event Unit -> Event.Event  String ) where
  attr Slope eventValue = unsafeAttribute (map (map (
    \value -> { key: "slope", value: prop' value })) eventValue)
...
instance Attr FeFuncR_ Slope  String  where
  attr Slope value = unsafeAttribute (  
    { key: "slope", value: prop' value  } <$ _)
instance Attr FeFuncR_ Slope (Event.Event Unit -> Event.Event  String ) where
  attr Slope eventValue = unsafeAttribute (map (map (
    \value -> { key: "slope", value: prop' value })) eventValue)
...
instance Attr everything Slope (Event.Event Unit -> Event.Event  Unit ) where
  attr Slope eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "slope", value: unset' })) eventValue)
