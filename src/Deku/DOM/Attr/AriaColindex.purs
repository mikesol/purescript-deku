...
instance Attr Circle_ AriaColindex String where
  attr AriaColindex bothValues  = unsafeAttribute $ Both { key: "aria-colindex", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "aria-colindex", value:  prop' value  })
  pureAttr AriaColindex value  = unsafeAttribute $ This { key: "aria-colindex", value:  prop' value  }
  unpureAttr AriaColindex eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "aria-colindex", value:  prop' value  }
...
instance Attr everything AriaColindex Unit where
  attr AriaColindex bothValues  = unsafeAttribute $ Both { key: "aria-colindex", value:  unset'  } (snd bothValues <#> \_ -> { key: "aria-colindex", value:  unset'  })
  pureAttr AriaColindex _  = unsafeAttribute $ This { key: "aria-colindex", value:  unset'  }
  unpureAttr AriaColindex eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "aria-colindex", value:  unset'  }
