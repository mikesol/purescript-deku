...
instance Attr Circle_ AriaRowcount String where
  attr AriaRowcount bothValues  = unsafeAttribute $ Both { key: "aria-rowcount", value:  prop' (fst bothValues)  } (snd bothValues <#> \value -> { key: "aria-rowcount", value:  prop' value  })
  pureAttr AriaRowcount value  = unsafeAttribute $ This { key: "aria-rowcount", value:  prop' value  }
  unpureAttr AriaRowcount eventValue  = unsafeAttribute $ That $ eventValue <#> \value -> { key: "aria-rowcount", value:  prop' value  }
...
instance Attr everything AriaRowcount Unit where
  attr AriaRowcount bothValues  = unsafeAttribute $ Both { key: "aria-rowcount", value:  unset'  } (snd bothValues <#> \_ -> { key: "aria-rowcount", value:  unset'  })
  pureAttr AriaRowcount _  = unsafeAttribute $ This { key: "aria-rowcount", value:  unset'  }
  unpureAttr AriaRowcount eventValue  = unsafeAttribute $ That $ eventValue <#> \_ -> { key: "aria-rowcount", value:  unset'  }
