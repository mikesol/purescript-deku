...
instance Attr Circle_ AriaMultiselectable (ST.ST Global.Global  String ) where
  attr AriaMultiselectable iValue = unsafeAttribute $ This $
    iValue <#> \value -> { key: "aria-multiselectable", value: prop' value }
...
instance Attr everything AriaMultiselectable (ST.ST Global.Global  Unit ) where
  attr AriaMultiselectable iValue = unsafeAttribute $ This $
    iValue <#> \_ -> { key: "aria-multiselectable", value: unset' }
