...
instance Attr Circle_ AriaControls (Event.Event Unit -> Event.Event  String ) where
  attr AriaControls eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-controls", value: prop' value })) eventValue)
...
instance Attr Ellipse_ AriaControls  String  where
  attr AriaControls value = unsafeAttribute (  
    { key: "aria-controls", value: prop' value  } <$ _)
instance Attr Ellipse_ AriaControls (Event.Event Unit -> Event.Event  String ) where
  attr AriaControls eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-controls", value: prop' value })) eventValue)
...
instance Attr ForeignObject_ AriaControls  String  where
  attr AriaControls value = unsafeAttribute (  
    { key: "aria-controls", value: prop' value  } <$ _)
instance Attr ForeignObject_ AriaControls (Event.Event Unit -> Event.Event  String ) where
  attr AriaControls eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-controls", value: prop' value })) eventValue)
...
instance Attr G_ AriaControls  String  where
  attr AriaControls value = unsafeAttribute (  
    { key: "aria-controls", value: prop' value  } <$ _)
instance Attr G_ AriaControls (Event.Event Unit -> Event.Event  String ) where
  attr AriaControls eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-controls", value: prop' value })) eventValue)
...
instance Attr Line_ AriaControls  String  where
  attr AriaControls value = unsafeAttribute (  
    { key: "aria-controls", value: prop' value  } <$ _)
instance Attr Line_ AriaControls (Event.Event Unit -> Event.Event  String ) where
  attr AriaControls eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-controls", value: prop' value })) eventValue)
...
instance Attr Marker_ AriaControls  String  where
  attr AriaControls value = unsafeAttribute (  
    { key: "aria-controls", value: prop' value  } <$ _)
instance Attr Marker_ AriaControls (Event.Event Unit -> Event.Event  String ) where
  attr AriaControls eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-controls", value: prop' value })) eventValue)
...
instance Attr Path_ AriaControls  String  where
  attr AriaControls value = unsafeAttribute (  
    { key: "aria-controls", value: prop' value  } <$ _)
instance Attr Path_ AriaControls (Event.Event Unit -> Event.Event  String ) where
  attr AriaControls eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-controls", value: prop' value })) eventValue)
...
instance Attr Polygon_ AriaControls  String  where
  attr AriaControls value = unsafeAttribute (  
    { key: "aria-controls", value: prop' value  } <$ _)
instance Attr Polygon_ AriaControls (Event.Event Unit -> Event.Event  String ) where
  attr AriaControls eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-controls", value: prop' value })) eventValue)
...
instance Attr Polyline_ AriaControls  String  where
  attr AriaControls value = unsafeAttribute (  
    { key: "aria-controls", value: prop' value  } <$ _)
instance Attr Polyline_ AriaControls (Event.Event Unit -> Event.Event  String ) where
  attr AriaControls eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-controls", value: prop' value })) eventValue)
...
instance Attr Rect_ AriaControls  String  where
  attr AriaControls value = unsafeAttribute (  
    { key: "aria-controls", value: prop' value  } <$ _)
instance Attr Rect_ AriaControls (Event.Event Unit -> Event.Event  String ) where
  attr AriaControls eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-controls", value: prop' value })) eventValue)
...
instance Attr Svg_ AriaControls  String  where
  attr AriaControls value = unsafeAttribute (  
    { key: "aria-controls", value: prop' value  } <$ _)
instance Attr Svg_ AriaControls (Event.Event Unit -> Event.Event  String ) where
  attr AriaControls eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-controls", value: prop' value })) eventValue)
...
instance Attr Symbol_ AriaControls  String  where
  attr AriaControls value = unsafeAttribute (  
    { key: "aria-controls", value: prop' value  } <$ _)
instance Attr Symbol_ AriaControls (Event.Event Unit -> Event.Event  String ) where
  attr AriaControls eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-controls", value: prop' value })) eventValue)
...
instance Attr Text_ AriaControls  String  where
  attr AriaControls value = unsafeAttribute (  
    { key: "aria-controls", value: prop' value  } <$ _)
instance Attr Text_ AriaControls (Event.Event Unit -> Event.Event  String ) where
  attr AriaControls eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-controls", value: prop' value })) eventValue)
...
instance Attr TextPath_ AriaControls  String  where
  attr AriaControls value = unsafeAttribute (  
    { key: "aria-controls", value: prop' value  } <$ _)
instance Attr TextPath_ AriaControls (Event.Event Unit -> Event.Event  String ) where
  attr AriaControls eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-controls", value: prop' value })) eventValue)
...
instance Attr Tspan_ AriaControls  String  where
  attr AriaControls value = unsafeAttribute (  
    { key: "aria-controls", value: prop' value  } <$ _)
instance Attr Tspan_ AriaControls (Event.Event Unit -> Event.Event  String ) where
  attr AriaControls eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-controls", value: prop' value })) eventValue)
...
instance Attr Use_ AriaControls  String  where
  attr AriaControls value = unsafeAttribute (  
    { key: "aria-controls", value: prop' value  } <$ _)
instance Attr Use_ AriaControls (Event.Event Unit -> Event.Event  String ) where
  attr AriaControls eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-controls", value: prop' value })) eventValue)
...
instance Attr View_ AriaControls  String  where
  attr AriaControls value = unsafeAttribute (  
    { key: "aria-controls", value: prop' value  } <$ _)
instance Attr View_ AriaControls (Event.Event Unit -> Event.Event  String ) where
  attr AriaControls eventValue = unsafeAttribute (map (map (
    \value -> { key: "aria-controls", value: prop' value })) eventValue)
...
instance Attr everything AriaControls (Event.Event Unit -> Event.Event  Unit ) where
  attr AriaControls eventValue = unsafeAttribute (map (map (
    \_ -> { key: "aria-controls", value: unset' })) eventValue)
