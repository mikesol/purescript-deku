...
instance Attr anything OnPointerover (Event.Event Unit -> Event.Event  Cb ) where
  attr OnPointerover eventValue = unsafeAttribute (map (map (
    \value -> { key: "pointerover", value: cb' value })) eventValue)
...
instance Attr anything OnPointerover (Event.Event Unit -> Event.Event  (Effect Unit) ) where
  attr OnPointerover eventValue = unsafeAttribute (map (map (
    \value -> { key: "pointerover", value: cb' (Cb (const (value $> true))) })) eventValue)
...
instance Attr anything OnPointerover (Event.Event Unit -> Event.Event  (Effect Boolean) ) where
  attr OnPointerover eventValue = unsafeAttribute (map (map (
    \value -> { key: "pointerover", value: cb' (Cb (const value)) })) eventValue) 
...
instance Attr everything OnPointerover (Event.Event Unit -> Event.Event  Unit ) where
  attr OnPointerover eventValue = unsafeAttribute (map (map (
    \_ -> { key: "pointerover", value: unset' })) eventValue)
