...
instance Attr Animate_ KeyTimes (Event.Event Unit -> Event.Event  String ) where
  attr KeyTimes eventValue = unsafeAttribute (map (map (
    \value -> { key: "keyTimes", value: prop' value })) eventValue)
...
instance Attr AnimateMotion_ KeyTimes  String  where
  attr KeyTimes value = unsafeAttribute (  
    { key: "keyTimes", value: prop' value  } <$ _)
instance Attr AnimateMotion_ KeyTimes (Event.Event Unit -> Event.Event  String ) where
  attr KeyTimes eventValue = unsafeAttribute (map (map (
    \value -> { key: "keyTimes", value: prop' value })) eventValue)
...
instance Attr AnimateTransform_ KeyTimes  String  where
  attr KeyTimes value = unsafeAttribute (  
    { key: "keyTimes", value: prop' value  } <$ _)
instance Attr AnimateTransform_ KeyTimes (Event.Event Unit -> Event.Event  String ) where
  attr KeyTimes eventValue = unsafeAttribute (map (map (
    \value -> { key: "keyTimes", value: prop' value })) eventValue)
...
instance Attr everything KeyTimes (Event.Event Unit -> Event.Event  Unit ) where
  attr KeyTimes eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "keyTimes", value: unset' })) eventValue)
