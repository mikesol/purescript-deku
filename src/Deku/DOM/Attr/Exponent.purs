...
instance Attr FeFuncA_ Exponent (Event.Event Unit -> Event.Event  String ) where
  attr Exponent eventValue = unsafeAttribute (map (map (
    \value -> { key: "exponent", value: prop' value })) eventValue)
...
instance Attr FeFuncB_ Exponent  String  where
  attr Exponent value = unsafeAttribute (  
    { key: "exponent", value: prop' value  } <$ _)
instance Attr FeFuncB_ Exponent (Event.Event Unit -> Event.Event  String ) where
  attr Exponent eventValue = unsafeAttribute (map (map (
    \value -> { key: "exponent", value: prop' value })) eventValue)
...
instance Attr FeFuncG_ Exponent  String  where
  attr Exponent value = unsafeAttribute (  
    { key: "exponent", value: prop' value  } <$ _)
instance Attr FeFuncG_ Exponent (Event.Event Unit -> Event.Event  String ) where
  attr Exponent eventValue = unsafeAttribute (map (map (
    \value -> { key: "exponent", value: prop' value })) eventValue)
...
instance Attr FeFuncR_ Exponent  String  where
  attr Exponent value = unsafeAttribute (  
    { key: "exponent", value: prop' value  } <$ _)
instance Attr FeFuncR_ Exponent (Event.Event Unit -> Event.Event  String ) where
  attr Exponent eventValue = unsafeAttribute (map (map (
    \value -> { key: "exponent", value: prop' value })) eventValue)
...
instance Attr everything Exponent (Event.Event Unit -> Event.Event  Unit ) where
  attr Exponent eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "exponent", value: unset' })) eventValue)
