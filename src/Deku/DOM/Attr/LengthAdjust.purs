...
instance Attr Text_ LengthAdjust (Event.Event Unit -> Event.Event  String ) where
  attr LengthAdjust eventValue = unsafeAttribute (map (map (
    \value -> { key: "lengthAdjust", value: prop' value })) eventValue)
...
instance Attr TextPath_ LengthAdjust  String  where
  attr LengthAdjust value = unsafeAttribute (  
    { key: "lengthAdjust", value: prop' value  } <$ _)
instance Attr TextPath_ LengthAdjust (Event.Event Unit -> Event.Event  String ) where
  attr LengthAdjust eventValue = unsafeAttribute (map (map (
    \value -> { key: "lengthAdjust", value: prop' value })) eventValue)
...
instance Attr Tspan_ LengthAdjust  String  where
  attr LengthAdjust value = unsafeAttribute (  
    { key: "lengthAdjust", value: prop' value  } <$ _)
instance Attr Tspan_ LengthAdjust (Event.Event Unit -> Event.Event  String ) where
  attr LengthAdjust eventValue = unsafeAttribute (map (map (
    \value -> { key: "lengthAdjust", value: prop' value })) eventValue)
...
instance Attr everything LengthAdjust (Event.Event Unit -> Event.Event  Unit ) where
  attr LengthAdjust eventValue = unsafeAttribute (map (map (
    \_ -> { key: "lengthAdjust", value: unset' })) eventValue)
