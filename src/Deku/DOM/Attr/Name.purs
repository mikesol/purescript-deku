...
instance Attr Button_ Name (Event.Event Unit -> Event.Event  String ) where
  attr Name eventValue = unsafeAttribute (map (map ( \value ->
    { key: "name", value: prop' value })) eventValue)
...
instance Attr Form_ Name  String  where
  attr Name value = unsafeAttribute (  
    { key: "name", value: prop' value  } <$ _)
instance Attr Form_ Name (Event.Event Unit -> Event.Event  String ) where
  attr Name eventValue = unsafeAttribute (map (map ( \value ->
    { key: "name", value: prop' value })) eventValue)
...
instance Attr Fieldset_ Name  String  where
  attr Name value = unsafeAttribute (  
    { key: "name", value: prop' value  } <$ _)
instance Attr Fieldset_ Name (Event.Event Unit -> Event.Event  String ) where
  attr Name eventValue = unsafeAttribute (map (map ( \value ->
    { key: "name", value: prop' value })) eventValue)
...
instance Attr Iframe_ Name  String  where
  attr Name value = unsafeAttribute (  
    { key: "name", value: prop' value  } <$ _)
instance Attr Iframe_ Name (Event.Event Unit -> Event.Event  String ) where
  attr Name eventValue = unsafeAttribute (map (map ( \value ->
    { key: "name", value: prop' value })) eventValue)
...
instance Attr Input_ Name  String  where
  attr Name value = unsafeAttribute (  
    { key: "name", value: prop' value  } <$ _)
instance Attr Input_ Name (Event.Event Unit -> Event.Event  String ) where
  attr Name eventValue = unsafeAttribute (map (map ( \value ->
    { key: "name", value: prop' value })) eventValue)
...
instance Attr Object_ Name  String  where
  attr Name value = unsafeAttribute (  
    { key: "name", value: prop' value  } <$ _)
instance Attr Object_ Name (Event.Event Unit -> Event.Event  String ) where
  attr Name eventValue = unsafeAttribute (map (map ( \value ->
    { key: "name", value: prop' value })) eventValue)
...
instance Attr Output_ Name  String  where
  attr Name value = unsafeAttribute (  
    { key: "name", value: prop' value  } <$ _)
instance Attr Output_ Name (Event.Event Unit -> Event.Event  String ) where
  attr Name eventValue = unsafeAttribute (map (map ( \value ->
    { key: "name", value: prop' value })) eventValue)
...
instance Attr Select_ Name  String  where
  attr Name value = unsafeAttribute (  
    { key: "name", value: prop' value  } <$ _)
instance Attr Select_ Name (Event.Event Unit -> Event.Event  String ) where
  attr Name eventValue = unsafeAttribute (map (map ( \value ->
    { key: "name", value: prop' value })) eventValue)
...
instance Attr Textarea_ Name  String  where
  attr Name value = unsafeAttribute (  
    { key: "name", value: prop' value  } <$ _)
instance Attr Textarea_ Name (Event.Event Unit -> Event.Event  String ) where
  attr Name eventValue = unsafeAttribute (map (map ( \value ->
    { key: "name", value: prop' value })) eventValue)
...
instance Attr Map_ Name  String  where
  attr Name value = unsafeAttribute (  
    { key: "name", value: prop' value  } <$ _)
instance Attr Map_ Name (Event.Event Unit -> Event.Event  String ) where
  attr Name eventValue = unsafeAttribute (map (map ( \value ->
    { key: "name", value: prop' value })) eventValue)
...
instance Attr Meta_ Name  String  where
  attr Name value = unsafeAttribute (  
    { key: "name", value: prop' value  } <$ _)
instance Attr Meta_ Name (Event.Event Unit -> Event.Event  String ) where
  attr Name eventValue = unsafeAttribute (map (map ( \value ->
    { key: "name", value: prop' value })) eventValue)
...
instance Attr Param_ Name  String  where
  attr Name value = unsafeAttribute (  
    { key: "name", value: prop' value  } <$ _)
instance Attr Param_ Name (Event.Event Unit -> Event.Event  String ) where
  attr Name eventValue = unsafeAttribute (map (map ( \value ->
    { key: "name", value: prop' value })) eventValue)
...
instance Attr everything Name (Event.Event Unit -> Event.Event  Unit ) where
  attr Name eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "name", value: unset' })) eventValue)
