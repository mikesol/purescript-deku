...
instance Attr anything OnMouseleave (Event.Event Unit -> Event.Event  Cb ) where
  attr OnMouseleave eventValue = unsafeAttribute (map (map (
    \value -> { key: "mouseleave", value: cb' value })) eventValue)
...
instance Attr anything OnMouseleave (Event.Event Unit -> Event.Event  (Effect Unit) ) where
  attr OnMouseleave eventValue = unsafeAttribute (map (map (
    \value -> { key: "mouseleave", value: cb' (Cb (const (value $> true))) })) eventValue)
...
instance Attr anything OnMouseleave (Event.Event Unit -> Event.Event  (Effect Boolean) ) where
  attr OnMouseleave eventValue = unsafeAttribute (map (map (
    \value -> { key: "mouseleave", value: cb' (Cb (const value)) })) eventValue) 
...
instance Attr everything OnMouseleave (Event.Event Unit -> Event.Event  Unit ) where
  attr OnMouseleave eventValue = unsafeAttribute (map (map (
    \_ -> { key: "mouseleave", value: unset' })) eventValue)
