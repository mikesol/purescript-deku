...
instance Attr Circle_ AriaCurrent String where
  attr AriaCurrent bothValues = unsafeAttribute $ Both
    { key: "aria-current", value: prop' (fst bothValues) }
    (snd bothValues <#> \value -> { key: "aria-current", value: prop' value })
  pureAttr AriaCurrent value = unsafeAttribute $ This
    { key: "aria-current", value: prop' value }
  unpureAttr AriaCurrent eventValue = unsafeAttribute $ That $ eventValue <#>
...
instance Attr everything AriaCurrent Unit where
  attr AriaCurrent bothValues = unsafeAttribute $ Both
    ...
    (snd bothValues <#> \_ -> { key: "aria-current", value: unset' })
  pureAttr AriaCurrent _ = unsafeAttribute $ This
    { key: "aria-current", value: unset' }
  unpureAttr AriaCurrent eventValue = unsafeAttribute $ That $ eventValue <#>
