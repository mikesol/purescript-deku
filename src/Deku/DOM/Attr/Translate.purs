...
instance Attr A_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr A_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
instance Attr A_ Translate (Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute \_ -> eventValue <#>
    \value -> { key: "translate", value: prop' value }
instance Attr Abbr_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Abbr_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Acronym_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Acronym_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Address_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Address_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Applet_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Applet_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Area_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Area_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Article_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Article_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Aside_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Aside_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Audio_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Audio_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr B_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr B_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Base_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Base_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Basefont_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Basefont_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Bdi_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Bdi_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Bdo_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Bdo_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Big_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Big_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Blockquote_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Blockquote_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Body_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Body_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Br_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Br_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Button_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Button_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Canvas_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Canvas_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Caption_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Caption_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Center_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Center_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Cite_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Cite_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Code_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Code_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Col_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Col_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Colgroup_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Colgroup_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Xdata_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Xdata_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Datalist_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Datalist_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Dd_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Dd_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Del_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Del_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Details_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Details_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Dfn_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Dfn_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Dialog_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Dialog_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Dir_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Dir_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Div_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Div_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Dl_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Dl_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Dt_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Dt_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Em_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Em_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Embed_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Embed_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Fieldset_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Fieldset_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Figcaption_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Figcaption_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Figure_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Figure_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Font_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Font_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Footer_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Footer_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Form_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Form_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Frame_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Frame_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Frameset_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Frameset_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr H1_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr H1_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr H2_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr H2_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr H3_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr H3_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr H4_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr H4_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr H5_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr H5_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr H6_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr H6_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Head_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Head_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Header_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Header_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Hr_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Hr_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Html_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Html_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr I_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr I_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Iframe_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Iframe_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Img_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Img_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Input_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Input_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Ins_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Ins_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Kbd_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Kbd_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Label_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Label_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Legend_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Legend_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Li_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Li_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Link_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Link_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Main_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Main_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Map_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Map_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Mark_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Mark_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Meta_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Meta_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Meter_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Meter_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Nav_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Nav_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Noframes_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Noframes_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Noscript_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Noscript_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Object_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Object_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Ol_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Ol_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Optgroup_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Optgroup_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Option_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Option_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Output_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Output_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr P_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr P_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Param_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Param_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Picture_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Picture_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Pre_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Pre_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Progress_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Progress_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Q_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Q_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Rp_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Rp_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Rt_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Rt_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Ruby_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Ruby_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr S_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr S_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Samp_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Samp_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Script_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Script_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Section_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Section_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Select_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Select_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Small_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Small_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Source_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Source_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Span_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Span_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Strike_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Strike_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Strong_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Strong_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Style_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Style_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Sub_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Sub_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Summary_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Summary_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Sup_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Sup_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Svg_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Svg_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Table_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Table_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Tbody_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Tbody_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Td_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Td_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Template_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Template_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Textarea_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Textarea_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Tfoot_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Tfoot_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Th_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Th_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Thead_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Thead_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Time_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Time_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Title_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Title_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Tr_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Tr_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Track_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Track_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Tt_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Tt_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr U_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr U_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Ul_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Ul_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Var_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Var_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Video_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Video_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr Wbr_ Translate  String  where
  attr Translate value = unsafeAttribute (  
    { key: "translate", value: prop' value  } <$ _)
instance Attr Wbr_ Translate (Event.Event Unit -> Event.Event  String ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \value -> { key: "translate", value: prop' value })) eventValue)
...
instance Attr everything Translate  Unit  where
  attr Translate _ = unsafeAttribute (  
    { key: "translate", value: unset'  } <$ _)
instance Attr everything Translate (Event.Event Unit -> Event.Event  Unit ) where
  attr Translate eventValue = unsafeAttribute (map (map (
    \_ -> { key: "translate", value: unset' })) eventValue)
