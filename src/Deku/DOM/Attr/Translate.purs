...
instance Attr A_ Translate String where
  attr Translate bothValues = unsafeAttribute $ Both
    { key: "translate", value: prop' (fst bothValues) }
    (snd bothValues <#> \value -> { key: "translate", value: prop' value })
  pureAttr Translate value = unsafeAttribute $ This
    { key: "translate", value: prop' value }
  unpureAttr Translate eventValue = unsafeAttribute $ That $ eventValue <#>
...
instance Attr everything Translate Unit where
  attr Translate bothValues = unsafeAttribute $ Both
    ...
    (snd bothValues <#> \_ -> { key: "translate", value: unset' })
  pureAttr Translate _ = unsafeAttribute $ This
    { key: "translate", value: unset' }
  unpureAttr Translate eventValue = unsafeAttribute $ That $ eventValue <#>
