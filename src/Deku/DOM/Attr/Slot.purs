...
instance Attr A_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr A_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
instance Attr A_ Slot (Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute \_ -> eventValue <#> \value ->
    { key: "slot", value: prop' value }
instance Attr Abbr_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Abbr_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Acronym_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Acronym_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Address_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Address_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Applet_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Applet_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Area_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Area_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Article_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Article_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Aside_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Aside_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Audio_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Audio_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr B_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr B_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Base_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Base_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Basefont_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Basefont_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Bdi_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Bdi_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Bdo_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Bdo_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Big_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Big_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Blockquote_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Blockquote_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Body_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Body_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Br_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Br_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Button_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Button_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Canvas_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Canvas_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Caption_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Caption_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Center_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Center_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Cite_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Cite_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Code_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Code_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Col_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Col_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Colgroup_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Colgroup_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Xdata_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Xdata_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Datalist_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Datalist_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Dd_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Dd_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Del_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Del_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Details_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Details_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Dfn_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Dfn_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Dialog_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Dialog_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Dir_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Dir_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Div_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Div_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Dl_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Dl_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Dt_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Dt_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Em_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Em_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Embed_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Embed_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Fieldset_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Fieldset_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Figcaption_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Figcaption_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Figure_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Figure_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Font_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Font_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Footer_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Footer_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Form_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Form_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Frame_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Frame_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Frameset_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Frameset_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr H1_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr H1_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr H2_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr H2_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr H3_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr H3_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr H4_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr H4_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr H5_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr H5_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr H6_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr H6_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Head_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Head_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Header_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Header_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Hr_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Hr_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Html_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Html_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr I_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr I_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Iframe_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Iframe_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Img_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Img_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Input_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Input_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Ins_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Ins_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Kbd_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Kbd_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Label_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Label_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Legend_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Legend_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Li_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Li_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Link_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Link_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Main_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Main_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Map_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Map_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Mark_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Mark_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Meta_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Meta_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Meter_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Meter_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Nav_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Nav_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Noframes_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Noframes_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Noscript_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Noscript_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Object_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Object_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Ol_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Ol_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Optgroup_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Optgroup_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Option_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Option_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Output_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Output_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr P_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr P_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Param_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Param_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Picture_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Picture_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Pre_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Pre_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Progress_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Progress_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Q_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Q_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Rp_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Rp_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Rt_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Rt_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Ruby_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Ruby_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr S_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr S_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Samp_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Samp_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Script_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Script_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Section_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Section_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Select_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Select_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Small_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Small_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Source_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Source_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Span_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Span_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Strike_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Strike_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Strong_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Strong_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Style_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Style_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Sub_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Sub_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Summary_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Summary_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Sup_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Sup_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Svg_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Svg_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Table_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Table_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Tbody_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Tbody_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Td_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Td_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Template_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Template_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Textarea_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Textarea_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Tfoot_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Tfoot_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Th_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Th_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Thead_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Thead_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Time_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Time_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Title_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Title_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Tr_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Tr_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Track_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Track_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Tt_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Tt_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr U_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr U_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Ul_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Ul_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Var_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Var_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Video_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Video_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr Wbr_ Slot  String  where
  attr Slot value = unsafeAttribute (  
    { key: "slot", value: prop' value  } <$ _)
instance Attr Wbr_ Slot (Event.Event Unit -> Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \value ->
    { key: "slot", value: prop' value })) eventValue)
...
instance Attr everything Slot  Unit  where
  attr Slot _ = unsafeAttribute (  { key: "slot", value: unset'  } <$ _)
instance Attr everything Slot (Event.Event Unit -> Event.Event  Unit ) where
  attr Slot eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "slot", value: unset' })) eventValue)
instance Attr everything Slot (Event.Event  Unit ) where
  attr Slot eventValue = unsafeAttribute \_ -> eventValue <#> \_ ->
