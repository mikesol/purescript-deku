...
instance Attr A_ Slot  String  where
  attr Slot value = unsafeAttribute $ Left $  
    { key: "slot", value: prop' value }
instance Attr A_ Slot (Event.Event  String ) where
  attr Slot eventValue = unsafeAttribute $ Right $ eventValue <#> \value ->
    { key: "slot", value: prop' value }
...
instance Attr everything Slot  Unit  where
  attr Slot _ = unsafeAttribute $ Left $  { key: "slot", value: unset' }
instance Attr everything Slot (Event.Event  Unit ) where
  attr Slot eventValue = unsafeAttribute $ Right $ eventValue <#> \_ ->
