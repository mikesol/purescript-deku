...
instance Attr A_ Hreflang (Event.Event Unit -> Event.Event  String ) where
  attr Hreflang eventValue = unsafeAttribute (map (map (
    \value -> { key: "hreflang", value: prop' value })) eventValue)
...
instance Attr Area_ Hreflang  String  where
  attr Hreflang value = unsafeAttribute (  
    { key: "hreflang", value: prop' value  } <$ _)
instance Attr Area_ Hreflang (Event.Event Unit -> Event.Event  String ) where
  attr Hreflang eventValue = unsafeAttribute (map (map (
    \value -> { key: "hreflang", value: prop' value })) eventValue)
...
instance Attr Link_ Hreflang  String  where
  attr Hreflang value = unsafeAttribute (  
    { key: "hreflang", value: prop' value  } <$ _)
instance Attr Link_ Hreflang (Event.Event Unit -> Event.Event  String ) where
  attr Hreflang eventValue = unsafeAttribute (map (map (
    \value -> { key: "hreflang", value: prop' value })) eventValue)
...
instance Attr everything Hreflang (Event.Event Unit -> Event.Event  Unit ) where
  attr Hreflang eventValue = unsafeAttribute (map (map ( \_ ->
    { key: "hreflang", value: unset' })) eventValue)
