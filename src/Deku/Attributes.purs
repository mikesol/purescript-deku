...
-- | fired.
klass_ :: forall e. Attr e D.Class String => String -> Poll (Attribute e)
klass_ = klass <<< pure
...
-- | fired.
style_ :: forall e. Attr e D.Style String => String -> Poll (Attribute e)
style_ = style <<< pure
...
-- | fired.
id_ :: forall e. Attr e D.Id String => String -> Poll (Attribute e)
id_ = id <<< pure
...
-- | fired.
href_ :: forall e. Attr e D.Href String => String -> Poll (Attribute e)
href_ = href <<< pure