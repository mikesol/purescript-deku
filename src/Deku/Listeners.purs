...
keyPoll'
  ...
  -> f59 (Attribute e64)
keyPoll' listener = map \f -> listener := cb \e -> for_ (fromEvent e) f
...
keyUp
  :: forall element
   . Poll (KeyboardEvent -> Effect Unit)
  -> Poll (Attribute element)
keyUp = keyPoll' D.OnKeyup
