...
instance PathWalker a r => PathWalker (Path.XRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
...
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXXXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXXXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXXXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXXXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXXYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXXYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXXYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXXYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXYXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXYXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXYXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXYXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXYYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXYYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXYYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXYYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYXXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYXXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYXXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYXXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYXYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYXYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYXYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYXYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYYXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYYXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYYXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYYXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYYYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYYYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYYYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYYYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXXXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXXXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXXXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXXXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXXYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXXYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXXYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXXYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXYXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXYXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXYXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXYXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXYYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXYYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXYYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXYYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYXXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYXXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYXXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYXXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYXYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYXYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYXYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYXYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYYXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYYXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYYXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYYXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYYYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYYYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYYYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYYYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXXXXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXXXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXXXXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXXXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXXXXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXXXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXXXXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXXXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXXXYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXXXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXXXYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXXXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXXXYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXXXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXXXYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXXXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXXYXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXXYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXXYXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXXYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXXYXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXXYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXXYXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXXYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXXYYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXXYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXXYYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXXYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXXYYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXXYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXXYYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXXYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXYXXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXYXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXYXXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXYXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXYXXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXYXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXYXXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXYXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXYXYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXYXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXYXYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXYXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXYXYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXYXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXYXYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXYXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXYYXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXYYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXYYXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXYYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXYYXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXYYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXYYXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXYYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXYYYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXYYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXYYYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXYYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XXYYYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XXYYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XXYYYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XXYYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYXXXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYXXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYXXXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYXXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYXXXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYXXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYXXXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYXXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYXXYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYXXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYXXYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYXXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYXXYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYXXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYXXYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYXXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYXYXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYXYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYXYXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYXYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYXYXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYXYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYXYXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYXYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYXYYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYXYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYXYYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYXYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYXYYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYXYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYXYYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYXYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYYXXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYYXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYYXXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYYXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYYXXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYYXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYYXXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYYXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYYXYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYYXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYYXYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYYXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYYXYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYYXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYYXYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYYXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYYYXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYYYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYYYXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYYYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYYYXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYYYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYYYXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYYYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYYYYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYYYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYYYYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYYYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.XYYYYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.XYYYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.XYYYYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.XYYYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXXXXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXXXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXXXXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXXXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXXXXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXXXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXXXXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXXXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXXXYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXXXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXXXYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXXXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXXXYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXXXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXXXYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXXXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXXYXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXXYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXXYXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXXYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXXYXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXXYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXXYXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXXYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXXYYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXXYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXXYYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXXYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXXYYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXXYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXXYYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXXYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXYXXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXYXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXYXXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXYXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXYXXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXYXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXYXXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXYXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXYXYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXYXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXYXYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXYXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXYXYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXYXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXYXYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXYXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXYYXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXYYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXYYXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXYYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXYYXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXYYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXYYXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXYYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXYYYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXYYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXYYYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXYYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YXYYYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YXYYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YXYYYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YXYYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYXXXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYXXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYXXXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYXXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYXXXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYXXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYXXXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYXXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYXXYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYXXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYXXYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYXXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYXXYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYXXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYXXYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYXXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYXYXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYXYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYXYXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYXYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYXYXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYXYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYXYXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYXYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYXYYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYXYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYXYYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYXYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYXYYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYXYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYXYYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYXYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYYXXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYYXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYYXXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYYXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYYXXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYYXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYYXXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYYXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYYXYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYYXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYYXYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYYXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYYXYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYYXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYYXYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYYXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYYYXXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYYYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYYYXXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYYYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYYYXYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYYYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYYYXYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYYYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYYYYXRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYYYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYYYYXTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYYYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
...
instance PathWalker a r => PathWalker (Path.YYYYYYRightGroup a) r where
  walk = mkEffectFn4 \_ r di e -> do
    ...
    runEffectFn4 walk (Proxy :: _ a) r di p
instance (RL.RowToList r rl, ProcessInstructions r rl, PathWalker a r) => PathWalker (Path.YYYYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
instance (PathWalker a r, PathWalker b r) => PathWalker (Path.YYYYYYTwoContGroups a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
instance (PathWalker a r, PathWalker b r, RL.RowToList r rl, ProcessInstructions r rl) => PathWalker (Path.YYYYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn4 \_ r di e -> do
    runEffectFn4 processInstructions (Proxy :: _ rl) r di e
    runEffectFn4 walk (Proxy :: _ a) r di e
    runEffectFn4 walk (Proxy :: _ b) r di e
