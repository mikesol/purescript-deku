...
class PathWalker p r | p -> r where
  walk
    :: EffectFn5 InstructionDelegate (Proxy p) { | r } DOMInterpret MElement
         Unit

class ProcessInstruction :: Symbol -> Type -> Constraint
class ProcessInstruction s i where
  processInstruction
    :: EffectFn5 InstructionDelegate (Proxy s) i DOMInterpret MElement Unit

class ProcessInstructions :: Row Type -> RL.RowList Symbol -> Constraint
class ProcessInstructions r rl | rl -> r where
  processInstructions
    :: EffectFn5 InstructionDelegate (Proxy rl) { | r } DOMInterpret MElement
         Unit
...
instance
  ( IsSymbol k
  , R.Cons k v r' r
  , ProcessInstruction k v
  , ProcessInstructions r c
  ) =>
  ProcessInstructions r (RL.Cons k k c) where
  processInstructions = mkEffectFn5 \instr _ r di e -> do
    runEffectFn5 processInstruction instr (Proxy :: _ k) (get (Proxy :: _ k) r)
      di
      e
    runEffectFn5 processInstructions instr (Proxy :: _ c) r di e

instance IsSymbol k => ProcessInstruction k String where
  processInstruction = mkEffectFn5
    \(InstructionDelegate { processString }) k s di e -> do
...
instance IsSymbol k => ProcessInstruction k (Poll (Attribute e)) where
  processInstruction = mkEffectFn5
    \(InstructionDelegate { processAttribute }) k att di e -> do
      runEffectFn4 processAttribute (reflectSymbol k)
        (map unsafeUnAttribute att)
        di
        e

processNutPursx :: EffectFn2 String MElement Text -> InstructionSignature Nut
processNutPursx splitter = mkEffectFn4
  \k (Nut nut) di@(DOMInterpret { makeElement }) e -> do

    fauxPar <- runEffectFn2 makeElement Nothing (Tag "template")
    let par = mEltParent e
    o <- runEffectFn2 nut
      (PSR { unsubs: [], parent: fauxPar, beacon: Nothing, fromPortal: false })
      di
...
instance IsSymbol k => ProcessInstruction k Nut where
  processInstruction = mkEffectFn5
    \(InstructionDelegate { processNut }) k nut di e -> do
...
instance
  ( ProcessInstructions r zz
  , PathWalker a r
  ) =>
  PathWalker (Path.ContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.TwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.TwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXXYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XXYYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYXYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.XYYYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXXYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YXYYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYXYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYXYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYXXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYXXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYXXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYXYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYXYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYXYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYYXContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYYXTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYYXTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYYYContGroupWithMarkers zz a) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYYYTwoContGroups a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
...
instance
  ...
  PathWalker (Path.YYYYYYTwoContGroupsWithMarkers zz a b) r where
  walk = mkEffectFn5 \instr _ r di e -> do
