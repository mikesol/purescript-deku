...
instance Deku.Attribute.Attr everything OnReset Data.Unit.Unit where
  attr _ _ = Deku.Attribute.unsafeAttribute { key: "onReset", value: Deku.Attribute.unset' }

instance
  Deku.Attribute.Attr everything
    OnReset
    (Web.Event.Internal.Types.Event -> Effect.Effect Data.Unit.Unit) where
  attr _ = Deku.Attribute.unsafeAttribute <<< { key: "onReset", value: _ } <<< Deku.Attribute.cb'
    <<< Deku.Attribute.cb
