...
</div>`}})()()(er()(zr()(er()(xr)({reflectType:function(){return"result"}})({reflectSymbol:function(){return"result"}}))({reflectType:function(){return"next"}})({reflectSymbol:function(){return"next"}}))({reflectType:function(){return"code"}})({reflectSymbol:function(){return"code"}}))(BC)({code:rr(hr([Sr([Wt(dl)])])),result:rr(Yt([Wt("Hello world")])),next:mr(Dt)(D)(_(V))([tt(dr)(cr.value)(fr(function(r){return Rt(tr)(Rt(tr)(Nr(r))(t.dpage(Ra.value)))(Qr)})),tt(Or)(Mr.value)(t.slug+"component/")])})};var UC=function(){return J.value}(),mD=function(t){return Rr({reflectType:function(){return`<div>
  <h1>Deku</h1>
...
</div>`}})()()(zr()(xr)({reflectType:function(){return"next"}})({reflectSymbol:function(){return"next"}}))(UC)({next:mr(Dt)(D)(_(V))([tt(dr)(cr.value)(fr(function(r){return Rt(tr)(Rt(tr)(Nr(r))(t.dpage(Oa.value)))(Qr)})),tt(Or)(Mr.value)(t.slug+"hello/")])})};var zC=function(){return J.value}(),DD=function(t){return Rr({reflectType:function(){return`<div>
  <h1>Portals</h1>
...
`}})()(xr)(jC)),next:mr(Dt)(D)(_(V))([tt(dr)(cr.value)(fr(function(r){return Rt(tr)(Rt(tr)(Nr(r))(t.dpage(Ba.value)))(Qr)})),tt(Or)(Mr.value)(t.slug+"events1/")])})};var GC=function(){return J.value}(),KC=function(){return J.value}(),dD=function(t){return vl({reflectType:function(){return`<div>
  <h1>Pursx 2</h1>
